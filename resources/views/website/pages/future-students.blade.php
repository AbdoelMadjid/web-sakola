...
<!-- Mirrored from htmlstream.com/preview/unify-v2.6.3/multipage/education/page-future-students-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Feb 2026 13:34:18 GMT -->

<head>
    <base href="{{ url('/') }}/">
    <!-- Title -->
    <title>{{ str_starts_with(app()->getLocale(), 'id') ? 'Multipage - Halaman Calon Siswa Pendidikan | Unify - Template Website Responsif' : 'Multipage - Education Future Students Page | Unify - Responsive Website Template' }}</title>
    ...
    <main>
            ...
            <div class="js-bg-video" data-hs-bgv-type="youtube" data-hs-bgv-id="FxiskmF16gU" data-hs-bgv-loop="1">
                <div class="g-bg-cover g-bg-black-opacity-0_6--after g-pos-rel g-z-index-1">
                    <div class="container text-center g-pos-rel g-z-index-1 g-pt-100 g-pb-80">
                        <!-- Promo Block Info -->
                        <div class="g-mb-40">
                            <h1 class="g-color-white g-font-size-60--lg">Become a Unify Student</h1>
                            <p class="g-color-white-opacity-0_8 g-font-size-22">Search from more than 500 diverse
                                programs. Find your fit at Unify.</p>
                        </div>
                        ...
                        <form class="g-max-width-645 mx-auto">
                            <input
                                class="form-control h-100 g-brd-none g-font-size-16 g-rounded-30 g-px-30 g-py-14 g-mb-20"
        ...
        <div class="container g-pt-100 g-pb-50">
            ...
            <div class="g-max-width-645 text-center mx-auto g-mb-60">
                <h2 class="h1 mb-3">Your Unify Edge</h2>
            ...
            <div class="row">
                ...
                <article class="col-md-4 g-mb-30">
                    ...
                    <div class="g-mb-35">
                        ...
                        <p class="g-font-size-15">With <a class="g-font-weight-500" href="page-programs-1.html">over
                                80 programs</a> and a thriving community, Unify provides a <a class="g-font-weight-500"
                                href="page-programs-1.html">fantastic learning environment</a> for students coming
                            straight from high school or transferring from other post-secondary instititions.</p>
                    </div>
                    <a class="btn u-shadow-v39 g-color-white g-color-white--hover g-bg-main g-bg-primary--hover g-font-size-default g-rounded-30 g-px-35 g-py-8"
                        href="page-apply-1.html">Start Your Application</a>
                </article>
                <!-- End Studies -->
                ...
                <article class="col-md-4 g-mb-30">
                    ...
                    <div class="g-mb-35">
                        ...
                        <p class="g-font-size-15">Unify's Faculty of Graduate Studies is home to over 3500 students
                            studying in <a class="g-font-weight-500" href="page-programs-1.html">over 160 graduate
                                programs</a>, with a reputation for quality and innovation that's respected around the
                            globe.</p>
                    </div>
                    <a class="btn u-shadow-v39 g-color-white g-color-white--hover g-bg-main g-bg-primary--hover g-font-size-default g-rounded-30 g-px-35 g-py-8"
                        href="page-apply-1.html">Start Your Application</a>
                ...
                <article class="col-md-4 g-mb-30">
                    ...
                    <div class="g-mb-35">
                        ...
                        <p class="g-font-size-15">Take the next step on your journey with <a class="g-font-weight-500"
                                href="#">continuing studies</a> and professional-development programs at Unify.
                            Learn skills that will benefit your current job, or head down an entirely new career path.
                        </p>
                    </div>
                    <a class="btn u-shadow-v39 g-color-white g-color-white--hover g-bg-main g-bg-primary--hover g-font-size-default g-rounded-30 g-px-35 g-py-8"
                        href="page-apply-1.html">Start Your Application</a>
        ...
        <div class="container-fluid g-pos-rel g-pa-30">
            <div class="row justify-content-end align-items-center">
                    ...
                    <div id="carouselCus1" class="js-carousel g-bg-secondary g-pos-rel" data-infinite="true"
                        ...
                        <div class="js-slide d-flex g-min-height-70vh g-flex-centered g-pa-70">
                            <div class="text-center">
                                <div class="mb-5">
                                    <h2 class="h1 mb-3">Fuel your success with dynamic learning</h2>
                                    <p>Don't just learn: get real-world experience as you learn. It gives you an edge by
                                        accelerating your personal and academic growth, and prepares you for career
                                        success.</p>
                                </div>
                        ...
                        <div class="js-slide d-flex g-min-height-70vh g-flex-centered g-pa-70">
                            <div class="text-center">
                                <div class="mb-5">
                                    <h2 class="h1 mb-3">Make a vital impact your way</h2>
                                    <p>Being at Unify means belonging to a community of minds committed to tackling
                                        real-world issues. What will your vital impact be?</p>
                                </div>
                                <a class="btn g-brd-2 g-brd-main-opacity-0_1 g-brd-primary--hover g-color-main g-color-white--hover g-bg-primary--hover g-font-size-15 g-rounded-30 g-px-25 g-py-8"
                                    href="#">Learn More</a>
                            </div>
                        ...
                        <div class="js-slide d-flex g-min-height-70vh g-flex-centered g-pa-70">
                            <div class="text-center">
                                <div class="mb-5">
                                    <h2 class="h1 mb-3">Learn by doing</h2>
                                    <p>The world is interconnected and ever-evolving. Learning should be too. That's why
                                        our undergraduate students are immersed in hands-on learning opportunities.</p>
                                </div>
                                <a class="btn g-brd-2 g-brd-main-opacity-0_1 g-brd-primary--hover g-color-main g-color-white--hover g-bg-primary--hover g-font-size-15 g-rounded-30 g-px-25 g-py-8"
                                    href="#">Learn More</a>
                            </div>
                ...
                <div class="col-sm-6">
                    <!-- Carousel - Image -->
                    <div id="carouselCus2" class="js-carousel g-pos-rel" data-infinite="true"
            ...
            <div class="row">
                <div class="col-md-4 g-py-15 g-mb-30">
                    <div class="g-px-30--lg">
                        ...
                        <p class="g-color-text-light-v1 mb-0">In an extraordinary environment that inspires you to new
                            ways of thinking.</p>
                    </div>
                </div>
                <div class="col-md-4 g-brd-x g-brd-secondary-light-v2 g-py-15 g-mb-30">
                    <div class="g-px-30--lg">
                        ...
                        <p class="g-color-text-light-v1 mb-0">In a landscape full of dynamic learning opportunities.
                        </p>
                    </div>
                </div>
                <div class="col-md-4 g-py-15 g-mb-30">
                    <div class="g-px-30--lg">
                        ...
                        <p class="g-color-text-light-v1 mb-0">In a community that provides endless opportunities for
                            you to make impact.</p>
                    </div>
                </div>
            </div>
            <!-- End Info -->
                    ...
                    <div class="col-md-9 col-lg-7 g-mb-30">
                        ...
                        <div class="media align-items-center g-pr-15--lg">
                            ...
                            <div class="media-body">
                                <h3 class="h2">Take a virtual tour of Unify University</h3>
                                <p>Do you want to implement microtransactions, have unusually large average order
                                    values, or operate with high refund rates? Get in touch to discuss your idea.</p>
                            </div>
                        </div>
                        <!-- End Media -->
                    </div>
        ...
        <div class="container g-pos-rel g-pt-100">
            <div class="row justify-content-end align-items-center">
                <div class="col-sm-6 order-sm-2 g-mb-30">
                    ...
                    <div id="carouselCus3" class="js-carousel" data-infinite="true" data-autoplay="true"
                        data-speed="10000" data-nav-for="#carouselCus4" data-in-effect="slideInRight"
                        ...
                        <div class="js-slide g-pl-50--lg">
                            ...
                            <div class="media mb-3">
                                ...
                                <div class="media-body">
                                    <blockquote class="g-brd-left-none g-font-style-italic g-font-size-20 g-pl-0">The
                                        program offers both a strong theoretical and practical component providing the
                                        solid foundation needed for student teachers to venture out into the realm of
                                        teaching.
                                        <span
                            ...
                            <div class="g-pl-30">
                                ...
                                <span class="d-block g-font-size-18 g-pl-20">&#8212; Bachelor Student</span>
                            </div>
                        ...
                        <div class="js-slide g-pl-50--lg">
                            ...
                            <div class="media mb-3">
                                ...
                                <div class="media-body">
                                    <blockquote class="g-brd-left-none g-font-style-italic g-font-size-20 g-pl-0">
                                        Unify's TESL program was a personally enriching and professionally beneficial
                                        experience that opened the door to a rewarding second career in ESL.
                                        <span
                                            class="align-self-end g-font-secondary g-font-size-40 g-opacity-0_3 g-line-height-0 align-bottom g-pos-rel g-top-minus-10">&#8221;</span>
                                    </blockquote>
                                </div>
                            ...
                            <div class="g-pl-30">
                                ...
                                <span class="d-block g-font-size-18 g-pl-20">&#8212; 2015 Grad</span>
                            </div>
                            <!-- End Testimonials - Content -->
                        </div>
                        ...
                        <div class="js-slide g-pl-50--lg">
                            ...
                            <div class="media mb-3">
                                ...
                                <div class="media-body">
                                    <blockquote class="g-brd-left-none g-font-style-italic g-font-size-20 g-pl-0">I
                                        would highly recommend the Unify TESL program – it gave me the training, tools
                                        and network to get ESL teaching opportunities in Toronto. Unify's program
                                        provided a good balance of both the practical and theoretical knowledge.
                                        <span
                                            class="align-self-end g-font-secondary g-font-size-40 g-opacity-0_3 g-line-height-0 align-bottom g-pos-rel g-top-minus-10">&#8221;</span>
                                    </blockquote>
                                </div>
                            ...
                            <div class="g-pl-30">
                                ...
                                <span class="d-block g-font-size-18 g-pl-20">&#8212; 2017 Grad</span>
                            </div>
                            <!-- End Testimonials - Content -->
                        </div>
                    </div>
                ...
                <div class="col-sm-6 order-sm-1 g-pos-stc g-mb-30">
                    <!-- Carousel - Image -->
                    <div id="carouselCus4" class="js-carousel g-pos-stc" data-infinite="true"
...
<!-- Mirrored from htmlstream.com/preview/unify-v2.6.3/multipage/education/page-future-students-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Feb 2026 13:34:24 GMT -->
