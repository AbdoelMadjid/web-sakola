...
<!-- Mirrored from htmlstream.com/preview/unify-v2.6.3/multipage/education/page-programs-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Feb 2026 13:34:18 GMT -->

<head>
    <base href="{{ url('/') }}/">
    <!-- Title -->
    <title>{{ str_starts_with(app()->getLocale(), 'id') ? 'Multipage - Halaman Program Pendidikan | Unify - Template Website Responsif' : 'Multipage - Education Programs Page | Unify - Responsive Website Template' }}</title>
            ...
            <div class="container g-pt-100 g-pb-70">
                ...
                <div class="row justify-content-center align-items-center g-mb-30">
                        ...
                        <ul
                            ...
                            <li class="list-inline-item g-mx-10">
                                <label class="form-check-inline u-check g-pl-30 ml-0 g-mr-15 mb-0">
                                    <input class="g-hidden-xs-up g-pos-abs g-top-0 g-left-0" name="radGroup1_1"
                                        type="radio" checked="">
                    ...
                    <div class="col-sm-6 col-md-2">
                        ...
                        <select
                            ...
                            data-placeholder="Campus" data-open-icon="fa fa-angle-down"
                            data-close-icon="fa fa-angle-up">
                            <option></option>
                            <option
                                class="g-brd-secondary-light-v2 g-color-main g-color-white--active g-bg-primary--active"
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-3 g-mb-30">
                        ...
                        <select
                            class="js-custom-select w-100 u-select-v1 u-shadow-v32 g-brd-none g-color-main g-color-primary--hover g-bg-white text-left g-rounded-30 g-pl-25 g-py-12"
                            data-placeholder="Intake" data-open-icon="fa fa-angle-down"
                            data-close-icon="fa fa-angle-up">
                            <option></option>
                            <option
                                class="g-brd-secondary-light-v2 g-color-main g-color-white--active g-bg-primary--active"
                    ...
                    <div class="col-sm-6 col-md-3 g-mb-30">
                        ...
                        <select
                            class="js-custom-select w-100 u-select-v1 u-shadow-v32 g-brd-none g-color-main g-color-primary--hover g-bg-white text-left g-rounded-30 g-pl-25 g-py-12"
                            data-placeholder="Area of Study" data-open-icon="fa fa-angle-down"
                            data-close-icon="fa fa-angle-up">
                            <option></option>
                            <option
                                class="g-brd-secondary-light-v2 g-color-main g-color-white--active g-bg-primary--active"
                ...
                <div class="col-lg-9 g-mb-70">
                    <div class="mb-5">
                        ...
                        <p>Explore your program details, including entry points, entrance requirements and application
                            deadlines. In addition to academic unit requirements, you must also meet the general
                            admission requirements for the Faculty of Graduate Studies to be admitted into graduate
                            studies at Unify. See the Graduate Calendar for more information about our academic
                            programs.</p>
                    </div>
                        ...
                        <div class="row g-bg-main g-color-white g-font-size-16 g-py-15">
                            <div class="col-sm-4">
                                <div class="d-flex align-items-center">
                                    <h2 class="h5 mb-0"><a
                                            class="u-link-v5 g-color-white-opacity-0_8 g-color-white--hover"
                                            href="#">
                        ...
                        <div class="js-sticky-block g-sticky-block--lg pt-4" data-responsive="true"
                            ...
                            <ul class="list-unstyled g-mb-50">
                                <li class="mb-1">
                                    <a class="d-block u-link-v5 g-color-text g-color-white--hover g-bg-secondary g-bg-main--hover g-font-size-default rounded g-pl-30--hover g-px-20 g-py-7"
                                        href="#">
                                        <i
                                            class="g-font-size-13 g-pos-rel g-top-2 mr-2 material-icons">arrow_forward</i>
                                        Academic Calendar
                                    </a>
                                </li>
                                <li class="mb-1">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="g-brd-bottom g-brd-secondary-light-v2 g-pb-20">
                                    <h4 class="h6">RT <a class="g-font-weight-600" href="#">@UofA_Arts:</a>
                                        DON'T MISS</h4>
                                    <p class="g-color-text-light-v1 g-font-size-13 mb-0">Political Science's “What
                                        Comes Next? The Political Afterlives of the <a class="g-font-weight-500"
