...
<!-- Mirrored from htmlstream.com/preview/unify-v2.6.3/multipage/education/page-apply-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Feb 2026 13:34:07 GMT -->

<head>
    <base href="{{ url('/') }}/">
    <!-- Title -->
    <title>{{ str_starts_with(app()->getLocale(), 'id') ? 'Multipage - Halaman Pendaftaran Pendidikan | Unify - Template Website Responsif' : 'Multipage - Education Apply Page | Unify - Responsive Website Template' }}</title>
...
<body>
            ...
            <div class="container g-pb-50">
                <div class="row">
                    ...
                    <div class="col-lg-5 g-mb-50">
                        <h2 class="g-hidden-md-down g-font-size-18 g-font-primary g-font-weight-400 mb-4">Be part of
                            Innovation</h2>

                        <!-- Disclaimer -->
                        <div class="u-shadow-v32 g-bg-white rounded g-pa-30 g-mb-30">
                            <p class="mb-0">The information on this page applies to future students. Current students
                                should refer to their faculty handbooks for course information.</p>
                        </div>
                        <!-- End Disclaimer -->

                        <!-- Info Banner -->
                        <div
                            class="u-shadow-v36 g-bg-main-light-v2 g-bg-primary--hover rounded g-pos-rel g-pa-30 g-mb-30">
        ...
        <div id="sub-navigation" class="g-pos-rel">
            <div class="js-sticky-block container u-secondary-navigation u-shadow-v19 g-bg-white g-line-height-1_3 g-py-20 g-pos-abs g-top-0 g-left-0 g-right-0"
                ...
                <ul id="js-scroll-nav"
                    ...
                    <li class="nav-item g-brd-right--sm g-brd-gray-light-v4 g-color-primary--active">
                        <a href="#careerPaths" class="nav-link g-font-weight-500 g-font-size-default g-px-20">Career
                            Paths</a>
                    </li>
                    <li class="nav-item g-brd-right--sm g-brd-gray-light-v4 g-color-primary--active">
                    ...
                    <li class="nav-item g-color-primary--active">
                        <a href="#entryFeesAndApply"
                            class="nav-link g-font-weight-500 g-font-size-default g-px-20">Entry Fees &amp; How to
                            Apply</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="container g-pt-150 g-pb-170">
                <div class="g-max-width-960 mx-auto">
                    ...
                    <div id="carouseDetails" class="row g-pb-80">
                        <div class="col-lg-1 g-mb-20 g-mb-0--lg">
                            <span
                                class="u-icon-v1 u-icon-size--xl g-color-main g-bg-secondary g-font-size-30 rounded-circle">
                            ...
                            <div class="g-pl-15--lg">
                                ...
                                <div class="row">
                                    ...
                                    <ul class="col-md-4 g-color-text-light-v1 g-font-size-15 g-pl-30 mb-0">
                                        ...
                                        <li class="py-1"><a class="g-color-primary" href="#">Graduate
                                                Attributes</a></li>
                                    </ul>
                                </div>

                                <ul class="g-color-text-light-v1 g-font-size-15 g-pl-15 mb-0">
                                    <li class="py-1">Duration full time: 5 years full time for Domestic and
                                        International students</li>
                                    <li class="py-1">Duration part time: Part time study available for eligible
                                        applicants (excluding international student visa holders)</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="careerPaths" class="row g-py-80">
                        ...
                        <div class="col-lg-11">
                            <div class="g-pl-15--lg">
                                <h3>Career Paths</h3>
                                <p>Government departments at all levels recruit outstanding graduates. Employers value
                                    the maturity, interpersonal skills, written and oral communication and teamwork
                                    skills of Sydney graduates.</p>
                                <p>Our advanced computing and commerce graduates can be found in a broad range of
                                    careers and roles including:</p>
                    ...
                    <div id="yourFee" class="row g-py-80">
                        ...
                        <div class="col-lg-11">
                            <div class="g-pl-15--lg">
                                <h3>Your Fee</h3>
                                <p><span class="g-font-weight-500">Student Contribution Amount (SCA) for year 1:
                                        $10,951</span> (indicative only)</p>
                                <p>For Commonwealth Supported students commencing this course, the indicative SCA for
                                    Year 1 of full-time study of 48 credit points (1.0 EFTSL).</p>
                                <p>The SCA that you will pay depends on the calendar year in which you undertake your
                                    study in the course, and the specific units of study in which you enrol.</p>
                                <p class="g-font-weight-500">This amount is subject to annual increase each year of
                                    your study (subject to a maximum amount determined by the Australian Government),
                                    effective at the start of each calendar year. Please read carefully the 'Important
                                    Fee Information' section set out below.</p>
                            </div>
                        </div>
                    </div>
                    <!-- End Your Fee -->
                        ...
                        <div class="col-lg-11">
                            <div class="g-pl-15--lg">
                                ...
                                <div class="card-group d-block d-md-flex g-mx-minus-15">
                                    <div class="card g-brd-none g-mx-15 g-mb-30">
                                        <a class="card-body d-block u-link-v5 u-shadow-v32 g-color-main g-color-primary--hover g-bg-white g-pa-30"
                                            href="#">Graduate Certificate in Logistics and Supply Chain
                                            Management</a>
                                    </div>

                                    <div class="card g-brd-none g-mx-15 g-mb-30">
                                        <a class="card-body d-block u-link-v5 u-shadow-v32 g-color-main g-color-primary--hover g-bg-white g-pa-30"
                                            href="#">Master of Business Administration (Leadership and
                                            Enterprise)</a>
                                    </div>
                                ...
                                <a class="btn u-shadow-v33 g-color-white g-bg-primary g-bg-main--hover g-font-size-16 text-left g-rounded-30 g-px-30 g-py-10"
                                    ...
                                    Apply Now
                                    <i
                                        class="g-font-size-15 g-pos-rel g-top-3 ml-auto material-icons">arrow_forward</i>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div id="entryFeesAndApply" class="row g-pt-80">
                    <div class="col-lg-6 g-mb-30">
                        <!-- Media -->
                        <div
                            class="media u-block-hover u-shadow-v34 g-bg-white rounded g-overflow-hidden g-px-40 g-py-50">
                            ...
                            <div class="media-body">
                                ...
                                <p class="mb-0">Refer to the <a href="#">UAC website</a> Scholarship deadlines
                                    apply - visit the <a href="#">scholarships webpage</a> for details.</p>
                            </div>
                        </div>
                        <!-- End Media -->
                    </div>
                        ...
                        <div
                            ...
                            <div class="media-body">
                                <h3 class="h4 g-color-main g-color-primary--hover g-font-primary">Download guide <i
                                        class="g-font-size-16 mr-2 material-icons">arrow_forward</i></h3>
                                <p class="mb-0">2018 Engineering and Information Technologies Undergraduate Guide
                                    (15MB/PDF)</p>
                            </div>
                        </div>
                        <!-- End Media -->
                    ...
                    <div class="u-shadow-v36">
                        <div class="g-bg-main">
                            <header class="g-brd-bottom g-brd-white-opacity-0_1 text-center g-pa-30">
                                <h3 class="h4 g-color-white g-font-primary g-font-weight-400 mb-0">Entry Fees and How
                                    to Apply</h3>
                            </header>
                            ...
                            <div class="g-pa-40">
                                ...
                                <div class="row">
                                    <div class="col-6 g-mb-30">
                                        <!-- Start In -->
                                        <label class="g-color-white-opacity-0_5 g-font-size-15 mb-3">I would like to
                                            start study in</label>
                                        <select
                                            ...
                                            <option
                                                class="g-brd-secondary-light-v2 g-color-text-light-v1 g-color-white--active g-bg-primary--active"
                                                value="2020">2020 Spring</option>
                                            <option
                                                class="g-brd-secondary-light-v2 g-color-text-light-v1 g-color-white--active g-bg-primary--active"
                                                value="2020">2020 Fall</option>
                                        </select>
                                        <!-- End Start In -->
                                    </div>
                                ...
                                <h3
                                    class="g-color-white-opacity-0_5 g-font-primary g-font-weight-400 g-font-size-15 mb-3">
                                    My qualification is from</h3>
                                ...
                                <p class="g-color-white-opacity-0_6 text-center mb-0">The details on this page based on
                                    your selections are a guide only, and are subject to change.</p>
                            </div>
                        </div>
    ...
    <script src="web/assets/js/components/hs.scroll-nav.js"></script>
    <script src="web/assets/js/components/hs.sticky-block.js"></script>
...
<!-- Mirrored from htmlstream.com/preview/unify-v2.6.3/multipage/education/page-apply-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Feb 2026 13:34:08 GMT -->
