...
<!-- Mirrored from htmlstream.com/preview/unify-v2.6.3/multipage/education/page-research-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Feb 2026 13:34:12 GMT -->

<head>
    <base href="{{ url('/') }}/">
    <!-- Title -->
    <title>{{ str_starts_with(app()->getLocale(), 'id') ? 'Multipage - Halaman Riset Pendidikan | Unify - Template Website Responsif' : 'Multipage - Education Research Page | Unify - Responsive Website Template' }}</title>
                ...
                <div class="row justify-content-lg-between align-items-center">
                    ...
                    <div class="col-md-5">
                        <div class="mb-4">
                            ...
                            <p>Food security, epigenetics, media ownership and space weather are among the topics that
                                will be investigated as part of a $28 million funding injection to Unify research from
                                the Australian Research Council (ARC).</p>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-9 g-mb-50">
                    <div class="d-flex justify-content-lg-between align-items-lg-center g-mb-30">
                        <h2>Publications</h2>
                        <a class="u-link-v5 g-color-primary g-color-main--hover" href="#">See all Publications
                    ...
                    <div class="row">
                        <div class="col-6 col-md-4 g-mb-40">
                            ...
                            <article>
                                ...
                                <p class="g-color-text-light-v1 g-font-size-15">Researchers at the University of Unify
                                    have received almost $23 million from the National Health and Medical Research
                                    Council (NHMRC).</p>
                        ...
                        <div class="col-6 col-md-4 g-mb-40">
                            ...
                            <article>
                                ...
                                <p class="g-color-text-light-v1 g-font-size-15">Twenty-one projects have been awarded
                                    funding under the University’s industry and community engagement seed fund.</p>
                                <a class="g-font-size-default" href="#">Read More <i
                                        class="g-font-size-13 g-pos-rel g-top-3 material-icons">arrow_forward</i></a>
                            </article>
                            <!-- End Research Article -->
                        ...
                        <div class="col-6 col-md-4 g-mb-40">
                            ...
                            <article>
                                ...
                                <p class="g-color-text-light-v1 g-font-size-15">NSW Premier Gladys Berejiklian
                                    announces a state government investment of $7.6m to create the Unify Insitute for
                                    Community Languages Education (SICLE).</p>
                                <a class="g-font-size-default" href="#">Read More <i
                                        class="g-font-size-13 g-pos-rel g-top-3 material-icons">arrow_forward</i></a>
                            </article>
                            <!-- End Research Article -->
                        ...
                        <div class="col-6 col-md-4 g-mb-40">
                            ...
                            <article>
                                ...
                                <p class="g-color-text-light-v1 g-font-size-15">Quantum computers face roadblocks in
                                    development due to qubit instability. With backing from CSIRO and venture capital,
                                    Q-Ctrl will develop the firmware to stabilise the quantum revolution.</p>
                                <a class="g-font-size-default" href="#">Read More <i
                                        class="g-font-size-13 g-pos-rel g-top-3 material-icons">arrow_forward</i></a>
                            </article>
                            <!-- End Research Article -->
                        ...
                        <div class="col-6 col-md-4 g-mb-40">
                            ...
                            <article>
                                ...
                                <p class="g-color-text-light-v1 g-font-size-15">What are the difficulties of using
                                    medicinal cannabis in Australia? Professor Iain McGregor from the University's
                                    Lambert Initiative explains in this article.</p>
                                <a class="g-font-size-default" href="#">Read More <i
                                        class="g-font-size-13 g-pos-rel g-top-3 material-icons">arrow_forward</i></a>
                            </article>
                            <!-- End Research Article -->
                        ...
                        <div class="col-6 col-md-4 g-mb-40">
                            ...
                            <article>
                                ...
                                <p class="g-color-text-light-v1 g-font-size-15">Nine scholars from the University of
                                    Unify have been inducted as fellows of the Australian Academy of Health and Medical
                                    Sciences.</p>
                                <a class="g-font-size-default" href="#">Read More <i
                                        class="g-font-size-13 g-pos-rel g-top-3 material-icons">arrow_forward</i></a>
                            </article>
                    ...
                    <div class="u-shadow-v36 g-bg-main-light-v2 g-pa-30">
                        <ul class="list-unstyled mb-0">
                            ...
                            <li class="g-brd-bottom g-brd-white-opacity-0_1 g-py-20">
                                ...
                                <p class="g-color-white-opacity-0_8 g-font-size-default mb-0">One of the world's top
                                    research universities</p>
                            </li>
                            <li class="g-brd-bottom g-brd-white-opacity-0_1 g-py-20">
                                <h3 class="g-color-white g-font-primary mb-0">100%</h3>
                                <p class="g-color-white-opacity-0_8 g-font-size-default mb-0">of our research is ranked
                                    at world standard or above</p>
                            </li>
                            <li class="g-brd-bottom g-brd-white-opacity-0_1 g-py-20">
                            ...
                            <li class="g-pt-20">
                                ...
                                <p class="g-color-white-opacity-0_8 g-font-size-default mb-0">our investment in
                                    research</p>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="g-bg-main-light-v2">
            <div class="container g-pt-100 g-pb-80">
                ...
                <div class="g-max-width-645 text-center mx-auto g-mb-60">
                    ...
                    <p class="g-color-white-opacity-0_8">Our strategy is simple: to create a place where the best
                        researchers and most promising students can achieve their full potential.</p>
                </div>
                <!-- End Heading -->
                ...
                <div class="card-group d-block d-md-flex g-mx-minus-15">
                    ...
                    <div class="card u-shadow-v36 g-brd-none g-mx-15 g-mb-30">
                        ...
                        <article>
                            ...
                            <div class="card-body g-bg-white text-center g-pa-20">
                                <h3 class="h4 mb-0">Qantas customers help shape future of inflight health and wellness
                                </h3>
                            </div>
                        </article>
                        <!-- End Research Article -->
...
<!-- Mirrored from htmlstream.com/preview/unify-v2.6.3/multipage/education/page-research-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Feb 2026 13:34:18 GMT -->
