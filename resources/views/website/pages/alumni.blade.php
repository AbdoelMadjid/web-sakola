...
<!-- Mirrored from htmlstream.com/preview/unify-v2.6.3/multipage/education/page-alumni-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Feb 2026 13:34:35 GMT -->

<head>
    <base href="{{ url('/') }}/">
    <!-- Title -->
    <title>{{ str_starts_with(app()->getLocale(), 'id') ? 'Multipage - Halaman Alumni Pendidikan | Unify - Template Website Responsif' : 'Multipage - Education Alumni Page | Unify - Responsive Website Template' }}</title>
            ...
            <div class="container g-py-100 g-py-150--lg">
                <div class="row align-items-lg-center">
                    <div class="col-lg-6 g-mb-70 g-mb-150--sm g-mb-50--lg">
                        <div class="g-pr-15--lg">
                            ...
                            <div class="mb-5">
                                ...
                                <p>We're proud of our incredible community of more than 320,000 alumni and more than
                                    57,000 donors worldwide. Their global impact is immense – from mentoring students to
                                    showing their generous support for life-changing research.</p>
                            </div>
                    ...
                    <div class="col-lg-6 g-mb-50">
                        <div class="g-max-width-550 g-pos-rel g-pl-15--lg mx-auto">
                            ...
                            <svg class="g-hidden-xs-down g-width-25 g-height-45 g-pos-abs g-bottom-minus-40 g-left-0 g-z-index-2"
                                ...
                                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 45.9 52.9"
                                enable-background="new 0 0 45.9 52.9" xml:space="preserve">
                    ...
                    0.1,13.4 22.9,0.1 45.7,13.2 " />
                                ...
                                <line fill="#7cd1d8" stroke="#FFFFFF" stroke-width="0.4" stroke-miterlimit="10"
                                    x1="45.5" y1="13.2" x2="23" y2="26.5" />
                            </svg>
                            <!-- End SVG Square #1 -->
                            ...
                            <svg class="g-hidden-xs-down g-width-60 g-height-80 g-pos-abs g-top-minus-40 g-right-0 g-z-index-2"
                                version="1.1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 52.8 47.5"
                                enable-background="new 0 0 52.8 47.5" xml:space="preserve">
                    ...
                    52.7,22 41,45.6 " />
                            ...
                            <svg class="g-hidden-xs-down g-width-50 g-height-20 g-pos-abs g-top-minus-120 g-right-100"
                                version="1.1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 73.5 20"
                                enable-background="new 0 0 73.5 20" xml:space="preserve">
                                <g>
                    ...
                    <div class="col-md-5 offset-md-7 align-self-md-center g-py-100--md g-mb-50 g-mb-0--md">
                        <div class="g-pl-15--md">
                            <div class="mb-5">
                                <div class="mb-4">
                                    <span
                                        class="u-icon-v3 u-icon-size--lg g-color-main g-bg-secondary rounded-circle mb-4">
                                        <i class="material-icons">verified_user</i>
                                    </span>
                                    <h2 class="mb-3">Alumni Benefits and Awards</h2>
                                    <p>You may be surprised to discover what alumni benefits are on offer as a Unify
                                        graduate, including an alumni magazine, career resources, library membership,
                                        and more.</p>
                                </div>
                                <p>As a University of Unify graduate, you have access to a wide range of resources,
                                    mentoring opportunities, events and support to help you continue your passion for
                                    learning.</p>
                            </div>
        ...
        <section class="clearfix">
            <div class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-bg-cover g-bg-black-opacity-0_2--after"
                ...
                <div class="dzsparallaxer--target" style="width: 100%; height: 200%;" data-forcewidth_ratio="1.77">
                    <div class="js-bg-video g-pos-abs w-100 h-100" data-hs-bgv-type="youtube"
                        data-hs-bgv-id="FxiskmF16gU" data-hs-bgv-loop="1"></div>
                </div>
                    ...
                    <div class="col-md-4 col-lg-3 g-pt-100">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="g-brd-bottom g-brd-secondary-light-v2 g-pb-20">
                                <h4 class="h6">RT <a class="g-font-weight-500" href="#">@UofA_Arts:</a>
                                    DON'T MISS</h4>
                                <p class="g-color-text-light-v1 g-font-size-13 mb-0">Political Science's “What Comes
                                    Next? The Political Afterlives of the <a class="g-font-weight-500"
                                        href="#">#TRC</a>, WED/OCT 4/4:30-6 pm… <a class="g-font-weight-500"
                            ...
                            <li class="g-pt-20">
                                ...
                                <p class="g-color-text-light-v1 g-font-size-13 mb-0">Political Science's “What Comes
                                    Next? The Political Afterlives of the <a class="g-font-weight-500"
                                        href="#">#TRC</a>, WED/OCT 4/4:30-6 pm…</p>
                            </li>
                        </ul>
                        <!-- End Twitter Feed -->
                    </div>
                            ...
                            <div class="col-sm-6 g-mb-30">
                                <article>
                                    ...
                                    <p class="g-font-size-16">Give back to the University community by getting involved
                                        in volunteering opportunities to support our students, staff and fellow
                                        graduates.</p>
                                </article>
                            </div>
                            <!-- End Alumni Article -->
                            ...
                            <div class="col-sm-6 g-mb-30">
                                <article>
                                    ...
                                    <p class="g-font-size-16">Help us pursue limitless possibilities and make countless
                                        lives better. There are numerous ways you can make a donation to the University.
                                    </p>
                                </article>
                            </div>
                            <!-- End Alumni Article -->
                            ...
                            <div class="col-sm-6 g-mb-30">
                                <article>
                                    ...
                                    <h2 class="h5"><a href="#">We provide many opportunities for our
                                            community</a></h2>
                                    <p class="g-font-size-16">Stay connected with your fellow alumni in Australia and
                                        around the world through our network of groups, publications and our social
                                        networks.</p>
                                </article>
                            </div>
                            <!-- End Alumni Article -->
                        ...
                        <div class="g-pl-15--md">
                            <div class="mb-5">
                                <div class="mb-4">
                                    ...
                                    <h2 class="mb-3">3 secrets to success: our Alumni Award winners share their tips
                                    </h2>
                                    <p>As the University marks its 2017 Alumni Awards, we reflect on the essential
                                        qualities shared by all our award winners.</p>
                                </div>
                                <p>From starting a school in Uganda, to making maths a YouTube sensation. From improving
                                    the health of people the world over, to conducting some of the world’s greatest
                                    orchestras.</p>
                            </div>
                            <a class="btn u-shadow-v39 g-brd-main g-brd-primary--hover g-color-main g-color-white--hover g-bg-primary--hover g-font-size-default g-rounded-30 g-px-35 g-py-11"
                                href="#">Read More</a>
...
<!-- Mirrored from htmlstream.com/preview/unify-v2.6.3/multipage/education/page-alumni-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Feb 2026 13:34:37 GMT -->
