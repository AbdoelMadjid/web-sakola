            ...
            <div class="container g-pos-rel g-z-index-1 g-pt-80 g-pb-150">
                <div class="row justify-content-lg-between align-items-md-center">
                    <div class="col-md-6 col-lg-5 g-mb-30">
                        <h1 class="g-color-white g-font-size-40--md mb-4">The Impact of Augmented, Mixed and Virtual
                            Reality Beyond Gaming</h1>
                        <p class="g-color-white-opacity-0_9 g-font-size-20--md">22nd - 23rd May 2018, Kingston Hall,
                            Orlando</p>
                    </div>
                        ...
                        <form class="u-shadow-v35 g-bg-white rounded g-px-40 g-py-50">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <a class="u-link-v5 g-color-text-light-v1 g-color-primary--hover g-font-size-default"
                                    href="#"><i
                                        class="align-middle mr-1 icon-real-estate-027 u-line-icon-pro"></i> Get the
                                    Location</a>
                                <button type="submit"
                        ...
                        <div class="row">
                            <div class="col-sm-6 g-mb-50">
                                ...
                                <select
                                    ...
                                    <option
                                        class="g-brd-secondary-light-v2 g-color-text-light-v1 g-color-white--active g-bg-primary--active"
                                        value="architecture_creative_arts">Architecture, visual and creative arts
                                    </option>
                                    <option
                                        class="g-brd-secondary-light-v2 g-color-text-light-v1 g-color-white--active g-bg-primary--active"
                            ...
                            <div class="col-sm-6 g-mb-50">
                                ...
                                <select
                                    class="js-custom-select w-100 u-select-v2 u-shadow-v19 g-brd-none g-color-text-light-v1 g-color-primary--hover g-bg-white text-left g-rounded-30 g-pl-30 g-py-12"
                                    data-placeholder="Type" data-open-icon="fa fa-angle-down"
                                    data-close-icon="fa fa-angle-up">
                                    <option
                                        class="g-brd-secondary-light-v2 g-color-text-light-v1 g-color-white--active g-bg-primary--active"
                                        value="">All</option>
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-3 g-mb-30">
                    ...
                    <article class="u-block-hover u-shadow-v38">
                        ...
                        <div class="g-pa-25">
                            <h3 class="g-color-primary--hover g-font-size-18 mb-0">Core Research Facilities, Annual
                                Symposium</h3>
                        </div>
                ...
                <div class="col-sm-6 col-lg-3 g-mb-30">
                    ...
                    <article class="u-block-hover u-shadow-v38">
                        ...
                        <div class="g-pa-25">
                            <h3 class="g-color-primary--hover g-font-size-18 mb-0">Ontario Ideas - Digital Rights: what
                                are they, and why do we need them?</h3>
                        </div>
                ...
                <div class="col-sm-6 col-lg-3 g-mb-30">
                    ...
                    <article class="u-block-hover u-shadow-v38">
                        ...
                        <div class="g-pa-25">
                            <h3 class="g-color-primary--hover g-font-size-18 mb-0">2017 Unify College of the Arts
                                Undergraduate Degree Show</h3>
                        </div>
        ...
        <div class="container g-brd-y g-brd-secondary-light-v2 g-pt-50 g-pb-60">
            <div class="row justify-content-lg-center align-items-md-center">
                <div class="col-md-6 col-lg-5 g-mb-30 g-mb-0--md">
                    ...
                    <p>Following the previous main symposiums of FOCSA (The Federation of Chinese Scholars in
                        Australia), the 7th Australia-China Symposium in Education.</p>
                </div>
                                ...
                                <div class="media align-items-center g-py-40">
                                    <div class="d-flex col-8">
                                        <h3 class="g-line-height-1 mb-0"><a
                                                ...
                                                href="#">Camino de Santiago: treading the ancient path to the end
                                                of the earth</a></h3>
                                    </div>
                            ...
                            <div class="col-8 g-min-height-170 g-flex-centered">
                                <div class="media align-items-center g-py-40">
                                    <div class="d-flex col-8">
                                        <h3 class="g-line-height-1 mb-0"><a
                                                class="u-link-v5 g-color-main g-color-primary--hover g-font-size-18"
                                                href="#">Kopernik X Navicula: Music and Technology for Change</a>
                                        </h3>
                                    </div>
                                    <div class="media-body col-4">
                                        <span
...
<!-- Mirrored from htmlstream.com/preview/unify-v2.6.3/multipage/education/page-events-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Feb 2026 13:34:35 GMT -->
