    ...
    <main>
                ...
                <div class="g-min-height-70vh g-flex-centered g-bg-img-hero rounded"
                    ...
                    <div class="w-100 g-pos-abs g-bottom-0 g-left-0 g-z-index-1">
                        <div class="g-bg-white g-pos-rel g-px-30 g-pt-30 g-pt-0--md g-pb-15">
                            ...
                            <p>Hundreds of new Unify graduates and their families are gathering on campus this week to
                                celebrate the end of one journey, and the beginning of another.</p>

                            <!-- SVG Top Background Shape -->
                            <svg class="w-100 g-hidden-sm-down g-pos-abs g-top-minus-80x g-left-0 g-z-index-minus-1"
                                version="1.1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1200 237"
                                enable-background="new 0 0 1200 237" xml:space="preserve">
            ...
            <div class="container g-pt-100 g-py-70">
                <div class="row align-items-md-center">
                    ...
                    <div class="col-md-6 g-mb-30">
                        <p class="g-font-size-17 mb-0">Leadership through excellence in teaching and research. We offer
                            the widest range of academic programs of any university in Canada.</p>
                    </div>
            ...
            <div class="row justify-content-lg-between align-items-center">
                ...
                <div class="col-md-5 g-mb-50 g-mb-0--md">
                    <div class="mb-5">
                        ...
                        <p>Nov. 16, 2017 — Members of the university community may be aware of a number of instances in
                            which posters designed to offend, draw response and divide us have appeared sporadically
                            across our campus in recent weeks. For context, see messages from the President, myself, and
                            the university.</p>
                    </div>
            ...
            <div class="row justify-content-lg-between align-items-center">
                ...
                <div class="col-md-5 order-md-1 g-mb-50 g-mb-0--md">
                    <div class="mb-5">
                        ...
                        <p>Unify's revised competency model is now ready. Review the model and associated resources that
                            help describe what it means for employees to contribute to Unify’s success.</p>
                    </div>
                    <a class="btn u-shadow-v39 g-brd-main g-brd-primary--hover g-color-main g-color-white--hover g-bg-primary--hover g-font-size-default g-rounded-30 g-px-35 g-py-11"
                        href="#">Learn More</a>
                </div>
        ...
        <div class="clearfix g-bg-secondary g-py-100">
            ...
            <div class="js-carousel" data-infinite="true" data-slides-show="3" data-slides-scroll="1"
                ...
                data-arrow-right-classes="fa fa-angle-right g-right-40" data-center-mode="true"
               ...
               "settings": {
                ...
                <div class="js-slide u-block-hover g-pb-10 g-mx-15">
                    ...
                    <div class="u-shadow-v32 g-bg-white g-pa-30">
                        ...
                        <span class="d-block g-color-text-light-v1 g-font-size-16">Associate Professor in
                            Biology</span>
                    </div>
                    <a class="u-link-v2" href="#"></a>
                </div>
                ...
                <div class="js-slide u-block-hover g-pb-10 g-mx-15">
                    ...
                    <div class="u-shadow-v32 g-bg-white g-pa-30">
                        ...
                        <span class="d-block g-color-text-light-v1 g-font-size-16">Professorship in Thoracic
                            Surgery</span>
                    </div>
                    <a class="u-link-v2" href="#"></a>
                </div>
                ...
                <div class="js-slide u-block-hover g-pb-10 g-mx-15">
                    ...
                    <div class="u-shadow-v32 g-bg-white g-pa-30">
                        ...
                        <span class="d-block g-color-text-light-v1 g-font-size-16">Writing and Core Literature
                            Lecturer</span>
                    </div>
                    <a class="u-link-v2" href="#"></a>
                </div>
...
<!-- Mirrored from htmlstream.com/preview/unify-v2.6.3/multipage/education/page-faculty-and-staff-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Feb 2026 13:34:30 GMT -->
