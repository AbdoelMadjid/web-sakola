...
@section('title')
    {{ str_starts_with(app()->getLocale(), 'id') ? 'Kehidupan Kampus' : 'Campus Life' }}
@endsection
...
@section('content')
    ...
    <div id="recognition" class="container g-pt-100 g-pb-70">
        ...
        <div class="row g-mb-60">
            ...
            <div class="col-sm-6 col-lg-3 g-mb-30">
                ...
                <article>
                    <div class="g-pos-rel">
                        <img class="img-fluid mb-3" src="web/assets/img-temp/600x350/img23.jpg" alt="Image Description">
    ...
    <!-- Student Life -->
    <div id="student-life" class="g-bg-img-hero" style="background-image: url(web/assets/include/svg/svg-bg3.svg);">
