...
@section('title')
    {{ str_starts_with(app()->getLocale(), 'id') ? 'Kontak' : 'Contacts' }}
@endsection
...
@section('content')
    <!-- Contacts -->
    <div class="g-bg-img-hero g-bg-pos-top-center" style="background-image: url(web/assets/include/svg/svg-bg2.svg);">
