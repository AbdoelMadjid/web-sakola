...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
    ...
    <a href="/dashboard">
        @if (!empty($LightSidebar) && $LightSidebar === true)
            ...
            <img alt="Logo" src="admin/assets/media/logos/default-small.svg" class="h-20px app-sidebar-logo-minimize" />
        @else
            {{-- Default: dark-sidebar --}}
            <img alt="Logo" src="admin/assets/media/logos/default-dark.svg" class="h-25px app-sidebar-logo-default" />
            <img alt="Logo" src="admin/assets/media/logos/default-small.svg" class="h-20px app-sidebar-logo-minimize" />
        @endif
    </a>
    <!--end::Logo image-->
