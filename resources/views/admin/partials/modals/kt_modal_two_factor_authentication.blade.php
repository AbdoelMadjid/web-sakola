            ...
            <div class="modal-body scroll-y pt-10 pb-15 px-lg-17">
                ...
                <div data-kt-element="options">
                    ...
                    <p class="text-muted fs-5 fw-semibold mb-10">
                        ...
                        a code (delivered via app or SMS) to log into your account.
                    </p>
                    <!--end::Notice-->
                    <!--begin::Wrapper-->
                    <div class="pb-10">
                ...
                <div class="d-none" data-kt-element="apps">
                    ...
                    <div class="text-gray-500 fw-semibold fs-6 mb-10">
                        ...
                        or
                        <a href="/https://support.1password.com/one-time-passwords/" target="_blank">1Password</a>, scan
                        the QR code. It will generate a 6 digit code for you to enter below.
                        <!--begin::QR code image-->
                        <div class="pt-5 text-center">
                            <img src="admin/assets/media/misc/qr.png" alt="" class="mw-150px" />
                        </div>
                        <!--end::QR code image-->
                    </div>
                    <!--end::Description-->
                        ...
                        <div class="d-flex flex-stack flex-grow-1">
                            ...
                            <div class="fw-semibold">
                                <div class="fs-6 text-gray-700">
                                    If you having trouble using the QR code, select manual
