            ...
            <div class="modal-body scroll-y m-5">
                ...
                <div class="stepper stepper-links d-flex flex-column" id="kt_modal_create_campaign_stepper">
                    ...
                    <form class="mx-auto w-100 mw-600px pt-15 pb-10" novalidate="novalidate"
                        ...
                        <!--begin::Step 1-->
                        @include('admin.partials.modals.create-campaign._step-1')
                        <!--end::Step 1-->
                        <!--begin::Step 2-->
                        @include('admin.partials.modals.create-campaign._step-2')
                        <!--end::Step 2-->
                        <!--begin::Step 3-->
                        @include('admin.partials.modals.create-campaign._step-3')
                        <!--end::Step 3-->
                        <!--begin::Step 4-->
                        @include('admin.partials.modals.create-campaign._step-4')
                        <!--end::Step 4-->
                        <!--begin::Step 5-->
                        @include('admin.partials.modals.create-campaign._step-5')
                        <!--end::Step 5-->
                        <!--begin::Actions-->
