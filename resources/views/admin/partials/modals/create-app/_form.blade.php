...
<div class="d-flex flex-column mb-7 fv-row">
    ...
    <div class="position-relative">
        ...
        <div class="position-absolute translate-middle-y top-50 end-0 me-5">
            <img src="admin/assets/media/svg/card-logos/visa.svg" alt="" class="h-25px" />
            <img src="admin/assets/media/svg/card-logos/mastercard.svg" alt="" class="h-25px" />
            <img src="admin/assets/media/svg/card-logos/american-express.svg" alt="" class="h-25px" />
        </div>
        <!--end::Card logos-->
    </div>
    <!--end::Input wrapper-->
