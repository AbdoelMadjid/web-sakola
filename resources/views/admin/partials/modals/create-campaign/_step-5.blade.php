<div data-kt-stepper-element="content">
    ...
    <div class="w-100">
        ...
        <div class="d-flex flex-center pb-20">
            <button id="kt_modal_create_campaign_create_new" type="button" class="btn btn-lg btn-light me-3"
        ...
        <div class="text-center px-4">
            <img src="{{ URL::asset('admin/assets/media/illustrations/sketchy-1/9.png') }}" alt=""
