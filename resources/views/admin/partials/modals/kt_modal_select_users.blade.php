                                ...
                                <div class="ms-5">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <a href="/pages/general/user-profile/overview"
                                            class="text-gray-900 fw-bold text-hover-primary fs-5 me-4">Emma Smith</a>
                                        <!--begin::Label-->
                                        <span
                        ...
                        <div class="p-0">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <p class="text-gray-700 fw-semibold fs-6 mb-4">
                                    First, a disclaimer - the entire process writing a blog
                                    post often takes more.
                                </p>
                                <!--end::Text-->
                                <!--begin::Tags-->
                        ...
                        <div class="d-flex flex-stack pb-3">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="ms-5">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <a href="/pages/general/user-profile/overview"
                                            class="text-gray-900 fw-bold text-hover-primary fs-5 me-4">Sean Bean</a>
                                        <!--begin::Label-->
                                        <span
                                            class="badge badge-light-success d-flex align-items-center fs-8 fw-semibold">
                                            <i class="ki-duotone ki-star fs-8 text-success me-1"></i>
                    ...
                    <div class="border border-hover-primary p-7 rounded mb-7">
                        ...
                        <div class="d-flex flex-stack pb-3">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="ms-5">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <a href="/pages/general/user-profile/overview"
                                            class="text-gray-900 fw-bold text-hover-primary fs-5 me-4">Lusy Kunic</a>
                                        <!--begin::Label-->
                                        <span class="m-0"></span>
                                        <!--end::Label-->
                                    </div>
                        ...
                        <div class="p-0">
                            ...
                            <div class="d-flex flex-column">
                                <!--begin::Text-->
                                <p class="text-gray-700 fw-semibold fs-6 mb-4">
                                    Long before you sit down to put digital pen to paper you
                                    need make sure you have to sit down and write.
                                </p>
                                <!--end::Text-->
                                <!--begin::Tags-->
                                <div class="d-flex text-gray-700 fw-semibold fs-7">
                    ...
                    <div class="border border-hover-primary p-7 rounded">
                        ...
                        <div class="d-flex flex-stack pb-3">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="ms-5">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <a href="/pages/general/user-profile/overview"
                                            class="text-gray-900 fw-bold text-hover-primary fs-5 me-4">Mat Dillon</a>
                                        <!--begin::Label-->
                                        <span class="m-0"></span>
                                        <!--end::Label-->
                                    </div>
                        ...
                        <div class="p-0">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <p class="text-gray-700 fw-semibold fs-6 mb-4">
                                    First, a disclaimer - the entire process writing a blog
                                    post often takes more than couple of hours.
                                </p>
                                <!--end::Text-->
                                <!--begin::Tags-->
                                <div class="d-flex text-gray-700 fw-semibold fs-7">
