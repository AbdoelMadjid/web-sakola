            ...
            <div class="modal-body scroll-y m-5">
                ...
                <div class="stepper stepper-links d-flex flex-column gap-5" id="kt_modal_top_up_wallet_stepper">
                    ...
                    <form class="mx-auto w-100 mw-600px pt-15 pb-10" novalidate="novalidate"
                        ...
                        <!--begin::Step 1-->
                        @include('admin.partials.modals.top-up-wallet._step-1')
                        <!--end::Step 1-->
                        <!--begin::Step 2-->
                        @include('admin.partials.modals.top-up-wallet._step-2')
                        <!--end::Step 2-->
                        <!--begin::Step 3-->
                        @include('admin.partials.modals.top-up-wallet._step-3')
                        <!--end::Step 3-->
                        <!--begin::Step 5-->
                        @include('admin.partials.modals.top-up-wallet._step-4')
                        <!--end::Step 5-->
                        <!--begin::Actions-->
