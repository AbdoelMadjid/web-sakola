    ...
    <div class="w-100">
        ...
        <div class="fv-row mb-8">
            ...
            <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                ...
                <span class="lh-1 ms-1" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-html="true"
            ...
            <div class="position-relative w-lg-250px" id="kt_modal_create_project_budget_setup" data-kt-dialer="true"
                ...
                <input type="text" class="form-control form-control-solid border-0 ps-12"
                    data-kt-dialer-control="input" placeholder="Amount" name="budget_setup" readonly="readonly"
                    value="$50" />
                <!--end::Input control-->
                ...
                <div class="col-md-6 col-lg-12 col-xxl-6">
                    ...
                    <label
                        ...
                        <span
                            ...
                            <input class="form-check-input" type="radio" name="budget_usage" value="1"
                                checked="checked" />
                        </span>
                        <!--end::Radio-->
                        <!--begin::Info-->
        ...
        <div class="fv-row mb-15">
            ...
            <div class="d-flex flex-stack">
                ...
                <label class="form-check form-switch form-check-custom form-check-solid">
                    <input class="form-check-input" type="checkbox" value="1" name="budget_allow"
                        checked="checked" />
