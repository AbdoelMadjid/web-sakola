                                ...
                                <div class="d-flex flex-column mb-7 fv-row">
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                                            <img src="{{ URL::asset('admin/assets/media/svg/card-logos/visa.svg') }}"
                                                alt="" class="h-25px" />
                                            <img src="{{ URL::asset('admin/assets/media/svg/card-logos/mastercard.svg') }}"
                                                alt="" class="h-25px" />
                                            <img src="{{ URL::asset('admin/assets/media/svg/card-logos/american-express.svg') }}"
                                                alt="" class="h-25px" />
                                        </div>
                                        <!--end::Card logos-->
                                    </div>
                                        ...
                                        <div class="d-flex flex-stack flex-grow-1">
                                            ...
                                            <div class="fw-semibold">
                                                ...
                                                <div class="fs-6 text-gray-700">
                                                    ...
                                                    <a href="/pages/utilities/wizards/vertical" class="fw-bold">
