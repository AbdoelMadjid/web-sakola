                ...
                <div class="stepper stepper-links d-flex flex-column" id="kt_modal_create_project_stepper">
                    ...
                    <div class="container">
                        ...
                        <form class="mx-auto w-100 mw-600px pt-15 pb-10" novalidate="novalidate"
                            ...
                            <!--begin::Type-->
                            @include('admin.partials.modals.create-project._type')
                            <!--end::Type-->
                            <!--begin::Settings-->
                            @include('admin.partials.modals.create-project._setting')
                            <!--end::Settings-->
                            <!--begin::Budget-->
                            @include('admin.partials.modals.create-project._budget')
                            <!--end::Budget-->
                            <!--begin::Team-->
                            @include('admin.partials.modals.create-project._team')
                            <!--end::Team-->
                            <!--begin::Targets-->
                            @include('admin.partials.modals.create-project._target')
                            <!--end::Targets-->
                            <!--begin::Files-->
                            @include('admin.partials.modals.create-project._files')
                            <!--end::Files-->
                            <!--begin::Complete-->
                            @include('admin.partials.modals.create-project._complete')
                            <!--end::Complete-->
                        </form>
                        <!--end::Form-->
                    </div>
