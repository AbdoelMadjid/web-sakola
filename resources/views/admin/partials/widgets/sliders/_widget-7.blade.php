...
<div id="kt_sliders_widget_7_slider"
    class="card card-flush carousel carousel-custom carousel-light-dots carousel-stretch slide h-xl-100"
    data-bs-ride="carousel" data-bs-interval="5000" style="background-color: #FFE896" data-bs-theme="light">
    <!--begin::Header-->
    <div class="card-header align-items-center pt-7">
        <!--begin::Title-->
        <h4 class="card-label fw-bold text-gray-800 m-0">Recent Updates</h4>
        <!--end::Title-->
        <!--begin::Toolbar-->
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active show">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="m-0">
                        <!--begin::Subtitle-->
                        <h5 class="fw-bold text-gray-800 mb-3">Ruby on Rails</h5>
                        <!--end::Subtitle-->
                        <!--begin::Items-->
                        <div class="d-flex d-grid gap-5">
                            ...
                            <div class="d-flex flex-column flex-shrink-0 me-4">
                                ...
                                <span class="d-flex align-items-center fs-7 fw-bold text-gray-600 mb-2">
                                    <i class="ki-outline ki-right-square fs-6 text-gray-600 me-2"></i> 3 lesson
                                </span>
                                <!--end::Section-->
                                <!--begin::Section-->
                                <span class="d-flex align-items-center text-gray-600 fw-bold fs-7">
                                    <i class="ki-outline ki-right-square fs-6 text-gray-600 me-2"></i> 1 agenda
                                </span>
                                <!--end::Section-->
                            </div>
                            <!--end::Item-->
                            ...
                            <div class="d-flex flex-column flex-shrink-0">
                                <!--begin::Section-->
                                <span class="d-flex align-items-center fs-7 fw-bold text-gray-600 mb-2">
                                    <i class="ki-outline ki-right-square fs-6 text-gray-600 me-2"></i> 50 Min
                                </span>
                                <!--end::Section-->
                                <!--begin::Section-->
                                <span class="d-flex align-items-center text-gray-600 fw-bold fs-7">
                                    <i class="ki-outline ki-right-square fs-6 text-gray-600 me-2"></i> 72 students
                                </span>
                                <!--end::Section-->
                            </div>
                            <!--end::Item-->
