<div class="card card-xl-stretch mb-xl-8">
                    ...
                    <div class="mb-10">
                        ...
                        <div>
                            <select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true"
                                ...
                                data-dropdown-parent="#kt_menu_6606385c53b21" data-allow-clear="true">
                                <option></option>
    ...
    <div class="card-body p-0 d-flex flex-column">
        ...
        <!--end::Stats-->
        <!--begin::Chart-->
        <div class="mixed-widget-6-chart card-rounded-bottom" data-kt-chart-color="primary" style="height: 150px">
        </div>
        <!--end::Chart-->
    </div>
    <!--end::Body-->
