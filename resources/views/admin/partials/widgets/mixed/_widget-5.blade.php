<div class="card card-xl-stretch mb-xl-8">
    ...
    <div class="card-header border-0 py-5">
        ...
        <div class="card-toolbar">
            <!--begin::Menu-->
            @include('admin.partials.general._button-1')
            <!--begin::Menu 3-->
    ...
    <div class="card-body d-flex flex-column">
        ...
        <div class="mt-5">
            ...
            <div class="d-flex flex-stack mb-5">
                ...
                <div class="d-flex align-items-center me-2">
                    ...
                    <div class="symbol symbol-50px me-3">
                        <div class="symbol-label bg-light">
                            <img src="admin/assets/media/svg/brand-logos/plurk.svg" class="h-50" alt="" />
                        </div>
                    </div>
                    <!--end::Symbol-->
                    <!--begin::Title-->
                ...
                <!--end::Section-->
                <!--begin::Label-->
                <div class="badge badge-light fw-semibold py-4 px-3">
                    +82$
                </div>
                <!--end::Label-->
            </div>
            ...
            <div class="d-flex flex-stack mb-5">
                ...
                <div class="d-flex align-items-center me-2">
                    ...
                    <div class="symbol symbol-50px me-3">
                        <div class="symbol-label bg-light">
                            <img src="admin/assets/media/svg/brand-logos/figma-1.svg" class="h-50" alt="" />
                        </div>
                    </div>
                    <!--end::Symbol-->
                    <!--begin::Title-->
            ...
            <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center me-2">
                    ...
                    <div class="symbol symbol-50px me-3">
                        <div class="symbol-label bg-light">
                            <img src="admin/assets/media/svg/brand-logos/vimeo.svg" class="h-50" alt="" />
                        </div>
                    </div>
                    <!--end::Symbol-->
                    <!--begin::Title-->
