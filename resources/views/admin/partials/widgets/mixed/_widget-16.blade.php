...
<div class="card card-xl-stretch bg-body border-0">
    ...
    <div class="card-body pt-5 mb-xl-9 position-relative">
        ...
        <div class="d-flex flex-stack">
            ...
            <div class="me-1">
                <button class="btn btn-icon btn-color-gray-500 w-auto px-0 btn-active-color-primary"
                    ...
                    <i class="ki-duotone ki-dots-square fs-1 me-n1"><span class="path1"></span><span
                            class="path2"></span><span class="path3"></span><span class="path4"></span></i>
                </button>
                <!--begin::Menu 1-->
                <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
                    id="kt_menu_68e64e5eee2a2">
                    <!--begin::Header-->
                    <div class="px-7 py-5">
                        ...
                        <div class="mb-10">
                            ...
                            <div>
                                <select class="form-select form-select-solid" multiple data-kt-select2="true"
                                    ...
                                    data-dropdown-parent="#kt_menu_68e64e5eee2a2" data-allow-clear="true">
                                    <option></option>
        ...
        <div class="text-center position-absolute bottom-0 start-50 translate-middle-x w-100 mb-10">
            <!--begin::Text-->
            <p class="fw-semibold fs-4 text-gray-500 mb-7 px-5">
                Long before you sit down to put the <br />
