        ...
        <div class="">
            ...
            <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center me-5">
                    <!--begin::Flag-->
                    <img src="admin/assets/media/svg/brand-logos/atica.svg" class="me-4 w-30px" style="border-radius: 4px"
                        alt="" />
                    <!--end::Flag-->
                    <!--begin::Content-->
                    <div class="me-5">
                        <!--begin::Title-->
                        <a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">Abstergo
                            Ltd.</a>
                        <!--end::Title-->
                        <!--begin::Desc-->
            ...
            <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center me-5">
                    ...
                    <div class="me-5">
                        <!--begin::Title-->
                        <a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">Binford
                            Ltd.</a>
                        <!--end::Title-->
                        <!--begin::Desc-->
            ...
            <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center me-5">
                    <!--begin::Flag-->
                    <img src="admin/assets/media/svg/brand-logos/balloon.svg" class="me-4 w-30px" style="border-radius: 4px"
                        alt="" />
                    <!--end::Flag-->
                    <!--begin::Content-->
                    <div class="me-5">
                        <!--begin::Title-->
                        <a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">Barone
                            LLC.</a>
                        <!--end::Title-->
                        <!--begin::Desc-->
            ...
            <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center me-5">
                    <!--begin::Flag-->
                    <img src="admin/assets/media/svg/brand-logos/vimeo.svg" class="me-4 w-30px" style="border-radius: 4px"
                        alt="" />
                    <!--end::Flag-->
                    <!--begin::Content-->
                    <div class="me-5">
            ...
            <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center me-5">
                    <!--begin::Flag-->
                    <img src="admin/assets/media/svg/brand-logos/plurk.svg" class="me-4 w-30px" style="border-radius: 4px"
                        alt="" />
                    <!--end::Flag-->
                    <!--begin::Content-->
                    <div class="me-5">
                        <!--begin::Title-->
                        <a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">Big
                            Kahuna Burger</a>
                        <!--end::Title-->
                        <!--begin::Desc-->
                        <span class="text-gray-500 fw-semibold fs-7 d-block text-start ps-0">Social
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="m-0">
                        ...
                        <span class="badge badge-light-success fs-base">
                            <i class="ki-duotone ki-arrow-up fs-5 text-success ms-n1">
                                <span class="path1"></span>
                                <span class="path2"></span> </i>1.9%</span>
                        <!--end::Label-->
                    </div>
                    <!--end::Info-->
                </div>
