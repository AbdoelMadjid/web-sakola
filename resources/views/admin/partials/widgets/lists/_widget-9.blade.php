            ...
            <div class="d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
                ...
                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                    ...
                    <span class="text-gray-500 fw-semibold fs-7">
                        By: <a href="#" class="text-primary fw-bold">CoreAd</a>
                    </span>
                </div>
                <!--end::Title-->
                <!--begin::Info-->
        ...
        <div class="d-flex mb-7">
            ...
            <div class="d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
                ...
                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                    ...
                    <span class="text-gray-500 fw-semibold fs-7 my-1">Study highway types</span>
                    <span class="text-gray-500 fw-semibold fs-7">
                        By: <a href="#" class="text-primary fw-bold">KeenThemes</a>
                    </span>
                </div>
                <!--end::Title-->
                <!--begin::Info-->
        ...
        <div class="d-flex mb-7">
            ...
            <div class="d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
                ...
                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                    ...
                    <span class="text-gray-500 fw-semibold fs-7 my-1">Study highway types</span>
                    <span class="text-gray-500 fw-semibold fs-7">
                        By: <a href="#" class="text-primary fw-bold">Invision Inc.</a>
                    </span>
                </div>
                <!--end::Title-->
                <!--begin::Info-->
        ...
        <div class="d-flex mb-7">
            ...
            <div class="d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
                ...
                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                    ...
                    <span class="text-gray-500 fw-semibold fs-7 my-1">Study highway types</span>
                    <span class="text-gray-500 fw-semibold fs-7">
                        By: <a href="#" class="text-primary fw-bold">Figma Studio</a>
                    </span>
                </div>
                <!--end::Title-->
                <!--begin::Info-->
