    ...
    <div class="card-body pt-0">
        ...
        <div class="m-0">
            ...
            <div class="d-flex flex-stack">
                <!--begin::Flag-->
                <img src="admin/assets/media/flags/united-states.svg" class="me-4 w-25px" style="border-radius: 4px"
                    alt="" />
                <!--end::Flag-->
                <!--begin::Section-->
            ...
            <div class="d-flex flex-stack">
                <!--begin::Flag-->
                <img src="admin/assets/media/flags/brazil.svg" class="me-4 w-25px" style="border-radius: 4px"
                    alt="" />
                <!--end::Flag-->
                <!--begin::Section-->
                <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
            ...
            <div class="d-flex flex-stack">
                <!--begin::Flag-->
                <img src="admin/assets/media/flags/turkey.svg" class="me-4 w-25px" style="border-radius: 4px"
                    alt="" />
                <!--end::Flag-->
                <!--begin::Section-->
                <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
            ...
            <div class="d-flex flex-stack">
                <!--begin::Flag-->
                <img src="admin/assets/media/flags/france.svg" class="me-4 w-25px" style="border-radius: 4px"
                    alt="" />
                <!--end::Flag-->
                <!--begin::Section-->
                <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
            ...
            <div class="d-flex flex-stack">
                <!--begin::Flag-->
                <img src="admin/assets/media/flags/india.svg" class="me-4 w-25px" style="border-radius: 4px" alt="" />
                <!--end::Flag-->
                <!--begin::Section-->
                <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                    <!--begin::Content-->
            ...
            <div class="d-flex flex-stack">
                <!--begin::Flag-->
                <img src="admin/assets/media/flags/sweden.svg" class="me-4 w-25px" style="border-radius: 4px"
                    alt="" />
                <!--end::Flag-->
                <!--begin::Section-->
                <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
