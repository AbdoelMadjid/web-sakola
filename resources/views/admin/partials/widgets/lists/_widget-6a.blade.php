...
<div class="card card-xl-stretch mb-5 mb-xl-8">
    ...
    <div class="card-header pt-7">
        ...
        <div class="card-toolbar">
            <a href="/apps/ecommerce/catalog/categories" class="btn btn-sm btn-light">View All</a>
        </div>
        <!--end::Toolbar-->
    </div>
    <!--end::Header-->
        ...
        <div class="table-responsive">
            ...
            <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                ...
                <tbody>
                    <tr>
                        <td>
                            <img src="admin/assets/media/stock/ecommerce/210.png" class="w-50px" alt="" />
                        </td>
                        <td class="ps-0">
                    ...
                    <tr>
                        <td>
                            <img src="admin/assets/media/stock/ecommerce/215.png" class="w-50px" alt="" />
                        </td>
                        <td class="ps-0">
                            <a href="/apps/ecommerce/sales/details"
                                class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
                            <span class="text-gray-500 fw-semibold fs-7 d-block text-start ps-0">Item: #XDG-2347</span>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <img src="admin/assets/media/stock/ecommerce/209.png" class="w-50px" alt="" />
                        </td>
                        <td class="ps-0">
                            <a href="/apps/ecommerce/sales/details"
                    ...
                    <tr>
                        <td>
                            <img src="admin/assets/media/stock/ecommerce/214.png" class="w-50px" alt="" />
                        </td>
                        <td class="ps-0">
                            <a href="/apps/ecommerce/sales/details"
