...
<div class="card card-xl-stretch mb-5 mb-xl-8">
    ...
    <div class="card-body card-body d-flex justify-content-between flex-column pt-3">
        ...
        <div class="d-flex flex-stack">
            <!--begin::Flag-->
            <img src="admin/assets/media/svg/brand-logos/dribbble-icon-1.svg" class="me-4 w-30px" style="border-radius: 4px"
                alt="" />
            <!--end::Flag-->
            <!--begin::Section-->
        ...
        <div class="d-flex flex-stack">
            <!--begin::Flag-->
            <img src="admin/assets/media/svg/brand-logos/linkedin-1.svg" class="me-4 w-30px" style="border-radius: 4px"
                alt="" />
            <!--end::Flag-->
            <!--begin::Section-->
            <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
        ...
        <div class="d-flex flex-stack">
            <!--begin::Flag-->
            <img src="admin/assets/media/svg/brand-logos/slack-icon.svg" class="me-4 w-30px" style="border-radius: 4px"
                alt="" />
            <!--end::Flag-->
            <!--begin::Section-->
            <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
        ...
        <div class="d-flex flex-stack">
            <!--begin::Flag-->
            <img src="admin/assets/media/svg/brand-logos/youtube-3.svg" class="me-4 w-30px" style="border-radius: 4px"
                alt="" />
            <!--end::Flag-->
            <!--begin::Section-->
            <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
        ...
        <div class="d-flex flex-stack">
            <!--begin::Flag-->
            <img src="admin/assets/media/svg/brand-logos/instagram-2-1.svg" class="me-4 w-30px" style="border-radius: 4px"
                alt="" />
            <!--end::Flag-->
            <!--begin::Section-->
            <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
        ...
        <div class="d-flex flex-stack">
            <!--begin::Flag-->
            <img src="admin/assets/media/svg/brand-logos/facebook-3.svg" class="me-4 w-30px" style="border-radius: 4px"
                alt="" />
            <!--end::Flag-->
            <!--begin::Section-->
            <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
