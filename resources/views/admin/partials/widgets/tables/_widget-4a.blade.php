                    ...
                    <table class="table align-middle gs-0 gy-3">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="text-gray-900 fw-bold text-hover-primary mb-1 fs-6">Lebron
                                        Wayde</a>
                    ...
                    <table class="table align-middle gs-0 gy-3">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="symbol symbol-50px">
                                        <img src="admin/assets/media/svg/avatars/043-boy-18.svg" alt="" />
                                    </div>
                                </td>
                                <td>
                                    <a href="#" class="text-gray-900 fw-bold text-hover-primary mb-1 fs-6">Kevin
                            ...
                            <tr>
                                <td>
                                    <div class="symbol symbol-50px">
                                        <img src="admin/assets/media/svg/avatars/018-girl-9.svg" alt="" />
                                    </div>
                                </td>
                                <td>
                                    <a href="#"
                            ...
                            <tr>
                                <td>
                                    <div class="symbol symbol-50px">
                                        <img src="admin/assets/media/svg/avatars/001-boy.svg" alt="" />
                                    </div>
                                </td>
                                <td>
                                    <a href="#" class="text-gray-900 fw-bold text-hover-primary mb-1 fs-6">Brad
                    ...
                    <table class="table align-middle gs-0 gy-3">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="symbol symbol-50px">
                                        <img src="admin/assets/media/svg/avatars/047-girl-25.svg" alt="" />
                                    </div>
                                </td>
                                <td>
                                    <a href="#"
