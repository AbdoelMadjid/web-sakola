                    ...
                    <table class="table align-middle gs-0 gy-3">
                        ...
                        <tbody>
                                ...
                                <td>
                                    <div class="symbol symbol-50px me-2">
                                        <span class="symbol-label">
                                            <img src="admin/assets/media/svg/avatars/001-boy.svg" class="h-75 align-self-end"
                                                alt="" />
                                        </span>
                                    </div>
                                </td>
                                <td>
                                    <a href="#" class="text-gray-900 fw-bold text-hover-primary mb-1 fs-6">Brad
                                        Simmons</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="text-gray-900 fw-bold text-hover-primary mb-1 fs-6">Jessie
                                        Clarcson</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="text-gray-900 fw-bold text-hover-primary mb-1 fs-6">Natali
                                        Trump</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="text-gray-900 fw-bold text-hover-primary mb-1 fs-6">Kevin
                                        Leonard</a>
