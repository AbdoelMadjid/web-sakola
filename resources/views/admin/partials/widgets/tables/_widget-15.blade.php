                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex justify-content-start flex-column">
                                    <a href="?page=apps/projects/users"
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex justify-content-start flex-column">
                                    <a href="?page=apps/projects/users"
                                        class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Jane Cooper</a>
                        ...
                        <td class="text-end pe-0">
                            <div id="kt_table_widget_15_chart_2" class="h-50px mt-n8 pe-7" data-kt-chart-color="danger">
                            </div>
                        </td>
                        <td class="text-end">
                            <a href="#"
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex justify-content-start flex-column">
                                    <a href="?page=apps/projects/users"
                                        class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Jacob Jones</a>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex justify-content-start flex-column">
                                    <a href="?page=apps/projects/users"
                                        class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Ralph Edwards</a>
