        ...
        <ul class="nav nav-pills nav-pills-custom mb-3">
            ...
            <li class="nav-item mb-3 me-3 me-lg-6">
                ...
                <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden active w-80px h-85px py-4"
                    ...
                    <!--begin::Icon-->
                    <div class="nav-icon">
                        <img alt="" src="admin/assets/media/svg/products-categories/t-shirt.svg" class="" />
                    </div>
                    <!--end::Icon-->
                    <!--begin::Subtitle-->
            ...
            <li class="nav-item mb-3 me-3 me-lg-6">
                ...
                <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                    ...
                    <!--begin::Icon-->
                    <div class="nav-icon">
                        <img alt="" src="admin/assets/media/svg/products-categories/gaming.svg" class="" />
                    </div>
                    <!--end::Icon-->
                    <!--begin::Subtitle-->
                    <span class="nav-text text-gray-700 fw-bold fs-6 lh-1">
            ...
            <li class="nav-item mb-3 me-3 me-lg-6">
                ...
                <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                    ...
                    <!--begin::Icon-->
                    <div class="nav-icon">
                        <img alt="" src="admin/assets/media/svg/products-categories/watch.svg" class="" />
                    </div>
                    <!--end::Icon-->
                    <!--begin::Subtitle-->
            ...
            <li class="nav-item mb-3 me-3 me-lg-6">
                ...
                <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                    ...
                    <!--begin::Icon-->
                    <div class="nav-icon">
                        <img alt="" src="admin/assets/media/svg/products-categories/gloves.svg" class="nav-icon" />
                    </div>
                    <!--end::Icon-->
                    <!--begin::Subtitle-->
                    <span class="nav-text text-gray-600 fw-bold fs-6 lh-1">
            ...
            <li class="nav-item mb-3">
                ...
                <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                    ...
                    <!--begin::Icon-->
                    <div class="nav-icon">
                        <img alt="" src="admin/assets/media/svg/products-categories/shoes.svg" class="nav-icon" />
                    </div>
                    <!--end::Icon-->
                    <!--begin::Subtitle-->
                    <span class="nav-text text-gray-600 fw-bold fs-6 lh-1">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <img src="admin/assets/media/stock/ecommerce/210.png" class="w-50px ms-n1"
                                        alt="" />
                                </td>
                                <td class="ps-0">
                            ...
                            <tr>
                                <td>
                                    <img src="admin/assets/media/stock/ecommerce/215.png" class="w-50px ms-n1"
                                        alt="" />
                                </td>
                                <td class="ps-0">
                                    <a href="/apps/ecommerce/catalog/edit-product"
                            ...
                            <tr>
                                <td>
                                    <img src="admin/assets/media/stock/ecommerce/209.png" class="w-50px ms-n1"
                                        alt="" />
                                </td>
                                <td class="ps-0">
                                    <a href="/apps/ecommerce/catalog/edit-product"
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <img src="admin/assets/media/stock/ecommerce/197.png" class="w-50px ms-n1"
                                        alt="" />
                                </td>
                                <td class="ps-0">
                                    <a href="/apps/ecommerce/catalog/edit-product"
                            ...
                            <tr>
                                <td>
                                    <img src="admin/assets/media/stock/ecommerce/178.png" class="w-50px ms-n1"
                                        alt="" />
                                </td>
                                <td class="ps-0">
                                    <a href="/apps/ecommerce/catalog/edit-product"
                            ...
                            <tr>
                                <td>
                                    <img src="admin/assets/media/stock/ecommerce/22.png" class="w-50px ms-n1"
                                        alt="" />
                                </td>
                                <td class="ps-0">
                                    <a href="/apps/ecommerce/catalog/edit-product"
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <img src="admin/assets/media/stock/ecommerce/24.png" class="w-50px ms-n1"
                                        alt="" />
                                </td>
                                <td class="ps-0">
                                    <a href="/apps/ecommerce/catalog/edit-product"
                            ...
                            <tr>
                                <td>
                                    <img src="admin/assets/media/stock/ecommerce/71.png" class="w-50px ms-n1"
                                        alt="" />
                                </td>
                                <td class="ps-0">
                                    <a href="/apps/ecommerce/catalog/edit-product"
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <img src="admin/assets/media/stock/ecommerce/41.png" class="w-50px ms-n1"
                                        alt="" />
                                </td>
                                <td class="ps-0">
                                    <a href="/apps/ecommerce/catalog/edit-product"
                            ...
                            <tr>
                                <td>
                                    <img src="admin/assets/media/stock/ecommerce/63.png" class="w-50px ms-n1"
                                        alt="" />
                                </td>
                                <td class="ps-0">
                                    <a href="/apps/ecommerce/catalog/edit-product"
                            ...
                            <tr>
                                <td>
                                    <img src="admin/assets/media/stock/ecommerce/59.png" class="w-50px ms-n1"
                                        alt="" />
                                </td>
                                <td class="ps-0">
                                    <a href="/apps/ecommerce/catalog/edit-product"
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <img src="admin/assets/media/stock/ecommerce/10.png" class="w-50px ms-n1"
                                        alt="" />
                                </td>
                                <td class="ps-0">
                                    <a href="/apps/ecommerce/catalog/edit-product"
                            ...
                            <tr>
                                <td>
                                    <img src="admin/assets/media/stock/ecommerce/96.png" class="w-50px ms-n1"
                                        alt="" />
                                </td>
                                <td class="ps-0">
                                    <a href="/apps/ecommerce/catalog/edit-product"
                            ...
                            <tr>
                                <td>
                                    <img src="admin/assets/media/stock/ecommerce/13.png" class="w-50px ms-n1"
                                        alt="" />
                                </td>
                                <td class="ps-0">
                                    <a href="/apps/ecommerce/catalog/edit-product"
