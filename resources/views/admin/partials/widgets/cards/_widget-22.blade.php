        ...
        <div class="row g-5 g-lg-9">
            ...
            <div class="col-6">
                ...
                <div class="card card-shadow">
                    ...
                    <div class="card-body p-0">
                        <!--begin::Items-->
                        <a href='?page=apps/subscriptions/list'
            ...
            <div class="col-6">
                ...
                <div class="card card-shadow">
                    ...
                    <div class="card-body p-0">
                        <!--begin::Items-->
                        <a href='?page=apps/ecommerce/catalog/products'
                            class="btn btn-active-color-primary px-7 py-6 text-start w-100">
                            <!--begin::Icon-->
            ...
            <div class="col-6">
                ...
                <div class="card card-shadow">
                    ...
                    <div class="card-body p-0">
                        <!--begin::Items-->
                        <a href='?page=pages/contact' class="btn btn-active-color-primary px-7 py-6 text-start w-100">
                            <!--begin::Icon-->
            ...
            <div class="col-6">
                ...
                <div class="card card-shadow">
                    ...
                    <div class="card-body p-0">
                        <!--begin::Items-->
                        <a href='?page=apps/file-manager/folders'
                            class="btn btn-active-color-primary px-7 py-6 text-start w-100">
                            <!--begin::Icon-->
            ...
            <div class="col-6">
                ...
                <div class="card card-shadow">
                    ...
                    <div class="card-body p-0">
                        <!--begin::Items-->
                        <a href='?page=apps/support-center/overview'
                            class="btn btn-active-color-primary px-7 py-6 text-start w-100">
                            <!--begin::Icon-->
