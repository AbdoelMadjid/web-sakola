...
<div class="card draggable-handle h-lg-100" style="background: linear-gradient(112.14deg, #FF8A00 0%, #E96922 100%)">
    ...
    <div class="card-body">
        ...
        <div class="row align-items-center">
                ...
                <div class="d-flex justify-content-between h-100 flex-column pt-xl-5 pb-xl-2 ps-xl-7">
                    ...
                    <div class="mb-7">
                        ...
                        <div class="mb-6">
                            ...
                            <span class="fw-semibold text-white opacity-75">Flat cartoony and illustrations with vivid
                                color</span>
                        </div>
                        <!--end::Title-->
                        <!--begin::Items-->
                        <div class="d-flex align-items-center flex-wrap d-grid gap-2 ">
                            ...
                            <div class="d-flex align-items-center me-5 me-xl-13">
                                ...
                                <div class="symbol symbol-30px symbol-circle me-3">
                                    <span class="symbol-label" style="background: rgba(255, 255, 255, 0.15);">
                                        <i class="ki-outline ki-abstract-41 fs-4 text-white"></i> </span>
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Info-->
                                <div class="m-0">
                                    <a href="?page=pages/user-profile/projects"
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-30px symbol-circle me-3">
                                    <span class="symbol-label" style="background: rgba(255, 255, 255, 0.15);">
                                        <i class="ki-outline ki-abstract-26 fs-4 text-white"></i> </span>
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Info-->
                                <div class="m-0">
                                    <a href="?page=apps/user-management/users/list"
            ...
            <div class="col-sm-5">
                <!--begin::Illustration-->
                <img src="admin/assets/media/svg/illustrations/easy/7.svg" class="h-200px h-lg-250px my-n6" alt="" />
                <!--end::Illustration-->
            </div>
            <!--begin::Col-->
        </div>
