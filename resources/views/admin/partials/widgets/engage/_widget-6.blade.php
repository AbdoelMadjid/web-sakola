<div class="card flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100"
    style="background-color: #020202;background-image: url(admin/assets/media/stock/600x600/img-62.jpg);">
    <!--begin::Body-->
    <div class="card-body d-flex justify-content-between flex-column ps-xl-18">
        ...
        <div class="mb-xl-10 mb-3">
            ...
            <a href="/apps/support-center/overview" class="btn btn-color-white bg-transparent btn-outline fw-semibold"
