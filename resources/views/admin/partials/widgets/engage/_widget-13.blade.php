...
<div class="card card-flush ">
    ...
    <div class="card-header pt-7 mb-2">
        ...
        <div class="card-toolbar">
            <a href="admin/assets/media/apps/ecommerce/sales/details" class="btn btn-sm btn-light">Help</a>
        </div>
        <!--end::Toolbar-->
    </div>
    <!--end::Header-->
    ...
    <div class="card-body text-center">
        ...
        <!--end::Select-->
        <!--begin::Illustration-->
        <img class="h-250px mb-8 theme-light-show" src="admin/assets/media/illustrations/sigma-1/21.png" alt="" />
        <img class="h-250px mb-8 theme-dark-show" src="admin/assets/media/illustrations/sigma-1/21-dark.png" alt="" />
        <!--end::Illustration-->
        <!--begin::Text-->
