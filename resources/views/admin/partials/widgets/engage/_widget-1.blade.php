...
<div class="card bgi-position-y-bottom bgi-position-x-end bgi-no-repeat bgi-size-cover min-h-250px bg-primary mb-5 mb-xl-8 border-0"
    style="background-position: 100% 50px;background-size: 500px auto;background-image:url('admin/assets/media/misc/city.png')"
    dir="ltr">
    <!--begin::Body-->
    <div class="card-body d-flex flex-column justify-content-center ps-lg-12">
        ...
        <!--begin::Action-->
        <div class="m-0">
            <a href='#' class="btn btn-success fw-semibold px-6 py-3" data-bs-toggle="modal"
