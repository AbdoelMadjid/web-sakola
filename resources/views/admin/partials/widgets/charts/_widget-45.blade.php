        ...
        <div class="m-0">
                ...
                <div class="d-flex align-items-center me-2">
                    ...
                    <div class="symbol symbol-50px me-5">
                        <div class="symbol-label bg-light">
                            <img src="admin/assets/media/svg/brand-logos/plurk.svg" alt="" class="h-50"
                                alt="" />
                        </div>
                    </div>
                    <!--end::Symbol-->
            ...
            <div class="d-flex flex-stack mb-9">
                ...
                <div class="d-flex align-items-center me-2">
                    ...
                    <div class="symbol symbol-50px me-5">
                        <div class="symbol-label bg-light">
                            <img src="admin/assets/media/svg/brand-logos/telegram-2.svg" alt="" class="h-50"
                                alt="" />
                        </div>
                    </div>
                    <!--end::Symbol-->
            ...
            <div class="d-flex flex-stack ">
                ...
                <div class="d-flex align-items-center me-2">
                    ...
                    <div class="symbol symbol-50px me-5">
                        <div class="symbol-label bg-light">
                            <img src="admin/assets/media/svg/brand-logos/vimeo.svg" alt="" class="h-50"
                                alt="" />
                        </div>
                    </div>
                    <!--end::Symbol-->
