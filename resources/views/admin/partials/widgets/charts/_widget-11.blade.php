    ...
    <div class="card-body pb-0 pt-4">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="kt_chart_widget_11_tab_content_2" role="tabpanel">
                ...
                <!--end::Statistics-->
                <!--begin::Chart-->
                <div id="kt_charts_widget_11_chart_2" class="ms-n5 me-n3 min-h-auto" style="height: 300px">
                </div>
                <!--end::Chart-->
            </div>
            <!--end::Tab pane-->
            ...
            <div class="tab-pane fade active show" id="kt_chart_widget_11_tab_content_3" role="tabpanel">
                ...
                <!--end::Statistics-->
                <!--begin::Chart-->
                <div id="kt_charts_widget_11_chart_3" class="ms-n5 me-n3 min-h-auto" style="height: 300px">
                </div>
                <!--end::Chart-->
            </div>
            <!--end::Tab pane-->
