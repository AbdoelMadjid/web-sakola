                ...
                <div class="col-xl-8">
                    ...
                    <div class="card flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100"
                        style="
                          ...
                          background-image: url(admin/assets/media/stock/600x600/img-62.jpg);
                        ">
                        <!--begin::Body-->
                        <div class="card-body d-flex justify-content-between flex-column ps-xl-18">
                            ...
                            <div class="mb-20 pt-xl-13">
                                <!--begin::Title-->
                                <h3 class="fw-bold text-white fs-4x mb-5 ms-n1">
                                    Utah Case
                                </h3>
                                <!--end::Title-->
                                <!--begin::Description-->
                            ...
                            <div class="mb-xl-10 mb-3">
                                <a href="#" class="btn btn-primary fw-semibold me-2" data-bs-toggle="modal"
                                    data-bs-target="#kt_modal_upgrade_plan">Listen Now</a>
                                <a href="/apps/support-center/overview"
                                    class="btn btn-color-white bg-transparent btn-outline fw-semibold"
                                    style="border: 1px solid rgba(255, 255, 255, 0.3)">Save for Later</a>
                            </div>
                            <!--begin::Action-->
                        </div>
                        <!--end::Body-->
                    ...
                    <div class="card card-flush h-xl-100" id="kt_player_widget_2">
                        ...
                        <div class="card-body bg-black pt-0">
                            ...
                            <div class="mx-auto mb-6 bgi-no-repeat bgi-size-contain bgi-position-center rounded-circle w-125px h-125px"
                                style="
                              background-image: url(admin/assets/media/stock/600x600/img-59.jpg);
                            ">
                            </div>
                            <!--end::Image-->
                            <!--begin::Section-->
                ...
                <div class="col-xl-8">
                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-header pt-7">
                            ...
                            <!--begin::Toolbar-->
                            <div class="card-toolbar">
                                <a href="/pages/account/statements" class="btn btn-sm btn-light">History</a>
                            </div>
                            <!--end::Toolbar-->
                        </div>
                        <!--end::Header-->
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="card-rounded position-relative mb-5">
                                            ...
                                            <div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
                                                style="
                                      background-image: url(admin/assets/media/stock/600x600/img-61.jpg);
                                    ">
                                            </div>
                                            <!--end::Img-->
                                            <!--begin::Play-->
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="card-rounded position-relative mb-5">
                                            ...
                                            <div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
                                                style="
                                      background-image: url(admin/assets/media/stock/600x600/img-60.jpg);
                                    ">
                                            </div>
                                            <!--end::Img-->
                                            <!--begin::Play-->
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="card-rounded position-relative mb-5">
                                            ...
                                            <div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
                                                style="
                                      background-image: url(admin/assets/media/stock/600x600/img-63.jpg);
                                    ">
                                            </div>
                                            <!--end::Img-->
                                            <!--begin::Play-->
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="card-rounded position-relative mb-5">
                                            ...
                                            <div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
                                                style="
                                      background-image: url(admin/assets/media/stock/600x600/img-56.jpg);
                                    ">
                                            </div>
                                            <!--end::Img-->
                                            <!--begin::Play-->
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="card-rounded position-relative mb-5">
                                            ...
                                            <div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
                                                style="
                                      background-image: url(admin/assets/media/stock/600x600/img-57.jpg);
                                    ">
                                            </div>
                                            <!--end::Img-->
                                            <!--begin::Play-->
                                        ...
                                        <div class="m-0">
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fs-3 fw-bold d-block mb-2">It is
                                                what it is</a>
                                            <!--end::Title-->
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="card-rounded position-relative mb-5">
                                            ...
                                            <div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
                                                style="
                                      background-image: url(admin/assets/media/stock/600x600/img-58.jpg);
                                    ">
                                            </div>
                                            <!--end::Img-->
                                            <!--begin::Play-->
                                        ...
                                        <div class="m-0">
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fs-3 fw-bold d-block mb-2">Broken
                                                Mirros</a>
                                            <!--end::Title-->
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="card-rounded position-relative mb-5">
                                            ...
                                            <div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
                                                style="
                                      background-image: url(admin/assets/media/stock/600x600/img-55.jpg);
                                    ">
                                            </div>
                                            <!--end::Img-->
                                            <!--begin::Play-->
                                        ...
                                        <div class="m-0">
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fs-3 fw-bold d-block mb-2">The
                                                Hood</a>
                                            <!--end::Title-->
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="card-rounded position-relative mb-5">
                                            ...
                                            <div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
                                                style="
                                      background-image: url(admin/assets/media/stock/600x600/img-64.jpg);
                                    ">
                                            </div>
                                            <!--end::Img-->
                                            <!--begin::Play-->
                                        ...
                                        <div class="m-0">
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fs-3 fw-bold d-block mb-2">Cirle
                                                Lights</a>
                                            <!--end::Title-->
                        ...
                        <div class="card-body pt-6">
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="symbol symbol-circle symbol-60px me-4">
                                    <img src="admin/assets/media/avatars/300-28.jpg" class="" alt="" />
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Section-->
                                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                    ...
                                    <div class="flex-grow-1 me-2">
                                        <a href="/pages/general/user-profile/overview"
                                            class="text-gray-800 text-hover-primary fs-5 fw-bolder">Leslie Alexander</a>
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Symbol-->
                                <div class="symbol symbol-circle symbol-60px me-4">
                                    <img src="admin/assets/media/avatars/300-29.jpg" class="" alt="" />
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Section-->
                                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                    ...
                                    <div class="flex-grow-1 me-2">
                                        <a href="/pages/general/user-profile/overview"
                                            class="text-gray-800 text-hover-primary fs-5 fw-bolder">Jacob Jones</a>
                                        <span class="text-gray-500 fw-semibold d-block fs-6">Community</span>
                                    </div>
                                    <!--end:Author-->
                                    <!--begin::Follow-->
                                    <button class="btn btn-sm btn-primary py-2 px-4 fs-7 fw-bold"
                                        data-kt-element="follow">
                                        Following
                                    </button>
                                    <!--end::Follow-->
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Symbol-->
                                <div class="symbol symbol-circle symbol-60px me-4">
                                    <img src="admin/assets/media/avatars/300-9.jpg" class="" alt="" />
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Section-->
                                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                    ...
                                    <div class="flex-grow-1 me-2">
                                        <a href="/pages/general/user-profile/overview"
                                            class="text-gray-800 text-hover-primary fs-5 fw-bolder">Ronald Richards</a>
                                        <span class="text-gray-500 fw-semibold d-block fs-6">Community</span>
                                    </div>
                                    <!--end:Author-->
                                    <!--begin::Follow-->
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Symbol-->
                                <div class="symbol symbol-circle symbol-60px me-4">
                                    <img src="admin/assets/media/avatars/300-3.jpg" class="" alt="" />
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Section-->
                                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                    ...
                                    <div class="flex-grow-1 me-2">
                                        <a href="/pages/general/user-profile/overview"
                                            class="text-gray-800 text-hover-primary fs-5 fw-bolder">Courtney Henry</a>
                                        <span class="text-gray-500 fw-semibold d-block fs-6">Community</span>
                                    </div>
                                    <!--end:Author-->
                                    <!--begin::Follow-->
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Symbol-->
                                <div class="symbol symbol-circle symbol-60px me-4">
                                    <img src="admin/assets/media/avatars/300-27.jpg" class="" alt="" />
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Section-->
                                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                    ...
                                    <div class="flex-grow-1 me-2">
                                        <a href="/pages/general/user-profile/overview"
                                            class="text-gray-800 text-hover-primary fs-5 fw-bolder">Arlene McCoy</a>
                                        <span class="text-gray-500 fw-semibold d-block fs-6">Community</span>
                                    </div>
                                    <!--end:Author-->
                                    <!--begin::Follow-->
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Symbol-->
                                <div class="symbol symbol-circle symbol-60px me-4">
                                    <img src="admin/assets/media/avatars/300-30.jpg" class="" alt="" />
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Section-->
                                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                    ...
                                    <div class="flex-grow-1 me-2">
                                        <a href="/pages/general/user-profile/overview"
                                            class="text-gray-800 text-hover-primary fs-5 fw-bolder">Marvin McKinney</a>
                                        <span class="text-gray-500 fw-semibold d-block fs-6">Community</span>
                                    </div>
                                    <!--end:Author-->
                                    <!--begin::Follow-->
                            ...
                            <div class="row align-items-end h-100 gx-5 gx-xl-10">
                                ...
                                <div class="col-md-4 mb-11 mb-md-0">
                                    ...
                                    <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                        href="admin/assets/media/stock/900x600/42.jpg">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded mb-3"
                                            style="height: 266px;background-image:url(admin/assets/media/stock/900x600/42.jpg">
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Action-->
                                ...
                                <div class="col-md-4 mb-11 mb-md-0">
                                    <!--begin::Overlay-->
                                    <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                        href="admin/assets/media/stock/900x600/40.jpg">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded mb-3"
                                            style="height: 266px;background-image:url(admin/assets/media/stock/900x600/40.jpg">
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Action-->
                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                ...
                                <div class="col-md-4">
                                    <!--begin::Overlay-->
                                    <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                        href="admin/assets/media/stock/900x600/41.jpg">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded mb-3"
                                            style="height: 266px;background-image:url(admin/assets/media/stock/900x600/41.jpg">
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Action-->
                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                    ...
                                    <div class="m-0">
                                        <!--begin::Title-->
                                        <a href="#"
                                            class="text-gray-800 text-hover-primary fs-3 fw-bold d-block mb-2">Birds in
                                            the Sky</a>
                                        <!--end::Title-->
                                        <!--begin::Time-->
                        ...
                        <div class="card-body d-flex flex-column flex-center">
                            ...
                            <div class="mb-2">
                                ...
                                <div class="py-10 text-center">
                                    <img src="admin/assets/media/svg/illustrations/easy/2.svg" class="theme-light-show h-125px"
                                        alt="" />
                                    <img src="admin/assets/media/svg/illustrations/easy/2-dark.svg"
                            ...
                            <div class="text-center mb-1">
                                ...
                                <!--end::Link-->
                                <!--begin::Link-->
                                <a class="btn btn-sm btn-light" href="/pages/account/billing">Learn More</a>
                                <!--end::Link-->
                            </div>
                            <!--end::Links-->
                        </div>
                                ...
                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <a href="#"
                                                    class="text-gray-800 fw-bold text-hover-primary d-block mb-1 fs-6">$5,400</a>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <a href="#"
                                                    class="text-gray-800 fw-bold text-hover-primary d-block mb-1 fs-6">$174,074</a>
                                                <span class="text-gray-500 fw-semibold d-block fs-7">Earnings</span>
                                            </td>
                                            <td class="float-end text-end border-0">
                                                <div class="rating">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <a href="#"
                                                    class="text-gray-800 fw-bold text-hover-primary d-block mb-1 fs-6">$2,737</a>
                                                <span class="text-gray-500 fw-semibold d-block fs-7">Earnings</span>
                                            </td>
                                            <td class="float-end text-end border-0">
                                                <div class="rating">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <a href="#"
                                                    class="text-gray-800 fw-bold text-hover-primary d-block mb-1 fs-6">$59,634</a>
                                                <span class="text-gray-500 fw-semibold d-block fs-7">Earnings</span>
                                            </td>
                                            <td class="float-end text-end border-0">
                                                <div class="rating">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-circle symbol-40px me-3">
                                                        <img src="admin/assets/media/avatars/300-3.jpg" class=""
                                                            alt="" />
                                                    </div>
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <a href="/pages/account/overview"
                                            ...
                                            <td class="text-end">
                                                <a href="#"
                                                    class="text-gray-800 fw-bold text-hover-primary d-block mb-1 fs-6">$19,842</a>
                                                <span class="text-gray-500 fw-semibold d-block fs-7">Earnings</span>
                                            </td>
                                            <td class="float-end text-end border-0">
                                                <div class="rating">
                        ...
                        <div class="card-body py-0 px-0">
                            ...
                            <ul class="nav d-flex justify-content-between mb-3 mx-9">
                                ...
                                <li class="nav-item mb-3">
                                    ...
                                    <a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px active"
                                        data-bs-toggle="tab" id="kt_charts_widget_34_tab_1"
                                        href="#kt_charts_widget_34_tab_content_1">1d</a>
                                    <!--end::Link-->
                                </li>
                                <!--end::Item-->
                                <!--begin::Item-->
                                <li class="nav-item mb-3">
                                    ...
                                    <a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px"
                                        data-bs-toggle="tab" id="kt_charts_widget_34_tab_2"
                                        href="#kt_charts_widget_34_tab_content_2">5d</a>
                                    <!--end::Link-->
                                </li>
                                <!--end::Item-->
                                <!--begin::Item-->
                                <li class="nav-item mb-3">
                                    <!--begin::Link-->
                                    <a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px"
                                        data-bs-toggle="tab" id="kt_charts_widget_34_tab_3"
                                        href="#kt_charts_widget_34_tab_content_3">1m</a>
                                    <!--end::Link-->
                                </li>
                                <!--end::Item-->
                                <!--begin::Item-->
                                <li class="nav-item mb-3">
                                    <!--begin::Link-->
                                    <a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px"
                                        data-bs-toggle="tab" id="kt_charts_widget_34_tab_4"
                                        href="#kt_charts_widget_34_tab_content_4">6m</a>
                                    <!--end::Link-->
                                </li>
                                <!--end::Item-->
                                <!--begin::Item-->
                                <li class="nav-item mb-3">
                                    <!--begin::Link-->
                                    <a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px"
                                        data-bs-toggle="tab" id="kt_charts_widget_34_tab_5"
                                        href="#kt_charts_widget_34_tab_content_5">1y</a>
                                    <!--end::Link-->
                                </li>
                                <!--end::Item-->
                            </ul>
                            ...
                            <div class="tab-content mt-n6">
                                ...
                                <div class="tab-pane fade active show" id="kt_charts_widget_34_tab_content_1">
                                    <!--begin::Chart-->
                                    <div id="kt_charts_widget_34_chart_1" data-kt-chart-color="info"
                                ...
                                <div class="tab-pane fade" id="kt_charts_widget_34_tab_content_2">
                                    <!--begin::Chart-->
                                    <div id="kt_charts_widget_34_chart_2" data-kt-chart-color="info"
                                        class="min-h-auto h-200px ps-3 pe-6"></div>
                                    <!--end::Chart-->
                                    <!--begin::Table container-->
                                    <div class="table-responsive mx-9 mt-n6">
                                ...
                                <div class="tab-pane fade" id="kt_charts_widget_34_tab_content_3">
                                    <!--begin::Chart-->
                                    <div id="kt_charts_widget_34_chart_3" data-kt-chart-color="info"
                                        class="min-h-auto h-200px ps-3 pe-6"></div>
                                    <!--end::Chart-->
                                    <!--begin::Table container-->
                                    <div class="table-responsive mx-9 mt-n6">
                                ...
                                <div class="tab-pane fade" id="kt_charts_widget_34_tab_content_4">
                                    <!--begin::Chart-->
                                    <div id="kt_charts_widget_34_chart_4" data-kt-chart-color="info"
                                        class="min-h-auto h-200px ps-3 pe-6"></div>
                                    <!--end::Chart-->
                                    <!--begin::Table container-->
                                    <div class="table-responsive mx-9 mt-n6">
                                ...
                                <div class="tab-pane fade" id="kt_charts_widget_34_tab_content_5">
                                    <!--begin::Chart-->
                                    <div id="kt_charts_widget_34_chart_5" data-kt-chart-color="info"
                                        class="min-h-auto h-200px ps-3 pe-6"></div>
                                    <!--end::Chart-->
                                    <!--begin::Table container-->
                                    <div class="table-responsive mx-9 mt-n6">
