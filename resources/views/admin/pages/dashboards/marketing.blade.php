                        ...
                        <div class="col-sm-6 mb-5 mb-xl-10">
                            ...
                            <div class="card card-flush h-lg-100">
                                ...
                                <div class="card-body pt-5">
                                    ...
                                    <div class="d-flex flex-stack">
                                        <!--begin::Title-->
                                        <a href="#" class="text-primary opacity-75-hover fs-6 fw-semibold">Google
                                            Analytics</a>
                                        <!--end::Title-->
                                        <!--begin::Action-->
                                        <button type="button"
                                    ...
                                    <div class="d-flex flex-stack">
                                        <!--begin::Title-->
                                        <a href="#" class="text-primary opacity-75-hover fs-6 fw-semibold">Facebook
                                            Ads</a>
                                        <!--end::Title-->
                                        <!--begin::Action-->
                                        <button type="button"
                            ...
                            <ul class="nav nav-pills nav-pills-custom mb-3">
                                ...
                                <li class="nav-item mb-3 me-3 me-lg-6">
                                    ...
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden active w-80px h-85px py-4"
                                        ...
                                        <!--begin::Icon-->
                                        <div class="nav-icon">
                                            <img alt="" src="admin/assets/media/svg/brand-logos/beats-electronics.svg"
                                                class="" />
                                        </div>
                                        <!--end::Icon-->
                                        <!--begin::Subtitle-->
                                ...
                                <li class="nav-item mb-3 me-3 me-lg-6">
                                    ...
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                                        ...
                                        <!--begin::Icon-->
                                        <div class="nav-icon">
                                            <img alt="Logo" src="admin/assets/media/svg/brand-logos/amazon.svg"
                                                class="theme-light-show" />
                                            <img alt="Logo" src="admin/assets/media/svg/brand-logos/amazon-dark.svg"
                                ...
                                <li class="nav-item mb-3 me-3 me-lg-6">
                                    ...
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                                        ...
                                        <!--begin::Icon-->
                                        <div class="nav-icon">
                                            <img alt="" src="admin/assets/media/svg/brand-logos/bp-2.svg"
                                                class="" />
                                        </div>
                                        <!--end::Icon-->
                                        <!--begin::Subtitle-->
                                ...
                                <li class="nav-item mb-3 me-3 me-lg-6">
                                    ...
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                                        ...
                                        <!--begin::Icon-->
                                        <div class="nav-icon">
                                            <img alt="" src="admin/assets/media/svg/brand-logos/slack-icon.svg"
                                                class="nav-icon" />
                                        </div>
                                        <!--end::Icon-->
                                        <!--begin::Subtitle-->
                                ...
                                <li class="nav-item mb-3">
                                    ...
                                    <a class="nav-link d-flex flex-center overflow-hidden w-80px h-85px"
                                        data-bs-toggle="modal" data-bs-target="#kt_modal_create_campaign" href="#">
                                        <!--begin::Icon-->
                                        <div class="nav-icon">
                                        ...
                                        <table class="table align-middle gs-0 gy-4 my-0">
                                            ...
                                            <thead>
                                                <tr class="fs-7 fw-bold text-gray-500">
                                                    <th class="p-0 min-w-150px d-block pt-3">
                                                        EMAIL TITLE
                                                    </th>
                                                    <th class="text-end min-w-140px pt-3">
                                                        STATUS
                                                    </th>
                                                    <th class="pe-0 text-end min-w-120px pt-3">
                                                        CONVERSION
                                                    </th>
                                                </tr>
                                            </thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <span class="badge badge-light-primary fs-7 fw-bold">In
                                                            Draft</span>
                                                    </td>
                                                    <td class="text-end">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <span class="badge badge-light-warning fs-7 fw-bold">In
                                                            Queue</span>
                                                    </td>
                                                    <td class="text-end">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <div class="d-flex align-items-center me-3">
                                            ...
                                            <div class="flex-grow-1">
                                                <a href="#"
                                                    class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Linked
                                                    In</a>
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <div>
                                                    <select class="form-select form-select-solid" multiple="multiple"
                                                        ...
                                                        data-dropdown-parent="#kt_menu_660638595fe14"
                                    ...
                                    <tr>
                                        <td class="min-w-175px">
                                            <div class="position-relative ps-6 pe-3 py-2">
                                                ...
                                                <a href="#"
                                                    class="mb-1 text-gray-900 text-hover-primary fw-bold">Team Getaway</a>
                                                <div class="fs-7 text-muted fw-bold">
                                                    Created on 24 Dec 21
                                                </div>
                                            </div>
                        ...
                        <div class="card-body d-flex flex-column flex-center">
                            ...
                            <div class="mb-2">
                                ...
                                <div class="py-10 text-center">
                                    <img src="admin/assets/media/svg/illustrations/easy/1.svg"
                            ...
                            <div class="text-center mb-1">
                                ...
                                <!--end::Link-->
                                <!--begin::Link-->
                                <a class="btn btn-sm btn-light" href="/pages/general/user-profile/followers">Learn
                                    more</a>
                                <!--end::Link-->
                            </div>
                            <!--end::Links-->
