        ...
        <div class="d-flex flex-column flex-root" id="kt_app_root">
            ...
            <div class="mb-0" id="home">
                ...
                <div class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom landing-dark-bg"
                    style="background-image: url({{ asset('admin/assets/media/svg/illustrations/landing.svg') }});">
                    <!--begin::Header-->
                ...
                <div class="container">
                    ...
                    <div class="tns tns-default">
                        ...
                        <div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000"
                            ...
                            <!--begin::Item-->
                            <div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
                                <img src="{{ asset('admin/assets/media/preview/demos/demo2/light-ltr.png') }}"
                                    class="card-rounded shadow mh-lg-650px mw-100" alt="" />
                            </div>
                            <!--end::Item-->
                            <!--begin::Item-->
                            <div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
                                <img src="{{ asset('admin/assets/media/preview/demos/demo4/light-ltr.png') }}"
                                    class="card-rounded shadow mh-lg-650px mw-100" alt="" />
                            </div>
                            <!--end::Item-->
                            <!--begin::Item-->
                            <div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
                                <img src="{{ asset('admin/assets/media/preview/demos/demo5/light-ltr.png') }}"
                                    class="card-rounded shadow mh-lg-650px mw-100" alt="" />
                            </div>
                            <!--end::Item-->
                        </div>
                        ...
                        <div class="d-flex flex-center">
                            ...
                            <div
                                ...
                                <div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain"
                                    style="background-image: url({{ asset('admin/assets/media/svg/misc/octagon.svg') }});">
                                    <!--begin::Symbol-->
                    ...
                    <div class="tns tns-default" style="direction: ltr">
                        ...
                        <div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000"
                            ...
                            <div class="text-center">
                                <!--begin::Photo-->
                                <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                    style="background-image: url({{ asset('admin/assets/media/avatars/300-2.jpg') }});">
                                </div>
                                <!--end::Photo-->
                                <!--begin::Person-->
                                <div class="mb-0">
                            ...
                            <div class="text-center">
                                <!--begin::Photo-->
                                <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                    style="background-image: url({{ asset('admin/assets/media/avatars/300-5.jpg') }});">
                                </div>
                                <!--end::Photo-->
                                <!--begin::Person-->
                                <div class="mb-0">
                            ...
                            <div class="text-center">
                                <!--begin::Photo-->
                                <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                    style="background-image: url({{ asset('admin/assets/media/avatars/300-20.jpg') }});">
                                </div>
                                <!--end::Photo-->
                                <!--begin::Person-->
                                <div class="mb-0">
                            ...
                            <div class="text-center">
                                <!--begin::Photo-->
                                <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                    style="background-image: url({{ asset('admin/assets/media/avatars/300-23.jpg') }});">
                                </div>
                                <!--end::Photo-->
                                <!--begin::Person-->
                                <div class="mb-0">
                            ...
                            <div class="text-center">
                                <!--begin::Photo-->
                                <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                    style="background-image: url({{ asset('admin/assets/media/avatars/300-12.jpg') }});">
                                </div>
                                <!--end::Photo-->
                                <!--begin::Person-->
                                <div class="mb-0">
                            ...
                            <div class="text-center">
                                <!--begin::Photo-->
                                <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                    style="background-image: url({{ asset('admin/assets/media/avatars/300-9.jpg') }});">
                                </div>
                                <!--end::Photo-->
                                <!--begin::Person-->
                                <div class="mb-0">
                                    ...
                                    <div class="row g-10">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <a class="d-block card-rounded overlay h-lg-100"
                                                ...
                                                href="{{ asset('admin/assets/media/stock/600x600/img-23.jpg') }}">
                                                <!--begin::Image-->
                                                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-lg-100 min-h-250px"
                                                    style="background-image: url({{ asset('admin/assets/media/stock/600x600/img-23.jpg') }});">
                                                </div>
                                                <!--end::Image-->
                                                <!--begin::Action-->
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="row g-10 mb-10">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <a class="d-block card-rounded overlay"
                                                        data-fslightbox="lightbox-projects"
                                                        href="{{ asset('admin/assets/media/stock/600x600/img-22.jpg') }}">
                                                        <!--begin::Image-->
                                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                                            style="background-image: url({{ asset('admin/assets/media/stock/600x600/img-22.jpg') }});">
                                                        </div>
                                                        <!--end::Image-->
                                                        <!--begin::Action-->
                                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <a class="d-block card-rounded overlay"
                                                        data-fslightbox="lightbox-projects"
                                                        href="{{ asset('admin/assets/media/stock/600x600/img-21.jpg') }}">
                                                        <!--begin::Image-->
                                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                                            style="background-image: url({{ asset('admin/assets/media/stock/600x600/img-21.jpg') }});">
                                                        </div>
                                                        <!--end::Image-->
                                                        <!--begin::Action-->
                                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                            ...
                                            <a class="d-block card-rounded overlay"
                                                data-fslightbox="lightbox-projects"
                                                href="{{ asset('admin/assets/media/stock/600x400/img-20.jpg') }}">
                                                <!--begin::Image-->
                                                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                                    style="background-image: url({{ asset('admin/assets/media/stock/600x600/img-20.jpg') }});">
                                                </div>
                                                <!--end::Image-->
                                                <!--begin::Action-->
                                                <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                ...
                                <div class="tab-pane fade" id="kt_landing_projects_web_design">
                                    ...
                                    <div class="row g-10">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <a class="d-block card-rounded overlay h-lg-100"
                                                data-fslightbox="lightbox-projects"
                                                href="{{ asset('admin/assets/media/stock/600x600/img-11.jpg') }}">
                                                <!--begin::Image-->
                                                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-lg-100 min-h-250px"
                                                    style="background-image: url({{ asset('admin/assets/media/stock/600x600/img-11.jpg') }});">
                                                </div>
                                                <!--end::Image-->
                                                <!--begin::Action-->
                                                <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="row g-10 mb-10">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <a class="d-block card-rounded overlay"
                                                        data-fslightbox="lightbox-projects"
                                                        href="{{ asset('admin/assets/media/stock/600x600/img-12.jpg') }}">
                                                        <!--begin::Image-->
                                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                                            style="background-image: url({{ asset('admin/assets/media/stock/600x600/img-12.jpg') }});">
                                                        </div>
                                                        <!--end::Image-->
                                                        <!--begin::Action-->
                                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="row g-10 mb-10">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <a class="d-block card-rounded overlay"
                                                        data-fslightbox="lightbox-projects"
                                                        href="{{ asset('admin/assets/media/stock/600x600/img-16.jpg') }}">
                                                        <!--begin::Image-->
                                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                                            style="background-image: url({{ asset('admin/assets/media/stock/600x600/img-16.jpg') }});">
                                                        </div>
                                                        <!--end::Image-->
                                                        <!--begin::Action-->
                                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                            ...
                                            <a class="d-block card-rounded overlay"
                                                data-fslightbox="lightbox-projects"
                                                href="{{ asset('admin/assets/media/stock/600x400/img-15.jpg') }}">
                                                <!--begin::Image-->
                                                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                                    style="background-image: url({{ asset('admin/assets/media/stock/600x600/img-15.jpg') }});">
                                                </div>
                                                <!--end::Image-->
                                                <!--begin::Action-->
                                                <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                ...
                                <div class="tab-pane fade" id="kt_landing_projects_development">
                                    ...
                                    <div class="row g-10">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <a class="d-block card-rounded overlay h-lg-100"
                                                data-fslightbox="lightbox-projects"
                                                href="{{ asset('admin/assets/media/stock/600x600/img-15.jpg') }}">
                                                <!--begin::Image-->
                                                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-lg-100 min-h-250px"
                                                    style="background-image: url({{ asset('admin/assets/media/stock/600x600/img-15.jpg') }});">
                                                </div>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <a class="d-block card-rounded overlay"
                                                data-fslightbox="lightbox-projects"
                                                href="{{ asset('admin/assets/media/stock/600x400/img-14.jpg') }}">
                                                <!--begin::Image-->
                                                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                                    style="background-image: url({{ asset('admin/assets/media/stock/600x600/img-14.jpg') }});">
                                                </div>
                                                <!--end::Image-->
                                                <!--begin::Action-->
                                                <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                            ...
                            <div
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-circle symbol-50px me-5">
                                        <img src="{{ asset('admin/assets/media/avatars/300-1.jpg') }}" class=""
                                            alt="" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Name-->
                        ...
                        <div class="col-lg-4">
                            ...
                            <div
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-circle symbol-50px me-5">
                                        <img src="{{ asset('admin/assets/media/avatars/300-2.jpg') }}" class=""
                                            alt="" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Name-->
                        ...
                        <div class="col-lg-4">
                            ...
                            <div
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-circle symbol-50px me-5">
                                        <img src="{{ asset('admin/assets/media/avatars/300-16.jpg') }}" class=""
                                            alt="" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Name-->
                            ...
                            <div class="col-lg-6 pe-lg-16 mb-10 mb-lg-0">
                                ...
                                <div class="rounded landing-dark-border p-9">
                                    ...
                                    <span class="fw-normal fs-4 text-gray-700">Use Our Custom Development Service.
                                        <a href="#" class="text-white opacity-50 text-hover-primary">Click to
                                            Get a Quote</a></span>
                                    <!--end::Text-->
                                </div>
                                <!--end::Block-->
                                ...
                                <div class="d-flex justify-content-center">
                                    ...
                                    <div class="d-flex fw-semibold flex-column ms-lg-20">
                                        ...
                                        <a href="https://www.facebook.com/keenthemes" class="mb-6">
                                            <img src="{{ asset('admin/assets/media/svg/brand-logos/facebook-4.svg') }}"
                                        ...
                                        <a href="https://twitter.com/keenthemes" class="mb-6">
                                            <img src="{{ asset('admin/assets/media/svg/brand-logos/twitter.svg') }}"
                                                class="h-20px me-2" alt="" />
                                            <span
