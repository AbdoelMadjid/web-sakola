                                    ...
                                    <div class="d-flex align-items-center mb-6">
                                        ...
                                        <div class="flex-grow-1 me-5">
                                            ...
                                            <div class="text-gray-500 fw-semibold fs-7">
                                                Lead by
                                                <!--begin::Name-->
                                                <a href="#" class="text-primary opacity-75-hover fw-semibold">Lead
                                                    by Bob</a>
                                                <!--end::Name-->
                                            </div>
                                            <!--end::Link-->
                                ...
                                <div id="kt_schedule_day_9" class="tab-pane fade show">
                                    ...
                                    <div class="d-flex flex-stack position-relative mt-8">
                                        ...
                                        <div class="fw-semibold ms-5 text-gray-600">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="fs-5 fw-bold text-gray-800 text-hover-primary mb-2">9 Degree
                                                Project
                                                Estimation Meeting</a>
                                            <!--end::Title-->
                                            <!--begin::User-->
                        ...
                        <div class="card-body py-9">
                            ...
                            <div class="row gx-9 h-100">
                                ...
                                <div class="col-sm-6 mb-10 mb-sm-0">
                                  ...
                                  background-image: url(admin/assets/media/stock/600x600/img-33.jpg);
                                ">
                                    </div>
                                    <!--end::Image-->
                                </div>
                                    ...
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="mb-6">
                                            ...
                                            <span class="fw-semibold text-gray-600 fs-6 mb-8 d-block">Flat cartoony
                                                illustrations
                                                with vivid
                                                unblended colors and asymmetrical beautiful
                                        ...
                                        <div class="d-flex flex-stack mt-auto bd-highlight">
                                            ...
                                            <div class="symbol-group symbol-hover flex-nowrap">
                                                ...
                                                <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                                    title="Michael Eberon">
                                                    <img alt="Pic" src="admin/assets/media/avatars/300-3.jpg" />
                                                </div>
                                                <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                                    title="Susan Redwood">
                                                    <span
                            ...
                            <div class="row align-items-center h-100">
                                ...
                                <div class="col-7 ps-xl-13">
                                    ...
                                    <div class="text-white mb-6 pt-6">
                                        <span class="fs-4 fw-semibold me-2 d-block lh-1 pb-2 opacity-75">Get best
                                            offer</span>
                                ...
                                <div class="col-5 pt-10">
                                    ...
                                    <div class="bgi-no-repeat bgi-size-contain bgi-position-x-end h-225px"
                                        style="background-image:url(admin/assets/media/svg/illustrations/easy/5.svg">
                                    </div>
                                    <!--end::Illustration-->
                                </div>
                                <!--end::Col-->
                ...
                <div class="col-xl-8">
                    ...
                    <div class="card card-flush h-md-100">
                        ...
                        <div class="card-header pt-7">
                            ...
                            <!--begin::Toolbar-->
                            <div class="card-toolbar">
                                <a href="/apps/ecommerce/catalog/add-product" class="btn btn-sm btn-light">History</a>
                            </div>
                            <!--end::Toolbar-->
                        </div>
                        <!--end::Header-->
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="admin/assets/media/stock/600x600/img-49.jpg" class=""
                                                            alt="" />
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="admin/assets/media/stock/600x600/img-40.jpg" class=""
                                                            alt="" />
                                                    </div>
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <a href="#"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="admin/assets/media/stock/600x600/img-39.jpg" class=""
                                                            alt="" />
                                                    </div>
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <a href="#"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="admin/assets/media/stock/600x600/img-47.jpg" class=""
                                                            alt="" />
                                                    </div>
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <a href="#"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="admin/assets/media/stock/600x600/img-48.jpg" class=""
                                                            alt="" />
                                                    </div>
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <a href="#"
                        ...
                        <div class="card-body d-flex flex-column flex-center">
                            ...
                            <div class="mb-2">
                                ...
                                <div class="py-10 text-center">
                                    <img src="admin/assets/media/svg/illustrations/easy/2.svg"
                            ...
                            <div class="text-center mb-1">
                                ...
                                <!--end::Link-->
                                <!--begin::Link-->
                                <a class="btn btn-sm btn-light" href="apps/user-management/users/view">Learn
                                    More</a>
                                <!--end::Link-->
                            </div>
                            <!--end::Links-->
                                ...
                                <div class="tab-pane active" id="kt_timeline_widget_4_tab_day" role="tabpanel"
                                    ...
                                    <div class="table-responsive pb-10">
                                        ...
                                        <div id="kt_timeline_widget_4_1" class="vis-timeline-custom h-350px min-w-700px"
                                            data-kt-timeline-widget-4-image-root="/admin/assets/media/"></div>
                                        <!--end::Timeline-->
                                    </div>
                                </div>
                                <!--end::Tab pane-->
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/utilities/modals/new-address.js"></script>
