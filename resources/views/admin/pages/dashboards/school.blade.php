                        ...
                        <div class="card-body d-flex flex-column pt-13 pb-14">
                            ...
                            <div class="m-0">
                                ...
                                <div class="flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-center card-rounded-bottom h-200px mh-200px my-5 mb-lg-12"
                                    style="
                                background-image: url(admin/assets/media/svg/illustrations/easy/6.svg)">
                                </div>
                                <!--end::Illustration-->
                            </div>
                            <!--end::Heading-->
                            ...
                            <div class="text-center">
                                ...
                                <a class="btn btn-sm bg-white btn-color-white bg-opacity-20"
                                    href="pages/general/careers/list">Nurse</a>
                                <!--end::Link-->
                            </div>
                            <!--end::Links-->
                        </div>
                                    ...
                                    <div class="d-flex flex-wrap flex-md-nowrap">
                                            ...
                                            <div class="d-flex border border-gray-300 border-dashed rounded p-6 mb-6">
                                                ...
                                                <div class="d-flex align-items-center flex-grow-1 me-2 me-sm-5">
                                                    ...
                                                    <div class="me-2">
                                                        ...
                                                        <span class="text-gray-500 fw-bold d-block fs-7">Don’t forget to
                                                            turn in your
                                                            task</span>
                                                    </div>
                                                    <!--end::Section-->
                                            ...
                                            <div class="d-flex border border-gray-300 border-dashed rounded p-6 mb-6">
                                                ...
                                                <div class="d-flex align-items-center flex-grow-1 me-2 me-sm-5">
                                                    ...
                                                    <div class="me-2">
                                                        ...
                                                        <span class="text-gray-500 fw-bold d-block fs-7">You take 12
                                                            subjects at this
                                                            semester</span>
                                                    </div>
                                                    <!--end::Section-->
                                        ...
                                        <div
                                            ...
                                            <div class="fs-4 fw-bold text-gray-900 text-center mb-5">
                                                Session Attendance <br />for Current
                                                Academic Year
                                            </div>
                                            <!--end::Title-->
                                            <!--begin::Chart-->
