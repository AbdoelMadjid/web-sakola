                        ...
                        <div class="card-body d-flex flex-column flex-center">
                            ...
                            <div class="mb-2">
                                ...
                                <div class="py-10 text-center">
                                    <img src="admin/assets/media/svg/illustrations/easy/1.svg" class="theme-light-show w-200px"
                                        alt="" />
                                    <img src="admin/assets/media/svg/illustrations/easy/1-dark.svg"
                            ...
                            <div class="text-center mb-1">
                                ...
                                <!--end::Link-->
                                <!--begin::Link-->
                                <a class="btn btn-sm btn-light" href="pages/general/user-profile/activity">Learn more</a>
                                <!--end::Link-->
                            </div>
                            <!--end::Links-->
                        </div>
                ...
                <div class="col-sm-6 col-xl-2 mb-xl-10">
                    ...
                    <div class="card h-lg-100">
                        ...
                        <div class="card-body d-flex justify-content-between align-items-start flex-column">
                            <!--begin::Icon-->
                            <div class="m-0">
                                <img src="admin/assets/media/svg/brand-logos/instagram-2-1.svg" class="w-35px"
                                    alt="" />
                            </div>
                            <!--end::Icon-->
                            <!--begin::Section-->
                ...
                <div class="col-sm-6 col-xl-2 mb-xl-10">
                    ...
                    <div class="card h-lg-100">
                        ...
                        <div class="card-body d-flex justify-content-between align-items-start flex-column">
                            <!--begin::Icon-->
                            <div class="m-0">
                                <img src="admin/assets/media/svg/brand-logos/facebook-3.svg" class="w-35px" alt="" />
                            </div>
                            <!--end::Icon-->
                            <!--begin::Section-->
                            <div class="d-flex flex-column my-7">
                ...
                <div class="col-sm-6 col-xl-2 mb-xl-10">
                    ...
                    <div class="card h-lg-100">
                        ...
                        <div class="card-body d-flex justify-content-between align-items-start flex-column">
                            <!--begin::Icon-->
                            <div class="m-0">
                                <img src="admin/assets/media/svg/brand-logos/dribbble-icon-1.svg" class="w-35px"
                                    alt="" />
                            </div>
                            <!--end::Icon-->
                            <!--begin::Section-->
                ...
                <div class="col-sm-6 col-xl-2 mb-xl-10">
                    ...
                    <div class="card h-lg-100">
                        ...
                        <div class="card-body d-flex justify-content-between align-items-start flex-column">
                            <!--begin::Icon-->
                            <div class="m-0">
                                <img src="admin/assets/media/svg/brand-logos/twitter.svg" class="w-35px" alt="" />
                            </div>
                            <!--end::Icon-->
                            <!--begin::Section-->
                            <div class="d-flex flex-column my-7">
                                ...
                                <div class="tab-pane active" id="kt_timeline_widget_1_tab_day" role="tabpanel"
                                    ...
                                    <div class="table-responsive pb-10">
                                        ...
                                        <div id="kt_timeline_widget_1_1" class="vis-timeline-custom h-350px min-w-700px"
                                            data-kt-timeline-widget-1-image-root="/admin/assets/media/"></div>
                                        <!--end::Timeline-->
                                    </div>
                                </div>
                                <!--end::Tab pane-->
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex flex-stack">
                                            ...
                                            <div class="m-0">
                                                ...
                                                <span class="text-gray-500 fw-semibold fs-6">Avarage <br />Likes</span>
                                            </div>
                                            <!--end::Section-->
                                            <!--begin::Statistics-->
                                        ...
                                        <div class="d-flex flex-stack">
                                            ...
                                            <div class="m-0">
                                                ...
                                                <span class="text-gray-500 fw-semibold fs-6">Avarage <br />Comments</span>
                                            </div>
                                            <!--end::Section-->
                                            <!--begin::Statistics-->
                                            <div class="d-flex flex-column align-items-end w-100 mw-250px overflow-hidden">
                                        ...
                                        <div class="d-flex flex-stack">
                                            ...
                                            <div class="m-0">
                                                ...
                                                <span class="text-gray-500 fw-semibold fs-6">Avarage <br />Shares</span>
                                            </div>
                                            <!--end::Section-->
                                            <!--begin::Statistics-->
                                            <div class="d-flex flex-column align-items-end w-100 mw-250px overflow-hidden">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <div>
                                                    <select class="form-select form-select-solid" multiple="multiple"
                                                        ...
                                                        data-dropdown-parent="#kt_menu_6606385f16a4e"
                                    ...
                                    <tr>
                                        <td class="min-w-175px">
                                            <div class="position-relative ps-6 pe-3 py-2">
                                                ...
                                                <a href="#"
                                                    class="mb-1 text-gray-900 text-hover-primary fw-bold">Happy
                                                    Christmas</a>
                                        ...
                                        <td>
                                            ...
                                            <div class="d-flex gap-2 mb-2">
                                                <a href="#">
                                                    <img src="admin/assets/media/svg/brand-logos/facebook-4.svg" class="w-20px"
                                                        alt="" />
                                                </a>
                                                <a href="#">
                                                    <img src="admin/assets/media/svg/brand-logos/twitter-2.svg" class="w-20px"
                                                        alt="" />
                                                </a>
                                                <a href="#">
                                                    <img src="admin/assets/media/svg/brand-logos/linkedin-2.svg" class="w-20px"
                                                        alt="" />
                                                </a>
                                                <a href="#">
                                                    <img src="admin/assets/media/svg/brand-logos/youtube-3.svg" class="w-20px"
                                                        alt="" />
                                                </a>
                                            </div>
                                            <!--end::Icons-->
                                    ...
                                    <tr>
                                        <td class="min-w-175px">
                                            <div class="position-relative ps-6 pe-3 py-2">
                                                ...
                                                <a href="#"
                                                    class="mb-1 text-gray-900 text-hover-primary fw-bold">Halloween</a>
                                                <div class="fs-7 text-muted fw-bold">
                                                    Created on 24 Dec 21
                                                </div>
                                            </div>
                                    ...
                                    <tr>
                                        <td class="min-w-175px">
                                            <div class="position-relative ps-6 pe-3 py-2">
                                                ...
                                                <a href="#"
                                                    class="mb-1 text-gray-900 text-hover-primary fw-bold">Cyber Monday</a>
                                                <div class="fs-7 text-muted fw-bold">
                                                    Created on 24 Dec 21
                                                </div>
                                            </div>
                                    ...
                                    <tr>
                                        <td class="min-w-175px">
                                            <div class="position-relative ps-6 pe-3 py-2">
                                                ...
                                                <a href="#"
                                                    class="mb-1 text-gray-900 text-hover-primary fw-bold">Thanksgiving</a>
                                                <div class="fs-7 text-muted fw-bold">
                                                    Created on 24 Dec 21
                                                </div>
                                            </div>
                                    ...
                                    <tr>
                                        <td class="min-w-175px">
                                            <div class="position-relative ps-6 pe-3 py-2">
                                                ...
                                                <a href="#"
                                                    class="mb-1 text-gray-900 text-hover-primary fw-bold">Happy Mother's
                                                    Day</a>
                                                <div class="fs-7 text-muted fw-bold">
                                                    Created on 24 Dec 21
                                                </div>
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card card-flush h-lg-100">
                        ...
                        <div class="card-body d-flex justify-content-between flex-column p-0">
                            ...
                            <div class="mb-5 px-9">
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center me-3">
                                        <!--begin::Icon-->
                                        <img src="admin/assets/media/svg/brand-logos/dribbble-icon-1.svg" class="me-3 w-30px"
                                            alt="" />
                                        <!--end::Icon-->
                                        <!--begin::Section-->
                                        <div class="flex-grow-1">
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Dribbble</a>
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center me-3">
                                        <!--begin::Icon-->
                                        <img src="admin/assets/media/svg/brand-logos/instagram-2-1.svg" class="me-3 w-30px"
                                            alt="" />
                                        <!--end::Icon-->
                                        <!--begin::Section-->
                                        <div class="flex-grow-1">
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Linked In</a>
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center me-3">
                                        <!--begin::Icon-->
                                        <img src="admin/assets/media/svg/brand-logos/slack-icon.svg" class="me-3 w-30px"
                                            alt="" />
                                        <!--end::Icon-->
                                        <!--begin::Section-->
                                        <div class="flex-grow-1">
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Slack</a>
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center me-3">
                                        <!--begin::Icon-->
                                        <img src="admin/assets/media/svg/brand-logos/google-icon.svg" class="me-3 w-30px"
                                            alt="" />
                                        <!--end::Icon-->
                                        <!--begin::Section-->
                                        <div class="flex-grow-1">
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Google</a>
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center me-3">
                                        <!--begin::Icon-->
                                        <img src="admin/assets/media/svg/brand-logos/invision.svg" class="me-3 w-30px"
                                            alt="" />
                                        <!--end::Icon-->
                                        <!--begin::Section-->
                                        <div class="flex-grow-1">
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">inVision</a>
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center me-3">
                                        <!--begin::Icon-->
                                        <img src="admin/assets/media/svg/brand-logos/facebook-3.svg" class="me-3 w-30px"
                                            alt="" />
                                        <!--end::Icon-->
                                        <!--begin::Section-->
                                        <div class="flex-grow-1">
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Facebook</a>
                            ...
                            <!--end::Items-->
                            <!--begin::Chart-->
                            <div class="card-rounded-bottom" id="kt_charts_widget_2" data-kt-chart-color="primary"
