                        ...
                        <div class="card-body d-flex flex-column flex-center">
                            ...
                            <div class="mb-2">
                                ...
                                <div class="py-10 text-center">
                                    <img src="admin/assets/media/svg/illustrations/easy/3.svg" class="theme-light-show w-200px"
                                        alt="" />
                                    <img src="admin/assets/media/svg/illustrations/easy/3-dark.svg"
                            ...
                            <div class="card card-flush h-md-50 mb-lg-10">
                                ...
                                <div class="card-header pt-5">
                                    ...
                                    <div class="card-title d-flex flex-column">
                                        ...
                                        <!--end::Amount-->
                                        <!--begin::Subtitle-->
                                        <span class="text-gray-500 pt-1 fw-semibold fs-6">Expected Earnings This
                                            Month</span>
                                        <!--end::Subtitle-->
                                    </div>
                                    <!--end::Title-->
                            ...
                            <div class="card card-flush h-lg-100">
                                ...
                                <div class="card-header pt-7 mb-5">
                                    ...
                                    <h3 class="card-title align-items-start flex-column">
                                        ...
                                        <span class="text-gray-500 mt-1 fw-semibold fs-6">20 countries share 97%
                                            visits</span>
                                    </h3>
                                    <!--end::Title-->
                                    <!--begin::Toolbar-->
