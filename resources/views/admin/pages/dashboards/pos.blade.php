    ...
    @component('admin.layouts.partials._toolbar')
        ...
        @slot('action')
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="/apps/ecommerce/sales/listing" class="btn btn-sm fw-bold btn-secondary">Recent Orders</a>
                <!--end::Secondary button-->
                <!--begin::Primary button-->
                <a href="/apps/ecommerce/catalog/add-product" class="btn btn-sm fw-bold btn-primary">New
                    Product</a>
                <!--end::Primary button-->
            </div>
        @endslot
                            ...
                            <ul class="nav nav-pills d-flex justify-content-between nav-pills-custom gap-3 mb-6">
                                ...
                                <li class="nav-item mb-3 me-0">
                                    ...
                                    <a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg show active"
                                        ...
                                        <div class="nav-icon mb-3">
                                            <!--begin::Food icon-->
                                            <img src="admin/assets/media/svg/food-icons/spaghetti.svg" class="w-50px"
                                                alt="" />
                                            <!--end::Food icon-->
                                        </div>
                                        <!--end::Icon-->
                                ...
                                <li class="nav-item mb-3 me-0">
                                    ...
                                    <a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg"
                                        ...
                                        <div class="nav-icon mb-3">
                                            <!--begin::Food icon-->
                                            <img src="admin/assets/media/svg/food-icons/salad.svg" class="w-50px"
                                                alt="" />
                                            <!--end::Food icon-->
                                        </div>
                                        <!--end::Icon-->
                                ...
                                <li class="nav-item mb-3 me-0">
                                    ...
                                    <a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg"
                                        ...
                                        <div class="nav-icon mb-3">
                                            <!--begin::Food icon-->
                                            <img src="admin/assets/media/svg/food-icons/cheeseburger.svg" class="w-50px"
                                                alt="" />
                                            <!--end::Food icon-->
                                        </div>
                                        <!--end::Icon-->
                                ...
                                <li class="nav-item mb-3 me-0">
                                    ...
                                    <a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg"
                                        ...
                                        <div class="nav-icon mb-3">
                                            <!--begin::Food icon-->
                                            <img src="admin/assets/media/svg/food-icons/coffee.svg" class="w-50px"
                                                alt="" />
                                            <!--end::Food icon-->
                                        </div>
                                        <!--end::Icon-->
                                ...
                                <li class="nav-item mb-3 me-0">
                                    ...
                                    <a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg"
                                        ...
                                        <div class="nav-icon mb-3">
                                            <!--begin::Food icon-->
                                            <img src="admin/assets/media/svg/food-icons/cheesecake.svg" class="w-50px"
                                                alt="" />
                                            <!--end::Food icon-->
                                        </div>
                                        <!--end::Icon-->
                                    ...
                                    <div class="d-flex flex-wrap d-grid gap-5 gap-xxl-9">
                                        ...
                                        <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                            ...
                                            <div class="card-body text-center">
                                                <!--begin::Food img-->
                                                <img src="admin/assets/media/stock/food/img-2.jpg"
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <div class="text-center">
                                                        <span
                                                            ...
                                                            Stake</span>
                                                        <span class="text-gray-500 fw-semibold d-block fs-6 mt-n1">16 mins
                                                            to cook</span>
                                                    </div>
                                                    <!--end::Title-->
                                                </div>
                                        ...
                                        <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                            ...
                                            <div class="card-body text-center">
                                                <!--begin::Food img-->
                                                <img src="admin/assets/media/stock/food/img-7.jpg"
                                                    class="rounded-3 mb-4 w-150px h-150px w-xxl-200px h-xxl-200px"
                                                    alt="" />
                                                <!--end::Food img-->
                                                <!--begin::Info-->
                                        ...
                                        <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                            ...
                                            <div class="card-body text-center">
                                                <!--begin::Food img-->
                                                <img src="admin/assets/media/stock/food/img-8.jpg"
                                                    class="rounded-3 mb-4 w-150px h-150px w-xxl-200px h-xxl-200px"
                                                    alt="" />
                                                <!--end::Food img-->
                                                <!--begin::Info-->
                                        ...
                                        <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                            ...
                                            <div class="card-body text-center">
                                                <!--begin::Food img-->
                                                <img src="admin/assets/media/stock/food/img-4.jpg"
                                                    class="rounded-3 mb-4 w-150px h-150px w-xxl-200px h-xxl-200px"
                                                    alt="" />
                                                <!--end::Food img-->
                                                <!--begin::Info-->
                                        ...
                                        <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                            ...
                                            <div class="card-body text-center">
                                                <!--begin::Food img-->
                                                <img src="admin/assets/media/stock/food/img-10.jpg"
                                                    class="rounded-3 mb-4 w-150px h-150px w-xxl-200px h-xxl-200px"
                                                    alt="" />
                                                <!--end::Food img-->
                                                <!--begin::Info-->
                                        ...
                                        <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                            ...
                                            <div class="card-body text-center">
                                                <!--begin::Food img-->
                                                <img src="admin/assets/media/stock/food/img-9.jpg"
                                                    class="rounded-3 mb-4 w-150px h-150px w-xxl-200px h-xxl-200px"
                                                    alt="" />
                                                <!--end::Food img-->
                                                <!--begin::Info-->
                                        ...
                                        <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                            ...
                                            <div class="card-body text-center">
                                                <!--begin::Food img-->
                                                <img src="admin/assets/media/stock/food/img-3.jpg"
                                                    class="rounded-3 mb-4 w-150px h-150px w-xxl-200px h-xxl-200px"
                                                    alt="" />
                                                <!--end::Food img-->
                                                <!--begin::Info-->
                                        ...
                                        <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                            ...
                                            <div class="card-body text-center">
                                                <!--begin::Food img-->
                                                <img src="admin/assets/media/stock/food/img-5.jpg"
                                                    class="rounded-3 mb-4 w-150px h-150px w-xxl-200px h-xxl-200px"
                                                    alt="" />
                                                <!--end::Food img-->
                                                <!--begin::Info-->
                                        ...
                                        <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                            ...
                                            <div class="card-body text-center">
                                                <!--begin::Food img-->
                                                <img src="admin/assets/media/stock/food/img-11.jpg"
                                                    class="rounded-3 mb-4 w-150px h-150px w-xxl-200px h-xxl-200px"
                                                    alt="" />
                                                <!--end::Food img-->
                                                <!--begin::Info-->
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/pages/general/pos.js"></script>
