                    ...
                    <div class="card card-flush overflow-hidden h-md-100">
                        ...
                        <div class="card-header py-5">
                            ...
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-gray-900">Sales This
                                    Months</span>
                                <span class="text-gray-500 mt-1 fw-semibold fs-6">Users from
                                    all channels</span>
                            </h3>
                            <!--end::Title-->
                            <!--begin::Toolbar-->
                        ...
                        <div class="card-body d-flex justify-content-between flex-column pb-1 px-0">
                            ...
                            <div class="px-9 mb-5">
                                ...
                                <!--end::Statistics-->
                                <!--begin::Description-->
                                <span class="fs-6 fw-semibold text-gray-500">Another $48,346
                                    to Goal</span>
                                <!--end::Description-->
                            </div>
                            <!--end::Statistics-->
                            ...
                            <ul class="nav nav-pills nav-pills-custom mb-3">
                                ...
                                <li class="nav-item mb-3 me-3 me-lg-6">
                                    ...
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden active w-80px h-85px py-4"
                                        ...
                                        <!--begin::Icon-->
                                        <div class="nav-icon">
                                            <img alt="" src="admin/assets/media/svg/products-categories/t-shirt.svg"
                                                class="" />
                                        </div>
                                        <!--end::Icon-->
                                        <!--begin::Subtitle-->
                                ...
                                <li class="nav-item mb-3 me-3 me-lg-6">
                                    ...
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                                        ...
                                        <!--begin::Icon-->
                                        <div class="nav-icon">
                                            <img alt="" src="admin/assets/media/svg/products-categories/gaming.svg"
                                                class="" />
                                        </div>
                                        <!--end::Icon-->
                                        <!--begin::Subtitle-->
                                ...
                                <li class="nav-item mb-3 me-3 me-lg-6">
                                    ...
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                                        ...
                                        <!--begin::Icon-->
                                        <div class="nav-icon">
                                            <img alt="" src="admin/assets/media/svg/products-categories/watch.svg"
                                                class="" />
                                        </div>
                                        <!--end::Icon-->
                                        <!--begin::Subtitle-->
                                ...
                                <li class="nav-item mb-3 me-3 me-lg-6">
                                    ...
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                                        ...
                                        <!--begin::Icon-->
                                        <div class="nav-icon">
                                            <img alt="" src="admin/assets/media/svg/products-categories/gloves.svg"
                                                class="nav-icon" />
                                        </div>
                                        <!--end::Icon-->
                                        <!--begin::Subtitle-->
                                ...
                                <li class="nav-item mb-3">
                                    ...
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                                        ...
                                        <!--begin::Icon-->
                                        <div class="nav-icon">
                                            <img alt="" src="admin/assets/media/svg/products-categories/shoes.svg"
                                                class="nav-icon" />
                                        </div>
                                        <!--end::Icon-->
                                        <!--begin::Subtitle-->
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="admin/assets/media/stock/ecommerce/210.png"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="admin/assets/media/stock/ecommerce/215.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="/apps/ecommerce/catalog/edit-product"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="admin/assets/media/stock/ecommerce/209.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="/apps/ecommerce/catalog/edit-product"
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="admin/assets/media/stock/ecommerce/197.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="/apps/ecommerce/catalog/edit-product"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="admin/assets/media/stock/ecommerce/178.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="/apps/ecommerce/catalog/edit-product"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="admin/assets/media/stock/ecommerce/22.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="/apps/ecommerce/catalog/edit-product"
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="admin/assets/media/stock/ecommerce/1.png" class="w-50px ms-n1"
                                                            alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="/apps/ecommerce/catalog/edit-product"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="admin/assets/media/stock/ecommerce/24.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="/apps/ecommerce/catalog/edit-product"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="admin/assets/media/stock/ecommerce/71.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="/apps/ecommerce/catalog/edit-product"
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="admin/assets/media/stock/ecommerce/41.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="/apps/ecommerce/catalog/edit-product"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="admin/assets/media/stock/ecommerce/63.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="/apps/ecommerce/catalog/edit-product"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="admin/assets/media/stock/ecommerce/59.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="/apps/ecommerce/catalog/edit-product"
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="admin/assets/media/stock/ecommerce/10.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="/apps/ecommerce/catalog/edit-product"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="admin/assets/media/stock/ecommerce/96.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="/apps/ecommerce/catalog/edit-product"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="admin/assets/media/stock/ecommerce/13.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="/apps/ecommerce/catalog/edit-product"
                    ...
                    <div class="card card-flush overflow-hidden h-md-100">
                        ...
                        <div class="card-body d-flex justify-content-between flex-column pb-1 px-0">
                            ...
                            <div class="px-9 mb-5">
                                ...
                                <!--end::Statistics-->
                                <!--begin::Description-->
                                <span class="fs-6 fw-semibold text-gray-500">Total Discounted
                        ...
                        <div class="card-body d-flex flex-column flex-center">
                            ...
                            <div class="mb-2">
                                ...
                                <div class="py-10 text-center">
                                    <img src="admin/assets/media/svg/illustrations/easy/2.svg" class="theme-light-show w-200px"
                                        alt="" />
                            ...
                            <div class="text-center mb-1">
                                <!--begin::Link-->
                                <a class="btn btn-sm btn-primary me-2" href="apps/ecommerce/sales/listing">View
                                    App</a>
                                <!--end::Link-->
                                <!--begin::Link-->
                                <a class="btn btn-sm btn-light" href="apps/ecommerce/catalog/add-product">New
                                    Product</a>
                                <!--end::Link-->
                            </div>
                            <!--end::Links-->
                        ...
                        <div class="card-header pt-7">
                            ...
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-gray-800">Product
                                    Orders</span>
                                <span class="text-gray-500 mt-1 fw-semibold fs-6">Avg. 57
                                    orders per day</span>
                            </h3>
                            <!--end::Title-->
                            <!--begin::Actions-->
                                        ...
                                        <td colspan="2">
                                            <div class="d-flex align-items-center gap-3">
                                                <a href="#"
                                                    ...
                                                    <img src="" data-kt-src-path="admin/assets/media/stock/ecommerce/"
                        ...
                        <div class="card-header pt-7">
                            ...
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-gray-900">Product
                                    Delivery</span>
                                <span class="text-gray-500 mt-1 fw-semibold fs-6">1M Products
                                    Shipped so far</span>
                            </h3>
                            <!--end::Title-->
                            <!--begin::Toolbar-->
                            <div class="card-toolbar">
                                <a href="/apps/ecommerce/sales/details" class="btn btn-sm btn-light">Order Details</a>
                            </div>
                            <!--end::Toolbar-->
                        </div>
                        <!--end::Header-->
                            ...
                            <div class="hover-scroll-overlay-y pe-6 me-n6" style="height: 415px">
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="admin/assets/media/stock/ecommerce/210.png" class="w-50px ms-n1 me-1"
                                                alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <a href="/apps/ecommerce/catalog/edit-product"
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="admin/assets/media/stock/ecommerce/209.png" class="w-50px ms-n1 me-1"
                                                alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <a href="/apps/ecommerce/catalog/edit-product"
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="admin/assets/media/stock/ecommerce/214.png" class="w-50px ms-n1 me-1"
                                                alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <a href="/apps/ecommerce/catalog/edit-product"
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="admin/assets/media/stock/ecommerce/211.png" class="w-50px ms-n1 me-1"
                                                alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <a href="/apps/ecommerce/catalog/edit-product"
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="admin/assets/media/stock/ecommerce/215.png" class="w-50px ms-n1 me-1"
                                                alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <a href="/apps/ecommerce/catalog/edit-product"
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="admin/assets/media/stock/ecommerce/192.png" class="w-50px ms-n1 me-1"
                                                alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <a href="/apps/ecommerce/catalog/edit-product"
                        ...
                        <div class="card-header pt-7">
                            ...
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-gray-900">Stock
                                    Report</span>
                                <span class="text-gray-500 mt-1 fw-semibold fs-6">Total 2,356
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex flex-stack flex-wrap gap-4">
                                    ...
                                    <!--end::Status-->
                                    <!--begin::Search-->
                                    <a href="/apps/ecommerce/catalog/products" class="btn btn-light btn-sm">View
                                        Stock</a>
                                    <!--end::Search-->
                                </div>
                                <!--begin::Filters-->
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table">
                                ...
                                <tbody class="fw-bold text-gray-600">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/apps/ecommerce/catalog/edit-product"
                                                class="text-gray-900 text-hover-primary">Macbook
                                                Air M1</a>
                                        </td>
                                        <!--end::Item-->
                                        <!--begin::Product ID-->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/apps/ecommerce/catalog/edit-product"
                                                class="text-gray-900 text-hover-primary">Logitech
                                                MX 250</a>
                                        </td>
                                        <!--end::Item-->
                                        <!--begin::Product ID-->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/apps/ecommerce/catalog/edit-product"
                                                class="text-gray-900 text-hover-primary">HP
                                                Hyper LTR</a>
                                        </td>
                                        <!--end::Item-->
                                        <!--begin::Product ID-->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/apps/ecommerce/catalog/edit-product"
                                                class="text-gray-900 text-hover-primary">Dell
                                                32 UltraSharp</a>
                                        </td>
                                        <!--end::Item-->
                                        <!--begin::Product ID-->
