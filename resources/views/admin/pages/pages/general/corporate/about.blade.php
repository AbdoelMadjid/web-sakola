                ...
                <div class="card-body p-lg-17">
                    ...
                    <div class="mb-18">
                        ...
                        <div class="mb-10">
                            ...
                            <div class="text-center mb-15">
                                ...
                                <div class="fs-5 text-muted fw-semibold">
                                    Within the last 10 years, we have sold over
                                    100,000 admin theme copies that have been
                                    <br />successfully deployed by small businesses to
                                    global enterprises
                                </div>
                                <!--end::Text-->
                            </div>
                            ...
                            <div class="overlay">
                                <!--begin::Image-->
                                <img class="w-100 card-rounded" src="admin/assets/media/stock/1600x800/img-1.jpg"
                                    alt="" />
                                <!--end::Image-->
                                <!--begin::Links-->
                                <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                    <a href="/pages/general/pricing/column" class="btn btn-primary">Pricing</a>
                                    <a href="/pages/general/careers/apply" class="btn btn-light-primary ms-3">Join Us</a>
                                </div>
                                <!--end::Links-->
                            </div>
                            <!--end::Container-->
                        ...
                        <div class="fs-5 fw-semibold text-gray-600">
                            ...
                            <p class="mb-8">
                                ...
                                your writing skills are sharp. From the seed of the
                                idea to finally hitting “Publish,” you might spend
                                several days or maybe even a week “writing” a blog
                                post, but it’s important to spend those vital hours
                                planning your post and even thinking about
                                <a href="/pages/general/blog/post" class="link-primary pe-1">Your Post</a>(yes, thinking
                                counts
                                as
                                working if you’re a
                            ...
                            <p class="mb-8">
                                ...
                                and
                                <a href="/pages/general/blog/home" class="link-primary pe-1">I mean NOTHING</a>– will kill a
                                blog
                                post more effectively than a
                                lack of enthusiasm from the writer. You can tell
                                when a writer is bored by their subject, and it’s so
                            ...
                            <p class="mb-17">
                                ...
                                to blog for a cardboard box manufacturing company.”
                                I feel your pain, I really do. During the course of
                                my career, I’ve written content for dozens of
                                clients in some less-than-thrilling industries (such
                                as financial regulatory compliance and corporate
                                housing), but the hallmark of a professional blogger
                                is the ability to write well about any topic, no
                                matter how dry it may be. Blogging is a lot easier,
                                however, if you can muster at least a little
                    ...
                    <div class="card bg-light mb-18">
                        ...
                        <div class="card-body py-15">
                            ...
                            <div class="fs-2 fw-semibold text-muted text-center">
                                <a href="/pages/account/security" class="link-primary fs-4 fw-bold">Marcus Levy</a>
                        ...
                        <div class="row g-10">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card-xl-stretch me-md-6">
                                    ...
                                    <a class="d-block overlay mb-4" data-fslightbox="lightbox-hot-sales"
                                        href="admin/assets/media/stock/600x400/img-73.jpg">
                                        <!--begin::Image-->
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card-xl-stretch mx-md-3">
                                    <!--begin::Overlay-->
                                    <a class="d-block overlay mb-4" data-fslightbox="lightbox-hot-sales"
                                        href="admin/assets/media/stock/600x400/img-74.jpg">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card-xl-stretch ms-md-6">
                                    <!--begin::Overlay-->
                                    <a class="d-block overlay mb-4" data-fslightbox="lightbox-hot-sales"
                                        href="admin/assets/media/stock/600x400/img-47.jpg">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                    ...
                    <div class="card mb-4 bg-light text-center">
                        ...
                        <div class="card-body py-12">
                            <!--begin::Icon-->
                            <a href="#" class="mx-4">
                                <img src="admin/assets/media/svg/brand-logos/facebook-4.svg" class="h-30px my-2"
                                    alt="" />
                            </a>
                            <!--end::Icon-->
                            <!--begin::Icon-->
                            <a href="#" class="mx-4">
                                <img src="admin/assets/media/svg/brand-logos/instagram-2-1.svg" class="h-30px my-2"
                                    alt="" />
                            </a>
                            <!--end::Icon-->
                            <!--begin::Icon-->
                            <a href="#" class="mx-4">
                                <img src="admin/assets/media/svg/brand-logos/github.svg" class="h-30px my-2" alt="" />
                            </a>
                            <!--end::Icon-->
                            <!--begin::Icon-->
                            <a href="#" class="mx-4">
                                <img src="admin/assets/media/svg/brand-logos/behance.svg" class="h-30px my-2" alt="" />
                            </a>
                            <!--end::Icon-->
                            <!--begin::Icon-->
                            <a href="#" class="mx-4">
                                <img src="admin/assets/media/svg/brand-logos/pinterest-p.svg" class="h-30px my-2"
                                    alt="" />
                            </a>
                            <!--end::Icon-->
                            <!--begin::Icon-->
                            <a href="#" class="mx-4">
                                <img src="admin/assets/media/svg/brand-logos/twitter.svg" class="h-30px my-2" alt="" />
                            </a>
                            <!--end::Icon-->
                            <!--begin::Icon-->
                            <a href="#" class="mx-4">
                                <img src="admin/assets/media/svg/brand-logos/dribbble-icon-1.svg" class="h-30px my-2"
                                    alt="" />
                            </a>
                            <!--end::Icon-->
                        </div>
