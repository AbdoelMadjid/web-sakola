                    ...
                    <div class="position-relative mb-17">
                        ...
                        <div class="position-absolute text-white mb-8 ms-10 bottom-0">
                            ...
                            <div class="fs-5 fw-semibold">
                                You sit down. You stare at your screen. The cursor
                                blinks.
                            </div>
                            <!--end::Text-->
                        </div>
                            ...
                            <div class="mb-10 mb-lg-0">
                                ...
                                <div class="m-0">
                                    ...
                                    <div class="d-flex align-items-center collapsible py-3 toggle mb-0"
                                        data-bs-toggle="collapse" data-bs-target="#kt_job_3_1">
                                        <!--begin::Icon-->
                                ...
                                <div class="m-0">
                                    ...
                                    <div class="d-flex align-items-center collapsible py-3 toggle collapsed mb-0"
                                        data-bs-toggle="collapse" data-bs-target="#kt_job_3_2">
                                        <!--begin::Icon-->
                                        <div class="btn btn-sm btn-icon mw-20px btn-active-color-primary me-5">
                                            <i class="ki-duotone ki-minus-square toggle-on text-primary fs-1">
                                                <span class="path1"></span>
                                ...
                                <div class="m-0">
                                    <!--begin::Heading-->
                                    <div class="d-flex align-items-center collapsible py-3 toggle collapsed mb-0"
                                        data-bs-toggle="collapse" data-bs-target="#kt_job_3_4">
                                        <!--begin::Icon-->
                                        <div class="btn btn-sm btn-icon mw-20px btn-active-color-primary me-5">
                                            <i class="ki-duotone ki-minus-square toggle-on text-primary fs-1">
                                                <span class="path1"></span>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card-xl-stretch mx-md-3">
                                    ...
                                    <a class="d-block overlay mb-4" data-fslightbox="lightbox-hot-sales"
                                        ...
                                        <!--begin::Image-->
                                        <div
                                            class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"style="background-image: url(admin/assets/media/stock/600x400/img-74.jpg);">
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Action-->
                                        <div class="overlay-layer bg-dark card-rounded bg-opacity-25">
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/pages/careers/apply.js"></script>
