        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="row g-6 g-xl-9">
                ...
                <div class="col-md-6 col-xl-4">
                    <!--begin::Card-->
                    <a href="/apps/projects/view" class="card border-hover-primary">
                        <!--begin::Card header-->
                        <div class="card-header border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                ...
                                <div class="symbol symbol-50px w-50px bg-light">
                                    <img src="admin/assets/media/svg/brand-logos/plurk.svg" alt="image" class="p-3" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                            <!--end::Car Title-->
                    ...
                    <a href="/apps/projects/view" class="card border-hover-primary">
                        ...
                        <div class="card-header border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-50px w-50px bg-light">
                                    <img src="admin/assets/media/svg/brand-logos/disqus.svg" alt="image" class="p-3" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                            <!--end::Car Title-->
                    ...
                    <a href="/apps/projects/view" class="card border-hover-primary">
                        ...
                        <div class="card-header border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-50px w-50px bg-light">
                                    <img src="admin/assets/media/svg/brand-logos/figma-1.svg" alt="image" class="p-3" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                            <!--end::Car Title-->
                    ...
                    <a href="/apps/projects/view" class="card border-hover-primary">
                        ...
                        <div class="card-header border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-50px w-50px bg-light">
                                    <img src="admin/assets/media/svg/brand-logos/sentry-3.svg" alt="image" class="p-3" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                            <!--end::Car Title-->
                    ...
                    <a href="/apps/projects/view" class="card border-hover-primary">
                        ...
                        <div class="card-header border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-50px w-50px bg-light">
                                    <img src="admin/assets/media/svg/brand-logos/xing-icon.svg" alt="image"
                                        class="p-3" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                    ...
                    <a href="/apps/projects/view" class="card border-hover-primary">
                        ...
                        <div class="card-header border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-50px w-50px bg-light">
                                    <img src="admin/assets/media/svg/brand-logos/tvit.svg" alt="image" class="p-3" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                            <!--end::Car Title-->
                    ...
                    <a href="/apps/projects/view" class="card border-hover-primary">
                        ...
                        <div class="card-header border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-50px w-50px bg-light">
                                    <img src="admin/assets/media/svg/brand-logos/aven.svg" alt="image" class="p-3" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                            <!--end::Car Title-->
                    ...
                    <a href="/apps/projects/view" class="card border-hover-primary">
                        ...
                        <div class="card-header border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-50px w-50px bg-light">
                                    <img src="admin/assets/media/svg/brand-logos/treva.svg" alt="image" class="p-3" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                            <!--end::Car Title-->
                    ...
                    <a href="/apps/projects/view" class="card border-hover-primary">
                        ...
                        <div class="card-header border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-50px w-50px bg-light">
                                    <img src="admin/assets/media/svg/brand-logos/kanba.svg" alt="image" class="p-3" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                            <!--end::Car Title-->
                                                    ...
                                                    <div class="d-flex flex-stack">
                                                        ...
                                                        <label
                                                            ...
                                                            <input class="form-check-input" type="checkbox"
                                                                value="1" name="budget_allow" checked="checked" />
                                                            <span
                                                    ...
                                                    <div class="mh-300px scroll-y me-n7 pe-7">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="symbol symbol-35px">
                                                                    <img src="admin/assets/media/svg/files/pdf.svg"
                                                                        alt="icon" />
                                                                </div>
                                                                <!--end::Avatar-->
                                                                <!--begin::Details-->
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <!--begin::Avatar-->
                                                                <div class="symbol symbol-35px">
                                                                    <img src="admin/assets/media/svg/files/css.svg"
                                                                        alt="icon" />
                                                                </div>
                                                                <!--end::Avatar-->
                                                                <!--begin::Details-->
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <!--begin::Avatar-->
                                                                <div class="symbol symbol-35px">
                                                                    <img src="admin/assets/media/svg/files/ai.svg"
                                                                        alt="icon" />
                                                                </div>
                                                                <!--end::Avatar-->
                                                                <!--begin::Details-->
                                                        ...
                                                        <div class="d-flex flex-stack py-4">
                                                            <div class="d-flex align-items-center">
                                                                <!--begin::Avatar-->
                                                                <div class="symbol symbol-35px">
                                                                    <img src="admin/assets/media/svg/files/tif.svg"
                                                                        alt="icon" />
                                                                </div>
                                                                <!--end::Avatar-->
                                                                <!--begin::Details-->
                                            ...
                                            <div class="w-100">
                                                ...
                                                <div class="d-flex flex-center pb-20">
                                                    ...
                                                    <a href="/" class="btn btn-lg btn-primary"
                                                        data-bs-toggle="tooltip" title="Coming Soon">View Project</a>
                                                </div>
                                                <!--end::Actions-->
                                                <!--begin::Illustration-->
                                                <div class="text-center px-4">
                                                    <img src="admin/assets/media/illustrations/sketchy-1/9.png" alt=""
