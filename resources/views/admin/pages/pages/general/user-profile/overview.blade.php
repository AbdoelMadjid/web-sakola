                        ...
                        <div class="card-body pb-0">
                            ...
                            <div class="mb-5">
                                ...
                                <p class="text-gray-800 fw-normal mb-5">
                                    ...
                                    indulging in poorly thought-out metaphors about
                                    driving and keep you focused on the overall
                        ...
                        <div class="card-body pb-0">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="d-flex align-items-center flex-grow-1">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-45px me-5">
                                        <img src="admin/assets/media/avatars/300-21.jpg" alt="" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Info-->
                                    <div class="d-flex flex-column">
                            ...
                            <div class="mb-7">
                                ...
                                <div class="d-flex mb-5">
                                    ...
                                    <div class="d-flex flex-column flex-row-fluid">
                                        ...
                                        <span class="text-gray-800 fs-7 fw-normal pt-1">Long before you sit dow to put
                                            digital pen
                                            to
                                            paper you need to make sure you have to sit
                                            down and write.</span>
                                        <!--end::Post-->
                                    </div>
                                    <!--end::Info-->
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="d-flex flex-column flex-row-fluid">
                                        ...
                                        <!--end::Info-->
                                        <!--begin::Post-->
                                        <span class="text-gray-800 fs-7 fw-normal pt-1">Outlines keep you honest. They stop
                                            you
                                            from
                        ...
                        <div class="card-body pb-0">
                            ...
                            <div class="d-flex align-items-center mb-5">
                                ...
                                <div class="d-flex align-items-center flex-grow-1">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-45px me-5">
                                        <img src="admin/assets/media/avatars/300-7.jpg" alt="" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Info-->
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <div>
                                                <select class="form-select form-select-solid" multiple="multiple"
                                                    ...
                                                    data-dropdown-parent="#kt_menu_660638550b6b6" data-allow-clear="true">
                                                    <option></option>
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <div>
                                                <select class="form-select form-select-solid" multiple="multiple"
                                                    data-kt-select2="true" data-close-on-select="false"
                                                    data-placeholder="Select option"
                                                    data-dropdown-parent="#kt_menu_660638550b781" data-allow-clear="true">
                                                    <option></option>
                                                    <option value="1">Approved</option>
                                                    <option value="2">Pending</option>
                                                    <option value="2">In Process</option>
