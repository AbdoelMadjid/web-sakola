        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
                    ...
                    <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                        ...
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5"
                                href="/pages/general/user-profile/overview">Overview</a>
                        </li>
                        <!--end::Nav item-->
                        <!--begin::Nav item-->
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5"
                                href="/pages/general/user-profile/projects">Projects</a>
                        </li>
                        <!--end::Nav item-->
                        <!--begin::Nav item-->
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5 active"
                                href="/pages/general/user-profile/campaigns">Campaigns</a>
                        </li>
                        <!--end::Nav item-->
                        <!--begin::Nav item-->
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5"
                                href="/pages/general/user-profile/documents">Documents</a>
                        </li>
                        <!--end::Nav item-->
                        <!--begin::Nav item-->
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5"
                                href="/pages/general/user-profile/followers">Followers</a>
                        </li>
                        <!--end::Nav item-->
                        <!--begin::Nav item-->
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5"
                                href="/pages/general/user-profile/activity">Activity</a>
                        </li>
                        <!--end::Nav item-->
                    </ul>
                    <!--begin::Navs-->
            ...
            <div class="d-flex flex-wrap flex-stack mb-6">
                ...
                <h3 class="fw-bold my-2">
                    My Campaigns
                    <span class="fs-6 text-gray-500 fw-semibold ms-1">30 Days</span>
                </h3>
                <!--end::Title-->
                <!--begin::Controls-->
                        ...
                        <div class="card-header flex-nowrap border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                ...
                                <div class="symbol symbol-45px w-45px bg-light me-5">
                                    <img src="admin/assets/media/svg/brand-logos/twitch.svg" alt="image" class="p-3" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Title-->
                                <a href="#" class="fs-4 fw-semibold text-hover-primary text-gray-600 m-0">Twitch
                                    Posts</a>
                                <!--end::Title-->
                            </div>
                            <!--end::Card title-->
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-header flex-nowrap border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Icon-->
                                <div class="symbol symbol-45px w-45px bg-light me-5">
                                    <img src="admin/assets/media/svg/brand-logos/twitter.svg" alt="image" class="p-3" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Title-->
                                <a href="#" class="fs-4 fw-semibold text-hover-primary text-gray-600 m-0">Twitter
                                    Followers</a>
                                <!--end::Title-->
                            </div>
                            <!--end::Card title-->
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-header flex-nowrap border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Icon-->
                                <div class="symbol symbol-45px w-45px bg-light me-5">
                                    <img src="admin/assets/media/svg/brand-logos/spotify.svg" alt="image" class="p-3" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Title-->
                                <a href="#" class="fs-4 fw-semibold text-hover-primary text-gray-600 m-0">Spotify
                                    Listeners</a>
                                <!--end::Title-->
                            </div>
                            <!--end::Card title-->
                        ...
                        <div class="card-body d-flex flex-column px-9 pt-6 pb-8">
                            ...
                            <div class="d-flex align-items-center fw-semibold">
                                ...
                                <span class="ms-1" data-bs-toggle="tooltip"
                                    title="This is the total number of new non-trial">
                                    <i class="ki-duotone ki-information-5 text-gray-500 fs-6">
                                        <span class="path1"></span>
                                        <span class="path2"></span>
                                        <span class="path3"></span>
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-header flex-nowrap border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Icon-->
                                <div class="symbol symbol-45px w-45px bg-light me-5">
                                    <img src="admin/assets/media/svg/brand-logos/pinterest-p.svg" alt="image"
                                        class="p-3" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Title-->
                                <a href="#" class="fs-4 fw-semibold text-hover-primary text-gray-600 m-0">Pinterest
                                    Posts</a>
                                <!--end::Title-->
                            </div>
                            <!--end::Card title-->
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-header flex-nowrap border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Icon-->
                                <div class="symbol symbol-45px w-45px bg-light me-5">
                                    <img src="admin/assets/media/svg/brand-logos/github.svg" alt="image" class="p-3" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Title-->
                                <a href="#" class="fs-4 fw-semibold text-hover-primary text-gray-600 m-0">Github
                                    Contributes</a>
                                <!--end::Title-->
                            </div>
                            <!--end::Card title-->
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-header flex-nowrap border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Icon-->
                                <div class="symbol symbol-45px w-45px bg-light me-5">
                                    <img src="admin/assets/media/svg/brand-logos/youtube-play.svg" alt="image"
                                        class="p-3" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Title-->
                                <a href="#" class="fs-4 fw-semibold text-hover-primary text-gray-600 m-0">Youtube
                                    Subscribers</a>
                                <!--end::Title-->
                            </div>
                            <!--end::Card title-->
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-header flex-nowrap border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Icon-->
                                <div class="symbol symbol-45px w-45px bg-light me-5">
                                    <img src="admin/assets/media/svg/brand-logos/telegram.svg" alt="image" class="p-3" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Title-->
                                <a href="#" class="fs-4 fw-semibold text-hover-primary text-gray-600 m-0">Telegram
                                    Posts</a>
                                <!--end::Title-->
                            </div>
                            <!--end::Card title-->
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-header flex-nowrap border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Icon-->
                                <div class="symbol symbol-45px w-45px bg-light me-5">
                                    <img src="admin/assets/media/svg/brand-logos/reddit.svg" alt="image" class="p-3" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Title-->
                                <a href="#" class="fs-4 fw-semibold text-hover-primary text-gray-600 m-0">Reddit
                                    Awards</a>
                                <!--end::Title-->
                            </div>
                            <!--end::Card title-->
                        ...
                        <div class="card-body d-flex flex-column px-9 pt-6 pb-8">
                            ...
                            <div class="d-flex align-items-center fw-semibold">
                                ...
                                <span class="ms-1" data-bs-toggle="tooltip"
                                    title="This table displays revenue retention">
                                    <i class="ki-duotone ki-information-5 text-gray-500 fs-6">
                                        <span class="path1"></span>
                                        <span class="path2"></span>
                                        <span class="path3"></span>
                            ...
                            <div class="stepper stepper-links d-flex flex-column" id="kt_modal_offer_a_deal_stepper">
                                ...
                                <form class="mx-auto mw-500px w-100 pt-15 pb-10" novalidate="novalidate"
                                                    ...
                                                    <span class="d-flex">
                                                        ...
                                                        <span class="ms-4">
                                                            <span class="fs-3 fw-bold text-gray-900 mb-2 d-block">Personal
                                                                Deal</span>
                                                            <span class="fw-semibold fs-4 text-muted">If you need more
                                                                info, please check
                                                                it out</span>
                                                        </span>
                                                        <!--end::Info-->
                                    ...
                                    <div data-kt-stepper-element="content">
                                        ...
                                        Experience share market at your fingertips with TICK PRO stock investment mobile trading app</textarea>
                                                <!--end::Label-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                                        ...
                                                        <label
                                                            ...
                                                            <span class="ms-5">
                                                                <span
                                                                    ...
                                                                    Usage</span>
                                                                <span class="fw-semibold fs-7 text-gray-600">Withdraw
                                                                    money to your bank
                                            ...
                                            <div class="fv-row mb-15">
                                                ...
                                                <div class="d-flex flex-stack">
                                                    ...
                                                    <label
                                                        ...
                                                        <span
                                                            class="form-check-label fw-semibold text-muted">Allowed</span>
                                                    </label>
                                                    <!--end::Switch-->
                                                </div>
                                                <!--end::Wrapper-->
