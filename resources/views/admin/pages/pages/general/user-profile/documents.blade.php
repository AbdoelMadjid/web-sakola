        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="d-flex flex-wrap flex-stack mb-6">
                ...
                <div class="d-flex my-2">
                    ...
                    <!--end::Search-->
                    <a href="/apps/file-manager/files" class="btn btn-primary btn-sm">File Manager</a>
                </div>
                <!--end::Controls-->
            </div>
                        ...
                        <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                            ...
                            <a href="/apps/file-manager/files"
                                ...
                                <div class="symbol symbol-75px mb-5">
                                    <img src="admin/assets/media/svg/files/folder-document.svg" class="theme-light-show"
                                        alt="" />
                                    <img src="admin/assets/media/svg/files/folder-document-dark.svg" class="theme-dark-show"
                                        alt="" />
                                </div>
                                <!--end::Image-->
                                <!--begin::Title-->
