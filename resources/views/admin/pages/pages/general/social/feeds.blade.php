                                ...
                                <ul class="nav nav-pills nav-pills-custom flex-column border-transparent fs-5 fw-bold">
                                    ...
                                    <li class="nav-item mt-5">
                                        <a class="nav-link text-muted text-active-primary ms-0 py-0 me-10 ps-9 border-0"
                                            href="/pages/general/social/activity">
                                    ...
                                    <li class="nav-item mt-5">
                                        <a class="nav-link text-muted text-active-primary ms-0 py-0 me-10 ps-9 border-0"
                                            href="/pages/general/social/followers">
                ...
                <div class="w-100 flex-lg-row-fluid mx-lg-13">
                    ...
                    <div class="card card-flush mb-10">
                        ...
                        <div class="card-body pt-2 pb-0">
                            <!--begin::Input-->
                            <textarea class="form-control bg-transparent border-0 px-0" id="kt_social_feeds_post_input" name="message"
                        ...
                        <div class="card-footer d-flex justify-content-end pt-0">
                            <!--begin::Post action-->
                            <a href="/pages/general/blog/post" class="btn btn-sm btn-primary"
                                id="kt_social_feeds_post_btn">
                        ...
                        <div class="card card-flush mb-10">
                            ...
                            <div class="card-header pt-9">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-50px me-5">
                                        <img src="admin/assets/media/avatars/300-4.jpg" class="" alt="" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Info-->
                                    <div class="flex-grow-1">
                                        <!--begin::Name-->
                                        <a href="#" class="text-gray-800 text-hover-primary fs-4 fw-bold">Grace
                                            Logan</a>
                                        <!--end::Name-->
                                        <!--begin::Date-->
                            ...
                            <div class="card-body">
                                ...
                                <div class="fs-6 fw-normal text-gray-700 mb-5">
                                    There are two main approaches you can take to
                                    writing amazing blog post headlines. You can
                                    either decide on your final headline before
                                    outstanding you write the most of the rest of your
                                    creative post
                                </div>
                                <!--end::Post content-->
                                <!--begin::Post media-->
                                <div class="row g-7 h-250px h-md-375px">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <a class="d-block card-rounded overlay h-100" data-fslightbox="lightbox-projects"
                                            href="admin/assets/media/stock/600x600/img-23.jpg">
                                            <!--begin::Image-->
                                            <div
                                                class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-100"style="background-image: url(admin/assets/media/stock/600x600/img-23.jpg);">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                        ...
                                        <div class="row g-7 h-250px h-md-375px">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <a class="d-block card-rounded overlay h-100"
                                                    ...
                                                    href="admin/assets/media/stock/600x600/img-22.jpg">
                                                    <!--begin::Image-->
                                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-100"
                                                        style="background-image: url(admin/assets/media/stock/600x400/img-71.jpg);">
                                                    </div>
                                                    <!--end::Image-->
                                                    <!--begin::Action-->
                                                    <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <a class="d-block card-rounded overlay h-100"
                                                    data-fslightbox="lightbox-projects"
                                                    href="admin/assets/media/stock/600x600/img-21.jpg">
                                                    <!--begin::Image-->
                                                    <div
                                                        class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-100"style="background-image: url(admin/assets/media/stock/600x400/img-79.jpg);">
                                                    </div>
                                                    <!--end::Image-->
                                                    <!--begin::Action-->
                                                    <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                            ...
                            <div class="card-footer pt-0">
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="collapse show" id="kt_social_feeds_comments_1">
                                        ...
                                        <div class="d-flex pt-6">
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-45px me-5">
                                                <img src="admin/assets/media/avatars/300-13.jpg" alt="" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Wrapper-->
                                            <div class="d-flex flex-column flex-row-fluid">
                                                ...
                                                <div class="d-flex align-items-center flex-wrap mb-0">
                                                    <!--begin::Name-->
                                                    <a href="#"
                                                        class="text-gray-800 text-hover-primary fw-bold me-6">Mr.
                                                        Anderson</a>
                                                    <!--end::Name-->
                                                    <!--begin::Date-->
                                                ...
                                                <span class="text-gray-800 fs-7 fw-normal pt-1">Long before you sit dow to
                                                    put digital
                                                    pen to paper you need to make sure you
                                                    have to sit down and write.</span>
                                                <!--end::Text-->
                                            </div>
                                            <!--end::Wrapper-->
                                        </div>
                                        ...
                                        <div class="d-flex pt-6">
                                            ...
                                            <div class="d-flex flex-column flex-row-fluid">
                                                ...
                                                <div class="d-flex align-items-center flex-wrap mb-0">
                                                    <!--begin::Name-->
                                                    <a href="#"
                                                        class="text-gray-800 text-hover-primary fw-bold me-6">Mrs.
                                                        Anderson</a>
                                                    <!--end::Name-->
                                                    <!--begin::Date-->
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Author-->
                                    <div class="symbol symbol-35px me-3">
                                        <img src="admin/assets/media/avatars/300-3.jpg" alt="" />
                                    </div>
                                    <!--end::Author-->
                                    <!--begin::Input group-->
                        ...
                        <div class="card card-flush mb-10">
                            ...
                            <div class="card-header pt-9">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-50px me-5">
                                        <img src="admin/assets/media/avatars/300-7.jpg" class="" alt="" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Info-->
                                    <div class="flex-grow-1">
                                        <!--begin::Name-->
                                        <a href="#" class="text-gray-800 text-hover-primary fs-4 fw-bold">Brooklyn
                                            Simmons</a>
                                        <!--end::Name-->
                                        <!--begin::Date-->
                                        <span class="text-gray-500 fw-semibold d-block">Yestarday at 5:06 PM</span>
                            ...
                            <div class="card-body">
                                ...
                                <div class="fs-6 fw-normal text-gray-700">
                                    You can either decide on your final headline
                                    before outstanding you write the most of the rest
                                    of your creative post
                                </div>
                                <!--end::Post content-->
                            </div>
                            <!--end::Card body-->
                                        ...
                                        <div class="d-flex pt-6">
                                            ...
                                            <div class="d-flex flex-column flex-row-fluid">
                                                ...
                                                <div class="d-flex align-items-center flex-wrap mb-0">
                                                    <!--begin::Name-->
                                                    <a href="#"
                                                        class="text-gray-800 text-hover-primary fw-bold me-6">Alice
                                                        Danchik</a>
                                                    <!--end::Name-->
                                                    <!--begin::Date-->
                        ...
                        <div class="card card-flush mb-10">
                            ...
                            <div class="card-header pt-9">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <!--begin::Name-->
                                        <a href="#" class="text-gray-800 text-hover-primary fs-4 fw-bold">Finance
                                            Deprt - Annual
                                            Report</a>
                                        <!--end::Name-->
                                        <!--begin::Date-->
                            ...
                            <div class="card-footer pt-0">
                                ...
                                <div class="mb-6">
                                    ...
                                    <ul class="nav py-3">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link btn btn-sm btn-color-gray-600 btn-active-color-primary btn-active-light-primary fw-bold px-4 me-1 collapsible"
                                                data-bs-toggle="collapse" href="#kt_social_feeds_comments_3">
                                                <i class="ki-duotone ki-message-text-2 fs-2 me-1">
                                                    <span class="path1"></span>
                                                    <span class="path2"></span>
                                        ...
                                        <div class="d-flex pt-6">
                                            ...
                                            <div class="d-flex flex-column flex-row-fluid">
                                                ...
                                                <div class="d-flex align-items-center flex-wrap mb-0">
                                                    <!--begin::Name-->
                                                    <a href="#"
                                                        class="text-gray-800 text-hover-primary fw-bold me-6">Grace
                                                        Green</a>
                                                    <!--end::Name-->
                                                    <!--begin::Date-->
                        ...
                        <div class="card card-flush mb-10">
                            ...
                            <div class="card-header pt-9">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-50px me-5">
                                        <img src="admin/assets/media/avatars/300-10.jpg" class="" alt="" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Info-->
                                    <div class="flex-grow-1">
                                        <!--begin::Name-->
                                        <a href="#" class="text-gray-800 text-hover-primary fs-4 fw-bold">Ana
                                            Lee</a>
                                        <!--end::Name-->
                                        <!--begin::Date-->
                                        <span class="text-gray-500 fw-semibold d-block">Yestarday at 5:06 PM</span>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="collapse" id="kt_social_feeds_comments_4">
                                        ...
                                        <div class="d-flex pt-6">
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-45px me-5">
                                                <img src="admin/assets/media/avatars/300-25.jpg" alt="" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Wrapper-->
                                            <div class="d-flex flex-column flex-row-fluid">
                                                ...
                                                <div class="d-flex align-items-center flex-wrap mb-0">
                                                    <!--begin::Name-->
                                                    <a href="#"
                                                        class="text-gray-800 text-hover-primary fw-bold me-6">Mat
                                                        Dillon</a>
                                                    <!--end::Name-->
                                                    <!--begin::Date-->
                            ...
                            <div class="card card-flush mb-10">
                                ...
                                <div class="card-header pt-9">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-50px me-5">
                                            <img src="admin/assets/media/avatars/300-11.jpg" class="" alt="" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Info-->
                                        <div class="flex-grow-1">
                                            <!--begin::Name-->
                                            <a href="#" class="text-gray-800 text-hover-primary fs-4 fw-bold">Stive
                                                Strong</a>
                                            <!--end::Name-->
                                            <!--begin::Date-->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row g-3 g-lg-6">
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <!--begin::Img-->
                                            <a href="#">
                                                <img src="admin/assets/media/stock/600x600/img-14.jpg" class="rounded w-100"
                                                    alt="" />
                                            </a>
                                            <!--end::Img-->
                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <!--begin::Img-->
                                            <a href="#">
                                                <img src="admin/assets/media/stock/600x600/img-10.jpg" class="rounded w-100"
                                                    alt="" />
                                            </a>
                                            <!--end::Img-->
                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <!--begin::Img-->
                                            <a href="#">
                                                <img src="admin/assets/media/stock/600x600/img-18.jpg" class="rounded w-100"
                                                    alt="" />
                                            </a>
                                            <!--end::Img-->
                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <!--begin::Img-->
                                            <a href="#">
                                                <img src="admin/assets/media/stock/600x600/img-30.jpg" class="rounded w-100"
                                                    alt="" />
                                            </a>
                                            <!--end::Img-->
                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <!--begin::Img-->
                                            <a href="#">
                                                <img src="admin/assets/media/stock/600x600/img-31.jpg" class="rounded w-100"
                                                    alt="" />
                                            </a>
                                            <!--end::Img-->
                                        </div>
                                ...
                                <div class="card-footer pt-0">
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <ul class="nav py-3">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link btn btn-sm btn-color-gray-600 btn-active-color-primary btn-active-light-primary fw-bold px-4 me-1 collapsible"
                                                    data-bs-toggle="collapse" href="#kt_social_feeds_comments_5">
                                                    <i class="ki-duotone ki-message-text-2 fs-2 me-1">
                                                        <span class="path1"></span>
                                                        <span class="path2"></span>
                                                        <span class="path3"></span> </i>3 Comments</a>
                                            ...
                                            <div class="d-flex pt-6">
                                                ...
                                                <div class="d-flex flex-column flex-row-fluid">
                                                    ...
                                                    <div class="d-flex align-items-center flex-wrap mb-0">
                                                        ...
                                                        <!--end::Name-->
                                                        <!--begin::Date-->
                                                        <span class="text-gray-500 fw-semibold fs-7 me-5">2 Days
                                                            ago</span>
                                                        <!--end::Date-->
                                                        <!--begin::Reply-->
                                                        <a href="#"
                                            ...
                                            <div class="d-flex pt-6">
                                                ...
                                                <div class="d-flex flex-column flex-row-fluid">
                                                    ...
                                                    <div class="d-flex align-items-center flex-wrap mb-0">
                                                        ...
                                                        <!--end::Name-->
                                                        <!--begin::Date-->
                                                        <span class="text-gray-500 fw-semibold fs-7 me-5">3 Days
                                                            ago</span>
                                                        <!--end::Date-->
                                                        <!--begin::Reply-->
                                                        <a href="#"
                            ...
                            <div class="card card-flush mb-10">
                                ...
                                <div class="card-header pt-9">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <!--begin::Name-->
                                            <a href="#" class="text-gray-800 text-hover-primary fs-4 fw-bold">Lara
                                                Nilson</a>
                                            <!--end::Name-->
                                            <!--begin::Date-->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="fs-6 fw-normal text-gray-700">
                                        You can either decide on your final headline
                                        before outstanding you write the most of the
                                        rest of your creative post
                                    </div>
                                    <!--end::Post content-->
                                </div>
                                <!--end::Card body-->
                                ...
                                <div class="card-footer pt-0">
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <ul class="nav py-3">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link btn btn-sm btn-color-gray-600 btn-active-color-primary btn-active-light-primary fw-bold px-4 me-1 collapsible"
                                                    data-bs-toggle="collapse" href="#kt_social_feeds_comments_6">
                                                    <i class="ki-duotone ki-message-text-2 fs-2 me-1">
                                                        <span class="path1"></span>
                                                        <span class="path2"></span>
                                                        <span class="path3"></span> </i>2 Comments</a>
                        ...
                        <div class="card card-flush mb-10">
                            ...
                            <div class="card-header pt-9">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <!--begin::Name-->
                                        <a href="#" class="text-gray-800 text-hover-primary fs-4 fw-bold">Jerry
                                            Kane</a>
                                        <!--end::Name-->
                                        <!--begin::Date-->
                                        <span class="text-gray-500 fw-semibold d-block">Yestarday at 5:06 PM</span>
                ...
                <div class="d-lg-flex flex-column flex-lg-row-auto w-lg-325px" data-kt-drawer="true"
                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="symbol symbol-40px me-5">
                                    <img src="admin/assets/media/avatars/300-11.jpg" class="h-50 align-self-center"
                                        alt="" />
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Section-->
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Symbol-->
                                <div class="symbol symbol-40px me-5">
                                    <img src="admin/assets/media/avatars/300-2.jpg" class="h-50 align-self-center"
                                        alt="" />
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Section-->
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Symbol-->
                                <div class="symbol symbol-40px me-5">
                                    <img src="admin/assets/media/avatars/300-7.jpg" class="h-50 align-self-center"
                                        alt="" />
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Section-->
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Symbol-->
                                <div class="symbol symbol-40px me-5">
                                    <img src="admin/assets/media/avatars/300-9.jpg" class="h-50 align-self-center"
                                        alt="" />
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Section-->
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Symbol-->
                                <div class="symbol symbol-40px me-5">
                                    <img src="admin/assets/media/avatars/300-12.jpg" class="h-50 align-self-center"
                                        alt="" />
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Section-->
                    ...
                    <div class="card card-flush mb-5 mb-xl-8">
                        ...
                        <div class="card-header pt-5">
                            ...
                            <!--begin::Toolbar-->
                            <div class="card-toolbar">
                                <a href="/pages/general/social/activity" class="btn btn-sm btn-light">View All</a>
                            </div>
                            <!--end::Toolbar-->
                        </div>
                        <!--end::Header-->
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-3 g-lg-6">
                                ...
                                <div class="col-md-6">
                                    <!--begin::Img-->
                                    <a href="#">
                                        <img src="admin/assets/media/stock/600x600/img-33.jpg" class="rounded w-100"
                                            alt="" />
                                    </a>
                                    <!--end::Img-->
                                </div>
                                ...
                                <div class="col-md-6">
                                    <!--begin::Img-->
                                    <a href="#">
                                        <img src="admin/assets/media/stock/600x600/img-26.jpg" class="rounded w-100"
                                            alt="" />
                                    </a>
                                    <!--end::Img-->
                                </div>
                                ...
                                <div class="col-md-6">
                                    <!--begin::Img-->
                                    <a href="#">
                                        <img src="admin/assets/media/stock/600x600/img-25.jpg" class="rounded w-100"
                                            alt="" />
                                    </a>
                                    <!--end::Img-->
                                </div>
                                ...
                                <div class="col-md-6">
                                    <!--begin::Img-->
                                    <a href="#">
                                        <img src="admin/assets/media/stock/600x600/img-35.jpg" class="rounded w-100"
                                            alt="" />
                                    </a>
                                    <!--end::Img-->
                                </div>
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/pages/social/feeds.js"></script>
