                            ...
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-center flex-column py-9 px-5">
                                    ...
                                    <div class="symbol symbol-65px symbol-circle mb-5">
                                        <img src="admin/assets/media//avatars/300-11.jpg" alt="image" />
                                        <div
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-center flex-column py-9 px-5">
                                    ...
                                    <!--end::Avatar-->
                                    <!--begin::Name-->
                                    <a href="#" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">Kitona
                                        Johnson</a>
                                    <!--end::Name-->
                                    <!--begin::Position-->
                                    <div class="fw-semibold text-gray-500 mb-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-center flex-column py-9 px-5">
                                    ...
                                    <!--end::Avatar-->
                                    <!--begin::Name-->
                                    <a href="#" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">Robert
                                        Doe</a>
                                    <!--end::Name-->
                                    <!--begin::Position-->
                                    <div class="fw-semibold text-gray-500 mb-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-center flex-column py-9 px-5">
                                    ...
                                    <!--end::Avatar-->
                                    <!--begin::Name-->
                                    <a href="#" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">Soul
                                        Jacob</a>
                                    <!--end::Name-->
                                    <!--begin::Position-->
                                    <div class="fw-semibold text-gray-500 mb-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-center flex-column py-9 px-5">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-65px symbol-circle mb-5">
                                        <img src="admin/assets/media//avatars/300-7.jpg" alt="image" />
                                        <div
                                            class="bg-success position-absolute rounded-circle translate-middle start-100 top-100 border border-4 border-body h-15px w-15px ms-n3 mt-n3">
                                        </div>
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Name-->
                                    <a href="#" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">Nina
                                        Strong</a>
                                    <!--end::Name-->
                                    <!--begin::Position-->
                                    <div class="fw-semibold text-gray-500 mb-6">
