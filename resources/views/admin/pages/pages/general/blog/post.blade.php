                                ...
                                <div class="mb-8">
                                    ...
                                    <div class="overlay mt-8">
                                        ...
                                        <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-350px"
                                            style="background-image: url(admin/assets/media/stock/1600x800/img-1.jpg);">
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Links-->
                        ...
                        <div class="flex-column flex-lg-row-auto w-100 w-xl-300px mb-10">
                            ...
                            <div class="m-0">
                                ...
                                <div class="d-flex flex-stack mb-7">
                                    ...
                                    <div class="symbol symbol-60px symbol-2by3 me-4">
                                        <div class="symbol-label"
                                            style="background-image: url(admin/assets/media/stock/600x400/img-1.jpg);">
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                ...
                                <div class="d-flex flex-stack mb-7">
                                    ...
                                    <div class="symbol symbol-60px symbol-2by3 me-4">
                                        <div class="symbol-label"
                                            style="background-image: url(admin/assets/media/stock/600x400/img-2.jpg);">
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                ...
                                <div class="d-flex flex-stack mb-7">
                                    ...
                                    <div class="symbol symbol-60px symbol-2by3 me-4">
                                        <div class="symbol-label"
                                            style="background-image: url(admin/assets/media/stock/600x400/img-3.jpg);">
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="symbol symbol-60px symbol-2by3 me-4">
                                        <div class="symbol-label"
                                            style="background-image: url(admin/assets/media/stock/600x400/img-4.jpg);">
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                        ...
                        <div class="row g-10">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card-xl-stretch me-md-6">
                                    ...
                                    <a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5"
                                        style="background-image: url(admin/assets/media/stock/600x400/img-73.jpg);"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card-xl-stretch mx-md-3">
                                    <!--begin::Image-->
                                    <a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5"
                                        style="background-image: url(admin/assets/media/stock/600x400/img-74.jpg);"
                                        data-fslightbox="lightbox-video-tutorials"
                                        href="https://www.youtube.com/embed/btornGtLwIo">
                                        <img src="admin/assets/media/svg/misc/video-play.svg"
                                            class="position-absolute top-50 start-50 translate-middle" alt="" />
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card-xl-stretch ms-md-6">
                                    <!--begin::Image-->
                                    <a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5"
                                        style="background-image: url(admin/assets/media/stock/600x400/img-47.jpg);"
                                        data-fslightbox="lightbox-video-tutorials"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card-xl-stretch mx-md-3">
                                    ...
                                    <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                        ...
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                            style="background-image: url(admin/assets/media/stock/600x600/img-14.jpg);">
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Action-->
                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
