                                ...
                                <div class="ps-lg-6">
                                    ...
                                    <div class="d-flex flex-stack flex-wrap">
                                        ...
                                        <div class="d-flex align-items-center pe-2">
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-35px symbol-circle me-3">
                                                <img src="admin/assets/media/avatars/300-19.jpg" class="" alt="" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Text-->
                                            <div class="fs-5 fw-bold">
                        ...
                        <div class="row g-10 row-cols-2 row-cols-lg-5">
                            ...
                            <div class="col">
                                ...
                                <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                    ...
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                        style="background-image: url(admin/assets/media/stock/900x600/16.jpg);">
                                    </div>
                                    <!--end::Image-->
                                    <!--begin::Action-->
                                    <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                            ...
                            <div class="col">
                                ...
                                <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                    ...
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                        style="background-image: url(admin/assets/media/stock/900x600/13.jpg);">
                                    </div>
                                    <!--end::Image-->
                                    <!--begin::Action-->
                                    <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                            ...
                            <div class="col">
                                ...
                                <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                    ...
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                        style="background-image: url(admin/assets/media/stock/900x600/19.jpg);">
                                    </div>
                                    <!--end::Image-->
                                    <!--begin::Action-->
                                    <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                            ...
                            <div class="col">
                                ...
                                <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                    ...
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                        style="background-image: url(admin/assets/media/stock/900x600/15.jpg);">
                                    </div>
                                    <!--end::Image-->
                                    <!--begin::Action-->
                                    <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                            ...
                            <div class="col">
                                ...
                                <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                    ...
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                        style="background-image: url(admin/assets/media/stock/900x600/12.jpg);">
                                    </div>
                                    <!--end::Image-->
                                    <!--begin::Action-->
                                    <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
