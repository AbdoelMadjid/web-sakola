        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
                    ...
                    <div class="w-lg-500px p-10">
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="/dashboard"
                            ...
                            <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
                                <div></div>
                                <!--begin::Link-->
                                <a href="/pages/authentication/layouts/corporate/reset-password" class="link-primary">Forgot
                                    Password
                                    ?</a>
                                <!--end::Link-->
                            </div>
                            ...
                            <div class="text-gray-500 text-center fw-semibold fs-6">
                                Not a Member yet?
                                <a href="/pages/authentication/layouts/corporate/sign-up" class="link-primary">Sign
                                    up</a>
                            </div>
                            <!--end::Sign up-->
                        </form>
            ...
            <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2"
                ...
                <div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
                    <!--begin::Logo-->
                    <a href="/dashboard" class="mb-0 mb-lg-12">
