@extends('admin.layouts.index', ['CreativeLayout' => true])
@section('content')
    <!--begin::Root-->
            ...
            <div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
                ...
                <div class="d-flex flex-center flex-lg-start flex-column">
                    ...
                    <a href="index" class="mb-7">
                        <img alt="Logo" src="admin/assets/media/logos/custom-3.svg" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Title-->
            ...
            <div
                ...
                <div class="bg-body d-flex flex-column align-items-stretch flex-center rounded-4 w-md-600px p-20">
                    ...
                    <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                        <!--begin::Form-->
                        <form class="form w-100 mb-13" novalidate="novalidate" data-kt-redirect-url="index"
                            id="kt_sing_in_two_factor_form">
                            <!--begin::Icon-->
                            <div class="text-center mb-10">
                                <img alt="Logo" class="mh-125px" src="admin/assets/media/svg/misc/smartphone-2.svg" />
                            </div>
                            <!--end::Icon-->
                            <!--begin::Heading-->
                            <div class="text-center mb-10">
