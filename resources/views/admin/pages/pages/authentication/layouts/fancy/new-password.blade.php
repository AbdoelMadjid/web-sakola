@extends('admin.layouts.index', ['FancyLayout' => true])
@section('content')
    <!--begin::Root-->
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
            <!--begin::Logo-->
            <a href="index" class="d-block d-lg-none mx-auto py-20">
            ...
            <div class="d-flex flex-column flex-column-fluid flex-center w-lg-50 p-10">
                ...
                <div class="d-flex justify-content-between flex-column-fluid flex-column w-100 mw-450px">
                    ...
                    <div class="d-flex flex-stack py-2">
                        <!--begin::Back link-->
                        <div class="me-2">
                            <a href="/pages/authentication/layouts/fancy/sign-in"
                        ...
                        <!--begin::Sign Up link-->
                        <div class="m-0">
                            <span class="text-gray-500 fw-bold fs-5 me-2" data-kt-translate="new-password-head-desc">Already
                                a member
                                ?</span>
                            <a href="/pages/authentication/layouts/fancy/sign-in" class="link-primary fw-bold fs-5"
                    ...
                    <div class="py-20">
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_new_password_form"
                            data-kt-redirect-url="authentication/layouts/fancy/sign-in" action="#">
                            <!--begin::Heading-->
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="text-gray-500 fw-semibold fs-6 me-6" data-kt-translate="general-or">
                                        Or
                                    </div>
                                    <!--begin::Symbol-->
                                    ...
                                    <!--begin::Symbol-->
                                    <a href="#" class="symbol symbol-circle symbol-45px w-45px bg-light me-3">
                                        <img alt="Logo" src="admin/assets/media/svg/brand-logos/facebook-3.svg"
                                            class="p-4" />
                                    </a>
                                    <!--end::Symbol-->
                                    <!--begin::Symbol-->
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-4"
                            ...
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link d-flex px-5" data-kt-lang="Spanish">
                                    <span class="symbol symbol-20px me-4">
                                        <img data-kt-element="lang-flag" class="rounded-1"
                                            src="admin/assets/media/flags/spain.svg" alt="" />
                                    </span>
                            ...
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link d-flex px-5" data-kt-lang="German">
                                    <span class="symbol symbol-20px me-4">
                                        <img data-kt-element="lang-flag" class="rounded-1"
                                            src="admin/assets/media/flags/germany.svg" alt="" />
                                    </span>
                            ...
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link d-flex px-5" data-kt-lang="Japanese">
                                    <span class="symbol symbol-20px me-4">
                                        <img data-kt-element="lang-flag" class="rounded-1"
                                            src="admin/assets/media/flags/japan.svg" alt="" />
                                    </span>
                            ...
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link d-flex px-5" data-kt-lang="French">
                                    <span class="symbol symbol-20px me-4">
                                        <img data-kt-element="lang-flag" class="rounded-1"
                                            src="admin/assets/media/flags/france.svg" alt="" />
                                    </span>
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/authentication/reset-password/new-password.js"></script>
    <script src="admin/assets/js/custom/authentication/sign-in/i18n.js"></script>
