        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
            ...
            <div class="d-flex flex-column flex-column-fluid flex-center w-lg-50 p-10">
                ...
                <div class="d-flex justify-content-between flex-column-fluid flex-column w-100 mw-450px">
                    ...
                    <div class="py-20">
                        <!--begin::Form-->
                        <form class="form w-100 mb-10" novalidate="novalidate" data-kt-redirect-url="index"
                            id="kt_sing_in_two_factor_form">
                            <!--begin::Icon-->
                            <div class="text-center mb-10">
                                <img alt="Logo" class="theme-light-show mh-125px"
                                    src="admin/assets/media/svg/misc/smartphone-2.svg" />
                                <img alt="Logo" class="theme-dark-show mh-125px"
                                    src="admin/assets/media/svg/misc/smartphone-2-dark.svg" />
                            </div>
                            <!--end::Icon-->
                            <!--begin::Heading-->
                            <div class="text-center mb-10">
                            ...
                            <div class="text-center">
                                <!--begin::Submit-->
                                <button id="kt_sing_in_two_factor_submit" class="btn btn-primary"
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/authentication/sign-in/two-factor.js"></script>
