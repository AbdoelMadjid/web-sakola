            ...
            <div class="d-flex flex-column flex-column-fluid flex-center w-lg-50 p-10">
                ...
                <div class="d-flex justify-content-between flex-column-fluid flex-column w-100 mw-450px">
                    ...
                    <div class="d-flex flex-stack py-2">
                        ...
                        <!--begin::Sign Up link-->
                        <div class="m-0">
                            <span class="text-gray-500 fw-bold fs-5 me-2" data-kt-translate="sign-in-head-desc">Not a
                                Member
                                yet?</span>
                            <a href="/pages/authentication/layouts/fancy/sign-up" class="link-primary fw-bold fs-5"
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="index"
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-10">
                                    <div></div>
                                    <!--begin::Link-->
                                    <a href="/pages/authentication/layouts/fancy/reset-password" class="link-primary"
