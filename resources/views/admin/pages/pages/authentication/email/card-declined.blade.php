    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div class="bg-body d-flex flex-column-auto justify-content-cenrer align-items-start gap-2 gap-lg-4 py-4 px-10 overflow-auto"
                ...
                <a href="/pages/authentication/email/card-declined?nav=0" class="flex-grow-1 text-end mt-2">
                                        ...
                                        <div style="text-align:center; margin:0 60px 34px 60px">
                                            ...
                                            <div style="margin-bottom:10px">
                                                <a href="https://keenthemes.com" rel="noopener" target="_blank">
                                                    <img alt="Logo" src="admin/assets/media/email/logo-1.svg"
                                                        style="height: 35px" />
                                                </a>
                                            </div>
                                            <!--end:Logo-->
                                            ...
                                            <div style="margin-bottom:15px">
                                                <img alt="Logo" src="admin/assets/media/email/icon-positive-vote-4.svg" />
                                            </div>
                                            <!--end:Media-->
                                            <!--begin:Text-->
                                            <div
                                                ...
                                                <p
                                                    ...
                                                    Credit Card
                                                    Declined</p>
                                                <p style="margin-bottom:2px; color:#7E8299">Seems something went wrong
                                                    with your payment</p>
                                            </div>
                                            <!--end:Text-->
                                            <!--begin:Text-->
                                            <div
                                                ...
                                                <p style="margin-bottom:2px; color:#5E6278">As a courtesy, we would
                                                    like
                                                    to notify you that your
                                                    recent payment,</p>
                                                <p style="margin-bottom:2px; color:#5E6278">EUR16.93 EUR on 03/10/2022
                                                    for Zoom Account Number
                                                    500489234, was</p>
                                                <p style="margin-bottom:2px; color:#5E6278; margin-bottom:13px">unable
                                                    to process successfully.
                                                </p>
                                                <p style="margin-bottom:2px; color:#5E6278">Feel free to call our
                                                    customer care number:
                                                    <span style="color:#50cd89; font-weight: 600">+31 6 3344 55
                                                        56</span>
                                                <p style="margin-bottom:2px; color:#5E6278">You may reach us at
                                                    <a href="https://devs.keenthemes.com" target="_blank"
                                                        style="color:#50cd89; font-weight: 600">devs.keenthemes.com</a>
                                                </p>
                                                <!--end:Text-->
                                                <!--begin:Action-->
                                                <a href="/pages/general/corporate/contact" target="_blank"
                                                    style="position: relative; left: 50%; transform: translateX(-50%);background-color:#50cd89; border-radius:6px; display:inline-block; margin-top:27px; padding:11px 19px; color: #FFFFFF; font-size: 14px; font-weight:500;font-family:Arial,Helvetica,sans-serif;">Contact
                                                    Us Now</a>
                                                <!--end:Action-->
                                                <!--end:Email content-->
                                                ...
                                                <div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <p
                                                            ...
                                                            Lots of people make mistakes while creating paragraphs Some
                                                            writers just put whitespace in
                                                            their text</p>
                                                        <!--end::Desc-->
                                                    </div>
                                                    <!--end::Content-->
