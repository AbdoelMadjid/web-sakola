...
@section('content')
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <style>
            body {
                background-image: url("admin/assets/media/auth/bg9.jpg");
            }

            [data-bs-theme="dark"] body {
                background-image: url("admin/assets/media/auth/bg9-dark.jpg");
            }
        </style>
        <!--end::Page bg image-->
            ...
            <div class="d-flex flex-column flex-center text-center p-10">
                ...
                <div class="card card-flush w-lg-650px py-5">
                    <div class="card-body py-15 py-lg-20">
                        ...
                        <!--begin::Illustration-->
                        <div class="mb-n5">
                            <img src="admin/assets/media/auth/chart-graph.png" class="mw-100 mh-300px theme-light-show"
                                alt="" />
                            <img src="admin/assets/media/auth/chart-graph-dark.png" class="mw-100 mh-300px theme-dark-show"
                                alt="" />
                        </div>
                        <!--end::Illustration-->
                    </div>
...
@section('script')
    ...
    <script src="admin/assets/js/custom/authentication/sign-up/coming-soon.js"></script>
