                ...
                <div class="card-body">
                    ...
                    <div class="card-px text-center pt-15 pb-15">
                        ...
                        <h2 class="fs-2x fw-bold mb-0">
                            Offer A Deal Modal Example
                        </h2>
                        <!--end::Title-->
                        <!--begin::Description-->
                        <p class="text-gray-500 fs-4 fw-semibold py-7">
                            Click on the below buttons to launch <br />a deal
                            offer agreement flow example.
                        </p>
                        <!--end::Description-->
                        <!--begin::Action-->
                    ...
                    <div class="text-center pb-15 px-5">
                        <img src="admin/assets/media/illustrations/sketchy-1/7.png" alt=""
