                ...
                <div class="card-body">
                    ...
                    <div class="card-px text-center pt-15 pb-15">
                        ...
                        <h2 class="fs-2x fw-bold mb-0">
                            Top Up Wallet Modal Example
                        </h2>
                        <!--end::Title-->
                        <!--begin::Description-->
                        <p class="text-gray-500 fs-4 fw-semibold py-7">
                            Click on the below buttons to launch <br />a Top Up
                            Wallet modal example.
                        </p>
                        <!--end::Description-->
                        <!--begin::Action-->
                        <a href="#" class="btn btn-primary er fs-6 px-8 py-4" data-bs-toggle="modal"
                            data-bs-target="#kt_modal_top_up_wallet">Top Up Wallet</a>
                        <!--end::Action-->
                    </div>
                    <!--end::Heading-->
                    <!--begin::Illustration-->
                    <div class="text-center pb-15 px-5">
                        <img src="admin/assets/media/illustrations/sketchy-1/2.png" alt=""
