                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="nav-group nav-group-fluid">
                                        ...
                                        <label>
                                            <input type="radio" class="btn-check" name="type" value="has"
                                                checked="checked" />
                                            <span
                                                class="btn btn-sm btn-color-muted btn-active btn-active-primary fw-bold px-4">1-5</span>
                                        </label>
                                        <!--end::Option-->
                                        <!--begin::Option-->
                                        <label>
                                            ...
                                            <span
                                                class="btn btn-sm btn-color-muted btn-active btn-active-primary fw-bold px-4">5-10</span>
                                        </label>
                                        <!--end::Option-->
                                        <!--begin::Option-->
                                        <label>
                                            ...
                                            <span
                                                class="btn btn-sm btn-color-muted btn-active btn-active-primary fw-bold px-4">10++</span>
                                        </label>
                                        <!--end::Option-->
                                    </div>
                                    <!--end::Radio group-->
                                ...
                                <div class="mb-10">
                                    ...
                                    <div class="form-check form-check-custom form-check-solid mb-5">
                                        ...
                                        <label class="form-check-label flex-grow-1 fw-semibold text-gray-700 fs-6"
                                            for="kt_search_category_1">Electronics</label>
                                    ...
                                    <div class="form-check form-check-custom form-check-solid mb-5">
                                        <input class="form-check-input" type="checkbox" id="kt_search_category_2"
                                            checked="checked" />
                                        <label class="form-check-label flex-grow-1 fw-semibold text-gray-700 fs-6"
                                            for="kt_search_category_2">Sport Equipments</label>
                                ...
                                <div class="d-flex align-items-center justify-content-end">
                                    <a href="#"
                                        class="btn btn-active-light-primary btn-color-gray-500 me-3">Discard</a>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                            ...
                                            <div class="symbol symbol-65px symbol-circle mb-5">
                                                <img src="admin/assets/media//avatars/300-2.jpg" alt="image" />
                                                <div
                                            ...
                                            <!--begin::Name-->
                                            <a href="#"
                                                class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">Karina Clark</a>
                                            <!--end::Name-->
                                            <!--begin::Position-->
                                ...
                                <div class="col-md-6 col-xl-12 col-xxl-6">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                            ...
                                            <!--begin::Name-->
                                            <a href="#"
                                                class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">Sean Bean</a>
                                            <!--end::Name-->
                                            <!--begin::Position-->
                                            <div class="fw-semibold text-gray-500 mb-6">
                                ...
                                <div class="col-md-6 col-xl-12 col-xxl-6">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                            ...
                                            <!--begin::Name-->
                                            <a href="#"
                                                class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">Alan Johnson</a>
                                            <!--end::Name-->
                                            <!--begin::Position-->
                                            <div class="fw-semibold text-gray-500 mb-6">
                                ...
                                <div class="col-md-6 col-xl-12 col-xxl-6">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-65px symbol-circle mb-5">
                                                <img src="admin/assets/media//avatars/300-14.jpg" alt="image" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Name-->
                                            <a href="#"
                                                class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">Robert Doe</a>
                                            <!--end::Name-->
                                            <!--begin::Position-->
                                            <div class="fw-semibold text-gray-500 mb-6">
                                ...
                                <div class="col-md-6 col-xl-12 col-xxl-6">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-65px symbol-circle mb-5">
                                                <img src="admin/assets/media//avatars/300-6.jpg" alt="image" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Name-->
                                            <a href="#"
                                                class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">Olivia Wild</a>
                                            <!--end::Name-->
                                            <!--begin::Position-->
                                            <div class="fw-semibold text-gray-500 mb-6">
                                ...
                                <div class="col-md-6 col-xl-12 col-xxl-6">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                            ...
                                            <!--begin::Name-->
                                            <a href="#"
                                                class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">Adam
                                                Williams</a>
                                            <!--end::Name-->
                                            <!--begin::Position-->
                                            <div class="fw-semibold text-gray-500 mb-6">
                                ...
                                <div class="col-md-6 col-xl-12 col-xxl-6">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                            ...
                                            <div class="symbol symbol-65px symbol-circle mb-5">
                                                <span
                                                    class="symbol-label fs-2x fw-semibold text-info bg-light-info">P</span>
                                                <div
                                                    class="bg-success position-absolute border border-4 border-body h-15px w-15px rounded-circle translate-middle start-100 top-100 ms-n3 mt-n3">
                                                </div>
                                            </div>
                                            ...
                                            <!--begin::Name-->
                                            <a href="#"
                                                class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">Peter Marcus</a>
                                            <!--end::Name-->
                                            <!--begin::Position-->
                                            <div class="fw-semibold text-gray-500 mb-6">
                                                Art Director at Novica Co.
                                ...
                                <div class="col-md-6 col-xl-12 col-xxl-6">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                            ...
                                            <!--begin::Name-->
                                            <a href="#"
                                                class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">Neil Owen</a>
                                            <!--end::Name-->
                                            <!--begin::Position-->
                                            <div class="fw-semibold text-gray-500 mb-6">
                                ...
                                <div class="col-md-6 col-xl-12 col-xxl-6">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-65px symbol-circle mb-5">
                                                <img src="admin/assets/media//avatars/300-12.jpg" alt="image" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Name-->
                                            <a href="#"
                                                class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">Benjamin
                                                Jacob</a>
                                            <!--end::Name-->
                                            <!--begin::Position-->
                                            <div class="fw-semibold text-gray-500 mb-6">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="me-5 position-relative">
                                                                ...
                                                                <div class="symbol symbol-35px symbol-circle">
                                                                    <img alt="Pic"
                                                                        src="admin/assets/media/avatars/300-6.jpg" />
                                                                </div>
                                                                <!--end::Avatar-->
                                                            </div>
                                                            <!--end::Wrapper-->
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="/"
                                                                    class="mb-1 text-gray-800 text-hover-primary">Melody
                                                                    Macy</a>
                                                                <div class="fw-semibold fs-6 text-gray-500">
                                                                    melody@altbox.com
                                                                </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="/"
                                                                    class="mb-1 text-gray-800 text-hover-primary">Max
                                                                    Smith</a>
                                                                <div class="fw-semibold fs-6 text-gray-500">
                                                                    max@kt.com
                                                                </div>
                                                    ...
                                                    <td>$698.00</td>
                                                    <td>
                                                        <span class="badge badge-light-info fw-bold px-4 py-3">In
                                                            progress</span>
                                                    </td>
                                                    <td class="text-end">
                                                        <a href="#" class="btn btn-light btn-sm">View</a>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="me-5 position-relative">
                                                                ...
                                                                <div class="symbol symbol-35px symbol-circle">
                                                                    <img alt="Pic"
                                                                        src="admin/assets/media/avatars/300-5.jpg" />
                                                                </div>
                                                                <!--end::Avatar-->
                                                            </div>
                                                            <!--end::Wrapper-->
                                                            ...
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="/"
                                                                    class="mb-1 text-gray-800 text-hover-primary">Sean
                                                                    Bean</a>
                                                                <div class="fw-semibold fs-6 text-gray-500">
                                                                    sean@dellito.com
                                                                </div>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="me-5 position-relative">
                                                                ...
                                                                <div class="symbol symbol-35px symbol-circle">
                                                                    <img alt="Pic"
                                                                        src="admin/assets/media/avatars/300-25.jpg" />
                                                                </div>
                                                                <!--end::Avatar-->
                                                            </div>
                                                            <!--end::Wrapper-->
                                                            ...
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="/"
                                                                    class="mb-1 text-gray-800 text-hover-primary">Brian
                                                                    Cox</a>
                                                                <div class="fw-semibold fs-6 text-gray-500">
                                                                    brian@exchange.com
                                                                </div>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="me-5 position-relative">
                                                                ...
                                                                <div class="symbol symbol-35px symbol-circle">
                                                                    <img alt="Pic"
                                                                        src="admin/assets/media/avatars/300-9.jpg" />
                                                                </div>
                                                                <!--end::Avatar-->
                                                            </div>
                                                            <!--end::Wrapper-->
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="/"
                                                                    class="mb-1 text-gray-800 text-hover-primary">Olivia
                                                                    Wild</a>
                                                                <div class="fw-semibold fs-6 text-gray-500">
                                                                    olivia@corpmail.com
                                                                </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="/"
                                                                    class="mb-1 text-gray-800 text-hover-primary">Neil
                                                                    Owen</a>
                                                                <div class="fw-semibold fs-6 text-gray-500">
                                                                    owen.neil@gmail.com
                                                                </div>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="me-5 position-relative">
                                                                ...
                                                                <div class="symbol symbol-35px symbol-circle">
                                                                    <img alt="Pic"
                                                                        src="admin/assets/media/avatars/300-23.jpg" />
                                                                </div>
                                                                <!--end::Avatar-->
                                                            </div>
                                                            <!--end::Wrapper-->
                                                            ...
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="/"
                                                                    class="mb-1 text-gray-800 text-hover-primary">Dan
                                                                    Wilson</a>
                                                                <div class="fw-semibold fs-6 text-gray-500">
                                                                    dam@consilting.com
                                                                </div>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="me-5 position-relative">
                                                                ...
                                                                <div class="symbol symbol-35px symbol-circle">
                                                                    <img alt="Pic"
                                                                        src="admin/assets/media/avatars/300-12.jpg" />
                                                                </div>
                                                                <!--end::Avatar-->
                                                            </div>
                                                            <!--end::Wrapper-->
                                                            ...
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="/"
                                                                    class="mb-1 text-gray-800 text-hover-primary">Ana
                                                                    Crown</a>
                                                                <div class="fw-semibold fs-6 text-gray-500">
                                                                    ana.cf@limtel.com
                                                                </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="/"
                                                                    class="mb-1 text-gray-800 text-hover-primary">Robert
                                                                    Doe</a>
                                                                <div class="fw-semibold fs-6 text-gray-500">
                                                                    robert@benko.com
                                                                </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="/"
                                                                    class="mb-1 text-gray-800 text-hover-primary">John
                                                                    Miller</a>
                                                                <div class="fw-semibold fs-6 text-gray-500">
                                                                    miller@mapple.com
                                                                </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="/"
                                                                    class="mb-1 text-gray-800 text-hover-primary">Lucy
                                                                    Kunic</a>
                                                                <div class="fw-semibold fs-6 text-gray-500">
                                                                    lucy.m@fentech.com
                                                                </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="/"
                                                                    class="mb-1 text-gray-800 text-hover-primary">Ethan
                                                                    Wilder</a>
                                                                <div class="fw-semibold fs-6 text-gray-500">
                                                                    ethan@loop.com.au
                                                                </div>
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/apps/projects/users/users.js"></script>
