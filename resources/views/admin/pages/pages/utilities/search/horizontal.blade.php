                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <a href="#" id="kt_horizontal_search_advanced_link" class="btn btn-link"
                                    data-bs-toggle="collapse" data-bs-target="#kt_advanced_search_form">Advanced Search</a>
                            </div>
                            <!--end:Action-->
                        </div>
                        <!--end::Compact form-->
                            ...
                            <div class="row g-8 mb-8">
                                ...
                                <div class="col-xxl-7">
                                    ...
                                    <input type="text" class="form-control form-control form-control-solid"
                                        name="tags" value="products, users, events" />
                                </div>
                                <!--end::Col-->
                                <!--begin::Col-->
                                <div class="col-xxl-5">
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/utilities/search/horizontal.js"></script>
