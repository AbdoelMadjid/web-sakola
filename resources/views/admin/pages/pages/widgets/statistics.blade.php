                    ...
                    <div
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-gray-900-75 fw-semibold fs-5 m-0">
                                Create a headline that is informative <br />and will
                                capture readers
                            </p>
                        </div>
                        <!--end::Body-->
                ...
                <div class="col-xl-4">
                    ...
                    <div
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-gray-900-75 fw-semibold fs-5 m-0">
                                Great blog posts don’t just happen Even the best
                                bloggers need it
                            </p>
                        </div>
                        <!--end::Body-->
                ...
                <div class="col-xl-4">
                    ...
                    <div
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-gray-900-75 fw-semibold fs-5 m-0">
                                AirWays - A Front-end solution for airlines build
                                with ReactJS
                            </p>
                        </div>
                        <!--end::Body-->
            ...
            <div class="row g-5 g-xl-8">
                    ...
                    <div class="card card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body d-flex align-items-center pt-3 pb-0">
                            <div class="d-flex flex-column flex-grow-1 py-2 py-lg-13 me-2">
                                <a href="#" class="fw-bold text-gray-900 fs-4 mb-2 text-hover-primary">Arthur
                                    Goldstain</a>
                                <span class="fw-semibold text-muted fs-5">System & Software Architect</span>
                            </div>
                            <img src="admin/assets/media/svg/avatars/029-boy-11.svg" alt=""
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body d-flex align-items-center pt-3 pb-0">
                            ...
                            <img src="admin/assets/media/svg/avatars/014-girl-7.svg" alt=""
                                class="align-self-end h-100px" />
                        </div>
                        <!--end::Body-->
                    </div>
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                        ...
                        <div class="card-body d-flex align-items-center pt-3 pb-0">
                            <div class="d-flex flex-column flex-grow-1 py-2 py-lg-13 me-2">
                                <a href="#" class="fw-bold text-gray-900 fs-4 mb-2 text-hover-primary">Nick
                                    Stone</a>
                                <span class="fw-semibold text-muted fs-5">Customer Support Team</span>
                            </div>
                            <img src="admin/assets/media/svg/avatars/004-boy-1.svg" alt=""
                                class="align-self-end h-100px" />
                        </div>
                        <!--end::Body-->
                    </div>
                        ...
                        <div class="card-body d-flex flex-column p-0">
                            <div class="d-flex flex-stack flex-grow-1 card-p">
                                <div class="d-flex flex-column me-2">
                                    <a href="#" class="text-gray-900 text-hover-primary fw-bold fs-3">Weekly
                                        Sales</a>
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body d-flex flex-column p-0">
                            <div class="d-flex flex-stack flex-grow-1 card-p">
                                <div class="d-flex flex-column me-2">
                                    <a href="#" class="text-gray-900 text-hover-primary fw-bold fs-3">Authors
                                        Progress</a>
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                        ...
                        <div class="card-body d-flex flex-column p-0">
                            <div class="d-flex flex-stack flex-grow-1 card-p">
                                <div class="d-flex flex-column me-2">
                                    <a href="#" class="text-gray-900 text-hover-primary fw-bold fs-3">Sales
                                        Progress</a>
            ...
            <div class="row g-5 g-xl-8">
                <div class="col-xl-4">
                    ...
                    <div class="card bg-light-success card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body my-3">
                            <a href="#" class="card-title fw-bold text-success fs-5 mb-3 d-block">Project
                                Progress</a>
                            <div class="py-1">
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card bg-light-warning card-xl-stretch mb-xl-8">
                        <!--begin::Body-->
                        <div class="card-body my-3">
                            <a href="#" class="card-title fw-bold text-warning fs-5 mb-3 d-block">Company
                                Finance</a>
                            <div class="py-1">
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card bg-light-primary card-xl-stretch mb-5 mb-xl-8">
                        <!--begin::Body-->
                        <div class="card-body my-3">
                            <a href="#" class="card-title fw-bold text-primary fs-5 mb-3 d-block">Marketing
                                Analysis</a>
                            <div class="py-1">
