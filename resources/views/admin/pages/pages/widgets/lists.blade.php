                                        ...
                                        <div class="mb-10">
                                            ...
                                            <div>
                                                <select class="form-select form-select-solid" multiple="multiple"
                                                    ...
                                                    data-dropdown-parent="#kt_menu_6606384e7a938" data-allow-clear="true">
                                                    <option></option>
                    ...
                    <div class="card card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body pt-2">
                            ...
                            <div class="d-flex align-items-center mb-7">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-50px me-5">
                                    <img src="admin/assets/media/avatars/300-6.jpg" class="" alt="" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Text-->
                            ...
                            <div class="d-flex align-items-center mb-7">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-50px me-5">
                                    <img src="admin/assets/media/avatars/300-5.jpg" class="" alt="" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Text-->
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center mb-7">
                                ...
                                <!--begin::Text-->
                                <div class="flex-grow-1">
                                    <a href="#" class="text-gray-900 fw-bold text-hover-primary fs-6">Francis
                                        Mitcham</a>
                                    <span class="text-muted d-block fw-bold">PHP, SQLite, Artisan CLI</span>
                                </div>
                                <!--end::Text-->
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-50px me-5">
                                    <img src="admin/assets/media/avatars/300-23.jpg" class="" alt="" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Text-->
                                <div class="flex-grow-1">
                    ...
                    <div class="card card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="d-flex align-items-sm-center mb-7">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <span class="symbol-label">
                                        <img src="admin/assets/media/svg/brand-logos/plurk.svg" class="h-50 align-self-center"
                                            alt="" />
                                    </span>
                                </div>
                                <!--end::Symbol-->
                            ...
                            <div class="d-flex align-items-sm-center mb-7">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <span class="symbol-label">
                                        <img src="admin/assets/media/svg/brand-logos/vimeo.svg" class="h-50 align-self-center"
                                            alt="" />
                                    </span>
                                </div>
                                <!--end::Symbol-->
                            ...
                            <div class="d-flex align-items-sm-center mb-7">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <span class="symbol-label">
                                        <img src="admin/assets/media/svg/brand-logos/bebo.svg" class="h-50 align-self-center"
                                            alt="" />
                                    </span>
                                </div>
                                <!--end::Symbol-->
                            ...
                            <div class="d-flex align-items-sm-center">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <span class="symbol-label">
                                        <img src="admin/assets/media/svg/brand-logos/fox-hub.svg" class="h-50 align-self-center"
                                            alt="" />
                                    </span>
                                </div>
                                <!--end::Symbol-->
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <div>
                                                <select class="form-select form-select-solid" multiple="multiple"
                                                    data-kt-select2="true" data-close-on-select="false"
                                                    data-placeholder="Select option"
                                                    data-dropdown-parent="#kt_menu_6606384e7ad13" data-allow-clear="true">
                                                    <option></option>
                                                    <option value="1">Approved</option>
                                                    <option value="2">Pending</option>
                                                    <option value="2">In Process</option>
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <div>
                                                <select class="form-select form-select-solid" multiple="multiple"
                                                    data-kt-select2="true" data-close-on-select="false"
                                                    data-placeholder="Select option"
                                                    data-dropdown-parent="#kt_menu_6606384e7ae8b" data-allow-clear="true">
                                                    <option></option>
                                                    <option value="1">Approved</option>
                                                    <option value="2">Pending</option>
                                                    <option value="2">In Process</option>
                        ...
                        <div class="card-body pt-3">
                            ...
                            <div class="d-flex align-items-sm-center mb-7">
                                ...
                                <div class="symbol symbol-60px symbol-2by3 me-4">
                                    <div class="symbol-label"
                                        style="
                                  background-image: url(admin/assets/media/stock/600x400/img-20.jpg);
                                ">
                                    </div>
                                </div>
                                <!--end::Symbol-->
                            ...
                            <div class="d-flex align-items-sm-center mb-7">
                                ...
                                <div class="symbol symbol-60px symbol-2by3 me-4">
                                    <div class="symbol-label"
                                        style="
                                  background-image: url(admin/assets/media/stock/600x400/img-19.jpg);
                                ">
                                    </div>
                                </div>
                                <!--end::Symbol-->
                            ...
                            <div class="d-flex align-items-sm-center mb-7">
                                ...
                                <div class="symbol symbol-60px symbol-2by3 me-4">
                                    <div class="symbol-label"
                                        style="
                                  background-image: url(admin/assets/media/stock/600x400/img-25.jpg);
                                ">
                                    </div>
                                </div>
                                <!--end::Symbol-->
                            ...
                            <div class="d-flex align-items-sm-center">
                                ...
                                <div class="symbol symbol-60px symbol-2by3 me-4">
                                    <div class="symbol-label"
                                        style="
                                  background-image: url(admin/assets/media/stock/600x400/img-24.jpg);
                                ">
                                    </div>
                                </div>
                                <!--end::Symbol-->
                        ...
                        <div class="card-body pt-3">
                            ...
                            <div class="d-flex align-items-sm-center mb-7">
                                ...
                                <div class="symbol symbol-60px symbol-2by3 me-4">
                                    <div class="symbol-label"
                                        style="
                                  background-image: url(admin/assets/media/stock/600x400/img-17.jpg);
                                ">
                                    </div>
                                </div>
                                <!--end::Symbol-->
                            ...
                            <div class="d-flex align-items-sm-center mb-7">
                                ...
                                <div class="symbol symbol-60px symbol-2by3 me-4">
                                    <div class="symbol-label"
                                        style="
                                  background-image: url(admin/assets/media/stock/600x400/img-10.jpg);
                                ">
                                    </div>
                                </div>
                                <!--end::Symbol-->
                                ...
                                <div class="d-flex flex-row-fluid align-items-center flex-wrap my-lg-0 me-2">
                                    <!--begin::Title-->
                                    <div class="flex-grow-1 my-lg-0 my-2 me-2">
                                        <a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">Pink
                                            Patterns</a>
                            ...
                            <div class="d-flex align-items-sm-center mb-7">
                                ...
                                <div class="d-flex flex-row-fluid align-items-center flex-wrap my-lg-0 me-2">
                                    <!--begin::Title-->
                                    <div class="flex-grow-1 my-lg-0 my-2 me-2">
                                        <a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">Abstract
                                            Art</a>
                                        <span class="text-muted fw-semibold d-block pt-1">The will to capture
                                            readers</span>
                                    </div>
                                    <!--end::Title-->
                                    <!--begin::Section-->
                            ...
                            <div class="d-flex align-items-sm-center">
                                ...
                                <div class="symbol symbol-60px symbol-2by3 me-4">
                                    <div class="symbol-label"
                                        style="
                                  background-image: url(admin/assets/media/stock/600x400/img-9.jpg);
                                ">
                                    </div>
                                </div>
                                <!--end::Symbol-->
                                ...
                                <div class="d-flex flex-row-fluid align-items-center flex-wrap my-lg-0 me-2">
                                    ...
                                    <div class="flex-grow-1 my-lg-0 my-2 me-2">
                                        <a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">Desserts
                                            platter</a>
                                        <span class="text-muted fw-semibold d-block pt-1">Food trends &
                                            inspirations</span>
                                    </div>
                                    <!--end::Title-->
                                    <!--begin::Section-->
                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="d-flex mb-7">
                                ...
                                <div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
                                    <img src="admin/assets/media/stock/600x400/img-3.jpg" class="mw-100" alt="" />
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Section-->
                                <div class="d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
                                    ...
                                    <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                                        <a href="#" class="fs-5 text-gray-800 text-hover-primary fw-bold">Cup &
                                            Green</a>
                            ...
                            <div class="d-flex mb-7">
                                <!--begin::Symbol-->
                                <div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
                                    <img src="admin/assets/media/stock/600x400/img-4.jpg" class="mw-100" alt="" />
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Section-->
                                <div class="d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
                                    <!--begin::Title-->
                                    <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                                        <a href="#" class="fs-5 text-gray-800 text-hover-primary fw-bold">Yellow
                                            Hearts</a>
                                        <span class="text-gray-500 fw-semibold fs-7 my-1">Study highway types</span>
                                        <span class="text-gray-500 fw-semibold fs-7">By:
                            ...
                            <div class="d-flex mb-7">
                                <!--begin::Symbol-->
                                <div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
                                    <img src="admin/assets/media/stock/600x400/img-5.jpg" class="mw-100" alt="" />
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Section-->
                                <div class="d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
                                    <!--begin::Title-->
                                    <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                                        <a href="#" class="fs-5 text-gray-800 text-hover-primary fw-bold">Nike &
                                            Blue</a>
                                        <span class="text-gray-500 fw-semibold fs-7 my-1">Study highway types</span>
                                        <span class="text-gray-500 fw-semibold fs-7">By:
                            ...
                            <div class="d-flex mb-7">
                                <!--begin::Symbol-->
                                <div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
                                    <img src="admin/assets/media/stock/600x400/img-6.jpg" class="mw-100" alt="" />
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Section-->
                                <div class="d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
                                    <!--begin::Title-->
                                    <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                                        <a href="#" class="fs-5 text-gray-800 text-hover-primary fw-bold">Red
                                            Boots</a>
                                        <span class="text-gray-500 fw-semibold fs-7 my-1">Study highway types</span>
                                        <span class="text-gray-500 fw-semibold fs-7">By:
                            ...
                            <div class="d-flex">
                                <!--begin::Symbol-->
                                <div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
                                    <img src="admin/assets/media/stock/600x400/img-7.jpg" class="mw-100" alt="" />
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Section-->
                                <div class="d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
                                    <!--begin::Title-->
                                    <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                                        <a href="#" class="fs-5 text-gray-800 text-hover-primary fw-bold">Desserts
                                            platter</a>
