                            ...
                            <div class="fw-semibold">
                                ...
                                <div class="fs-6 text-gray-700">
                                    ...
                                    <a href="#" class="fw-bold" data-bs-toggle="modal"
                                        data-bs-target="#kt_modal_new_card">Add
                                        Payment Method</a>.
                                </div>
                            </div>
                            <!--end::Content-->
            ...
            <div class="card mb-5 mb-xl-10">
                        ...
                        <ul class="nav nav-stretch nav-line-tabs border-transparent" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <a id="kt_billing_creditcard_tab" class="nav-link fs-5 fw-bold me-5 active"
                                    data-bs-toggle="tab" role="tab" href="#kt_billing_creditcard">Credit / Debit
                                    Card</a>
                            </li>
                            <!--end::Tab item-->
                            <!--begin::Tab item-->
                            <li class="nav-item" role="presentation">
                                <a id="kt_billing_paypal_tab" class="nav-link fs-5 fw-bold" data-bs-toggle="tab"
                                    role="tab" href="#kt_billing_paypal">Paypal</a>
                            </li>
                            <!--end::Tab item-->
                        </ul>
                        <!--end::Tab nav-->
                ...
                <div id="kt_billing_payment_tab_content" class="card-body tab-content">
                                    ...
                                    <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                                        ...
                                        <div class="mb-3 mb-md-0 fw-semibold">
                                            ...
                                            <div class="fs-6 text-gray-700 pe-7">
                                                ...
                                                <a href="#" class="fw-bold me-1">Product Terms</a>adding <br />your
                                                new payment card
                                            </div>
                                        </div>
                                        <!--end::Content-->
                    ...
                    <div id="kt_billing_paypal" class="tab-pane fade" role="tabpanel"
                        ...
                        <!--end::Title-->
                        <!--begin::Description-->
                        <div class="text-gray-600 fs-6 fw-semibold mb-5">
                            ...
                            <div class="card card-dashed h-xl-100 flex-row flex-stack flex-wrap p-6">
                                ...
                                <div class="d-flex flex-column py-2">
                                    ...
                                    <div class="fs-6 fw-semibold text-gray-600">
                                        Ap #285-7193 Ullamcorper Avenue <br />Amesbury
                                        HI 93373 <br />US
                                    </div>
                                </div>
                                <!--end::Details-->
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/account/billing/general.js"></script>
