            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div class="card-body py-10">
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-xl-6 mb-15 mb-xl-0 pe-5">
                            ...
                            <p class="fs-6 fw-semibold text-gray-600 py-4 m-0">
                                ...
                                add humor <br />and explain complex topics
                            </p>
                        ...
                        <div class="col-xl-6">
                            ...
                            <p class="fs-6 fw-semibold text-gray-600 py-4 m-0">
                                ...
                                outline conduct <br />research, and checking facts
                            </p>
                            <div class="d-flex">
                    ...
                    <p class="fs-5 fw-semibold text-gray-600 py-6">
                        ...
                        is a science, and probably warrants its own post, but
                        for now, all I’d advise is experimenting with what works
                        for your audience, especially if it’s not resonating
                        with your audience
                    </p>
                    <!--end::Info-->
                    <!--begin::Notice-->
                    <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed p-6">
                        ...
                        <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                            ...
                            <!--end::Content-->
                            <!--begin::Action-->
                            <a href="#" class="btn btn-primary px-6 align-self-center text-nowrap">Withdraw
                                Money</a>
                            <!--end::Action-->
                        </div>
                        <!--end::Wrapper-->
                    ...
                    <div class="card-toolbar">
                        ...
                        <ul class="nav nav-stretch fs-5 fw-semibold nav-line-tabs border-transparent" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a id="kt_referrals_tab_1" class="nav-link text-active-gray-800 me-4 active"
                                    data-bs-toggle="tab" role="tab" href="#kt_referrals_1">Month</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a id="kt_referrals_tab_2" class="nav-link text-active-gray-800 me-4"
                                    data-bs-toggle="tab" role="tab" href="#kt_referrals_2">2022</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a id="kt_referrals_tab_3" class="nav-link text-active-gray-800" data-bs-toggle="tab"
                                    role="tab" href="#kt_referrals_3">2021</a>
                            </li>
                        </ul>
                        <!--end::Tab nav-->
                    </div>
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/account/referrals/referral-program.js"></script>
