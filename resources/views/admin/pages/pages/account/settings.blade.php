                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    ...
                                    <select name="language" aria-label="Select a Language" data-control="select2"
                                        ...
                                        <option data-kt-flag="/flags/bangladesh.svg" value="bn">
                                            বাংলা - Bangla
                                        </option>
                                        <option data-kt-flag="/flags/guam.svg" value="gu">
                                            ગુજરાતી - Gujarati
                                    ...
                                    <!--begin::Hint-->
                                    <div class="form-text">
                                        Please select a preferred language, including
                            ...
                            <div class="d-flex flex-stack flex-grow-1">
                                ...
                                <div class="fw-semibold">
                                    <div class="fs-6 text-gray-700">
                                        Two-factor authentication adds an extra layer of
                                        security to your account. To log in, in you'll
                                        need to provide a 4 digit amazing code.
                        ...
                        <div class="card-body border-top px-9 py-9">
                            ...
                            <label class="form-check form-check-custom form-check-solid align-items-start">
                                ...
                                <span class="form-check-label d-flex flex-column align-items-start">
                                    ...
                                    <span class="text-muted fs-6">Receive a notification for
                                        every successful
                                        payment.</span>
                                </span>
                                <!--end::Label-->
                            ...
                            <label class="form-check form-check-custom form-check-solid align-items-start">
                                ...
                                <span class="form-check-label d-flex flex-column align-items-start">
                                    ...
                                    <span class="text-muted fs-6">Receive a notification each
                                        time you collect a
                                        fee from sales</span>
                                </span>
                                <!--end::Label-->
                            ...
                            <label class="form-check form-check-custom form-check-solid align-items-start">
                                ...
                                <!--begin::Label-->
                                <span class="form-check-label d-flex flex-column align-items-start">
                                    <span class="fw-bold fs-5 mb-0">Customer Payment
                                        Dispute</span>
                                    <span class="text-muted fs-6">Receive a notification if a
                                        payment is disputed
                                        by a customer and for dispute purposes.</span>
                                </span>
                                <!--end::Label-->
                            </label>
                            <!--end::Option-->
                            ...
                            <label class="form-check form-check-custom form-check-solid align-items-start">
                                ...
                                <span class="form-check-label d-flex flex-column align-items-start">
                                    ...
                                    <span class="text-muted fs-6">Receive a notification if a
                                        payment is stated
                                        as risk by the Finance Department.</span>
                                </span>
                                <!--end::Label-->
                            </label>
                            <!--end::Option-->
                            ...
                            <label class="form-check form-check-custom form-check-solid align-items-start">
                                ...
                                <!--begin::Label-->
                                <span class="form-check-label d-flex flex-column align-items-start">
                                    <span class="fw-bold fs-5 mb-0">Webhook API
                                        Endpoints</span>
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/account/settings/profile-details.js"></script>
    ...
    <script src="admin/assets/js/custom/utilities/modals/two-factor-authentication.js"></script>
