        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                ...
                <div class="card-header cursor-pointer">
                    ...
                    <!--end::Card title-->
                    <!--begin::Action-->
                    <a href="/pages/account/settings" class="btn btn-sm btn-primary align-self-center">Edit Profile</a>
                    <!--end::Action-->
                </div>
                <!--begin::Card header-->
                <!--begin::Card body-->
                        ...
                        <div class="d-flex flex-stack flex-grow-1">
                            ...
                            <div class="fw-semibold">
                                ...
                                <div class="fs-6 text-gray-700">
                                    ...
                                    please
                                    <a class="fw-bold" href="/pages/account/billing">Add Payment Method</a>.
                                </div>
                            </div>
                            <!--end::Content-->
                        </div>
                    ...
                    <div class="card h-md-100" dir="ltr">
                        ...
                        <div class="card-body d-flex flex-column flex-center">
                            ...
                            <div class="text-center mb-1">
                                ...
                                <!--end::Link-->
                                <!--begin::Link-->
                                <a class="btn btn-sm btn-light" href="/apps/invoices/view/invoice-1">Learn more</a>
                                <!--end::Link-->
                            </div>
                            <!--end::Links-->
                        </div>
