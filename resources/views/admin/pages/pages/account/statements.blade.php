            ...
            <div class="row g-xxl-9">
                ...
                <div class="col-xxl-8">
                    ...
                    <div class="card card-xxl-stretch mb-5 mb-xxl-10">
                        ...
                        <div class="card-body pb-0">
                            <span class="fs-5 fw-semibold text-gray-600 pb-5 d-block">Last 30
                                day earnings calculated. Apart
                                from
                            ...
                            <div class="d-flex flex-wrap justify-content-between pb-6">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div class="border border-dashed border-gray-300 w-125px rounded my-3 p-4 me-6">
                                        ...
                                        <span class="fs-6 fw-semibold text-gray-500 d-block lh-1 pt-2">Net
                                            Earnings</span>
                                    </div>
                                    <!--end::Col-->
                                    <!--begin::Col-->
                ...
                <div class="col-xxl-4">
                    ...
                    <div class="card card-xxl-stretch mb-5 mb-xxl-10">
                        ...
                        <!--begin::Body-->
                        <div class="card-body">
                            <span class="fs-5 fw-semibold text-gray-600 pb-6 d-block">Download
                                apart from order of the good
                                awesome
                                invoice topics</span>
                            <!--begin::Left Section-->
                        ...
                        <ul class="nav nav-stretch fs-5 fw-semibold nav-line-tabs border-transparent" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a id="kt_referrals_year_tab" class="nav-link text-active-gray-800 active"
                                    data-bs-toggle="tab" role="tab" href="#kt_referrals_1">This Year</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a id="kt_referrals_2019_tab" class="nav-link text-active-gray-800 me-4"
                                    data-bs-toggle="tab" role="tab" href="#kt_referrals_2">2023</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a id="kt_referrals_2018_tab" class="nav-link text-active-gray-800 me-4"
                                    data-bs-toggle="tab" role="tab" href="#kt_referrals_3">2022</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a id="kt_referrals_2017_tab" class="nav-link text-active-gray-800 ms-8"
                                    data-bs-toggle="tab" role="tab" href="#kt_referrals_4">2021</a>
                            </li>
                        </ul>
                        <!--end::Tab nav-->
                    </div>
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/account/api-keys/api-keys.js"></script>
