            ...
            <div class="d-flex flex-column flex-lg-row">
                ...
                <div class="d-none d-lg-flex flex-column flex-lg-row-auto w-100 w-lg-275px" data-kt-drawer="true"
                    ...
                    <div class="card card-flush mb-0" data-kt-sticky="true" data-kt-sticky-name="inbox-aside-sticky"
                        ...
                        <div class="card-body">
                            <!--begin::Button-->
                            <a href="/apps/inbox/compose" class="btn btn-primary fw-bold w-100 mb-8">New Message</a>
                            <!--end::Button-->
                            <!--begin::Menu-->
                            <div
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="w-150px w-md-175px">
                                            <a href="/apps/inbox/reply" class="d-flex align-items-center text-gray-900">
                                                <!--begin::Avatar-->
                                        ...
                                        <td>
                                            <div class="text-gray-900 gap-1 pt-2">
                                                <!--begin::Heading-->
                                                <a href="/apps/inbox/reply" class="text-gray-900">
                                                    <span class="fw-bold">Digital PPV Customer
                                                        Confirmation</span>
                                                    <span class="fw-bold d-none d-md-inine">-</span>
                                                    <span class="d-none d-md-inine text-muted">Thank
                                                        you for ordering UFC 240 Holloway
                                                        vs Edgar Alternate camera
                                                        angles...</span>
                                                </a>
                                                <!--end::Heading-->
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="text-gray-900 gap-1 pt-2">
                                                <!--begin::Heading-->
                                                <a href="/apps/inbox/reply" class="text-gray-900">
                                                    <span class="fw-bold">Your iBuy.com grocery
                                                        shopping
                                                        confirmation</span>
                                                    <span class="fw-bold d-none d-md-inine">-</span>
                                                    <span class="d-none d-md-inine text-muted">Please
                                                        make sure that you have one of
                                                        the following cards with you when we
                                                        deliver your order...</span>
                                                </a>
                                                <!--end::Heading-->
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="w-150px w-md-175px">
                                            <a href="/apps/inbox/reply" class="d-flex align-items-center text-gray-900">
                                                ...
                                                <div class="symbol symbol-35px me-3">
                                                    <span class="symbol-label"
                                                        style="
                                          background-image: url(admin/assets/media/avatars/300-5.jpg);
                                        "></span>
                                                </div>
                                                <!--end::Avatar-->
                                                <!--begin::Name-->
                                        ...
                                        <td>
                                            <div class="text-gray-900 gap-1 pt-2">
                                                <!--begin::Heading-->
                                                <a href="/apps/inbox/reply" class="text-gray-900">
                                                    <span class="fw-bold">Your Order
                                                        #224820998666029 has been
                                                        Confirmed</span>
                                                    <span class="fw-bold d-none d-md-inine">-</span>
                                                    <span class="d-none d-md-inine text-muted">Your
                                                        Order #224820998666029 has been
                                                        placed on Saturday, 29 June</span>
                                                </a>
                                                <!--end::Heading-->
                                            </div>
                                        </td>
                                        <td class="w-100px text-end fs-7 pe-9">
                                            <span class="fw-semibold text-muted">11:20
                                                PM</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="w-150px w-md-175px">
                                            <a href="/apps/inbox/reply" class="d-flex align-items-center text-gray-900">
                                                ...
                                                <div class="symbol symbol-35px me-3">
                                                    <span class="symbol-label"
                                                        style="
                                          background-image: url(admin/assets/media/avatars/300-25.jpg);
                                        "></span>
                                                </div>
                                                <!--end::Avatar-->
                                                <!--begin::Name-->
                                        ...
                                        <td>
                                            <div class="text-gray-900 gap-1 pt-2">
                                                <!--begin::Heading-->
                                                <a href="/apps/inbox/reply" class="text-gray-900">
                                                    <span class="fw-bold">Payment Notification
                                                        DLOP2329KD</span>
                                                    <span class="fw-bold d-none d-md-inine">-</span>
                                                    <span class="d-none d-md-inine text-muted">Your
                                                        payment of 4500USD to AirCar has
                                                        been authorized and confirmed, thank you
                                                        your account. This...</span>
                                                </a>
                                                <!--end::Heading-->
                                            </div>
                                            <!--begin::Badges-->
                                    ...
                                    <tr>
                                        ...
                                        <td class="w-150px w-md-175px">
                                            <a href="/apps/inbox/reply" class="d-flex align-items-center text-gray-900">
                                                ...
                                                <!--end::Avatar-->
                                                <!--begin::Name-->
                                                <span class="fw-semibold">Mikaela
                                                    Collins</span>
                                                <!--end::Name-->
                                            </a>
                                        </td>
                                        <td>
                                            <div class="text-gray-900 gap-1 pt-2">
                                                <!--begin::Heading-->
                                                <a href="/apps/inbox/reply" class="text-gray-900">
                                                    <span class="fw-bold">Congratulations on
                                                        your iRun Coach
                                                        subscription</span>
                                                    <span class="fw-bold d-none d-md-inine">-</span>
                                                    <span class="d-none d-md-inine text-muted">Congratulations
                                                        on your iRun Coach
                                                        subscription. You made no space for
                                                        excuses and you</span>
                                                </a>
                                                <!--end::Heading-->
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        "></span>
                                                ...
                                                <!--end::Avatar-->
                                                <!--begin::Name-->
                                                <span class="fw-semibold">Francis
                                                    Mitcham</span>
                                                <!--end::Name-->
                                            </a>
                                        </td>
                                        <td>
                                            <div class="text-gray-900 gap-1 pt-2">
                                                <!--begin::Heading-->
                                                <a href="/apps/inbox/reply" class="text-gray-900">
                                                    <span class="fw-bold">Pay bills & win up to
                                                        600$
                                                        Cashback!</span>
                                                    <span class="fw-bold d-none d-md-inine">-</span>
                                                    <span class="d-none d-md-inine text-muted">Congratulations
                                                        on your iRun Coach
                                                        subscription. You made no space for
                                                        excuses and you decided on a healthier
                                                        and happier life...</span>
                                                </a>
                                                <!--end::Heading-->
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="text-gray-900 gap-1 pt-2">
                                                <!--begin::Heading-->
                                                <a href="/apps/inbox/reply" class="text-gray-900">
                                                    <span class="fw-bold">Activate your LIPO
                                                        Account today</span>
                                                    <span class="fw-bold d-none d-md-inine">-</span>
                                                    <span class="d-none d-md-inine text-muted">Thank
                                                        you for creating a LIPO Account.
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="text-gray-900 gap-1 pt-2">
                                                <!--begin::Heading-->
                                                <a href="/apps/inbox/reply" class="text-gray-900">
                                                    <span class="fw-bold">About your request
                                                        for PalmLake</span>
                                                    <span class="fw-bold d-none d-md-inine">-</span>
                                                    <span class="d-none d-md-inine text-muted">What
                                                        you requested can't be arranged
                                                        ahead of time but PalmLake said they'll
                                                        do their best to accommodate you upon
                                                        arrival....</span>
                                                </a>
                                                <!--end::Heading-->
                                            </div>
                                        ...
                                        <td>
                                            <div class="text-gray-900 gap-1 pt-2">
                                                ...
                                                <a href="/apps/inbox/reply" class="text-gray-900">
                                                    ...
                                                    <span class="fw-bold d-none d-md-inine">-</span>
                                                    <span class="d-none d-md-inine text-muted">Discover
                                                        interesting ideas and unique
                                                        perspectives. Read, explore and follow
                                                        your interests. Get personalized
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="text-gray-900 gap-1 pt-2">
                                                <!--begin::Heading-->
                                                <a href="/apps/inbox/reply" class="text-gray-900">
                                                    <span class="fw-bold">Free Video Marketing
                                                        Guide</span>
                                                    <span class="fw-bold d-none d-md-inine">-</span>
                                                    <span class="d-none d-md-inine text-muted">Video
                                                        has rolled into every marketing
                                                        platform or channel, leaving...</span>
                                                </a>
                                                <!--end::Heading-->
                                            </div>
                                            <!--begin::Badges-->
                                    ...
                                    <tr>
                                        ...
                                        <td class="w-100px text-end fs-7 pe-9">
                                            <span class="fw-semibold text-muted">March
                                                17</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="text-gray-900 gap-1 pt-2">
                                                ...
                                                <a href="/apps/inbox/reply" class="text-gray-900">
                                                    ...
                                                    <span class="d-none d-md-inine text-muted">Your
                                                        Order #224820998666029 has been
                                                        placed on Saturday, 07 March</span>
                                                </a>
                                                <!--end::Heading-->
                                            </div>
                                        </td>
                                        ...
                                        <td class="w-150px w-md-175px">
                                            <a href="/apps/inbox/reply" class="d-flex align-items-center text-gray-900">
                                                ...
                                                <div class="symbol symbol-35px me-3">
                                                    <span class="symbol-label"
                                                        style="
                                          background-image: url(admin/assets/media/avatars/300-13.jpg);
                                        "></span>
                                                </div>
                                                <!--end::Avatar-->
                                                <!--begin::Name-->
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/apps/inbox/listing.js"></script>
