                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-7 d-none">
                                    <a href="#" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#kt_modal_customer_search">Select
                                        Customer</a>
                                    <span class="fw-bold text-gray-500 mx-2">or</span>
                                    <a href="apps/customers/list" class="btn btn-light-primary">Add New Customer</a>
                                </div>
                                <!--end::Customer add buttons-->
                                <!--begin::Customer change button-->
                                <div class="mb-10">
                                    <a href="#" class="btn btn-light-primary" data-bs-toggle="modal"
                                        data-bs-target="#kt_modal_customer_search">Change
                                        Customer</a>
                                </div>
                                    ...
                                    <div class="d-flex flex-stack flex-grow-1">
                                        ...
                                        <div class="fw-semibold">
                                            ...
                                            <div class="fs-6 text-gray-700">
                                                Writing headlines for blog posts is much
                                                science and probably cool audience.
                                                <a href="#" class="fw-bold">Learn
                                                    more</a>.
                                            </div>
                                        </div>
                                        <!--end::Content-->
                                                ...
                                                <div class="flex-equal me-5">
                                                    <table class="table table-flush fw-semibold gy-1">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-gray-800">12/2024
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-muted min-w-125px w-125px">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-gray-800">VICBANK
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-muted min-w-125px w-125px">
                                                ...
                                                <div class="flex-equal me-5">
                                                    <table class="table table-flush fw-semibold gy-1">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-gray-800">02/2022
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-muted min-w-125px w-125px">
                                                ...
                                                <div class="flex-equal me-5">
                                                    <table class="table table-flush fw-semibold gy-1">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-gray-800">08/2021
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-muted min-w-125px w-125px">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-gray-800">USABANK
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-muted min-w-125px w-125px">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div
                                    ...
                                    <label class="form-check form-check-custom form-check-solid">
                                        <input class="form-check-input" type="checkbox" checked="checked"
                                            value="1" />
                                        <span class="form-check-label text-gray-600">Bill
                                            immediately if usage treshold reaches
                                            80%.</span>
                                    </label>
                                    <!--end::Checkbox-->
                                </div>
                                ...
                                <div class="d-flex flex-column fv-row rounded-3 p-7 border border-dashed border-gray-300">
                                    ...
                                    <label class="form-check form-check-custom form-check-solid">
                                        ...
                                        <span class="form-check-label text-gray-600">Allow
                                            pro-rated billing when treshold usage
                                            is paid before end of billing cycle.</span>
                                    </label>
                                    <!--end::Checkbox-->
                                </div>
                                <!--end::Option-->
                    ...
                    <div class="card card-flush pt-3 mb-0" data-kt-sticky="true"
                        ...
                        <div class="card-body pt-0 fs-6">
                            ...
                            <div class="mb-7">
                                ...
                                <div class="d-flex align-items-center mb-1">
                                    ...
                                    <a href="apps/customers/view"
                                        class="fw-bold text-gray-800 text-hover-primary me-2">Sean
                                        Bean</a>
                                    <!--end::Name-->
                                    <!--begin::Status-->
                            ...
                            <div class="mb-7">
                                ...
                                <div class="mb-0">
                                    <!--begin::Plan-->
                                    <span class="badge badge-light-info me-2">Basic
                                        Bundle</span>
                                    <!--end::Plan-->
                                    <!--begin::Price-->
                                    <span class="fw-semibold text-gray-600">$149.99 /
                                        Year</span>
                                    <!--end::Price-->
                                </div>
                                <!--end::Details-->
                                ...
                                <div class="py-5">
                                    ...
                                    <div data-kt-search-element="suggestions">
                                        ...
                                        <div class="text-center px-4 pt-10">
                                            <img src="admin/assets/media/illustrations/sketchy-1/4.png" alt=""
                                    ...
                                    <div data-kt-search-element="empty" class="text-center d-none">
                                        ...
                                        <div class="text-center px-4">
                                            <img src="admin/assets/media/illustrations/sketchy-1/9.png" alt="user"
                                                class="mw-100 mh-200px" />
                                        </div>
                                        <!--end::Illustration-->
                                    </div>
                                    ...
                                    <div class="fv-row">
                                        ...
                                        <label class="d-flex align-items-center mb-5">
                                            ...
                                            <span class="form-check form-check-custom form-check-solid me-5">
                                                <input class="form-check-input" type="radio" name="product"
                                                    checked="checked" data-kt-product-name="Basic"
                                                    data-kt-product-price="15.99" data-kt-product-frequency="Month" />
                                            </span>
                                            <!--end::Radio-->
                                            <!--begin::Description-->
                                            <span class="d-flex flex-column me-3">
                                                <span class="fw-bold">Basic</span>
                                                <span class="text-gray-500 fw-semibold fs-6">Basic
                                                    subscription</span>
                                            </span>
                                            <!--end::Description-->
                                            <!--begin::Pricing-->
                                        ...
                                        <label class="d-flex align-items-center mb-5">
                                            ...
                                            <span class="d-flex flex-column me-3">
                                                ...
                                                <span class="text-gray-500 fw-semibold fs-6">Teams
                                                    subscription</span>
                                            </span>
                                            <!--end::Description-->
                                            <!--begin::Pricing-->
                                        ...
                                        <label class="d-flex align-items-center mb-5">
                                            ...
                                            <span class="d-flex flex-column me-3">
                                                ...
                                                <span class="text-gray-500 fw-semibold fs-6">Corporate
                                                    subscription</span>
                                            </span>
                                            <!--end::Description-->
                                            <!--begin::Pricing-->
                                        ...
                                        <label class="d-flex align-items-center mb-5">
                                            ...
                                            <span class="form-check form-check-custom form-check-solid me-5">
                                                <input class="form-check-input" type="radio" name="product"
                                                    ...
                                                    data-kt-product-price="1249.99" data-kt-product-frequency="Year" />
                                            </span>
                                            <!--end::Radio-->
                                            <!--begin::Description-->
                                            <span class="d-flex flex-column me-3">
                                        ...
                                        <label class="d-flex align-items-center mb-5">
                                            ...
                                            <span class="d-flex flex-column me-3">
                                                ...
                                                <span class="text-gray-500 fw-semibold fs-6">Enterprise
                                                    subscription</span>
                                            </span>
                                            <!--end::Description-->
                                            <!--begin::Pricing-->
                                        ...
                                        <label class="d-flex align-items-center mb-5">
                                            ...
                                            <span class="form-check form-check-custom form-check-solid me-5">
                                                <input class="form-check-input" type="radio" name="product"
                                                    ...
                                                    data-kt-product-price="2249.99" data-kt-product-frequency="Year" />
                                            </span>
                                            <!--end::Radio-->
                                            <!--begin::Description-->
                                            <span class="d-flex flex-column me-3">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            ...
                            <form id="kt_modal_new_card_form" class="form" action="#">
                                ...
                                <div class="d-flex flex-stack">
                                    <!--begin::Label-->
                                    <div class="me-5">
                                        <label class="fs-6 fw-semibold form-label">Save Card
                                            for
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/apps/subscriptions/add/advanced.js"></script>
    <script src="admin/assets/js/custom/apps/subscriptions/add/customer-select.js"></script>
    <script src="admin/assets/js/custom/apps/subscriptions/add/products.js"></script>
