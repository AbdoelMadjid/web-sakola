                ...
                <div class="flex-lg-row-fluid me-lg-15 order-2 order-lg-1 mb-10 mb-lg-0">
                    ...
                    <div class="card card-flush pt-3 mb-5 mb-xl-10">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                <a href="/apps/subscriptions/add" class="btn btn-light-primary">Update Product</a>
                            </div>
                            <!--end::Card toolbar-->
                        </div>
                        <!--end::Card header-->
                                        ...
                                        <table class="table fs-6 fw-semibold gs-0 gy-2 gx-2 m-0">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-gray-800 min-w-200px">
                                                    <a href="pages/apps/customers/view"
                                                        class="text-gray-800 text-hover-primary">smith@kpmg.com</a>
                                                </td>
                                            </tr>
                                            <!--end::Row-->
                                            <!--begin::Row-->
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-gray-800">
                                                    Floor 10, 101 Avenue of the Light Square,
                                                    New York, NY, 10050.
                                                </td>
                                            </tr>
                                            <!--end::Row-->
                                    ...
                                    <div class="flex-equal">
                                        ...
                                        <table class="table fs-6 fw-semibold gs-0 gy-2 gx-2 m-0">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-gray-800 min-w-200px">
                                                    <a href="#" class="text-gray-800 text-hover-primary">Basic
                                                        Bundle</a>
                                                </td>
                                            </tr>
                                            <!--end::Row-->
                                        ...
                                        <tbody class="fw-semibold text-gray-800">
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-6 w-200px py-4"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="#" class="menu-link px-3">Pause
                                                                Subscription</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="#" class="menu-link px-3"
                                                                data-kt-subscriptions-view-action="delete">Edit
                                                                Subscription</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="#" class="menu-link text-danger px-3"
                                                                data-kt-subscriptions-view-action="edit">Cancel
                                                                Subscription</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                    </div>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <div class="fw-normal text-gray-500">
                                                        Basic yearly bundle
                                                    </div>
                                                </td>
                                                <td>
                    ...
                    <div class="card card-flush pt-3 mb-5 mb-xl-10">
                        ...
                        <div class="card-header">
                            ...
                            <!--begin::Card toolbar-->
                            <div class="card-toolbar">
                                <a href="#" class="btn btn-light-primary">View All
                                    Events</a>
                            </div>
                            <!--end::Card toolbar-->
                        </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="min-w-400px">
                                                Invoice
                                                <a href="#"
                                                    class="fw-bold text-gray-800 text-hover-primary me-1">1139-4446</a>status
                                                has changed from
                                        ...
                                        <tr>
                                            <td class="min-w-400px">
                                                <a href="#"
                                                    class="fw-bold text-gray-800 text-hover-primary me-1">Emma
                                                    Smith</a>has
                                                made payment to
                                                <a href="#"
                                                    class="fw-bold text-gray-800 text-hover-primary">4797-2184</a>
                                            </td>
                                            <td class="pe-0 text-gray-600 text-end min-w-200px">
                                        ...
                                        <tr>
                                            <td class="min-w-400px">
                                                Invoice
                                                <a href="#"
                                                    class="fw-bold text-gray-800 text-hover-primary me-1">4438-4351</a>status
                                                has changed from
                                        ...
                                        <tr>
                                            <td class="min-w-400px">
                                                <a href="#"
                                                    class="fw-bold text-gray-800 text-hover-primary me-1">Melody
                                                    Macy</a>has
                                                made payment to
                                                <a href="#"
                                                    class="fw-bold text-gray-800 text-hover-primary">6535-4826</a>
                                            </td>
                                            <td class="pe-0 text-gray-600 text-end min-w-200px">
                                                10 Nov 2024, 5:20 pm
                                            </td>
                                        ...
                                        <tr>
                                            <td class="min-w-400px">
                                                <a href="#"
                                                    class="fw-bold text-gray-800 text-hover-primary me-1">Sean
                                                    Bean</a>has
                                                made payment to
                                                <a href="#"
                                                    class="fw-bold text-gray-800 text-hover-primary">4068-7006</a>
                                            </td>
                                            <td class="pe-0 text-gray-600 text-end min-w-200px">
                                                20 Dec 2024, 5:20 pm
                                            </td>
                                ...
                                <ul class="nav nav-stretch fs-5 fw-semibold nav-line-tabs nav-line-tabs-2x border-transparent"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a id="kt_referrals_year_tab" class="nav-link text-active-primary active"
                                            ...
                                            href="#kt_customer_details_invoices_1">This
                                            Year</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
