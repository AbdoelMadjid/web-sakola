                                ...
                                <div class="px-7 py-5" data-kt-subscription-table-filter="form">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <select class="form-select form-select-solid fw-bold" data-kt-select2="true"
                                            ...
                                            <option value="Manual - Cash">
                                                Manual - Cash
                                            </option>
                                            <option value="Manual - Paypal">
                                                Manual - Paypal
                                            </option>
                                        </select>
                                    </div>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                        ...
                        <tbody class="text-gray-600 fw-semibold">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="apps/customers/view" class="text-gray-800 text-hover-primary mb-1">Melody
                                        Macy</a>
                                </td>
                                <td>
                                    <div class="badge badge-light-success">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="apps/customers/view" class="text-gray-800 text-hover-primary mb-1">Max
                                        Smith</a>
                                </td>
                                <td>
                                    <div class="badge badge-light-success">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="apps/customers/view" class="text-gray-800 text-hover-primary mb-1">Sean
                                        Bean</a>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="apps/customers/view" class="text-gray-800 text-hover-primary mb-1">Brian
                                        Cox</a>
                                </td>
                                <td>
                                    <div class="badge badge-light-warning">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="apps/customers/view" class="text-gray-800 text-hover-primary mb-1">Mikaela
                                        Collins</a>
                                </td>
                                <td>
                                    <div class="badge badge-light-success">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="apps/customers/view" class="text-gray-800 text-hover-primary mb-1">Francis
                                        Mitcham</a>
                                </td>
                                <td>
                                    <div class="badge badge-light-success">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="apps/customers/view" class="text-gray-800 text-hover-primary mb-1">Olivia
                                        Wild</a>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="apps/customers/view" class="text-gray-800 text-hover-primary mb-1">Neil
                                        Owen</a>
                                </td>
                                <td>
                                    <div class="badge badge-light-warning">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="apps/customers/view" class="text-gray-800 text-hover-primary mb-1">Dan
                                        Wilson</a>
                                </td>
                                <td>
                                    <div class="badge badge-light-success">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="apps/customers/view" class="text-gray-800 text-hover-primary mb-1">Ana
                                        Crown</a>
                                </td>
                                <td>
                                    <div class="badge badge-light-success">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="apps/customers/view" class="text-gray-800 text-hover-primary mb-1">Robert
                                        Doe</a>
                                </td>
                                <td>
                                    <div class="badge badge-light-danger">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="apps/customers/view" class="text-gray-800 text-hover-primary mb-1">John
                                        Miller</a>
                                </td>
                                <td>
                                    <div class="badge badge-light-success">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="apps/customers/view" class="text-gray-800 text-hover-primary mb-1">Lucy
                                        Kunic</a>
                                </td>
                                <td>
                                    <div class="badge badge-light-success">
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/apps/subscriptions/list/export.js"></script>
    <script src="admin/assets/js/custom/apps/subscriptions/list/list.js"></script>
