                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5"
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            ...
                            <tr>
                                <td>
                                    <a href="/apps/ecommerce/customers/details" class="text-gray-900 text-hover-primary">Max
                                        Smith</a>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td class="text-end">$4614.00</td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="/apps/ecommerce/customers/details"
                                        class="text-gray-900 text-hover-primary">Dan
                                        Wilson</a>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <a href="/apps/ecommerce/customers/details"
                                        class="text-gray-900 text-hover-primary">Ana
                                        Crown</a>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td class="text-end pe-0">40</td>
                                <td class="text-end">$1176.00</td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="/apps/ecommerce/customers/details"
                                        class="text-gray-900 text-hover-primary">Max
                                        Smith</a>
                                </td>
                                <td>
                                    <a href="#" class="text-gray-900 text-hover-primary">max@kt.com</a>
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/apps/ecommerce/reports/customer-orders/customer-orders.js"></script>
