        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="d-flex flex-column gap-7 gap-lg-10">
                <div class="d-flex flex-wrap flex-stack gap-5 gap-lg-10">
                    ...
                    <!--end:::Tabs-->
                    <!--begin::Button-->
                    <a href="/apps/ecommerce/sales/listing"
                        class="btn btn-icon btn-light btn-active-secondary btn-sm ms-auto me-lg-n7">
                        <i class="ki-duotone ki-left fs-2"></i>
                    </a>
                    <!--end::Button-->
                    <!--begin::Button-->
                    <a href="/apps/ecommerce/sales/edit-order" class="btn btn-success btn-sm me-lg-n7">Edit
                        Order</a>
                    <!--end::Button-->
                    <!--begin::Button-->
                    <a href="/apps/ecommerce/sales/add-order" class="btn btn-primary btn-sm">Add New Order</a>
                    <!--end::Button-->
                </div>
                <!--begin::Order summary-->
                                    ...
                                    <tbody class="fw-semibold text-gray-600">
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-bold text-end">
                                                Online
                                                <img src="admin/assets/media/svg/card-logos/visa.svg" class="w-50px ms-2" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="text-muted">
                        ...
                        <div class="d-flex flex-column gap-7 gap-lg-10">
                            <div class="d-flex flex-column flex-xl-row gap-7 gap-lg-10">
                                ...
                                <div class="card card-flush py-4 flex-row-fluid position-relative">
                                    ...
                                    <!--begin::Card body-->
                                    <div class="card-body pt-0">
                                        Unit 1/23 Hastings Road, <br />Melbourne 3000,
                                        <br />Victoria, <br />Australia.
                                    </div>
                                    <!--end::Card body-->
                                </div>
                                <!--end::Payment address-->
                                              ...
                                              "></span>
                                                            ...
                                                            <div class="ms-5">
                                                                ...
                                                                <div class="fs-7 text-muted">
                                                                    Delivery Date: 29/03/2024
                                                                </div>
                                                            </div>
                                                            <!--end::Title-->
                                                        </div>
                                                    </td>
                                                    <td class="text-end">02314002</td>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <a href="/apps/ecommerce/catalog/edit-product"
                                                                ...
                                                                <span class="symbol-label"
                                                                    style="
                                                background-image: url(admin/assets/media//stock/ecommerce/100.png);
                                              "></span>
                                                            </a>
                                                            <!--end::Thumbnail-->
                                                            <!--begin::Title-->
