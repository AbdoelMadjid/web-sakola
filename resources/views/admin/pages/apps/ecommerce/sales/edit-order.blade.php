    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <form id="kt_ecommerce_edit_order_form" class="form d-flex flex-column flex-lg-row"
                data-kt-redirect="/apps/ecommerce/sales/listing">
                <!--begin::Aside column-->
                        ...
                        <div class="card-body pt-0">
                            <div class="d-flex flex-column gap-10">
                                ...
                                <div class="fv-row">
                                    ...
                                    <div class="fw-bold fs-3">#14274</div>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                <!--begin::Input group-->
                                ...
                                <div class="fv-row">
                                    ...
                                    <input id="kt_ecommerce_edit_order_date" name="order_date" placeholder="Select a date"
                                        class="form-control mb-2" value="2021-12-22" />
                                    <!--end::Editor-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">
                                        Set the date of the order to process.
                ...
                <div class="d-flex flex-column flex-lg-row-fluid gap-7 gap-lg-10">
                                ...
                                <div>
                                    ...
                                    <div class="row row-cols-1 row-cols-xl-3 row-cols-md-2 border border-dashed rounded pt-3 pb-1 px-2 mb-5 mh-300px overflow-scroll"
                                        ...
                                        <div class="col my-2" data-kt-ecommerce-edit-order-filter="product"
                                            ...
                                            <div
                                                class="d-flex align-items-center border border-dashed p-3 rounded bg-white">
                                                <!--begin::Thumbnail-->
                                        ...
                                        "></span>
                                                ...
                                                <div class="ms-5">
                                                    ...
                                                    <a href="/apps/ecommerce/catalog/edit-product"
                                                        class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 25</a>
                                                    <!--end::Title-->
                                                    <!--begin::Price-->
                                                    <div class="fw-semibold fs-7">
                                                        Price: $
                                                        <span data-kt-ecommerce-edit-order-filter="price">199.00</span>
                                                    </div>
                                                    <!--end::Price-->
                                                    <!--begin::SKU-->
                                                    <div class="text-muted fs-7">
                                        ...
                                        <div class="col my-2" data-kt-ecommerce-edit-order-filter="product"
                                            data-kt-ecommerce-edit-order-id="product_98">
                                            <div
                                                ...
                                                <a href="/apps/ecommerce/catalog/edit-product" class="symbol symbol-50px">
                                                    <span class="symbol-label"
                                                        style="
                                          background-image: url(admin/assets/media/stock/ecommerce/98.png);
                                        "></span>
                                                </a>
                                                <!--end::Thumbnail-->
                                                <div class="ms-5">
                                                    <!--begin::Title-->
                                                    <a href="/apps/ecommerce/catalog/edit-product"
                                                        class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 98</a>
                                                    <!--end::Title-->
                                                    <!--begin::Price-->
                                                    <div class="fw-semibold fs-7">
                                                        Price: $
                                                        <span data-kt-ecommerce-edit-order-filter="price">49.00</span>
                                                    </div>
                                                    <!--end::Price-->
                                                    <!--begin::SKU-->
                                                    <div class="text-muted fs-7">
                                    ...
                                    <div class="fw-bold fs-4">
                                        Total Cost: $
                                        <span id="kt_ecommerce_edit_order_total_price">248.00</span>
                                    </div>
                                    <!--end::Total price-->
                                </div>
                                <!--end::Input group-->
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">223.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">32.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">293.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                            ...
                                            <td class="text-end pe-5" data-order="2">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">207.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">105.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">160.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">141.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">91.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">168.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">38.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">172.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">233.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">47.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">234.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">10.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">184.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">176.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">84.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">43.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">25.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">211.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">62.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">218.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">143.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">16.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">215.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">153.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">228.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                                        ...
                                        <tr>
                                          ...
                                          "></span>
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">
                                                            Price: $
                                                            <span data-kt-ecommerce-edit-order-filter="price">243.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">
                            ...
                            <div class="d-flex flex-column gap-5 gap-md-7">
                                ...
                                <div class="d-flex flex-column flex-md-row gap-5">
                                    <div class="fv-row flex-row-fluid">
                                        ...
                                        <input class="form-control" name="billing_order_address_1"
                                            placeholder="Address Line 1" value="1/23 Hastings Road" />
                                        <!--end::Input-->
                                    </div>
                                ...
                                <div class="fv-row">
                                    ...
                                    <select class="form-select" data-placeholder="Select an option"
                                        ...
                                        <option></option>
                                        <option value="AF"
                                            data-kt-select2-country="admin/assets/media/flags/afghanistan.svg">
                                            Afghanistan
                                        </option>
                                        <option value="AX"
                                            data-kt-select2-country="admin/assets/media/flags/aland-islands.svg">
                                            Aland Islands
                                        </option>
                                        ...
                                        <option value="AZ"
                                            data-kt-select2-country="admin/assets/media/flags/azerbaijan.svg">
                                            Azerbaijan
                                        </option>
                                        ...
                                        <option value="BD"
                                            data-kt-select2-country="admin/assets/media/flags/bangladesh.svg">
                                            Bangladesh
                                        </option>
                                        ...
                                        <option value="BF"
                                            data-kt-select2-country="admin/assets/media/flags/burkina-faso.svg">
                                            Burkina Faso
                                        </option>
                                        ...
                                        <option value="CV"
                                            data-kt-select2-country="admin/assets/media/flags/cape-verde.svg">
                                            Cape Verde
                                        </option>
                                        <option value="KY"
                                        ...
                                        <option value="CC"
                                            data-kt-select2-country="admin/assets/media/flags/cocos-island.svg">
                                        ...
                                        <option value="CK"
                                            data-kt-select2-country="admin/assets/media/flags/cook-islands.svg">
                                            Cook Islands
                                        </option>
                                        <option value="CR"
                                            data-kt-select2-country="admin/assets/media/flags/costa-rica.svg">
                                            Costa Rica
                                        </option>
                                        <option value="CI"
                                            data-kt-select2-country="admin/assets/media/flags/ivory-coast.svg">
                                            Côte d'Ivoire
                                        </option>
                                        ...
                                        <option value="SV"
                                            data-kt-select2-country="admin/assets/media/flags/el-salvador.svg">
                                            El Salvador
                                        </option>
                                        <option value="GQ"
                                        ...
                                        <option value="GW"
                                            data-kt-select2-country="admin/assets/media/flags/guinea-bissau.svg">
                                            Guinea-Bissau
                                        </option>
                                        ...
                                        <option value="VA"
                                            data-kt-select2-country="admin/assets/media/flags/vatican-city.svg">
                                        ...
                                        <option value="IM"
                                            data-kt-select2-country="admin/assets/media/flags/isle-of-man.svg">
                                            Isle of Man
                                        </option>
                                        ...
                                        <option value="KZ"
                                            data-kt-select2-country="admin/assets/media/flags/kazakhstan.svg">
                                            Kazakhstan
                                        </option>
                                        ...
                                        <option value="KP"
                                            data-kt-select2-country="admin/assets/media/flags/north-korea.svg">
                                        ...
                                        <option value="KG"
                                            data-kt-select2-country="admin/assets/media/flags/kyrgyzstan.svg">
                                            Kyrgyzstan
                                        </option>
                                        ...
                                        <option value="LI"
                                            data-kt-select2-country="admin/assets/media/flags/liechtenstein.svg">
                                            Liechtenstein
                                        </option>
                                        ...
                                        <option value="LU"
                                            data-kt-select2-country="admin/assets/media/flags/luxembourg.svg">
                                            Luxembourg
                                        </option>
                                        ...
                                        <option value="MG"
                                            data-kt-select2-country="admin/assets/media/flags/madagascar.svg">
                                            Madagascar
                                        </option>
                                        ...
                                        <option value="MY"
                                            data-kt-select2-country="admin/assets/media/flags/malaysia.svg">
                                            Malaysia
                                        </option>
                                        <option value="MV"
                                            data-kt-select2-country="admin/assets/media/flags/maldives.svg">
                                            Maldives
                                        </option>
                                        ...
                                        <option value="MQ"
                                            data-kt-select2-country="admin/assets/media/flags/martinique.svg">
                                            Martinique
                                        </option>
                                        <option value="MR"
                                            data-kt-select2-country="admin/assets/media/flags/mauritania.svg">
                                            Mauritania
                                        </option>
                                        <option value="MU"
                                            data-kt-select2-country="admin/assets/media/flags/mauritius.svg">
                                            Mauritius
                                        </option>
                                        ...
                                        <option value="FM"
                                            data-kt-select2-country="admin/assets/media/flags/micronesia.svg">
                                        ...
                                        <option value="MN"
                                            data-kt-select2-country="admin/assets/media/flags/mongolia.svg">
                                            Mongolia
                                        </option>
                                        <option value="ME"
                                            data-kt-select2-country="admin/assets/media/flags/montenegro.svg">
                                            Montenegro
                                        </option>
                                        <option value="MS"
                                            data-kt-select2-country="admin/assets/media/flags/montserrat.svg">
                                            Montserrat
                                        </option>
                                        ...
                                        <option value="MZ"
                                            data-kt-select2-country="admin/assets/media/flags/mozambique.svg">
                                            Mozambique
                                        </option>
                                        ...
                                        <option value="NL"
                                            data-kt-select2-country="admin/assets/media/flags/netherlands.svg">
                                            Netherlands
                                        </option>
                                        <option value="NZ"
                                            data-kt-select2-country="admin/assets/media/flags/new-zealand.svg">
                                            New Zealand
                                        </option>
                                        <option value="NI"
                                            data-kt-select2-country="admin/assets/media/flags/nicaragua.svg">
                                            Nicaragua
                                        </option>
                                        ...
                                        <option value="PK"
                                            data-kt-select2-country="admin/assets/media/flags/pakistan.svg">
                                            Pakistan
                                        </option>
                                        ...
                                        <option value="PS"
                                            data-kt-select2-country="admin/assets/media/flags/palestine.svg">
                                        ...
                                        <option value="PY"
                                            data-kt-select2-country="admin/assets/media/flags/paraguay.svg">
                                            Paraguay
                                        </option>
                                        ...
                                        <option value="PH"
                                            data-kt-select2-country="admin/assets/media/flags/philippines.svg">
                                            Philippines
                                        </option>
                                        ...
                                        <option value="PT"
                                            data-kt-select2-country="admin/assets/media/flags/portugal.svg">
                                            Portugal
                                        </option>
                                        <option value="PR"
                                            data-kt-select2-country="admin/assets/media/flags/puerto-rico.svg">
                                            Puerto Rico
                                        </option>
                                        ...
                                        <option value="BL"
                                            data-kt-select2-country="admin/assets/media/flags/st-barts.svg">
                                            Saint Barthélemy
                                        </option>
                                        <option value="KN"
                                        ...
                                        <option value="LC"
                                            data-kt-select2-country="admin/assets/media/flags/st-lucia.svg">
                                            Saint Lucia
                                        </option>
                                        <option value="MF"
                                            data-kt-select2-country="admin/assets/media/flags/sint-maarten.svg">
                                        ...
                                        <option value="SM"
                                            data-kt-select2-country="admin/assets/media/flags/san-marino.svg">
                                            San Marino
                                        </option>
                                        <option value="ST"
                                        ...
                                        <option value="SA"
                                            data-kt-select2-country="admin/assets/media/flags/saudi-arabia.svg">
                                            Saudi Arabia
                                        </option>
                                        ...
                                        <option value="SC"
                                            data-kt-select2-country="admin/assets/media/flags/seychelles.svg">
                                            Seychelles
                                        </option>
                                        <option value="SL"
                                            data-kt-select2-country="admin/assets/media/flags/sierra-leone.svg">
                                            Sierra Leone
                                        </option>
                                        <option value="SG"
                                            data-kt-select2-country="admin/assets/media/flags/singapore.svg">
                                            Singapore
                                        </option>
                                        <option value="SX"
                                            data-kt-select2-country="admin/assets/media/flags/sint-maarten.svg">
                                        ...
                                        <option value="SK"
                                            data-kt-select2-country="admin/assets/media/flags/slovakia.svg">
                                            Slovakia
                                        </option>
                                        <option value="SI"
                                            data-kt-select2-country="admin/assets/media/flags/slovenia.svg">
                                            Slovenia
                                        </option>
                                        <option value="SB"
                                        ...
                                        <option value="ZA"
                                            data-kt-select2-country="admin/assets/media/flags/south-africa.svg">
                                            South Africa
                                        </option>
                                        <option value="KR"
                                            data-kt-select2-country="admin/assets/media/flags/south-korea.svg">
                                            South Korea
                                        </option>
                                        <option value="SS"
                                            data-kt-select2-country="admin/assets/media/flags/south-sudan.svg">
                                            South Sudan
                                        </option>
                                        ...
                                        <option value="LK"
                                            data-kt-select2-country="admin/assets/media/flags/sri-lanka.svg">
                                            Sri Lanka
                                        </option>
                                        ...
                                        <option value="SR"
                                            data-kt-select2-country="admin/assets/media/flags/suriname.svg">
                                            Suriname
                                        </option>
                                        <option value="SZ"
                                            data-kt-select2-country="admin/assets/media/flags/swaziland.svg">
                                            Swaziland
                                        </option>
                                        ...
                                        <option value="CH"
                                            data-kt-select2-country="admin/assets/media/flags/switzerland.svg">
                                            Switzerland
                                        </option>
                                        ...
                                        <option value="TJ"
                                            data-kt-select2-country="admin/assets/media/flags/tajikistan.svg">
                                            Tajikistan
                                        </option>
                                        <option value="TZ"
                                            data-kt-select2-country="admin/assets/media/flags/tanzania.svg">
                                            Tanzania, United Republic of
                                        </option>
                                        <option value="TH"
                                            data-kt-select2-country="admin/assets/media/flags/thailand.svg">
                                            Thailand
                                        </option>
                                        ...
                                        <option value="US"
                                            data-kt-select2-country="admin/assets/media/flags/united-states.svg">
                                            United States
                                        </option>
                                        ...
                                        <option value="UZ"
                                            data-kt-select2-country="admin/assets/media/flags/uzbekistan.svg">
                                            Uzbekistan
                                        </option>
                                        ...
                                        <option value="VE"
                                            data-kt-select2-country="admin/assets/media/flags/venezuela.svg">
                                        ...
                                        <option value="ZW"
                                            data-kt-select2-country="admin/assets/media/flags/zimbabwe.svg">
                                            Zimbabwe
                                        </option>
                                    </select>
                                    <!--end::Select2-->
                                ...
                                <div class="form-check form-check-custom form-check-solid">
                                    <input class="form-check-input" type="checkbox" value=""
                                        id="same_as_billing" />
                                    <label class="form-check-label" for="same_as_billing">Shipping address is the same
                                        as
                                        billing
                                        address</label>
                                </div>
                                ...
                                <div class="d-flex flex-column gap-5 gap-md-7"
                                    ...
                                    <div class="d-flex flex-column flex-md-row gap-5">
                                        <div class="fv-row flex-row-fluid">
                                            ...
                                            <input class="form-control" name="kt_ecommerce_edit_order_address_1"
                                                placeholder="Address Line 1" value="20 Randy Road" />
                                            <!--end::Input-->
                                        </div>
                                        <div class="flex-row-fluid">
                                            <!--begin::Label-->
                                    ...
                                    <div class="fv-row">
                                        ...
                                        <select class="form-select" data-placeholder="Select an option"
                                            ...
                                            <option value="AL"
                                                data-kt-select2-country="admin/assets/media/flags/albania.svg">
                                                Albania
                                            </option>
                                            <option value="DZ"
                                                data-kt-select2-country="admin/assets/media/flags/algeria.svg">
                                                Algeria
                                            </option>
                                            <option value="AS"
                                                data-kt-select2-country="admin/assets/media/flags/american-samoa.svg">
                                            ...
                                            <option value="AD"
                                                data-kt-select2-country="admin/assets/media/flags/andorra.svg">
                                                Andorra
                                            </option>
                                            <option value="AO"
                                                data-kt-select2-country="admin/assets/media/flags/angola.svg">
                                                Angola
                                            </option>
                                            <option value="AI"
                                                data-kt-select2-country="admin/assets/media/flags/anguilla.svg">
                                                Anguilla
                                            </option>
                                            <option value="AG"
                                                data-kt-select2-country="admin/assets/media/flags/antigua-and-barbuda.svg">
                                            ...
                                            <option value="AR"
                                                data-kt-select2-country="admin/assets/media/flags/argentina.svg">
                                                Argentina
                                            </option>
                                            <option value="AM"
                                                data-kt-select2-country="admin/assets/media/flags/armenia.svg">
                                                Armenia
                                            </option>
                                            <option value="AW"
                                                data-kt-select2-country="admin/assets/media/flags/aruba.svg">
                                                Aruba
                                            </option>
                                            <option value="AU"
                                                data-kt-select2-country="admin/assets/media/flags/australia.svg"
                                                selected="selected">
                                                Australia
                                            </option>
                                            <option value="AT"
                                                data-kt-select2-country="admin/assets/media/flags/austria.svg">
                                                Austria
                                            </option>
                                            <option value="AZ"
                                                data-kt-select2-country="admin/assets/media/flags/azerbaijan.svg">
                                            ...
                                            <option value="BS"
                                                data-kt-select2-country="admin/assets/media/flags/bahamas.svg">
                                                Bahamas
                                            </option>
                                            <option value="BH"
                                                data-kt-select2-country="admin/assets/media/flags/bahrain.svg">
                                                Bahrain
                                            </option>
                                            <option value="BD"
                                                data-kt-select2-country="admin/assets/media/flags/bangladesh.svg">
                                            ...
                                            <option value="BB"
                                                data-kt-select2-country="admin/assets/media/flags/barbados.svg">
                                                Barbados
                                            </option>
                                            <option value="BY"
                                                data-kt-select2-country="admin/assets/media/flags/belarus.svg">
                                                Belarus
                                            </option>
                                            <option value="BE"
                                                data-kt-select2-country="admin/assets/media/flags/belgium.svg">
                                                Belgium
                                            </option>
                                            <option value="BZ"
                                                data-kt-select2-country="admin/assets/media/flags/belize.svg">
                                                Belize
                                            </option>
                                            <option value="BJ"
                                                data-kt-select2-country="admin/assets/media/flags/benin.svg">
                                                Benin
                                            </option>
                                            <option value="BM"
                                                data-kt-select2-country="admin/assets/media/flags/bermuda.svg">
                                                Bermuda
                                            </option>
                                            <option value="BT"
                                                data-kt-select2-country="admin/assets/media/flags/bhutan.svg">
                                                Bhutan
                                            </option>
                                            <option value="BO"
                                                data-kt-select2-country="admin/assets/media/flags/bolivia.svg">
                                                Bolivia, Plurinational State of
                                            </option>
                                            <option value="BQ"
                                                data-kt-select2-country="admin/assets/media/flags/bonaire.svg">
                                                Bonaire, Sint Eustatius and Saba
                                            </option>
                                            <option value="BA"
                                                data-kt-select2-country="admin/assets/media/flags/bosnia-and-herzegovina.svg">
                                            ...
                                            <option value="BW"
                                                data-kt-select2-country="admin/assets/media/flags/botswana.svg">
                                                Botswana
                                            </option>
                                            <option value="BR"
                                                data-kt-select2-country="admin/assets/media/flags/brazil.svg">
                                                Brazil
                                            </option>
                                            <option value="IO"
                                                data-kt-select2-country="admin/assets/media/flags/british-indian-ocean-territory.svg">
                                            ...
                                            <option value="BN"
                                                data-kt-select2-country="admin/assets/media/flags/brunei.svg">
                                                Brunei Darussalam
                                            </option>
                                            <option value="BG"
                                                data-kt-select2-country="admin/assets/media/flags/bulgaria.svg">
                                                Bulgaria
                                            </option>
                                            <option value="BF"
                                                data-kt-select2-country="admin/assets/media/flags/burkina-faso.svg">
                                            ...
                                            <option value="BI"
                                                data-kt-select2-country="admin/assets/media/flags/burundi.svg">
                                                Burundi
                                            </option>
                                            <option value="KH"
                                                data-kt-select2-country="admin/assets/media/flags/cambodia.svg">
                                                Cambodia
                                            </option>
                                            <option value="CM"
                                                data-kt-select2-country="admin/assets/media/flags/cameroon.svg">
                                                Cameroon
                                            </option>
                                            <option value="CA"
                                                data-kt-select2-country="admin/assets/media/flags/canada.svg">
                                                Canada
                                            </option>
                                            <option value="CV"
                                                data-kt-select2-country="admin/assets/media/flags/cape-verde.svg">
                                            ...
                                            <option value="TD"
                                                data-kt-select2-country="admin/assets/media/flags/chad.svg">
                                                Chad
                                            </option>
                                            <option value="CL"
                                                data-kt-select2-country="admin/assets/media/flags/chile.svg">
                                                Chile
                                            </option>
                                            <option value="CN"
                                                data-kt-select2-country="admin/assets/media/flags/china.svg">
                                                China
                                            </option>
                                            <option value="CX"
                                                data-kt-select2-country="admin/assets/media/flags/christmas-island.svg">
                                            ...
                                            <option value="CO"
                                                data-kt-select2-country="admin/assets/media/flags/colombia.svg">
                                                Colombia
                                            </option>
                                            <option value="KM"
                                                data-kt-select2-country="admin/assets/media/flags/comoros.svg">
                                                Comoros
                                            </option>
                                            <option value="CK"
                                                data-kt-select2-country="admin/assets/media/flags/cook-islands.svg">
                                            ...
                                            <option value="HR"
                                                data-kt-select2-country="admin/assets/media/flags/croatia.svg">
                                                Croatia
                                            </option>
                                            <option value="CU"
                                                data-kt-select2-country="admin/assets/media/flags/cuba.svg">
                                                Cuba
                                            </option>
                                            <option value="CW"
                                                data-kt-select2-country="admin/assets/media/flags/curacao.svg">
                                                Curaçao
                                            </option>
                                            <option value="CZ"
                                                data-kt-select2-country="admin/assets/media/flags/czech-republic.svg">
                                            ...
                                            <option value="DK"
                                                data-kt-select2-country="admin/assets/media/flags/denmark.svg">
                                                Denmark
                                            </option>
                                            <option value="DJ"
                                                data-kt-select2-country="admin/assets/media/flags/djibouti.svg">
                                                Djibouti
                                            </option>
                                            <option value="DM"
                                                data-kt-select2-country="admin/assets/media/flags/dominica.svg">
                                                Dominica
                                            </option>
                                            <option value="DO"
                                                data-kt-select2-country="admin/assets/media/flags/dominican-republic.svg">
                                            ...
                                            <option value="EC"
                                                data-kt-select2-country="admin/assets/media/flags/ecuador.svg">
                                                Ecuador
                                            </option>
                                            <option value="EG"
                                                data-kt-select2-country="admin/assets/media/flags/egypt.svg">
                                                Egypt
                                            </option>
                                            <option value="SV"
                                                data-kt-select2-country="admin/assets/media/flags/el-salvador.svg">
                                            ...
                                            <option value="ER"
                                                data-kt-select2-country="admin/assets/media/flags/eritrea.svg">
                                                Eritrea
                                            </option>
                                            <option value="EE"
                                                data-kt-select2-country="admin/assets/media/flags/estonia.svg">
                                                Estonia
                                            </option>
                                            <option value="ET"
                                                data-kt-select2-country="admin/assets/media/flags/ethiopia.svg">
                                                Ethiopia
                                            </option>
                                            <option value="FK"
                                                data-kt-select2-country="admin/assets/media/flags/falkland-islands.svg">
                                            ...
                                            <option value="FJ"
                                                data-kt-select2-country="admin/assets/media/flags/fiji.svg">
                                                Fiji
                                            </option>
                                            <option value="FI"
                                                data-kt-select2-country="admin/assets/media/flags/finland.svg">
                                                Finland
                                            </option>
                                            <option value="FR"
                                                data-kt-select2-country="admin/assets/media/flags/france.svg">
                                                France
                                            </option>
                                            <option value="PF"
                                                data-kt-select2-country="admin/assets/media/flags/french-polynesia.svg">
                                            ...
                                            <option value="GA"
                                                data-kt-select2-country="admin/assets/media/flags/gabon.svg">
                                                Gabon
                                            </option>
                                            <option value="GM"
                                                data-kt-select2-country="admin/assets/media/flags/gambia.svg">
                                                Gambia
                                            </option>
                                            <option value="GE"
                                                data-kt-select2-country="admin/assets/media/flags/georgia.svg">
                                                Georgia
                                            </option>
                                            <option value="DE"
                                                data-kt-select2-country="admin/assets/media/flags/germany.svg">
                                                Germany
                                            </option>
                                            <option value="GH"
                                                data-kt-select2-country="admin/assets/media/flags/ghana.svg">
                                                Ghana
                                            </option>
                                            <option value="GI"
                                                data-kt-select2-country="admin/assets/media/flags/gibraltar.svg">
                                                Gibraltar
                                            </option>
                                            <option value="GR"
                                                data-kt-select2-country="admin/assets/media/flags/greece.svg">
                                                Greece
                                            </option>
                                            <option value="GL"
                                                data-kt-select2-country="admin/assets/media/flags/greenland.svg">
                                                Greenland
                                            </option>
                                            <option value="GD"
                                                data-kt-select2-country="admin/assets/media/flags/grenada.svg">
                                                Grenada
                                            </option>
                                            <option value="GU"
                                                data-kt-select2-country="admin/assets/media/flags/guam.svg">
                                                Guam
                                            </option>
                                            <option value="GT"
                                                data-kt-select2-country="admin/assets/media/flags/guatemala.svg">
                                                Guatemala
                                            </option>
                                            <option value="GG"
                                                data-kt-select2-country="admin/assets/media/flags/guernsey.svg">
                                                Guernsey
                                            </option>
                                            <option value="GN"
                                                data-kt-select2-country="admin/assets/media/flags/guinea.svg">
                                                Guinea
                                            </option>
                                            <option value="GW"
                                                data-kt-select2-country="admin/assets/media/flags/guinea-bissau.svg">
                                            ...
                                            <option value="HT"
                                                data-kt-select2-country="admin/assets/media/flags/haiti.svg">
                                                Haiti
                                            </option>
                                            <option value="VA"
                                                data-kt-select2-country="admin/assets/media/flags/vatican-city.svg">
                                            ...
                                            <option value="HN"
                                                data-kt-select2-country="admin/assets/media/flags/honduras.svg">
                                                Honduras
                                            </option>
                                            <option value="HK"
                                                data-kt-select2-country="admin/assets/media/flags/hong-kong.svg">
                                                Hong Kong
                                            </option>
                                            <option value="HU"
                                                data-kt-select2-country="admin/assets/media/flags/hungary.svg">
                                                Hungary
                                            </option>
                                            <option value="IS"
                                                data-kt-select2-country="admin/assets/media/flags/iceland.svg">
                                                Iceland
                                            </option>
                                            <option value="IN"
                                                data-kt-select2-country="admin/assets/media/flags/india.svg">
                                                India
                                            </option>
                                            <option value="ID"
                                                data-kt-select2-country="admin/assets/media/flags/indonesia.svg">
                                                Indonesia
                                            </option>
                                            <option value="IR"
                                                data-kt-select2-country="admin/assets/media/flags/iran.svg">
                                                Iran, Islamic Republic of
                                            </option>
                                            <option value="IQ"
                                                data-kt-select2-country="admin/assets/media/flags/iraq.svg">
                                                Iraq
                                            </option>
                                            <option value="IE"
                                                data-kt-select2-country="admin/assets/media/flags/ireland.svg">
                                                Ireland
                                            </option>
                                            <option value="IM"
                                                data-kt-select2-country="admin/assets/media/flags/isle-of-man.svg">
                                            ...
                                            <option value="IL"
                                                data-kt-select2-country="admin/assets/media/flags/israel.svg">
                                                Israel
                                            </option>
                                            <option value="IT"
                                                data-kt-select2-country="admin/assets/media/flags/italy.svg">
                                                Italy
                                            </option>
                                            <option value="JM"
                                                data-kt-select2-country="admin/assets/media/flags/jamaica.svg">
                                                Jamaica
                                            </option>
                                            <option value="JP"
                                                data-kt-select2-country="admin/assets/media/flags/japan.svg">
                                                Japan
                                            </option>
                                            <option value="JE"
                                                data-kt-select2-country="admin/assets/media/flags/jersey.svg">
                                                Jersey
                                            </option>
                                            <option value="JO"
                                                data-kt-select2-country="admin/assets/media/flags/jordan.svg">
                                                Jordan
                                            </option>
                                            <option value="KZ"
                                                data-kt-select2-country="admin/assets/media/flags/kazakhstan.svg">
                                            ...
                                            <option value="KE"
                                                data-kt-select2-country="admin/assets/media/flags/kenya.svg">
                                                Kenya
                                            </option>
                                            <option value="KI"
                                                data-kt-select2-country="admin/assets/media/flags/kiribati.svg">
                                                Kiribati
                                            </option>
                                            <option value="KP"
                                                data-kt-select2-country="admin/assets/media/flags/north-korea.svg">
                                            ...
                                            <option value="KW"
                                                data-kt-select2-country="admin/assets/media/flags/kuwait.svg">
                                                Kuwait
                                            </option>
                                            <option value="KG"
                                                data-kt-select2-country="admin/assets/media/flags/kyrgyzstan.svg">
                                            ...
                                            <option value="LA"
                                                data-kt-select2-country="admin/assets/media/flags/laos.svg">
                                                Lao People's Democratic Republic
                                            </option>
                                            <option value="LV"
                                                data-kt-select2-country="admin/assets/media/flags/latvia.svg">
                                                Latvia
                                            </option>
                                            <option value="LB"
                                                data-kt-select2-country="admin/assets/media/flags/lebanon.svg">
                                                Lebanon
                                            </option>
                                            <option value="LS"
                                                data-kt-select2-country="admin/assets/media/flags/lesotho.svg">
                                                Lesotho
                                            </option>
                                            <option value="LR"
                                                data-kt-select2-country="admin/assets/media/flags/liberia.svg">
                                                Liberia
                                            </option>
                                            <option value="LY"
                                                data-kt-select2-country="admin/assets/media/flags/libya.svg">
                                                Libya
                                            </option>
                                            <option value="LI"
                                                data-kt-select2-country="admin/assets/media/flags/liechtenstein.svg">
                                            ...
                                            <option value="LT"
                                                data-kt-select2-country="admin/assets/media/flags/lithuania.svg">
                                                Lithuania
                                            </option>
                                            <option value="LU"
                                                data-kt-select2-country="admin/assets/media/flags/luxembourg.svg">
                                            ...
                                            <option value="MO"
                                                data-kt-select2-country="admin/assets/media/flags/macao.svg">
                                                Macao
                                            </option>
                                            <option value="MG"
                                                data-kt-select2-country="admin/assets/media/flags/madagascar.svg">
                                            ...
                                            <option value="MW"
                                                data-kt-select2-country="admin/assets/media/flags/malawi.svg">
                                                Malawi
                                            </option>
                                            <option value="MY"
                                                data-kt-select2-country="admin/assets/media/flags/malaysia.svg">
                                            ...
                                            <option value="ML"
                                                data-kt-select2-country="admin/assets/media/flags/mali.svg">
                                                Mali
                                            </option>
                                            <option value="MT"
                                                data-kt-select2-country="admin/assets/media/flags/malta.svg">
                                                Malta
                                            </option>
                                            <option value="MH"
                                                data-kt-select2-country="admin/assets/media/flags/marshall-island.svg">
                                            ...
                                            <option value="MX"
                                                data-kt-select2-country="admin/assets/media/flags/mexico.svg">
                                                Mexico
                                            </option>
                                            <option value="FM"
                                                data-kt-select2-country="admin/assets/media/flags/micronesia.svg">
                                            ...
                                            <option value="MD"
                                                data-kt-select2-country="admin/assets/media/flags/moldova.svg">
                                                Moldova, Republic of
                                            </option>
                                            <option value="MC"
                                                data-kt-select2-country="admin/assets/media/flags/monaco.svg">
                                                Monaco
                                            </option>
                                            <option value="MN"
                                                data-kt-select2-country="admin/assets/media/flags/mongolia.svg">
                                            ...
                                            <option value="MA"
                                                data-kt-select2-country="admin/assets/media/flags/morocco.svg">
                                                Morocco
                                            </option>
                                            <option value="MZ"
                                                data-kt-select2-country="admin/assets/media/flags/mozambique.svg">
                                            ...
                                            <option value="MM"
                                                data-kt-select2-country="admin/assets/media/flags/myanmar.svg">
                                                Myanmar
                                            </option>
                                            <option value="NA"
                                                data-kt-select2-country="admin/assets/media/flags/namibia.svg">
                                                Namibia
                                            </option>
                                            <option value="NR"
                                                data-kt-select2-country="admin/assets/media/flags/nauru.svg">
                                                Nauru
                                            </option>
                                            <option value="NP"
                                                data-kt-select2-country="admin/assets/media/flags/nepal.svg">
                                                Nepal
                                            </option>
                                            <option value="NL"
                                                data-kt-select2-country="admin/assets/media/flags/netherlands.svg">
                                            ...
                                            <option value="NE"
                                                data-kt-select2-country="admin/assets/media/flags/niger.svg">
                                                Niger
                                            </option>
                                            <option value="NG"
                                                data-kt-select2-country="admin/assets/media/flags/nigeria.svg">
                                                Nigeria
                                            </option>
                                            <option value="NU"
                                                data-kt-select2-country="admin/assets/media/flags/niue.svg">
                                                Niue
                                            </option>
                                            <option value="NF"
                                                data-kt-select2-country="admin/assets/media/flags/norfolk-island.svg">
                                            ...
                                            <option value="NO"
                                                data-kt-select2-country="admin/assets/media/flags/norway.svg">
                                                Norway
                                            </option>
                                            <option value="OM"
                                                data-kt-select2-country="admin/assets/media/flags/oman.svg">
                                                Oman
                                            </option>
                                            <option value="PK"
                                                data-kt-select2-country="admin/assets/media/flags/pakistan.svg">
                                            ...
                                            <option value="PW"
                                                data-kt-select2-country="admin/assets/media/flags/palau.svg">
                                                Palau
                                            </option>
                                            <option value="PS"
                                                data-kt-select2-country="admin/assets/media/flags/palestine.svg">
                                            ...
                                            <option value="PA"
                                                data-kt-select2-country="admin/assets/media/flags/panama.svg">
                                                Panama
                                            </option>
                                            <option value="PG"
                                                data-kt-select2-country="admin/assets/media/flags/papua-new-guinea.svg">
                                            ...
                                            <option value="PE"
                                                data-kt-select2-country="admin/assets/media/flags/peru.svg">
                                                Peru
                                            </option>
                                            <option value="PH"
                                                data-kt-select2-country="admin/assets/media/flags/philippines.svg">
                                            ...
                                            <option value="PL"
                                                data-kt-select2-country="admin/assets/media/flags/poland.svg">
                                                Poland
                                            </option>
                                            <option value="PT"
                                                data-kt-select2-country="admin/assets/media/flags/portugal.svg">
                                            ...
                                            <option value="QA"
                                                data-kt-select2-country="admin/assets/media/flags/qatar.svg">
                                                Qatar
                                            </option>
                                            <option value="RO"
                                                data-kt-select2-country="admin/assets/media/flags/romania.svg">
                                                Romania
                                            </option>
                                            <option value="RU"
                                                data-kt-select2-country="admin/assets/media/flags/russia.svg">
                                                Russian Federation
                                            </option>
                                            <option value="RW"
                                                data-kt-select2-country="admin/assets/media/flags/rwanda.svg">
                                                Rwanda
                                            </option>
                                            <option value="BL"
                                                data-kt-select2-country="admin/assets/media/flags/st-barts.svg">
                                            ...
                                            <option value="WS"
                                                data-kt-select2-country="admin/assets/media/flags/samoa.svg">
                                                Samoa
                                            </option>
                                            <option value="SM"
                                                data-kt-select2-country="admin/assets/media/flags/san-marino.svg">
                                            ...
                                            <option value="SN"
                                                data-kt-select2-country="admin/assets/media/flags/senegal.svg">
                                                Senegal
                                            </option>
                                            <option value="RS"
                                                data-kt-select2-country="admin/assets/media/flags/serbia.svg">
                                                Serbia
                                            </option>
                                            <option value="SC"
                                                data-kt-select2-country="admin/assets/media/flags/seychelles.svg">
                                            ...
                                            <option value="SO"
                                                data-kt-select2-country="admin/assets/media/flags/somalia.svg">
                                                Somalia
                                            </option>
                                            <option value="ZA"
                                                data-kt-select2-country="admin/assets/media/flags/south-africa.svg">
                                            ...
                                            <option value="ES"
                                                data-kt-select2-country="admin/assets/media/flags/spain.svg">
                                                Spain
                                            </option>
                                            <option value="LK"
                                                data-kt-select2-country="admin/assets/media/flags/sri-lanka.svg">
                                            ...
                                            <option value="SD"
                                                data-kt-select2-country="admin/assets/media/flags/sudan.svg">
                                                Sudan
                                            </option>
                                            <option value="SR"
                                                data-kt-select2-country="admin/assets/media/flags/suriname.svg">
                                            ...
                                            <option value="SE"
                                                data-kt-select2-country="admin/assets/media/flags/sweden.svg">
                                                Sweden
                                            </option>
                                            <option value="CH"
                                                data-kt-select2-country="admin/assets/media/flags/switzerland.svg">
                                            ...
                                            <option value="SY"
                                                data-kt-select2-country="admin/assets/media/flags/syria.svg">
                                                Syrian Arab Republic
                                            </option>
                                            <option value="TW"
                                                data-kt-select2-country="admin/assets/media/flags/taiwan.svg">
                                                Taiwan, Province of China
                                            </option>
                                            <option value="TJ"
                                                data-kt-select2-country="admin/assets/media/flags/tajikistan.svg">
                                            ...
                                            <option value="TG"
                                                data-kt-select2-country="admin/assets/media/flags/togo.svg">
                                                Togo
                                            </option>
                                            <option value="TK"
                                                data-kt-select2-country="admin/assets/media/flags/tokelau.svg">
                                                Tokelau
                                            </option>
                                            <option value="TO"
                                                data-kt-select2-country="admin/assets/media/flags/tonga.svg">
                                                Tonga
                                            </option>
                                            <option value="TT"
                                                data-kt-select2-country="admin/assets/media/flags/trinidad-and-tobago.svg">
                                            ...
                                            <option value="TN"
                                                data-kt-select2-country="admin/assets/media/flags/tunisia.svg">
                                                Tunisia
                                            </option>
                                            <option value="TR"
                                                data-kt-select2-country="admin/assets/media/flags/turkey.svg">
                                                Turkey
                                            </option>
                                            <option value="TM"
                                                data-kt-select2-country="admin/assets/media/flags/turkmenistan.svg">
                                            ...
                                            <option value="TV"
                                                data-kt-select2-country="admin/assets/media/flags/tuvalu.svg">
                                                Tuvalu
                                            </option>
                                            <option value="UG"
                                                data-kt-select2-country="admin/assets/media/flags/uganda.svg">
                                                Uganda
                                            </option>
                                            <option value="UA"
                                                data-kt-select2-country="admin/assets/media/flags/ukraine.svg">
                                                Ukraine
                                            </option>
                                            <option value="AE"
                                                data-kt-select2-country="admin/assets/media/flags/united-arab-emirates.svg">
                                            ...
                                            <option value="UY"
                                                data-kt-select2-country="admin/assets/media/flags/uruguay.svg">
                                                Uruguay
                                            </option>
                                            <option value="UZ"
                                                data-kt-select2-country="admin/assets/media/flags/uzbekistan.svg">
                                            ...
                                            <option value="VU"
                                                data-kt-select2-country="admin/assets/media/flags/vanuatu.svg">
                                                Vanuatu
                                            </option>
                                            <option value="VE"
                                                data-kt-select2-country="admin/assets/media/flags/venezuela.svg">
                                            ...
                                            <option value="VN"
                                                data-kt-select2-country="admin/assets/media/flags/vietnam.svg">
                                                Vietnam
                                            </option>
                                            <option value="VI"
                                                data-kt-select2-country="admin/assets/media/flags/virgin-islands.svg">
                                            ...
                                            <option value="YE"
                                                data-kt-select2-country="admin/assets/media/flags/yemen.svg">
                                                Yemen
                                            </option>
                                            <option value="ZM"
                                                data-kt-select2-country="admin/assets/media/flags/zambia.svg">
                                                Zambia
                                            </option>
                                            <option value="ZW"
                                                data-kt-select2-country="admin/assets/media/flags/zimbabwe.svg">
                    ...
                    <div class="d-flex justify-content-end">
                        <!--begin::Button-->
                        <a href="/apps/ecommerce/catalog/products" id="kt_ecommerce_edit_order_cancel"
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/apps/ecommerce/sales/save-order.js"></script>
