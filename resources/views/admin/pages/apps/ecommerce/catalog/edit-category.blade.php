    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row"
                data-kt-redirect="/apps/ecommerce/catalog/categories">
                <!--begin::Aside column-->
                        ...
                        <div class="card-body text-center pt-0">
                            ...
                            <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3"
                                ...
                                <div class="image-input-wrapper w-150px h-150px"
                                    style="
                                background-image: url(admin/assets/media//stock/ecommerce/123.png);
                              ">
                                </div>
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="text-muted fs-7">
                                ...
                                how the category products are displayed.
                            </div>
                            <!--end::Description-->
                        </div>
                        <!--end::Card body-->
                                    ...
                                    <div class="form-check form-check-custom form-check-solid">
                                        ...
                                        <label class="form-check-label" for="kt_ecommerce_add_category_automation_0">
                                            ...
                                            <div class="text-gray-600">
                                                ...
                                                manually selecting this category during
                                ...
                                <div class="d-flex fv-row">
                                    ...
                                    <div class="form-check form-check-custom form-check-solid">
                                        ...
                                        <label class="form-check-label" for="kt_ecommerce_add_category_automation_1">
                                            ...
                                            <div class="text-gray-600">
                                                Products matched with the following
                                                conditions will be automatically assigned to
                                                this category.
                                            </div>
                                        </label>
                                        <!--end::Label-->
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/apps/ecommerce/catalog/save-category.js"></script>
