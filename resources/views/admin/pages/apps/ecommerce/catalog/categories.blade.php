            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Add customer-->
                        <a href="/apps/ecommerce/catalog/add-category" class="btn btn-primary">Add Category</a>
                        <!--end::Add customer-->
                    </div>
                    <!--end::Card toolbar-->
                </div>
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <!--begin::Thumbnail-->
                                        <a href="/apps/ecommerce/catalog/edit-category" class="symbol symbol-50px">
                                            <span class="symbol-label"
                                                style="
                                      background-image: url(admin/assets/media/stock/ecommerce/68.png);
                                    "></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="/apps/ecommerce/catalog/edit-category"
                                                class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1"
                                                data-kt-ecommerce-category-filter="category_name">Computers</a>
                                            <!--end::Title-->
                                            <!--begin::Description-->
                                            <div class="text-muted fs-7 fw-bold">
                                                Our computers and tablets include all the
                                                big brands.
                                            </div>
                                            <!--end::Description-->
                                        </div>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="/apps/ecommerce/catalog/add-category" class="menu-link px-3">Edit</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <a href="/apps/ecommerce/catalog/edit-category" class="symbol symbol-50px">
                                            <span class="symbol-label"
                                                style="
                                      background-image: url(admin/assets/media/stock/ecommerce/71.png);
                                    "></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                            ...
                                            <!--begin::Description-->
                                            <div class="text-muted fs-7 fw-bold">
                                                Our range of watches are perfect whether
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <a href="/apps/ecommerce/catalog/edit-category" class="symbol symbol-50px">
                                            <span class="symbol-label"
                                                style="
                                      background-image: url(admin/assets/media/stock/ecommerce/58.png);
                                    "></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <a href="/apps/ecommerce/catalog/edit-category" class="symbol symbol-50px">
                                            <span class="symbol-label"
                                                style="
                                      background-image: url(admin/assets/media/stock/ecommerce/52.png);
                                    "></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                            ...
                                            <!--begin::Description-->
                                            <div class="text-muted fs-7 fw-bold">
                                                Whatever your activity needs are, we’ve got
                                                you covered.
                                            </div>
                                            <!--end::Description-->
                                        </div>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <a href="/apps/ecommerce/catalog/edit-category" class="symbol symbol-50px">
                                            <span class="symbol-label"
                                                style="
                                      background-image: url(admin/assets/media/stock/ecommerce/76.png);
                                    "></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <a href="/apps/ecommerce/catalog/edit-category" class="symbol symbol-50px">
                                            <span class="symbol-label"
                                                style="
                                      background-image: url(admin/assets/media/stock/ecommerce/207.png);
                                    "></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                            ...
                                            <!--begin::Description-->
                                            <div class="text-muted fs-7 fw-bold">
                                                Any occasion, any time, we have everything
                                                you'll ever need.
                                            </div>
                                            <!--end::Description-->
                                        </div>
                                ...
                                <td>
                                    ...
                                    "></span>
                                        ...
                                        <div class="ms-5">
                                            ...
                                            <!--begin::Description-->
                                            <div class="text-muted fs-7 fw-bold">
                                                Spice up your home decor with our wide
                                                selection.
                                            </div>
                                            <!--end::Description-->
                                        </div>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <a href="/apps/ecommerce/catalog/edit-category" class="symbol symbol-50px">
                                            <span class="symbol-label"
                                                style="
                                      background-image: url(admin/assets/media/stock/ecommerce/193.png);
                                    "></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <a href="/apps/ecommerce/catalog/edit-category" class="symbol symbol-50px">
                                            <span class="symbol-label"
                                                style="
                                      background-image: url(admin/assets/media/stock/ecommerce/169.png);
                                    "></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                            ...
                                            <!--begin::Description-->
                                            <div class="text-muted fs-7 fw-bold">
                                                Great fashion, great selections, great
                                                prices
                                            </div>
                                            <!--end::Description-->
                                        </div>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <a href="/apps/ecommerce/catalog/edit-category" class="symbol symbol-50px">
                                            <span class="symbol-label"
                                                style="
                                      background-image: url(admin/assets/media/stock/ecommerce/177.png);
                                    "></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <a href="/apps/ecommerce/catalog/edit-category" class="symbol symbol-50px">
                                            <span class="symbol-label"
                                                style="
                                      background-image: url(admin/assets/media/stock/ecommerce/151.png);
                                    "></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                            ...
                                            <!--begin::Description-->
                                            <div class="text-muted fs-7 fw-bold">
                                                In season summer footwear with a huge range
                                                of options
                                            </div>
                                            <!--end::Description-->
                                        </div>
