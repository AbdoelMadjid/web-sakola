                ...
                <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                        ...
                        <div class="card-body text-center pt-0">
                            ...
                            <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3"
                                ...
                                <div class="image-input-wrapper w-150px h-150px"
                                    style="background-image: url(admin/assets/media//stock/ecommerce/78.png);">
                                </div>
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <!--end::Input group-->
                            <!--begin::Button-->
                            <a href="/apps/ecommerce/catalog/add-category" class="btn btn-light-primary btn-sm mb-10">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-muted fs-7">
                                                ...
                                                a comma <code>,</code>between each keyword.
                                            </div>
                                            <!--end::Description-->
                                        </div>
                                        <!--end::Input group-->
                                        ...
                                        <table class="table table-row-dashed fs-6 gy-5 my-0"
                                            ...
                                            <thead>
                                                <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                                    ...
                                                    <th class="min-w-100px text-end fs-7">
                                                        Date
                                                    </th>
                                                </tr>
                                            </thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="apps/inbox/reply"
                                                            ...
                                                            <div class="symbol symbol-circle symbol-25px me-3">
                                                                <span class="symbol-label"
                                                                    style="background-image: url(admin/assets/media/avatars/300-9.jpg);"></span>
                                                            </div>
                                                            <!--end::Avatar-->
                                                            <!--begin::Name-->
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="apps/inbox/reply"
                                                            ...
                                                            <div class="symbol symbol-circle symbol-25px me-3">
                                                                <span class="symbol-label"
                                                                    style="background-image: url(admin/assets/media/avatars/300-13.jpg);"></span>
                                                            </div>
                                                            <!--end::Avatar-->
                                                            <!--begin::Name-->
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/apps/ecommerce/catalog/save-product.js"></script>
