                                    ...
                                    <table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_payment">
                                        ...
                                        <tbody class="fs-6 fw-semibold text-gray-600">
                                            <tr>
                                                <td>
                                                    <a href="/apps/ecommerce/sales/details"
                                                        class="text-gray-600 text-hover-primary mb-1">#15392</a>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="/apps/ecommerce/sales/details"
                                                        class="text-gray-600 text-hover-primary mb-1">#14643</a>
                                                </td>
                                                <td>
                                                    <span class="badge badge-light-success">Successful</span>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="/apps/ecommerce/sales/details"
                                                        class="text-gray-600 text-hover-primary mb-1">#14353</a>
                                                </td>
                                                <td>
                                                    <span class="badge badge-light-success">Successful</span>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="/apps/ecommerce/sales/details"
                                                        class="text-gray-600 text-hover-primary mb-1">#15386</a>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="/apps/ecommerce/sales/details"
                                                        class="text-gray-600 text-hover-primary mb-1">#15849</a>
                                                </td>
                                                <td>
                                                    <span class="badge badge-light-success">Successful</span>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="/apps/ecommerce/sales/details"
                                                        class="text-gray-600 text-hover-primary mb-1">#14538</a>
                                                </td>
                                                <td>
                                                    <span class="badge badge-light-success">Successful</span>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="/apps/ecommerce/sales/details"
                                                        class="text-gray-600 text-hover-primary mb-1">#15054</a>
                                                </td>
                                                <td>
                                                    <span class="badge badge-light-success">Successful</span>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="/apps/ecommerce/sales/details"
                                                        class="text-gray-600 text-hover-primary mb-1">#14653</a>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="/apps/ecommerce/sales/details"
                                                        class="text-gray-600 text-hover-primary mb-1">#14532</a>
                                                </td>
                                                <td>
                                                    <span class="badge badge-light-warning">Pending</span>
                                                </td>
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold w-200px py-3"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="#" class="menu-link px-3"
                                                                data-kt-payment-mehtod-action="set_as_default">Set as
                                                                default address</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                    </div>
                                        ...
                                        <div class="py-0" data-kt-customer-payment-method="row">
                                            ...
                                            <div class="py-3 d-flex flex-stack flex-wrap">
                                                ...
                                                <div class="accordion-header d-flex align-items-center"
                                                    ...
                                                    <!--end::Arrow-->
                                                    <!--begin::Logo-->
                                                    <img src="admin/assets/media/svg/card-logos/mastercard.svg"
                                    ...
                                    <div class="d-flex flex-stack flex-grow-1">
                                        ...
                                        <div class="fw-semibold">
                                            <div class="fs-6 text-gray-700">
                                                Please note that a valid phone number may be
                                                required for order or shipping rescheduling.
                                            </div>
                                        </div>
                                        <!--end::Content-->
                                    </div>
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/apps/ecommerce/customers/details/transaction-history.js"></script>
    <script src="admin/assets/js/custom/apps/ecommerce/customers/details/add-auth-app.js"></script>
    <script src="admin/assets/js/custom/apps/ecommerce/customers/details/add-address.js"></script>
    <script src="admin/assets/js/custom/apps/ecommerce/customers/details/add-one-time-password.js"></script>
    <script src="admin/assets/js/custom/apps/ecommerce/customers/details/update-password.js"></script>
    <script src="admin/assets/js/custom/apps/ecommerce/customers/details/update-phone.js"></script>
    <script src="admin/assets/js/custom/apps/ecommerce/customers/details/update-address.js"></script>
    <script src="admin/assets/js/custom/apps/ecommerce/customers/details/update-profile.js"></script>
