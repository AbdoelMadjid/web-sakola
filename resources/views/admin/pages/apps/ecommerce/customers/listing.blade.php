                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <form class="form" action="#" id="kt_modal_add_customer_form"
                            data-kt-redirect="apps/customers/list">
                            <!--begin::Modal header-->
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/apps/ecommerce/customers/listing/listing.js"></script>
    <script src="admin/assets/js/custom/apps/ecommerce/customers/listing/add.js"></script>
    <script src="admin/assets/js/custom/apps/ecommerce/customers/listing/export.js"></script>
