        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="d-flex flex-wrap flex-stack mb-6">
                ...
                <h3 class="fw-bold my-2">
                    My Contacts
                    <span class="fs-6 fw-semibold ms-1">(59)</span>
                </h3>
                <!--end::Title-->
                <!--begin::Controls-->
                ...
                <div class="col-md-6 col-xxl-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body d-flex flex-center flex-column p-9">
                            ...
                            <!--end::Wrapper-->
                            <!--begin::Name-->
                            <a href="#" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">Mikaela
                                Collins</a>
                            <!--end::Name-->
                            <!--begin::Position-->
                            <div class="fw-semibold text-gray-500 mb-6">
                ...
                <div class="col-md-6 col-xxl-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body d-flex flex-center flex-column p-9">
                            ...
                            <!--end::Wrapper-->
                            <!--begin::Name-->
                            <a href="#" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">Francis
                                Mitcham</a>
                            <!--end::Name-->
                            <!--begin::Position-->
                            <div class="fw-semibold text-gray-500 mb-6">
