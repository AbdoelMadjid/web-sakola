                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="d-flex flex-column text-gray-600">
                                <div class="d-flex align-items-center py-2">
                                    <span class="bullet bg-primary me-3"></span>Some
                                    Admin Controls
                                </div>
                                <div class="d-flex align-items-center py-2">
                                    <span class="bullet bg-primary me-3"></span>View
                                    Financial Summaries only
                                </div>
                                <div class="d-flex align-items-center py-2">
                                    <span class="bullet bg-primary me-3"></span>View
                                    and Edit API Controls
                                </div>
                                <div class="d-flex align-items-center py-2">
                                    <span class="bullet bg-primary me-3"></span>View
                                    Payouts only
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/apps/user-management/roles/view/view.js"></script>
    <script src="admin/assets/js/custom/apps/user-management/roles/view/update-role.js"></script>
