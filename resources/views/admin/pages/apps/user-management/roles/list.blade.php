                ...
                <div class="col-md-4">
                    ...
                    <div class="card card-flush h-md-100">
                        ...
                        <div class="card-body pt-1">
                            ...
                            <div class="d-flex flex-column text-gray-600">
                                <div class="d-flex align-items-center py-2">
                                    <span class="bullet bg-primary me-3"></span>All
                                    Admin Controls
                                </div>
                                <div class="d-flex align-items-center py-2">
                                    <span class="bullet bg-primary me-3"></span>View
                                    and Edit Financial Summaries
                                </div>
                                <div class="d-flex align-items-center py-2">
                        ...
                        <div class="card-footer flex-wrap pt-0">
                            <a href="/apps/user-management/roles/view"
                ...
                <div class="col-md-4">
                    ...
                    <div class="card card-flush h-md-100">
                        ...
                        <div class="card-body pt-1">
                            ...
                            <div class="d-flex flex-column text-gray-600">
                                <div class="d-flex align-items-center py-2">
                                    <span class="bullet bg-primary me-3"></span>No
                                    Admin Controls
                                </div>
                                <div class="d-flex align-items-center py-2">
                                    <span class="bullet bg-primary me-3"></span>View
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/apps/user-management/roles/list/update-role.js"></script>
