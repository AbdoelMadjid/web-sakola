                                        ...
                                        <div id="kt_schedule_day_0" class="tab-pane fade show">
                                            ...
                                            <div class="d-flex flex-stack position-relative mt-6">
                                                ...
                                                <div class="fw-semibold ms-5">
                                                    ...
                                                    <!--begin::Title-->
                                                    <a href="#"
                                                        class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Sales
                                                        Pitch
                                                        Proposal</a>
                                                    <!--end::Title-->
                                                    <!--begin::User-->
                                        ...
                                        <div id="kt_schedule_day_2" class="tab-pane fade show">
                                            ...
                                            <div class="d-flex flex-stack position-relative mt-6">
                                                ...
                                                <div class="fw-semibold ms-5">
                                                    ...
                                                    <!--begin::Title-->
                                                    <a href="#"
                                                        class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Team
                                                        Backlog
                                                        Grooming Session</a>
                                                    <!--end::Title-->
                                                    <!--begin::User-->
                                        ...
                                        <div id="kt_schedule_day_4" class="tab-pane fade show">
                                            ...
                                            <div class="d-flex flex-stack position-relative mt-6">
                                                ...
                                                <div class="fw-semibold ms-5">
                                                    ...
                                                    <!--begin::Title-->
                                                    <a href="#"
                                                        class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Weekly
                                                        Team
                                                        Stand-Up</a>
                                                    <!--end::Title-->
                                                    <!--begin::User-->
                            ...
                            <div class="card card-flush mb-6 mb-xl-9">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center position-relative mb-7">
                                        ...
                                        <div class="fw-semibold ms-5">
                                            <a href="#"
                                                class="fs-5 fw-bold text-gray-900 text-hover-primary">Schedule a meeting
                                                with FireBear CTO
                                                John</a>
                                            <!--begin::Info-->
                                            <div class="fs-7 text-muted">
                                    ...
                                    <div class="d-flex align-items-center position-relative mb-7">
                                        ...
                                        <!--begin::Details-->
                                        <div class="fw-semibold ms-5">
                                            <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary">9
                                                Degree Project
                                                Estimation</a>
                                            <!--begin::Info-->
                                            <div class="fs-7 text-muted">
                                    ...
                                    <div class="d-flex align-items-center position-relative mb-7">
                                        ...
                                        <div class="fw-semibold ms-5">
                                            <a href="#"
                                                class="fs-5 fw-bold text-gray-900 text-hover-primary">Dashboard UI & UX for
                                                Leafr CRM</a>
                                            <!--begin::Info-->
                                            <div class="fs-7 text-muted">
                                    ...
                                    <div class="d-flex align-items-center position-relative">
                                        ...
                                        <!--begin::Details-->
                                        <div class="fw-semibold ms-5">
                                            <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary">Mivy
                                                App R&D, Meeting
                                                with clients</a>
                                            <!--begin::Info-->
                                            <div class="fs-7 text-muted">
                            ...
                            <div class="card pt-4 mb-6 mb-xl-9">
                                ...
                                <div class="card-header border-0">
                                    ...
                                    <div class="card-title flex-column">
                                        ...
                                        <div class="fs-6 fw-semibold text-muted">
                                            Choose what messages you’d like to receive for
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="form-check form-check-custom form-check-solid">
                                                ...
                                                <label class="form-check-label"
                                                    ...
                                                    <div class="text-gray-600">
                                                        Receive a notification for every
                                                        successful payment.
                                                    </div>
                                                </label>
                                                <!--end::Label-->
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="form-check form-check-custom form-check-solid">
                                                ...
                                                <label class="form-check-label"
                                                    ...
                                                    <div class="text-gray-600">
                                                        Receive a notification each time you
                                                        collect a fee from an account.
                                                    </div>
                                                </label>
                                                <!--end::Label-->
                                            </div>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="form-check form-check-custom form-check-solid">
                                                ...
                                                <label class="form-check-label"
                                                    ...
                                                    <div class="text-gray-600">
                                                        Receive a notification if a teammate
                                                        mentions you in a note.
                                                    </div>
                                                </label>
                                                <!--end::Label-->
                                            </div>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="form-check form-check-custom form-check-solid">
                                                ...
                                                <label class="form-check-label"
                                                    ...
                                                    <div class="text-gray-600">
                                                        Receive a notification if a customer
                                                        sends an incorrect amount to pay their
                                                        invoice.
                                                    </div>
                                                </label>
                                                <!--end::Label-->
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="form-check form-check-custom form-check-solid">
                                                ...
                                                <label class="form-check-label"
                                                    ...
                                                    <div class="text-gray-600">
                                                        Receive helpful tips when you try out
                                                        our products.
                                                    </div>
                                                </label>
                                                <!--end::Label-->
                                        ...
                                        <table
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        POST
                                                        /v1/customer/c_66063863960bf/not_found
                                                    </td>
                                                    <td class="pe-0 text-end min-w-200px">
                                                        22 Sep 2024, 11:30 am
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="min-w-70px">
                                                    ...
                                                    <td>
                                                        POST /v1/invoices/in_4250_4932/payment
                                                    </td>
                                                    <td class="pe-0 text-end min-w-200px">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        POST
                                                        /v1/customer/c_66063863960c1/not_found
                                                    </td>
                                                    <td class="pe-0 text-end min-w-200px">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        POST /v1/invoice/in_2887_7117/invalid
                                                    </td>
                                                    <td class="pe-0 text-end min-w-200px">
                                                        20 Jun 2024, 5:20 pm
                                                    </td>
                            ...
                            <form id="kt_modal_update_email_form" class="form" action="#">
                                ...
                                <div
                                    ...
                                    <div class="d-flex flex-stack flex-grow-1">
                                        ...
                                        <div class="fw-semibold">
                                            <div class="fs-6 text-gray-700">
                                                Please note that a valid email address is
                            ...
                            <form id="kt_modal_update_role_form" class="form" action="#">
                                ...
                                <div
                                    ...
                                    <div class="d-flex flex-stack flex-grow-1">
                                        ...
                                        <div class="fw-semibold">
                                            <div class="fs-6 text-gray-700">
                                                Please note that reducing a user role rank,
                                                that user will lose all priviledges that was
