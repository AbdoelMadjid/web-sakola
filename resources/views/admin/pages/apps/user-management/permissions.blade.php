                            ...
                            <form id="kt_modal_add_permission_form" class="form" action="#">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <label class="form-check form-check-custom form-check-solid me-9">
                                        ...
                                        <span class="form-check-label" for="kt_permissions_core">Set as core
                                            permission</span>
                                    </label>
                                    <!--end::Checkbox-->
                                </div>
                                ...
                                <div class="d-flex flex-stack flex-grow-1">
                                    ...
                                    <div class="fw-semibold">
                                        <div class="fs-6 text-gray-700">
                                            ...
                                            editing the permission name, you might break
                                            the system permissions functionality. Please
                                            ensure you're absolutely certain before
                                            proceeding.
                                        </div>
                                    </div>
                                    <!--end::Content-->
