                                    ...
                                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                                        ...
                                        <div class="m-0">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                                data-kt-menu="true" id="kt_menu_660638508e6b8">
                                                <!--begin::Header-->
                                                <div class="px-7 py-5">
                                                    ...
                                                    <div class="mb-10">
                                                        ...
                                                        <div>
                                                            <select class="form-select form-select-solid"
                                                                ...
                                                                data-dropdown-parent="#kt_menu_660638508e6b8"
                                ...
                                <div id="kt_app_content_container" class="app-container container-fluid">
                                    ...
                                    <div class="card card-flush pb-0 bgi-position-y-center bgi-no-repeat mb-10"
                                        style="
                                            ...
                                            background-image: url(&quot;admin/assets/media/illustrations/sketchy-1/4.png&quot;);
                                            ">
                                        <!--begin::Card header-->
                                                ...
                                                <ul
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link text-active-primary me-6 active"
                                                            href="/apps/file-manager/folders">Files</a>
                                                    </li>
                                                    <!--end::Nav item-->
                                                    <!--begin::Nav item-->
                                                    <li class="nav-item">
                                                        <a class="nav-link text-active-primary me-6"
                                                            href="/apps/file-manager/settings">Settings</a>
                                                    </li>
                                                    <!--end::Nav item-->
                                                </ul>
                                            </div>
                                        ...
                                        <div class="card-header pt-8">
                                            ...
                                            <div class="card-toolbar">
                                                ...
                                                <div class="d-flex justify-content-end"
                                                    ...
                                                    <a href="/apps/file-manager/folders"
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <div class="badge badge-lg badge-light-primary">
                                                    <div class="d-flex align-items-center flex-wrap">
                                                        ...
                                                        <a href="/apps/file-manager/folders">Keenthemes</a>
                                                        <i class="ki-duotone ki-right fs-2x text-primary mx-1"></i>
                                                        <a href="/apps/file-manager/folders">themes</a>
                                                        <i class="ki-duotone ki-right fs-2x text-primary mx-1"></i>
                                                        <a href="/apps/file-manager/folders">html</a>
                                                        <i class="ki-duotone ki-right fs-2x text-primary mx-1"></i>
                                                        <a href="/apps/file-manager/folders">demo1</a>
                                                        <i
                                                            class="ki-duotone ki-right fs-2x text-primary mx-1"></i>account
                                                    </div>
                                                </div>
                                                <!--end::Folder path-->
                                                <!--begin::Folder Stats-->
                                                ...
                                                <tbody class="fw-semibold text-gray-600">
                                                                            ...
                                                                            <div class="card-body p-5">
                                                                                ...
                                                                                <div class="d-flex flex-column text-start d-none"
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        Read only.
                                                                                        <a href="/apps/file-manager/settings"
                                                                                            class="ms-2">Change
                                                                                            permissions</a>
                                                                                    </div>
                                                                                </div>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <i
                                                                    class="ki-duotone ki-files fs-2x text-primary me-4"></i>
                                                                <a href="#"
                                                                    class="text-gray-800 text-hover-primary">widgets-4.html</a>
                                                            </div>
                                                        </td>
                                                        <td>514 KB</td>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <i
                                                                    class="ki-duotone ki-files fs-2x text-primary me-4"></i>
                                                                <a href="#"
                                                                    class="text-gray-800 text-hover-primary">widgets-5.html</a>
                                                            </div>
                                                        </td>
                                                        <td>475 KB</td>
                                                        <td>05 May 2024, 11:30 am</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <i
                                                                    class="ki-duotone ki-picture fs-2x text-primary me-4">
                                                                    <span class="path1"></span>
                                                                    <span class="path2"></span>
                                                                </i>
                                                                <a href="#"
                                                                    class="text-gray-800 text-hover-primary">pattern-1.jpg</a>
                                                            </div>
                                                        </td>
                                                        <td>11 KB</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <a href="#"
                                                                    class="text-gray-800 text-hover-primary">pattern-2.jpg</a>
                                                            </div>
                                                        </td>
                                                        <td>11 KB</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <a href="#"
                                                                    class="text-gray-800 text-hover-primary">pattern-3.jpg</a>
                                                            </div>
                                                        </td>
                                                        <td>11 KB</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <a href="#"
                                                                    class="text-gray-800 text-hover-primary">pattern-4.jpg</a>
                                                            </div>
                                                        </td>
                                                        <td>11 KB</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <a href="#"
                                                                    class="text-gray-800 text-hover-primary">pattern-5.jpg</a>
                                                            </div>
                                                        </td>
                                                        <td>11 KB</td>
                                                        <td>19 Aug 2024, 6:43 am</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <a href="#"
                                                                    class="text-gray-800 text-hover-primary">background-1.jpg</a>
                                                            </div>
                                                        </td>
                                                        <td>48 KB</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <a href="#"
                                                                    class="text-gray-800 text-hover-primary">background-2.jpg</a>
                                                            </div>
                                                        </td>
                                                        <td>48 KB</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <a href="#"
                                                                    class="text-gray-800 text-hover-primary">background-3.jpg</a>
                                                            </div>
                                                        </td>
                                                        <td>48 KB</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <a href="#"
                                                                    class="text-gray-800 text-hover-primary">background-4.jpg</a>
                                                            </div>
                                                        </td>
                                                        <td>48 KB</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <a href="#"
                                                                    class="text-gray-800 text-hover-primary">background-5.jpg</a>
                                                            </div>
                                                        </td>
                                                        <td>48 KB</td>
                                    ...
                                    <table class="d-none">
                                        <tr id="kt_file_manager_new_folder_row"
                                    ...
                                    <div class="modal fade" id="kt_modal_upload" tabindex="-1"
                                        aria-hidden="true">
                                        <!--begin::Modal dialog-->
                                                                    ...
                                                                    <div class="dropzone-item p-5"
                                                                        ...
                                                                        <div class="dropzone-toolbar">
                                                                            <span class="dropzone-start">
                                                                                <i
                                                                                    class="ki-duotone ki-to-right fs-1"></i>
                                                                            </span>
