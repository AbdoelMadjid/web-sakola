                ...
                <div class="card-body pb-0">
                    ...
                    <div class="d-flex overflow-auto h-55px">
                        <ul
                            ...
                            <!--begin::Nav item-->
                            <li class="nav-item">
                                <a class="nav-link text-active-primary me-6" href="/apps/file-manager/folders">Files</a>
                            </li>
                            <!--end::Nav item-->
                            <!--begin::Nav item-->
                            <li class="nav-item">
                ...
                <div class="card-body">
                    ...
                    <form class="form" id="kt_file_manager_settings">
                        ...
                        <div class="fv-row row mb-15">
                            ...
                            <div class="col-md-9">
                                ...
                                <select name="language" aria-label="Select a Language" data-control="select2"
                                    data-placeholder="Select a Language..." class="form-select mb-2">
                                    <option></option>
                                    <option value="id">
                        ...
                        <div class="fv-row row mb-15">
                            ...
                            <div class="col-md-9">
                                <!--begin::Input-->
                                <select name="dateformat" aria-label="Select a date format" data-hide-search="true"
                                    data-control="select2" data-placeholder="Select a date format..."
                        ...
                        <div class="fv-row row mb-15">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="form-check form-switch form-check-custom form-check-solid me-10">
                                    <input class="form-check-input h-30px w-50px" name="autotimezone" type="checkbox"
                        ...
                        <div class="fv-row row mb-15">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="text-muted fs-7">
                                    Default file compression type when downloading
                                    folders
                                </div>
                                <!--end::Label-->
                            </div>
                            ...
                            <div class="col-md-9">
                                <!--begin::Input-->
                                <select name="compression" aria-label="Select a Compressions type" data-control="select2"
                                    data-hide-search="true" data-placeholder="Select a Compressions type..."
                                    class="form-select mb-2">
                                    <option></option>
                        ...
                        <div class="fv-row row mb-15">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="d-flex">
                                    <!--begin::Switch-->
                                    <div class="form-check form-switch form-check-custom form-check-solid me-10">
                                        <input class="form-check-input h-30px w-50px" name="org_read" type="checkbox"
                                            value="" id="org_read" checked="checked" />
                                        <label class="form-check-label" for="org_read">Read</label>
                                    </div>
                                    <!--begin::Switch-->
                                    <!--begin::Switch-->
                                    <div class="form-check form-switch form-check-custom form-check-solid me-10">
                                        <input class="form-check-input h-30px w-50px" name="org_write" type="checkbox"
                                            value="" id="org_write" checked="checked" />
                                ...
                                <div class="d-flex">
                                    <!--begin::Switch-->
                                    <div class="form-check form-switch form-check-custom form-check-solid me-10">
                                        <input class="form-check-input h-30px w-50px" name="public_read" type="checkbox"
                                            value="" id="public_read" checked="checked" />
                                        <label class="form-check-label" for="public_read">Read</label>
                                    </div>
                                    <!--begin::Switch-->
                                    <!--begin::Switch-->
                                    <div class="form-check form-switch form-check-custom form-check-solid me-10">
                                        <input class="form-check-input h-30px w-50px" name="public_write" type="checkbox"
                                            value="" id="public_write" />
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/apps/file-manager/settings.js"></script>
