                ...
                <div class="card-body pb-0">
                    ...
                    <div class="d-flex overflow-auto h-55px">
                        <ul
                            ...
                            <!--begin::Nav item-->
                            <li class="nav-item">
                                <a class="nav-link text-active-primary me-6" href="/apps/file-manager/settings">Settings</a>
                            </li>
                            <!--end::Nav item-->
                        </ul>
                    </div>
                ...
                <div class="card-header pt-8">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-filemanager-table-toolbar="base">
                            ...
                            <a href="/apps/file-manager/folders" class="btn btn-icon btn-light-primary me-3">
                                ...
                                <div class="card-body p-5">
                                    ...
                                    <div class="d-flex flex-column text-start d-none"
                                        ...
                                        <div class="text-muted fw-normal mt-2 fs-8 px-3">
                                            Read only.
                                            <a href="/apps/file-manager/settings/" class="ms-2">Change
                                                permissions</a>
                                        </div>
                                    </div>
                                    <!--end::Link-->
