                        ...
                        <tbody class="fw-semibold text-gray-600">
                            <tr>
                                ...
                                <td data-filter="mastercard">
                                    <img src="admin/assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3"
                                        alt="" />**** 6915
                                </td>
                            ...
                            <tr>
                                ...
                                <td>Google</td>
                                <td data-filter="visa">
                                    <img src="admin/assets/media/svg/card-logos/visa.svg" class="w-35px me-3"
                                        alt="" />**** 9936
                                </td>
                            ...
                            <tr>
                                ...
                                <td data-filter="american_express">
                                    <img src="admin/assets/media/svg/card-logos/american-express.svg" class="w-35px me-3"
                                        alt="" />**** 1031
                                </td>
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/apps/customers/list/export.js"></script>
    <script src="admin/assets/js/custom/apps/customers/list/list.js"></script>
    <script src="admin/assets/js/custom/apps/customers/add.js"></script>
