                        ...
                        <div class="card-body pt-15">
                            ...
                            <div id="kt_customer_view_details" class="collapse show">
                                <div class="py-5 fs-6">
                                    ...
                                    <div class="text-gray-600">
                                        101 Collin Street, <br />Melbourne 3000 VIC
                                        <br />Australia
                                    </div>
                                    <!--begin::Details item-->
                                    <!--begin::Details item-->
                        ...
                        <div class="card-body pt-2">
                                ...
                                <div class="d-flex flex-stack flex-grow-1">
                                    ...
                                    <div class="fw-semibold">
                                        <div class="fs-6 text-gray-700">
                                            By connecting an account, you hereby agree to
                                            our
                            ...
                            <div class="py-2">
                                ...
                                <div class="d-flex flex-stack">
                                    <div class="d-flex">
                                        <img src="admin/assets/media/svg/brand-logos/google-icon.svg" class="w-30px me-6"
                                            alt="" />
                                ...
                                <div class="d-flex flex-stack">
                                    <div class="d-flex">
                                        <img src="admin/assets/media/svg/brand-logos/github.svg" class="w-30px me-6"
                                            alt="" />
                                        <div class="d-flex flex-column">
                                            <a href="#"
                                ...
                                <div class="d-flex flex-stack">
                                    <div class="d-flex">
                                        <img src="admin/assets/media/svg/brand-logos/slack-icon.svg" class="w-30px me-6"
                                            alt="" />
                                        <div class="d-flex flex-column">
                                            <a href="#"
                    ...
                    <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8">
                        ...
                        <li class="nav-item ms-auto">
                            ...
                            <a href="#" class="btn btn-primary ps-7" data-kt-menu-trigger="click"
                                data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">Actions <i
                                    class="ki-duotone ki-down fs-2 me-0"></i></a>
                            <!--begin::Menu-->
                                    ...
                                    <table class="table align-middle table-row-dashed gy-5"
                                        ...
                                        <tbody class="fs-6 fw-semibold text-gray-600">
                                            <tr>
                                                <td>
                                                    <a href="#"
                                                        class="text-gray-600 text-hover-primary mb-1">9570-9426</a>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="#"
                                                        class="text-gray-600 text-hover-primary mb-1">5780-1553</a>
                                                </td>
                                                <td>
                                                    <span class="badge badge-light-success">Successful</span>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="#"
                                                        class="text-gray-600 text-hover-primary mb-1">6355-9053</a>
                                                </td>
                                                <td>
                                                    <span class="badge badge-light-success">Successful</span>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="#"
                                                        class="text-gray-600 text-hover-primary mb-1">8473-9903</a>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="#"
                                                        class="text-gray-600 text-hover-primary mb-1">4164-7758</a>
                                                </td>
                                                <td>
                                                    <span class="badge badge-light-success">Successful</span>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="#"
                                                        class="text-gray-600 text-hover-primary mb-1">4167-6706</a>
                                                </td>
                                                <td>
                                                    <span class="badge badge-light-success">Successful</span>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="#"
                                                        class="text-gray-600 text-hover-primary mb-1">1888-1734</a>
                                                </td>
                                                <td>
                                                    <span class="badge badge-light-success">Successful</span>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="#"
                                                        class="text-gray-600 text-hover-primary mb-1">2026-6976</a>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="#"
                                                        class="text-gray-600 text-hover-primary mb-1">6407-7989</a>
                                                </td>
                                                <td>
                                                    <span class="badge badge-light-warning">Pending</span>
                                                </td>
                                    ...
                                    <div class="py-0" data-kt-customer-payment-method="row">
                                        ...
                                        <div class="py-3 d-flex flex-stack flex-wrap">
                                            ...
                                            <div class="d-flex align-items-center collapsible rotate"
                                                ...
                                                <!--end::Arrow-->
                                                <!--begin::Logo-->
                                                <img src="admin/assets/media/svg/card-logos/mastercard.svg" class="w-40px me-3"
                                                    alt="" />
                                                <!--end::Logo-->
                                                <!--begin::Summary-->
                                                <div class="me-3">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-gray-800">
                                                                ...
                                                                <div class="symbol symbol-20px symbol-circle ms-2">
                                                                    <img src="admin/assets/media/flags/australia.svg" />
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                    ...
                                    <div class="py-0" data-kt-customer-payment-method="row">
                                        ...
                                        <div class="py-3 d-flex flex-stack flex-wrap">
                                            ...
                                            <div class="d-flex align-items-center collapsible collapsed rotate"
                                                ...
                                                <!--end::Arrow-->
                                                <!--begin::Logo-->
                                                <img src="admin/assets/media/svg/card-logos/visa.svg" class="w-40px me-3"
                                                    alt="" />
                                                <!--end::Logo-->
                                                <!--begin::Summary-->
                                                <div class="me-3">
                                                    ...
                                                    <table class="table table-flush fw-semibold gy-1">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-gray-800">
                                                                United Kingdom
                                                                <div class="symbol symbol-20px symbol-circle ms-2">
                                                                    <img src="admin/assets/media/flags/united-kingdom.svg" />
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                    ...
                                    <div class="py-0" data-kt-customer-payment-method="row">
                                        ...
                                        <div class="py-3 d-flex flex-stack flex-wrap">
                                            ...
                                            <div class="d-flex align-items-center collapsible collapsed rotate"
                                                ...
                                                <!--end::Arrow-->
                                                <!--begin::Logo-->
                                                <img src="admin/assets/media/svg/card-logos/american-express.svg"
                                                    ...
                                                    <table class="table table-flush fw-semibold gy-1">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-gray-800">
                                                                ...
                                                                <div class="symbol symbol-20px symbol-circle ms-2">
                                                                    <img src="admin/assets/media/flags/united-states.svg" />
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                        ...
                                        <table
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        POST
                                                        /v1/customer/c_660638572c9ed/not_found
                                                    </td>
                                                    <td class="pe-0 text-end min-w-200px">
                                                        15 Apr 2024, 10:10 pm
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="min-w-70px">
                                                    ...
                                                    <td>
                                                        POST /v1/invoice/in_5494_5408/invalid
                                                    </td>
                                                    <td class="pe-0 text-end min-w-200px">
                                                        25 Jul 2024, 6:05 pm
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        POST /v1/invoices/in_9658_8538/payment
                                                    </td>
                                                    <td class="pe-0 text-end min-w-200px">
                                                        21 Feb 2024, 5:30 pm
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        POST /v1/invoices/in_8092_8956/payment
                                                    </td>
                                                    <td class="pe-0 text-end min-w-200px">
                                                        10 Mar 2024, 6:43 am
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        POST /v1/invoice/in_5095_4052/invalid
                                                    </td>
                                                    <td class="pe-0 text-end min-w-200px">
                                                        10 Mar 2024, 6:05 pm
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        POST
                                                        /v1/customer/c_660638572c9ec/not_found
                                                    </td>
                                                    <td class="pe-0 text-end min-w-200px">
                                                        22 Sep 2024, 9:23 pm
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        POST /v1/invoices/in_6609_3561/payment
                                                    </td>
                                                    <td class="pe-0 text-end min-w-200px">
                                                        21 Feb 2024, 5:30 pm
                                                    </td>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="pe-0 text-gray-600 text-end min-w-200px">
                                                    15 Apr 2024, 11:30 am
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="min-w-400px">
                                                    <a href="#"
                                                        class="text-gray-600 text-hover-primary me-1">Melody Macy</a>has
                                                    made
                                                    payment to
                                                    <a href="#"
                            ...
                            <div class="card mb-6 mb-xl-9">
                                ...
                                <div class="card-body py-0">
                                    <div class="fs-5 fw-semibold text-gray-500 mb-4">
                                        Last 30 day earnings calculated. Apart from
                                            ...
                                            <table id="kt_customer_view_statement_table_1"
                                                ...
                                                <thead class="border-bottom border-gray-200">
                                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                                        ...
                                                        <th class="w-100px text-end pe-7">
                                                            Invoice
                                                        </th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            Iphone 12 Pro Mockup Mega Bundle
                                                        </td>
                                                        <td class="text-success">$5.00</td>
                                                        <td class="text-end">
                                                            <button class="btn btn-sm btn-light btn-active-light-primary">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            ...
                            <div class="d-flex text-center mb-9">
                                <div class="w-50 border border-dashed border-gray-300 rounded mx-2 p-4">
                                    ...
                                    <div class="fs-2 fw-bold" kt-modal-adjust-balance="current_balance">
                                        US$ 32,487.57
                                    </div>
                                </div>
                                <div class="w-50 border border-dashed border-gray-300 rounded mx-2 p-4">
                            ...
                            <form id="kt_modal_adjust_balance_form" class="form" action="#">
                                ...
                                <div class="fs-7 text-muted mb-15">
                                    ...
                                    will be audited by the financial team every
                                    fortnight. Please maintain your invoices and
                                ...
                                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_customer_scroll"
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex flex-stack flex-grow-1">
                                            ...
                                            <div class="fw-semibold">
                                                <div class="fs-6 text-gray-700">
                                                    Updating customer details will receive a
                                                    privacy audit. For more info, please read
                                    ...
                                    <div id="kt_modal_update_customer_user_info" class="collapse show">
                                      ...
                                      ">
                                                    ...
                                                    <div class="image-input-wrapper w-125px h-125px"
                                                        style="
                                          background-image: url(admin/assets/media/avatars/300-1.jpg);
                                        ">
                                                    </div>
                                ...
                                <div class="d-flex flex-column mb-7 fv-row">
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                                            <img src="admin/assets/media/svg/card-logos/visa.svg" alt=""
                                                class="h-25px" />
                                            <img src="admin/assets/media/svg/card-logos/mastercard.svg" alt=""
                                                class="h-25px" />
                                            <img src="admin/assets/media/svg/card-logos/american-express.svg" alt=""
                                                class="h-25px" />
                                        </div>
                                        <!--end::Card logos-->
                                    </div>
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/apps/customers/view/add-payment.js"></script>
    <script src="admin/assets/js/custom/apps/customers/view/adjust-balance.js"></script>
    <script src="admin/assets/js/custom/apps/customers/view/invoices.js"></script>
    <script src="admin/assets/js/custom/apps/customers/view/payment-method.js"></script>
    <script src="admin/assets/js/custom/apps/customers/view/payment-table.js"></script>
    <script src="admin/assets/js/custom/apps/customers/view/statement.js"></script>
    <script src="admin/assets/js/custom/apps/customers/update.js"></script>
    <script src="admin/assets/js/widgets.bundle.js"></script>
    <script src="admin/assets/js/custom/widgets.js"></script>
    <script src="admin/assets/js/custom/apps/chat/chat.js"></script>
    <script src="admin/assets/js/custom/utilities/modals/upgrade-plan.js"></script>
    <script src="admin/assets/js/custom/utilities/modals/create-app.js"></script>
    <script src="admin/assets/js/custom/utilities/modals/new-card.js"></script>
