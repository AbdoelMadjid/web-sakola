                            ...
                            <form action="" id="kt_invoice_form">
                                ...
                                <div class="d-flex flex-column align-items-start flex-xxl-row">
                                    ...
                                    <div class="d-flex flex-center flex-equal fw-row text-nowrap order-1 order-xxl-2 me-4"
                                        ...
                                        <span class="fs-2x fw-bold text-gray-800">Invoice
                                            #</span>
                                        <input type="text"
                                                    ...
                                                    <th colspan="2" class="border-bottom border-bottom-dashed ps-0">
                                                        <div class="d-flex flex-column align-items-start">
                                                            ...
                                                            <button class="btn btn-link py-1" data-bs-toggle="tooltip"
                                                                data-bs-trigger="hover" title="Coming soon">
                                                                Add tax
                                                            </button>
                                                            <button class="btn btn-link py-1" data-bs-toggle="tooltip"
                                                                data-bs-trigger="hover" title="Coming soon">
                    ...
                    <div class="card" data-kt-sticky="true" data-kt-sticky-name="invoice"
                        ...
                        <div class="card-body p-10">
                            ...
                            <div class="mb-8">
                                ...
                                <label
                                    class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack mb-5">
                                    <span class="form-check-label ms-0 fw-bold fs-6 text-gray-700">Late
                                        fees</span>
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/apps/invoices/create.js"></script>
