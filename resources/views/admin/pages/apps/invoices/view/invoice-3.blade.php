                ...
                <div class="card-body py-20">
                    ...
                    <div class="mw-lg-950px mx-auto w-100">
                        ...
                        <div class="d-flex justify-content-between flex-column flex-sm-row mb-19">
                            ...
                            <div class="text-sm-end">
                                ...
                                <a href="#" class="d-block mw-150px ms-sm-auto">
                                    <img alt="Logo" src="admin/assets/media/svg/brand-logos/lloyds-of-london-logo.svg"
                                        class="w-100" />
                                </a>
                                <!--end::Logo-->
                                <!--begin::Text-->
                        ...
                        <div class="pb-12">
                            ...
                            <div class="d-flex flex-column gap-7 gap-md-10">
                                ...
                                <div class="fw-bold fs-2">
                                    Dear Dan Wilson
                                    <span class="fs-6">(dam@consilting.com)</span>,
                                    <br />
                                ...
                                <div class="d-flex flex-column flex-sm-row gap-7 gap-md-10 fw-bold">
                                    ...
                                    <div class="flex-root d-flex flex-column">
                                        ...
                                        <span class="fs-5">29 March, 2024</span>
                                    </div>
                                    <div class="flex-root d-flex flex-column">
                                ...
                                <div class="d-flex flex-column flex-sm-row gap-7 gap-md-10 fw-bold">
                                    <div class="flex-root d-flex flex-column">
                                        ...
                                        <span class="fs-6">Unit 1/23 Hastings Road, <br />Melbourne
                                            3000, <br />Victoria, <br />Australia.</span>
                                    </div>
                                    <div class="flex-root d-flex flex-column">
                        ...
                        <div class="d-flex flex-stack flex-wrap mt-lg-20 pt-13">
                            ...
                            <!-- end::Actions-->
                            <!-- begin::Action-->
                            <a href="/apps/invoices/create" class="btn btn-primary my-1">Create Invoice</a>
                            <!-- end::Action-->
                        </div>
                        <!-- end::Footer-->
                    </div>
