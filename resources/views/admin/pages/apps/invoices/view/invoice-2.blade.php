                    ...
                    <div class="mw-lg-950px mx-auto w-100">
                        ...
                        <div class="d-flex justify-content-between flex-column flex-sm-row mb-19">
                            ...
                            <div class="text-sm-end">
                                <!--begin::Logo-->
                                <a href="#">
                                    <img alt="Logo" src="admin/assets/media/svg/brand-logos/duolingo.svg" />
                                </a>
                                <!--end::Logo-->
                                <!--begin::Text-->
                        ...
                        <div class="border-bottom pb-12">
                            ...
                            <div class="d-flex flex-row-fluid bgi-no-repeat bgi-position-x-center bgi-size-cover card-rounded h-150px h-lg-250px mb-lg-20"
                                style="
                              background-image: url(admin/assets/media/misc/pattern-4.jpg);
                            ">
                            </div>
                            <!--end::Image-->
                            <!--begin::Wrapper-->
                            <div class="d-flex justify-content-between flex-column flex-md-row">
                                ...
                                <div class="flex-grow-1 pt-8 mb-13">
                                        ...
                                        <table class="table">
                                            <thead>
                                                <tr class="border-bottom fs-6 fw-bold text-muted text-uppercase">
                                                    <th class="min-w-175px pb-9">
                                                        Description
                                                    </th>
                                                    <th class="min-w-70px pb-9 text-end">
                                                        Hours
                                                    </th>
                                                    <th class="min-w-80px pb-9 text-end">
                                                        Rate
                                                    </th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="fw-bold text-gray-700 fs-5 text-end">
                                                    <td class="d-flex align-items-center">
                                                        <i class="fa fa-genderless text-success fs-1 me-2"></i>Logo Design
                                                    </td>
                                                    <td>120</td>
                                                    <td>$40.00</td>
                                                    <td class="fs-5 text-gray-900 fw-bolder pe-lg-6">
                                                        $4800.00
                                                    </td>
                                                </tr>
                                                <tr class="fw-bold text-gray-700 fs-5 text-end">
                                                    <td class="d-flex align-items-center pb-10">
                                                        <i class="fa fa-genderless text-primary fs-1 me-2"></i>Web
                                                        Development
                                                    </td>
                                                    <td>210</td>
                                                    <td>$60.00</td>
                                    ...
                                    <div class="d-flex flex-column mw-md-300px w-100">
                                        <!--begin::Label-->
                                        <div class="fw-semibold fs-5 mb-3 text-gray-90000">
                                            BANK TRANSFER
                                        </div>
                                        <!--end::Label-->
                                        <!--begin::Item-->
                                ...
                                <div class="text-end pt-10">
                                    <!--begin::Total Amount-->
                                    <div class="fs-3 fw-bold text-muted mb-3">
                                        TOTAL AMOUNT
                                    </div>
                                    <div class="fs-xl-2x fs-2 fw-bolder">
                                        $20,600.00
                                    </div>
                                    ...
                                    <!--begin::Invoice To-->
                                    <div class="text-gray-600 fs-6 fw-semibold mb-3">
                                        INVOICE TO.
                                    </div>
