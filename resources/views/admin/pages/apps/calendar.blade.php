                        ...
                        <form class="form" action="#" id="kt_modal_add_event_form">
                            ...
                            <div class="modal-body py-10 px-lg-17">
                                ...
                                <div class="fv-row mb-9">
                                    <!--begin::Label-->
                                    <label class="fs-6 fw-semibold required mb-2">Event
                                        Name</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                ...
                                <div class="fv-row mb-9">
                                    <!--begin::Label-->
                                    <label class="fs-6 fw-semibold mb-2">Event
                                        Description</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid" placeholder=""
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/apps/calendar/calendar.js"></script>
