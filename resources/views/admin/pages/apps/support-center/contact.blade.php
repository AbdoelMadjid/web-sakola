...
@section('styles')
    ...
    <link href="admin/assets/plugins/custom/leaflet/leaflet.bundle.css" rel="stylesheet" type="text/css" />
...
@section('scripts')
    ...
    <script src="admin/assets/plugins/custom/leaflet/leaflet.bundle.js"></script>
    <script src="admin/assets/plugins/custom/datatables/datatables.bundle.js"></script>
    <!--end::Vendors Javascript-->
    <!--begin::Custom Javascript(used for this page only)-->
    <script src="admin/assets/js/custom/apps/support-center/tickets/create.js"></script>
    <script src="admin/assets/js/custom/pages/general/contact.js"></script>
