                                ...
                                <div class="mb-10">
                                    ...
                                    <div class="d-flex mb-10">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center mb-2">
                                                <!--begin::Title-->
                                                <a href="/apps/support-center/tickets/view"
                                                    class="text-gray-900 text-hover-primary fs-4 me-3 fw-semibold">How to
                                                    use Netronic
                                                    with Django
                                                    Framework?</a>
                                                <!--end::Title-->
                                            ...
                                            <!--end::Content-->
                                            <!--begin::Text-->
                                            <span class="text-muted fw-semibold fs-6">By Keenthemes to save tons and more to
                                                time
                                                money projects are listed amazing
                                    ...
                                    <div class="d-flex mb-10">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center mb-2">
                                                <!--begin::Title-->
                                                <a href="/apps/support-center/tickets/view"
                                                    class="text-gray-900 text-hover-primary fs-4 me-3 fw-semibold">Admin
                                                    theme npm
                                                    issue</a>
                                                <!--end::Title-->
                                                <!--begin::Label-->
                                    ...
                                    <div class="d-flex mb-10">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <!--end::Content-->
                                            <!--begin::Text-->
                                            <span class="text-muted fw-semibold fs-6">By Keenthemes to save tons and more
                                                to time
                                                money projects are listed amazing
                                                <br />outstanding projects are listed</span>
                                            <!--end::Text-->
                                    ...
                                    <div class="d-flex mb-10">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center mb-2">
                                                <!--begin::Title-->
                                                <a href="/apps/support-center/tickets/view"
                                                    class="text-gray-900 text-hover-primary fs-4 me-3 fw-semibold">Reducing
                                                    footprint of
                                                    Start theme</a>
                                                <!--end::Title-->
                                                <!--begin::Label-->
                        ...
                        <div class="flex-column flex-lg-row-auto w-100 mw-lg-300px mw-xxl-350px">
                            ...
                            <div class="card-rounded bg-primary bg-opacity-5 p-10 mb-15">
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <!--begin::Subtitle-->
                                    <a href="#"
                                        class="fw-semibold text-gray-800 text-hover-primary fs-5 m-0">Angular Admin</a>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Item-->
                                <!--begin::Item-->
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Subtitle-->
                                    <a href="#"
                                        class="fw-semibold text-gray-800 text-hover-primary fs-5 m-0">Intranet Admin</a>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Item-->
                            </div>
