                            ...
                            <div class="mb-0">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="">
                                            ...
                                            <span class="fw-semibold text-muted me-6">By:
                                                <a href="#" class="text-muted text-hover-primary">Jerry
                                                    Johns</a></span>
                                            <!--end::Label-->
                                            <!--begin::Label-->
                                            <span class="fw-semibold text-muted">Created:
                                                <span class="fw-bold text-gray-600 me-1">3
                                                    Hours
                                                    ago</span>(24.06.2020 at
                                                5:03
                                                PM)</span>
                                            <!--end::Label-->
                                        </div>
                                ...
                                <div class="mb-15">
                                    ...
                                    <div class="mb-15 fs-5 fw-normal text-gray-800">
                                        ...
                                        <!--begin::Text-->
                                        <div class="mb-10">
                                            When you’re done bundling, you should decide
                                            on the order of the topics your article. In
                                            most cases, you can decide to order
                                            thematically. For instance, if you want to
                                            discuss various aspects or angles of the main
                                            topic of your blog post. But you can also
                                            order your text chronologically or
                                            didactically.
                                        </div>
                                        <!--end::Text-->
                                        <!--begin::Code-->
                                                ...
                                                <ul class="nav nav-pills" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link active" data-bs-toggle="tab"
                                                            href="#kt_highlight_6606385e983d0" role="tab">JAVASCRIPT</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-bs-toggle="tab"
                                                            href="#kt_highlight_6606385e983d3" role="tab">HTML</a>
                                                    </li>
                                                </ul>
                                                <div class="tab-content">
                                                    <div class="tab-pane fade show active" id="kt_highlight_6606385e983d0"
                                                        role="tabpanel">
...
setTimeout(function() {
    button.removeAttribute(&quot;data-kt-indicator);
                                                    ...
                                                    <div class="tab-pane fade" id="kt_highlight_6606385e983d3"
                                                        role="tabpanel">
                                                        <div class="highlight-code">
...
&lt;/button&gt;</code>
                                        ...
                                        <!--begin::Section-->
                                        <div class="mb-10">
                                            In the above example we’re discussing,
                                            ordering topics thematically makes the most
                                            sense.
                                        </div>
                                        <!--end::Section-->
                                        <!--begin::Section-->
                                        <div class="m-0">Than you, <br />Jerry</div>
                                        <!--end::Section-->
                                    </div>
                                    <!--end::Description-->
                                    <!--begin::Row-->
                                    <div class="row mb-7">
                                        ...
                                        <!--begin::Col-->
                                        <div class="col-md-3 fv-row mb-3">
                                            <label class="fs-6 fw-semibold mb-2">Assign
                                                To</label>
                                            <select class="form-select form-select-solid" data-control="select2"
                                    ...
                                    <!--begin::Input group-->
                                    <div class="mb-0">
                                        <textarea class="form-control form-control-solid placeholder-gray-600 fw-bold fs-4 ps-9 pt-7" rows="6"
                                        ...
                                        <div class="card card-bordered w-100">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="w-100 d-flex flex-stack mb-8">
                                                    ...
                                                    <div class="d-flex align-items-center f">
                                                        ...
                                                        <div
                                                            ...
                                                            <!--end::Text-->
                                                            <!--begin::Date-->
                                                            <span class="text-muted fw-semibold fs-6">2
                                                                Days ago</span>
                                                            <!--end::Date-->
                                                        </div>
                                                        <!--end::Info-->
                                                    ...
                                                    <div class="m-0">
                                                        <button
                                                            class="btn btn-color-gray-500 btn-active-color-primary p-0 fw-bold">
                                                            Reply
                                                        </button>
                                                    </div>
                                                    <!--end::Actions-->
                                                ...
                                                <p class="fw-normal fs-5 text-gray-700 m-0">
                                                    I run a team of 20 product managers,
                                                    developers, QA and UX Previously we
                                                    designed everything ourselves.
                                                </p>
                                                <!--end::Desc-->
                                            </div>
                                            <!--end::Body-->
                                                    ...
                                                    <div class="d-flex align-items-center f">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <!--begin::Username-->
                                                                <a href="/pages/general/user-profile/overview"
                                                                    class="text-gray-800 fw-bold text-hover-primary fs-5 me-3">Bob
                                                                    Clarcson</a>
                                                                <!--end::Username-->
                                                            ...
                                                            <!--end::Text-->
                                                            <!--begin::Date-->
                                                            <span class="text-muted fw-semibold fs-6">4
                                                                Days ago</span>
                                                            <!--end::Date-->
                                                        </div>
                                                        <!--end::Info-->
                                                    ...
                                                    <div class="d-flex align-items-center f">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <!--begin::Username-->
                                                                <a href="/pages/general/user-profile/overview"
                                                                    class="text-gray-800 fw-bold text-hover-primary fs-5 me-3">Matthew</a>
                                                                <!--end::Username-->
                                                                <span class="m-0"></span>
                                                            </div>
                                                            <!--end::Text-->
                                                            <!--begin::Date-->
                                                            <span class="text-muted fw-semibold fs-6">3
                                                                Days ago</span>
                                                            <!--end::Date-->
                                                        </div>
                                                        <!--end::Info-->
                                                    ...
                                                    <div class="d-flex align-items-center f">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <!--begin::Username-->
                                                                <a href="/pages/general/user-profile/overview"
                                                                    class="text-gray-800 fw-bold text-hover-primary fs-5 me-3">Boris</a>
                                                                <!--end::Username-->
                                                                <span class="m-0"></span>
                                                            </div>
                                                            <!--end::Text-->
                                                            <!--begin::Date-->
                                                            <span class="text-muted fw-semibold fs-6">6
                                                                Days ago</span>
                                                            <!--end::Date-->
                                                        </div>
                                                        <!--end::Info-->
                        ...
                        <div class="flex-column flex-lg-row-auto w-100 mw-lg-300px mw-xxl-350px">
                            ...
                            <div class="card-rounded bg-primary bg-opacity-5 p-10 mb-15">
                                <!--begin::Title-->
                                <h2 class="text-gray-900 fw-bold mb-11">
                                    More Channels
                                </h2>
                                <!--end::Title-->
                                <!--begin::Item-->
                                <div class="d-flex align-items-center mb-10">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="fw-semibold">
                                            ...
                                            <!--end::Desc-->
                                            <!--begin::Link-->
                                            <a href="#" class="link-primary">Support
                                                Policy</a>
                                            <!--end::Link-->
                                        </div>
                                        <!--end::Section-->
                                ...
                                <div class="d-flex align-items-center mb-10">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="fw-semibold">
                                            ...
                                            <!--end::Desc-->
                                            <!--begin::Link-->
                                            <a href="#" class="link-primary">KeenThemes
                                                Twitter</a>
                                            <!--end::Link-->
                                        </div>
                                        <!--end::Section-->
                            ...
                            <div class="card-rounded bg-primary bg-opacity-5 p-10 mb-15">
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <!--begin::Subtitle-->
                                    <a href="#"
                                        class="fw-semibold text-gray-800 text-hover-primary fs-5 m-0">Angular
                                        Admin</a>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Item-->
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <!--end::Icon-->
                                    <!--begin::Subtitle-->
                                    <a href="#" class="fw-semibold text-gray-800 text-hover-primary fs-5 m-0">React
                                        Admin</a>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Item-->
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <!--end::Icon-->
                                    <!--begin::Subtitle-->
                                    <a href="#" class="fw-semibold text-gray-800 text-hover-primary fs-5 m-0">Vue
                                        Dashboard</a>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Item-->
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <!--end::Icon-->
                                    <!--begin::Subtitle-->
                                    <a href="#" class="fw-semibold text-gray-800 text-hover-primary fs-5 m-0">Niche
                                        Theme</a>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Item-->
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <!--begin::Subtitle-->
                                    <a href="#"
                                        class="fw-semibold text-gray-800 text-hover-primary fs-5 m-0">Dashboard
                                        Admin</a>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Item-->
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <!--end::Icon-->
                                    <!--begin::Subtitle-->
                                    <a href="#" class="fw-semibold text-gray-800 text-hover-primary fs-5 m-0">CRM
                                        Admin</a>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Item-->
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Subtitle-->
                                    <a href="#"
                                        class="fw-semibold text-gray-800 text-hover-primary fs-5 m-0">Intranet
                                        Admin</a>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Item-->
                            ...
                            <form id="kt_modal_new_ticket_form" class="form" action="#">
                                ...
                                <div class="mb-13 text-center">
                                    ...
                                    <div class="text-gray-500 fw-semibold fs-5">
                                        ...
                                        <a href="" class="fw-bold link-primary">Support
                                            Guidelines</a>.
                                    </div>
                                    <!--end::Description-->
                                </div>
                                ...
                                <div class="row g-9 mb-8">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-md-6 fv-row">
                                        <label class="required fs-6 fw-semibold mb-2">Due
                                            Date</label>
                                        <!--begin::Input-->
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/apps/support-center/general.js"></script>
