            ...
            <div class="card">
                ...
                <div class="card-body p-10 p-lg-15">
                    ...
                    <div class="mb-14">
                        ...
                        <div class="mb-15">
                            <!--begin::Title-->
                            <h1 class="fs-2x text-gray-900 mb-6">
                                License Comparision
                            </h1>
                            <!--end::Title-->
                            <!--begin::Text-->
                                ...
                                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                    ...
                                    <thead>
                                        <tr class="fw-bold fs-6 text-gray-800 text-center border-0 bg-light">
                                            ...
                                            <th class="min-w-100px rounded-end">
                                                Extended
                                            </th>
                                        </tr>
                                    </thead>
                        ...
                        <div class="mb-20 pb-lg-20">
                            ...
                            <div class="fs-4 fw-semibold text-gray-700 mb-13">
                                If users can free browse and use your website or
                                Admin Panel is used only as interface(eCommerce
                                site) to sell other's products you can use Regular
                                license. <br />If you are going to use the item on
                                one domain and multiple subdomains, you only require
                                one Licence.(ex: www.
                                <span class="text-gray-900">domain.com</span>/site1
                                – site2.
                            ...
                            <!--end::Text-->
                            <!--begin::Title-->
                            <h2 class="fw-bold text-gray-900 mb-7">
                                Multisite License:
                            </h2>
                            <!--end::Title-->
                            <!--begin::List-->
                            <ul>
                                <li>
                                    <span class="fs-4 fw-semibold text-gray-700">It works the same as the Standard License,
                                        but
                                        you can use it in unlimited count of
                                        projects.</span>
                                </li>
                            </ul>
                            <!--end::List-->
                            <!--begin::Text-->
                            <div class="fs-4 fw-semibold text-gray-700 mb-13">
                                If users can free browse and use your website is
                                used only as interface(eCommerce site) to sell
                                other's products you can use Regular license. if you
                                are going to use the item on multiple domains, then
                                you will need to purchase a Licence for each domain
                                or buy Multisite License. <br />(ex:
                                www.domain-site-
                                <span class="text-gray-900">one.com</span>–
                                www.domain-site.
                                <span class="text-gray-900">two.com</span>–
                                www.site-three-
                                <span class="text-gray-900">domain.com</span>).
                            </div>
                            <!--end::Text-->
                            ...
                            <div class="fs-4 fw-semibold text-gray-700">
                                ...
                                Customer support center If users can free browse and
                                use your website is used only as interface(eCommerce
                                site) to sell other's products you can use Regular
                                license. If you are going to use the item on one
                                domain and multiple subdomains, you only require one
                                Licence . (ex: www.domain.com/site1 –
                                site2.domain.com – site.3.domain.com).
                            </div>
                            <!--end::Text-->
                        </div>
                        <!--end::Block-->
