            ...
            <div class="card card-docs flex-row-fluid mb-2" id="kt_docs_content_card">
                ...
                <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                    ...
                    <div class="pt-10">
                        ...
                        <div class="py-5">
                            <div class="mb-3">
                                Here's an example of a Bar Chart. For more info, please visit the <a
                        ...
                        <!--begin::Block-->
                        <div class="pt-5">
                            <div id="kt_docs_flot_bar" class="h-500px"></div>
                        </div>
                        <!--end::Block-->
                    </div>
                    <!--end::Section-->
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/documentation/charts/flotcharts/bar.js"></script>
