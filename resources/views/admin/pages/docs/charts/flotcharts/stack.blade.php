                ...
                <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                    ...
                    <div class="d-flex align-items-center rounded py-5 px-4 bg-light-info "> <!--begin::Icon-->
                        ...
                        <div class="text-gray-700 fw-bold fs-6 lh-lg">
                            Flot is a pure JavaScript plotting library for jQuery, with a focus on simple usage, attractive
                            looks and interactive features. . For more info see <a href="https://www.flotcharts.org/"
                                class="fw-bold me-1">the official site</a> and <a class="fw-bold"
                                href="https://github.com/flot/flot">the Github repository</a>.
                        </div> <!--end::Description-->
                    </div><!--end::Notice-->
                    <!--begin::Section-->
                    <div class="pt-10">
                        ...
                        <div class="py-5">
                            <div class="mb-3">
                                Here's an example of a Stack Chart Controls. For more info, please visit the <a
                                    href="https://www.flotcharts.org/" target="_blank">official website</a>.
                            </div>
                        </div>
                        <!--end::Block-->
                        ...
                        <!--begin::Block-->
                        <div class="pt-5">
                            <div id="kt_docs_flot_stack" class="h-500px"></div>
...
@section('scripts')
    ...
    <script src="admin/assets/plugins/custom/flotcharts/flotcharts.bundle.js"></script>
    <!--end::Vendors Javascript-->

    <!--begin::Custom Javascript(used for this page only)-->
    <script src="admin/assets/js/custom/documentation/charts/flotcharts/stack.js"></script>
