            ...
            <div class="card card-docs flex-row-fluid mb-2" id="kt_docs_content_card">
                ...
                <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                    ...
                    <div class="pt-10">
                        ...
                        <div class="py-5">
                            <div class="mb-3">
                                Here's an example of a Column Chart. For more info, please visit the <a
                        ...
                        <!--begin::Block-->
                        <div class="py-5">
                            <div id="kt_docs_google_chart_column" class="h-500px"></div>
                        </div>
                        <!--end::Block-->
                            ...
                            <div class="highlight"> <button class="highlight-copy btn" data-bs-toggle="tooltip"
                                ...
                                <ul class="nav nav-pills" role="tablist">
                                    <li class="nav-item"> <a class="nav-link active" data-bs-toggle="tab"
                                            href="#kt_highlight_68e50e40bfcb8" role="tab">JAVASCRIPT</a></li>
                                    <li class="nav-item"> <a class="nav-link " data-bs-toggle="tab"
                                            href="#kt_highlight_68e50e40bfcbc" role="tab">HTML</a></li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="kt_highlight_68e50e40bfcb8" role="tabpanel">
...
google.setOnLoadCallback(function () {
    ...
    chart.draw(data, options);
                                    ...
                                    <div class="tab-pane fade " id="kt_highlight_68e50e40bfcbc" role="tabpanel">
                                        <div class="highlight-code">
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/documentation/charts/google-charts/column.js"></script>
