            ...
            <div class="card card-docs flex-row-fluid mb-2" id="kt_docs_content_card">
                ...
                <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                    ...
                    <div class="py-10">
                        ...
                        <!--begin::Block-->
                        <div class="py-5">
                            Quill's script bundles are globally included. However, custom initialization Javascript files
                            will be required to be included manually.
                        </div>
                        <!--end::Block-->
...
&lt;script src=&quot;admin/assets/plugins/global/plugins.bundle.js&quot;&gt;&lt;/script&gt;</code></pre>
                    ...
                    <div class="pt-10">
                        ...
                        <div class="pt-5">
                            <ul class="py-0">
                                <li class="py-2">
                                    Quill's initialization Javascript is required to be added into the page via the <a
                                        href="#usage" class="me-1" data-kt-scroll-toggle>usage code</a> snippet above,
                                    along with our other global bundles.
                                </li>
                                <li class="py-2">
                                    Add a blank (or populated) <code>div</code> element with a unique <code>id</code> to
                                    initialize with JS.
                                </li>
                            </ul>
                        </div>
