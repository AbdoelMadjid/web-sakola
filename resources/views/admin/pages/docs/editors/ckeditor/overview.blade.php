            ...
            <div class="card card-docs flex-row-fluid mb-2" id="kt_docs_content_card">
                ...
                <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                    ...
                    <div class="py-10">
                        ...
                        <!--begin::Block-->
                        <div class="py-5">
                            CKEditor's script bundles are separate from our global bundle and required to be included and
                            initialized manually on related pages. Each CKEditor Build has it's own Javascript file to
                            include. Therefore, include the specifc JS files accordingly.
                        </div>
                        <!--end::Block-->
                        ...
                        <div class="py-5">
                            ...
                            <div class="highlight"> <button class="highlight-copy btn" data-bs-toggle="tooltip"
                                ...
                                <div class="highlight-code">
                                    <pre class="language-html"><code class="language-html">&lt;!--CKEditor Build Bundles:: Only include the relevant bundles accordingly--&gt;
...
&lt;script src=&quot;admin/assets/plugins/custom/ckeditor/ckeditor-balloon.bundle.js&quot;&gt;&lt;/script&gt;
&lt;script src=&quot;admin/assets/plugins/custom/ckeditor/ckeditor-balloon-block.bundle.js&quot;&gt;&lt;/script&gt;
&lt;script src=&quot;admin/assets/plugins/custom/ckeditor/ckeditor-document.bundle.js&quot;&gt;&lt;/script&gt;</code></pre>
                                </div>
                            </div><!--end::Highlight-->
                        </div>
                        <!--end::Code-->
                    ...
                    <div class="pt-10">
                        ...
                        <div class="pt-5">
                            <ul class="py-0">
                                <li class="py-2">
                                    CKEditor's Javascript is required to be added into the page via the <a href="#usage"
                                        class="me-1" data-kt-scroll-toggle>usage code</a> snippet above, along with our
                                    other global bundles.
                                </li>
                                <li class="py-2">
                                    For the Classic CKEditor build, add a blank (or populated) <code>textarea</code> element
                                    with a unique <code>id</code> to initialize with JS.
                                </li>
                                <li class="py-2">
                                    For the all other CKEditor builds, add a blank (or populated) <code>div</code> element
                                    with a unique <code>id</code> to initialize with JS.
                                </li>
                            </ul>
                        </div>
