...
@section('content')
                            ...
                            <div class="highlight"> <button class="highlight-copy btn" data-bs-toggle="tooltip"
                                ...
                                <ul class="nav nav-pills" role="tablist">
                                    <li class="nav-item"> <a class="nav-link active" data-bs-toggle="tab"
                                            href="#kt_highlight_68e3cb9eb9579" role="tab">JAVASCRIPT</a></li>
                                    <li class="nav-item"> <a class="nav-link " data-bs-toggle="tab"
                                            href="#kt_highlight_68e3cb9eb959c" role="tab">HTML</a></li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="kt_highlight_68e3cb9eb9579" role="tabpanel">
                                        <div class="highlight-code">
                                            <pre class="language-javascript"><code class="language-javascript">DecoupledEditor
    ...
    .catch(error =&gt; {
        console.error(error);
                                    ...
                                    <div class="tab-pane fade " id="kt_highlight_68e3cb9eb959c" role="tabpanel">
                                        <div class="highlight-code">
                                            <pre class="language-html"><code class="language-html">&lt;div id=&quot;kt_docs_ckeditor_document_toolbar&quot;&gt;&lt;/div&gt;
&lt;div id=&quot;kt_docs_ckeditor_document&quot;&gt;
    &lt;h1&gt;Quick and simple CKEditor 5 Integration&lt;/h1&gt;
...
@section('scripts')
    ...
    <script src="admin/assets/plugins/custom/ckeditor/ckeditor-document.bundle.js"></script>
    <!--end::Vendors Javascript-->

    <!--begin::Custom Javascript(used for this page only)-->
    <script src="admin/assets/js/custom/documentation/editors/ckeditor/document.js"></script>
