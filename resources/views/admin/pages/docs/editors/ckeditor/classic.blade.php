...
@section('content')
                            ...
                            <div class="highlight"> <button class="highlight-copy btn" data-bs-toggle="tooltip"
                                ...
                                <ul class="nav nav-pills" role="tablist">
                                    <li class="nav-item"> <a class="nav-link active" data-bs-toggle="tab"
                                            href="#kt_highlight_68e3c9a61089c" role="tab">JAVASCRIPT</a></li>
                                    <li class="nav-item"> <a class="nav-link " data-bs-toggle="tab"
                                            href="#kt_highlight_68e3c9a6108a0" role="tab">HTML</a></li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="kt_highlight_68e3c9a61089c" role="tabpanel">
                                        <div class="highlight-code">
                                            <pre class="language-javascript"><code class="language-javascript">ClassicEditor
    ...
    .catch(error =&gt; {
        console.error(error);
                                    ...
                                    <div class="tab-pane fade " id="kt_highlight_68e3c9a6108a0" role="tabpanel">
                                        <div class="highlight-code">
                                            <pre class="language-html"><code class="language-html">&lt;div class=&quot;py-5&quot; data-bs-theme=&quot;light&quot;&gt;
    &lt;textarea name=&quot;kt_docs_ckeditor_classic&quot; id=&quot;kt_docs_ckeditor_classic&quot;&gt;
        &lt;h1&gt;Quick and simple CKEditor 5 Integration&lt;/h1&gt;
        &lt;p&gt;Here goes the &lt;a href=&quot;#&quot;&gt;Minitial content of the editor&lt;/a&gt;. Lorem Ipsum is simply dummy text of the &lt;em&gt;printing and typesetting&lt;/em&gt; industry.&lt;/p&gt;
        &lt;blockquote&gt;Lorem Ipsum has been the industry&#039;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled. Lorem Ipsum is simply dummy text of the printing and typesetting industry.&lt;/blockquote&gt;
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/documentation/editors/ckeditor/classic.js"></script>
