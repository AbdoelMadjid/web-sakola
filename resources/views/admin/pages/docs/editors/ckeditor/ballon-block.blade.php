...
@section('content')
                ...
                <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                    ...
                    <div class="pt-10">
                        ...
                        <h1 class="anchor fw-bold mb-5" data-kt-scroll-offset="85" id="basic">
                            ...
                            Balloon Block CKEditor Example
                        </h1>
                        <!--end::Heading-->
                        ...
                        <div class="py-5">
                            <div class="mb-3">
                                Here's how a balloon block CKEditor will look like. Click anywhere on the sample content
                                below to trigger CKEditor. A small paragraph icon will appear on the left side of the
                                content container. Click on that to open CKEditor's options.
                            </div>
                        </div>
                        <!--end::Block-->
                        ...
                        <!--begin::Block-->
                        <div class="pt-5">
                            <div id="kt_docs_ckeditor_balloon_block">
                            ...
                            <div class="highlight"> <button class="highlight-copy btn" data-bs-toggle="tooltip"
                                ...
                                <ul class="nav nav-pills" role="tablist">
                                    <li class="nav-item"> <a class="nav-link active" data-bs-toggle="tab"
                                            href="#kt_highlight_68e3cb5760b1e" role="tab">JAVASCRIPT</a></li>
                                    <li class="nav-item"> <a class="nav-link " data-bs-toggle="tab"
                                            href="#kt_highlight_68e3cb5760b23" role="tab">HTML</a></li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="kt_highlight_68e3cb5760b1e" role="tabpanel">
                                        <div class="highlight-code">
                                            <pre class="language-javascript"><code class="language-javascript">BalloonEditor
    ...
    .catch(error =&gt; {
        console.error(error);
                                    ...
                                    <div class="tab-pane fade " id="kt_highlight_68e3cb5760b23" role="tabpanel">
                                        <div class="highlight-code">
                                            <pre class="language-html"><code class="language-html">&lt;div id=&quot;kt_docs_ckeditor_balloon_block&quot;&gt;
    &lt;h1&gt;Quick and simple CKEditor 5 Integration&lt;/h1&gt;
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/documentation/editors/ckeditor/balloon-block.js"></script>
