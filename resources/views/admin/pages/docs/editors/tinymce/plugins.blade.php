...
@section('content')
            ...
            <div class="card card-docs flex-row-fluid mb-2" id="kt_docs_content_card">
                ...
                <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                    ...
                    <div class="pt-10">
                        ...
                        <div class="py-5">
                            <div class="mb-3">
                                Here's how a TinyMCE editor integrates with specifc plugins. For more info, please visit the
                                <a href="https://www.tiny.cloud/docs/plugins/opensource/" target="_blank">official
                                    documentation</a>.
                            </div>
                        </div>
                        <!--end::Block-->
                            ...
                            <div class="highlight"> <button class="highlight-copy btn" data-bs-toggle="tooltip"
                                ...
                                <ul class="nav nav-pills" role="tablist">
                                    <li class="nav-item"> <a class="nav-link active" data-bs-toggle="tab"
                                            href="#kt_highlight_68e3cd4e41ac2" role="tab">JAVASCRIPT</a></li>
                                    <li class="nav-item"> <a class="nav-link " data-bs-toggle="tab"
                                            href="#kt_highlight_68e3cd4e41ac6" role="tab">HTML</a></li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="kt_highlight_68e3cd4e41ac2" role="tabpanel">
    ...
    plugins : &quot;advlist autolink link image lists charmap print preview&quot;
                                    ...
                                    <div class="tab-pane fade " id="kt_highlight_68e3cd4e41ac6" role="tabpanel">
                                        <div class="highlight-code">
                                            <pre class="language-html"><code class="language-html">&lt;textarea id=&quot;kt_docs_tinymce_plugins&quot; name=&quot;kt_docs_tinymce_plugins&quot; class=&quot;tox-target&quot;&gt;
    &lt;h1&gt;Quick and Simple TinyMCE 5 Integration&lt;/h1&gt;
    &lt;p&gt;Here goes the&amp;nbsp;&lt;a href=&quot;#&quot;&gt;Minitial content of the editor&lt;/a&gt;. Lorem Ipsum is simply dummy text of the&amp;nbsp;&lt;em&gt;printing and typesetting&lt;/em&gt;&amp;nbsp;industry.&lt;/p&gt;
    &lt;blockquote&gt;Lorem Ipsum has been the industry&#039;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled. Lorem Ipsum is simply dummy text of the printing and typesetting industry.&lt;/blockquote&gt;
    &lt;h3 style=&quot;text-align: right;&quot;&gt;Flexible &amp;amp; Powerful&lt;/h3&gt;
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/documentation/editors/tinymce/plugins.js"></script>
