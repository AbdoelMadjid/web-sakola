...
@section('content')
                ...
                <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                    ...
                    <div class="d-flex align-items-center rounded py-5 px-4 bg-light-info "> <!--begin::Icon-->
                        ...
                        <div class="text-gray-700 fw-bold fs-6 lh-lg">
                            TinyMCE is one of the world's most advanced rich text editor. The WYSIWYG editor that is
                            flexible, customizable, and designed with the user in mind. TinyMCE can handle any challenge,
                            from the most simple implementation through to the most complex use case. For more info see <a
                                href="https://www.tiny.cloud/docs/" class="fw-bold me-1">the official site</a>and <a
                                class="fw-bold" href="https://github.com/tinymce/">the Github repository</a>.
                        </div> <!--end::Description-->
                    </div><!--end::Notice-->
                    <!--begin::Section-->
                    <div class="pt-10">
                        <!--begin::Heading-->
                        <h1 class="anchor fw-bold mb-5" data-kt-scroll-offset="85" id="hidden">
                            <a href="#hidden" data-kt-scroll-toggle></a>
                        ...
                        <div class="py-5">
                            <div class="mb-3">
                                Here's how a TinyMCE editor will look like with a hidden menubar, where all the "File",
                                "Edit", etc tools usually sit.
                            </div>
                        </div>
                        <!--end::Block-->
                            ...
                            <div class="highlight"> <button class="highlight-copy btn" data-bs-toggle="tooltip"
                                ...
                                <ul class="nav nav-pills" role="tablist">
                                    <li class="nav-item"> <a class="nav-link active" data-bs-toggle="tab"
                                            href="#kt_highlight_68e3cd9e022a4" role="tab">JAVASCRIPT</a></li>
                                    <li class="nav-item"> <a class="nav-link " data-bs-toggle="tab"
                                            href="#kt_highlight_68e3cd9e022a8" role="tab">HTML</a></li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="kt_highlight_68e3cd9e022a4" role="tabpanel">
                                        <div class="highlight-code">
                                            <pre class="language-javascript"><code class="language-javascript">tinymce.init({
    ...
    plugins : &quot;advlist autolink link image lists charmap print preview code&quot;
                                    ...
                                    <div class="tab-pane fade " id="kt_highlight_68e3cd9e022a8" role="tabpanel">
                                        <div class="highlight-code">
                                            <pre class="language-html"><code class="language-html">&lt;textarea id=&quot;kt_docs_tinymce_hidden&quot; name=&quot;kt_docs_tinymce_hidden&quot; class=&quot;tox-target&quot;&gt;
    &lt;h1&gt;Quick and Simple TinyMCE 5 Integration&lt;/h1&gt;
    &lt;p&gt;Here goes the&amp;nbsp;&lt;a href=&quot;#&quot;&gt;Minitial content of the editor&lt;/a&gt;. Lorem Ipsum is simply dummy text of the&amp;nbsp;&lt;em&gt;printing and typesetting&lt;/em&gt;&amp;nbsp;industry.&lt;/p&gt;
    &lt;blockquote&gt;Lorem Ipsum has been the industry&#039;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled. Lorem Ipsum is simply dummy text of the printing and typesetting industry.&lt;/blockquote&gt;
    &lt;h3 style=&quot;text-align: right;&quot;&gt;Flexible &amp;amp; Powerful&lt;/h3&gt;
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/documentation/editors/tinymce/hidden.js"></script>
