            ...
            <div class="card card-docs flex-row-fluid mb-2" id="kt_docs_content_card">
                ...
                <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                    ...
                    <div class="py-10">
                        ...
                        <!--begin::Block-->
                        <div class="py-5">
                            Vis-timeline's style and script bundles are separate from our global bundle and required to be
                        ...
                        <div class="py-5">
                            ...
                            <div class="highlight"> <button class="highlight-copy btn" data-bs-toggle="tooltip"
                                ...
                                <div class="highlight-code">
                                    <pre class="language-html"><code class="language-html">&lt;link href=&quot;admin/assets/plugins/custom/vis-timeline/vis-timeline.bundle.css&quot; rel=&quot;stylesheet&quot; type=&quot;text/css&quot; /&gt;
&lt;script src=&quot;admin/assets/plugins/custom/vis-timeline/vis-timeline.bundle.js&quot;&gt;&lt;/script&gt;</code></pre>
                                </div>
                            </div><!--end::Highlight-->
                        </div>
                        <!--end::Code-->
                    ...
                    <div class="py-10">
                        ...
                        <div class="py-5">
                            <ul class="py-0">
                                <li class="py-2">
                                    Vis-timeline's CSS and Javascript is required to be added into the page via the <a
