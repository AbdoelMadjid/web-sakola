                            ...
                            <div class="rounded border p-5 p-lg-15">
                                ...
                                <div class="tns tns-default mb-3" style="direction: ltr">
                                    ...
                                    <div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false"
                                        ...
                                        data-tns-items="3" data-tns-center="true" data-tns-slide-by="true"
                                ...
                                <div class="d-flex flex-center">
                                    <ul class="d-flex align-items-center list-unstyled gap-5 cursor-pointer">
                                        <li class="d-flex gap-3" id="kt_slider_thumbnails">
                                            ...
                                            <img src="admin/assets/media/stock/600x400/img-1.jpg" class="w-50px rounded"
                                                alt="" />

                                            <img src="admin/assets/media/stock/600x400/img-2.jpg" class="w-50px rounded"
                                                alt="" />

                                            <img src="admin/assets/media/stock/600x400/img-3.jpg" class="w-50px rounded"
                                                alt="" />

                                            <img src="admin/assets/media/stock/600x400/img-4.jpg" class="w-50px rounded"
                                                alt="" />

                                            <img src="admin/assets/media/stock/600x400/img-5.jpg" class="w-50px rounded"
                                                alt="" />

                                            <img src="admin/assets/media/stock/600x400/img-6.jpg" class="w-50px rounded"
                                                alt="" />
                        ...
                        <div class="highlight"> <button class="highlight-copy btn" data-bs-toggle="tooltip"
                            ...
                            <ul class="nav nav-pills" role="tablist">
                                <li class="nav-item"> <a class="nav-link active" data-bs-toggle="tab"
                                        href="#kt_highlight_68e5d6e0cf1b3" role="tab">HTML</a></li>
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="kt_highlight_68e5d6e0cf1b3" role="tabpanel">
                                    <div class="highlight-code">
                                        <pre class="language-html" style="height:400px"><code class="language-html">&lt;div class=&quot;tns tns-default mb-3&quot; style=&quot;direction: ltr&quot;&gt;
    &lt;!--begin::Slider--&gt;
    &lt;div
        data-tns=&quot;true&quot;
        data-tns-loop=&quot;true&quot;
...
&lt;div class=&quot;d-flex flex-center&quot;&gt;
    &lt;ul class=&quot;d-flex align-items-center list-unstyled gap-5 cursor-pointer&quot;&gt;
        &lt;li class=&quot;d-flex gap-3&quot; id=&quot;kt_slider_thumbnails&quot;&gt;
            &lt;img src=&quot;admin/assets/media/stock/600x400/img-1.jpg&quot; class=&quot;w-50px rounded&quot; alt=&quot;&quot;/&gt;
        &lt;/li&gt;
    &lt;/ul&gt;
&lt;/div&gt;</code></pre>
                                    </div>
