        ...
        <div class="container d-flex flex-column flex-lg-row" id="kt_docs_content_container">
            ...
            <div class="card card-docs flex-row-fluid mb-2" id="kt_docs_content_card">
                ...
                <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                    ...
                    <div class="pt-10">
                        <!--begin::Heading-->
                        <h1 class="anchor fw-bold mb-5" data-kt-scroll-offset="85" id="multiple">
                            <a href="#multiple" data-kt-scroll-toggle></a>
                        ...
                        <div class="py-5">
                            <div class="mb-3">
                                Wrap draggable zone with <code>.min-h-200px draggable-zone</code> and define draggable
                                elements with <code>.draggable</code> and let drag & drop through
                            ...
                            <div class="highlight"> <button class="highlight-copy btn" data-bs-toggle="tooltip"
                                ...
                                <ul class="nav nav-pills" role="tablist">
                                    <li class="nav-item"> <a class="nav-link active" data-bs-toggle="tab"
                                            href="#kt_highlight_68e5b103071de" role="tab">JAVASCRIPT</a></li>
                                    <li class="nav-item"> <a class="nav-link " data-bs-toggle="tab"
                                            href="#kt_highlight_68e5b103071e2" role="tab">HTML</a></li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="kt_highlight_68e5b103071de"
                                        role="tabpanel">
                                        <div class="highlight-code">
                                            <pre class="language-javascript" style="height:400px"><code class="language-javascript">var containers = document.querySelectorAll(&quot;.min-h-200px draggable-zone&quot;);
...
var swappable = new Sortable.default(containers, {
    ...
    mirror: {
        ...
        constrainDimensions: true
                                    ...
                                    <div class="tab-pane fade " id="kt_highlight_68e5b103071e2" role="tabpanel">
                                        <div class="highlight-code">
...
@section('scripts')
    ...
    <script src="admin/assets/js/custom/documentation/general/draggable/multiple-containers.js"></script>
