            ...
            <div class="card card-docs flex-row-fluid mb-2" id="kt_docs_content_card">
                ...
                <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                    ...
                    <div class="py-10">
                        ...
                        <!--begin::Block-->
                        <div class="py-5">
                            Draggable's script bundles are separate from our global bundle and required to be included and
                            initialized manually on related pages.
                        </div>
                        <!--end::Block-->
                        ...
                        <div class="py-5">
                            ...
                            <div class="highlight"> <button class="highlight-copy btn" data-bs-toggle="tooltip"
                                ...
                                <div class="highlight-code">
                                    <pre class="language-html"><code class="language-html">&lt;script src=&quot;admin/assets/plugins/custom/draggable/draggable.bundle.js&quot;&gt;&lt;/script&gt;</code></pre>
                                </div>
                            </div><!--end::Highlight-->
                        </div>
                        <!--end::Code-->
                    ...
                    <div class="pt-10">
                        ...
                        <div class="pt-5">
                            <ul class="py-0 mb-0">
                                <li class="py-2">
                                    Draggable's Javascript is required to be added into the page via the <a href="#usage"
                                        class="me-1" data-kt-scroll-toggle>usage code</a> snippet above, along with our
                                    other global bundles.
                                </li>
                                <li class="py-2">
                                    Create the basic HTML structure using some of the default CSS classes for Draggable and
                                    Bootstrap for styling.
                                </li>
                                <li class="pt-2">
                                    Please refer to some of our examples:
                                    <ul class="pt-3">
                                        <li class="py-2"><a href="/html/metronic/docs/general/draggable/cards">Cards</a>
                                        </li>
                                        <li class="py-2"><a
                                                href="/html/metronic/docs/general/draggable/multiple-containers">Multiple
                                                Containers</a></li>
                                        <li class="py-2"><a
                                                href="/html/metronic/docs/general/draggable/swappable">Swappable</a></li>
                                        <li class="py-2"><a
                                                href="/html/metronic/docs/general/draggable/restricted">Restricted</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
