            ...
            <div class="card card-docs flex-row-fluid mb-2" id="kt_docs_content_card">
                ...
                <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                    ...
                    <div class="pb-10">
                        ...
                        <!--begin::Block-->
                        <div class="py-5">
                            Metronic customizes the <a href="https://getbootstrap.com/docs/5.2/components/alerts/"
                                target="_blank" class="fw-semibold">Bootstrap Alerts</a>&nbsp;
                        ...
                        <div class="py-5">
                            <div class="rounded border p-10 pb-0 d-flex flex-column">
                                ...
                                <div class="alert alert-info d-flex align-items-center p-5 mb-10">
                                    <i class="ki-duotone ki-shield-tick fs-2hx text-info me-4"><span
                                            class="path1"></span><span class="path2"></span></i>
                                    <div class="d-flex flex-column">
                        ...
                        <div class="py-5">
                            ...
                            <div class="highlight"> <button class="highlight-copy btn" data-bs-toggle="tooltip"
                                ...
                                <div class="highlight-code">
                                    <pre class="language-html"><code class="language-html">&lt;!--begin::Alert--&gt;
...
&lt;!--end::Alert--&gt;</code></pre>
                    ...
                    <div class="py-10">
                        ...
                        <!--begin::Heading-->
                        <h1 class="anchor fw-bold mb-5" id="solid-colors" data-kt-scroll-offset="50">
                        ...
                        <div class="py-5">
                            ...
                            with a solid color.
                            Please refer to our <a href="/docs/base/utilities#theme-colors" class="me-1">Theme colors</a>
                            for more info.
                        </div>
                        <!--end::Block-->
                        ...
                        <div class="py-5">
                            ...
                            and <code>data-bs-dismiss="alert"</code>
                            to the close button to allow dismissing alerts. Please take note of the HTML markup
                            sample below for all required responsive classes.
                        </div>
                        <!--end::Block-->
                        ...
                        <div class="py-5">
                            ...
                            <div class="highlight"> <button class="highlight-copy btn" data-bs-toggle="tooltip"
                                    title="Copy code">copy</button>
                                <div class="highlight-code">
                                    <pre class="language-html" style="height:400px"><code class="language-html">&lt;!--begin::Alert--&gt;
...
&lt;!--end::Alert--&gt;</code></pre>
                    ...
                    <div class="py-10">
                        ...
                        <div class="py-5">
                            ...
                            style with a light color. Please refer to our <a href="/docs/base/utilities#theme-colors"
                                class="me-1">Theme
                                colors</a> for more info.
                        </div>
                        <!--end::Block-->
                        ...
                        <div class="py-5">
                            Add the class <code>.alert-dismissible</code> to the parent <code>.alert</code> wrapper
                            and <code>data-bs-dismiss="alert"</code> to the close button to allow dismissing
                            alerts. Please take note of the HTML markup sample below for all required responsive
                            classes.
                        </div>
                        <!--end::Block-->
                        ...
                        <div class="py-5">
                            <div class="rounded border p-10 pb-0 d-flex flex-column">
                                ...
                                <div
                                    ...
                                    <!--begin::Icon-->
                                    <i class="ki-duotone ki-search-list fs-2hx text-primary me-4 mb-5 mb-sm-0"><span
                                            class="path1"></span><span class="path2"></span><span
                                            class="path3"></span></i> <!--end::Icon-->
                                ...
                                <div
                                    ...
                                    <!--begin::Icon-->
                                    <i class="ki-duotone ki-pencil fs-2hx text-success me-4 mb-5 mb-sm-0"><span
                                            class="path1"></span><span class="path2"></span></i>
                                    <!--end::Icon-->
...
&lt;!--end::Alert--&gt;</code></pre>
                    ...
                    <div class="py-10">
                        ...
                        <!--begin::Heading-->
                        <h1 class="anchor fw-bold mb-5" id="border-options" data-kt-scroll-offset="50">
                            <a href="#border-options"></a>
                        ...
                        <div class="py-5">
                            ...
                            classes to set the alert's style with borders.
                            Please refer to our <a href="/docs/base/utilities#theme-colors" class="me-1">Theme
                                colors</a> and
                            <a href="/docs/base/helpers/borders" class="me-1">Borders</a> for more
                            info.
                        </div>
                        <!--end::Block-->
...
&lt;!--end::Alert--&gt;</code></pre>
                    ...
                    <div class="pt-10">
                        ...
                        <!--begin::Block-->
                        <div class="py-5">
                            Here's a sample of an alert with rich content elements inside it. Please take note of
                            the HTML markup sample below for all required classes.
                        </div>
                        <!--end::Block-->
                            ...
                            <div class="rounded border p-10 pb-0 d-flex flex-column flex-center">
                                <div
                                    ...
                                    <div class="text-center text-gray-900">
                                        ...
                                        <div class="mb-9">
                                            The alert component can be used to highlight certain parts of your page
                                            for <strong>higher content visibility</strong>.<br />
                                            Please read our <a href="#" class="fw-bold me-1">Terms and
                                                Conditions</a> for more info.
                                        </div>
                ...
                <div class="card card-flush d-none d-lg-flex" data-kt-sticky="true" data-kt-sticky-name="sidebar-navs"
                    ...
                    <div class="card-body px-0 px-6 py-6 min-h-300px">
                        ...
                        <ul id="kt_sidebar_nav"
                            ...
                            <li class="menu-item py-2 px-3">
                                <!--begin::Link-->
                                <a href="#solid-colors" data-kt-scroll-toggle="true" class="menu-link p-0 nav-link">
                                    <span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
                            ...
                            <li class="menu-item py-2 px-3">
                                <!--begin::Link-->
                                <a href="#border-options" data-kt-scroll-toggle="true" class="menu-link p-0 nav-link">
                                    <span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
                                    <span class="menu-title">Border Options</span>
                                </a>
                                <!--end::Link-->
                            </li>
                            <!--end::Item-->
