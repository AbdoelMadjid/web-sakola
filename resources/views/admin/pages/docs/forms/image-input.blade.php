            ...
            <div class="card card-docs flex-row-fluid mb-2" id="kt_docs_content_card">
                ...
                <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                    ...
                    <div class="pb-10">
                        ...
                        <!--begin::Block-->
                        <div class="py-5">
                            Image input is an exclusive plugin of Metronic that enables a simple, user-friendly and
                            lightweight image input field.
                        </div>
                        <!--end::Block-->
                    </div>
                    <!--end::Section-->
                    ...
                    <div class="py-10">
                        ...
                        <!--begin::Block-->
                        <div class="py-5">
                            Image input's CSS and Javascript files are bundled in the global style and scripts bundles and
...
&lt;script src=&quot;admin/assets/js/scripts.bundle.js&quot;&gt;&lt;/script&gt;</code></pre>
                    ...
                    <div class="py-10">
                        ...
                        <div class="py-5">
                            <ul class="py-0">
                                <li class="py-2">
                                    Image input does not come with its own custom CSS and it uses global input controls and
                                    related elements.
                                </li>
                                <li class="py-2">
                                    Image input instances are automatically initialized through
                                    <code>data-kt-image-input="true"</code> HTML attribute on document ready event. However,
                                    some HTML markup is required to build the content and controls required. To initialize
                                    Image Input instance in Javascript remove <code>data-kt-image-input="true"</code>
                                    attribute and refer to <code>KTImageInput</code> class constructor below.
                                </li>
                                <li class="py-2">
                                    The HTML markup comes in a few sections:
                                    <ul class="pt-3">
                                        <li class="py-2">Main wrapper</li>
                                        <li class="py-2">Image preview wrapper</li>
                                        <li class="py-2">Edit button</li>
                                        <li class="py-2">Cancel button</li>
                                        <li class="py-2">Remove button</li>
                                    </ul>
                                </li>
                                <li class="py-2">
                                    The image preview wrapper element is identified by the <code>.image-input-wrapper</code>
                                    css class.
                                </li>
                                <li class="py-2">
                                    The edit button is identified by the <code>data-kt-image-input-action="change"</code>
                                    attribute.
                                </li>
                                <li class="py-2">
                                    The cancel button is identified by the <code>data-kt-image-input-action="cancel"</code>
                                    attribute.
                                </li>
                                <li class="py-2">
                                    The remove button is identified by the <code>data-kt-image-input-action="remove"</code>
                                    attribute.
                                </li>
                                <li class="py-2">
                                ...
                                <li class="py-2">
                                    Image input instances can also be controlled programmatically with Javascript. <a
                                        href="#methods" data-kt-scroll-toggle>See below for more info</a>.
                                </li>
                            </ul>
                        </div>
                        <!--end::Block-->
                    ...
                    <div class="py-10">
                        ...
                        <div class="py-5">
                            <div class="rounded border p-10">
                                ...
                                <!--begin::Image input-->
                                <div class="image-input image-input-empty image-input-placeholder1"
                                    ...
                                    <label
                                        ...
                                        data-kt-image-input-action="change" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                    ...
                                    <span
                                        ...
                                        data-kt-image-input-action="cancel" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                    ...
                                    <span
                                        class="btn btn-icon btn-color-muted btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                                        data-kt-image-input-action="remove" data-bs-toggle="tooltip" data-bs-trigger="hover"
                        ...
                        <div class="py-5">
                            ...
                            <div class="highlight"> <button class="highlight-copy btn" data-bs-toggle="tooltip"
                                    title="Copy code">copy</button>
                                <div class="highlight-code">
                                    <pre class="language-html" style="height:400px"><code class="language-html">&lt;!--begin::Image input placeholder--&gt;
&lt;style&gt;
                        ...
                        <div class="py-5">
                            <div class="rounded border p-10">
                                ...
                                <style>
                                    ...
                                    [data-bs-theme="dark"] .image-input-placeholder3 {
                                        background-image: url('admin/assets/media/svg/avatars/blank-dark.svg');
                                    }
                                </style>
                                ...
                                <!--begin::Image input-->
                                <div class="image-input image-input-outline image-input-placeholder3"
                                    data-kt-image-input="true">
                                    <!--begin::Preview existing avatar-->
                                    ...
                                    <label
                                        ...
                                        data-bs-trigger="hover" data-bs-dismiss="click" title="Change avatar">
                                        <i class="ki-duotone ki-pencil fs-6"><span class="path1"></span><span
                                                class="path2"></span></i>
                                        <!--begin::Inputs-->
                                        <input type="file" name="avatar" accept=".png, .jpg, .jpeg" />
                                    ...
                                    <span
                                        ...
                                        data-bs-trigger="hover" data-bs-dismiss="click" title="Cancel avatar">
                                        <i class="ki-outline ki-cross fs-3"></i> </span>
                                    <!--end::Cancel-->
                                    ...
                                    <span
                                        ...
                                        data-bs-trigger="hover" data-bs-dismiss="click" title="Remove avatar">
                                        <i class="ki-outline ki-cross fs-3"></i> </span>
                                    <!--end::Remove-->
                                </div>
                                <!--end::Image input-->
...
&lt;!--begin::Image input--&gt;
&lt;div class=&quot;image-input image-input-outline&quot; data-kt-image-input=&quot;true&quot; style=&quot;background-image: url(/admin/assets/media/svg/avatars/blank.svg)&quot;&gt;
    &lt;!--begin::Image preview wrapper--&gt;
    &lt;div class=&quot;image-input-wrapper w-125px h-125px&quot; style=&quot;background-image: url(/admin/assets/media/avatars/300-1.jpg)&quot;&gt;&lt;/div&gt;
    &lt;!--end::Image preview wrapper--&gt;
                    ...
                    <div class="py-10">
                        ...
                        <div class="py-5">
                            <div class="rounded border p-10">
                                ...
                                <!--end::Background image-->
                                <!--begin::Image input-->
                                <div class="image-input image-input-circle image-input-placeholder2"
                                    data-kt-image-input="true">
                                    <!--begin::Preview existing avatar-->
                                    <div class="image-input-wrapper w-125px h-125px"
...
&lt;div class=&quot;image-input image-input-circle&quot; data-kt-image-input=&quot;true&quot; style=&quot;background-image: url(/admin/assets/media/svg/avatars/blank.svg)&quot;&gt;
    &lt;!--begin::Image preview wrapper--&gt;
    &lt;div class=&quot;image-input-wrapper w-125px h-125px&quot; style=&quot;background-image: url(/admin/assets/media/avatars/300-20.jpg)&quot;&gt;&lt;/div&gt;
    &lt;!--end::Image preview wrapper--&gt;
...
&lt;!--end::Image input--&gt;</code></pre>
                    ...
                    <div class="py-10">
                        ...
                        <!--begin::Block-->
                        <div class="py-5">
                            Image input uses both CSS and HTML attributes to define the input configuration. The CSS classes
                            below must be placed next to the main <code>image-input</code> css class within the main
                            wrapper. Here are the references for each below
                        </div>
                        <!--end::Block-->
                        ...
                        <div class="py-5">
                            ...
                            <div class="d-flex align-items-center rounded py-5 px-5 bg-light-primary "><i
                                ...
                                <div class="text-gray-700 fw-bold fs-6">
                                    Tip: The <code>image-input-circle</code> and <code>image-input-outline</code> classes
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <code>true</code> is set <code>KTImageInput</code>
                                                Javascript class automatically initializes the image input instance to apply
                                                the edit & remove logic.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <code>data-kt-image-input-action</code>
                                            </td>
                                            <td>
                                                <code class="ms-0">mandatory</code>
                                            </td>
                                            <td>
                                                <div class="mb-3">
                                                    To be applied to each button type. Accepts either <code>change</code>,
                                                    <code>cancel</code> or <code>remove</code> values. This specifies the
                                                    type of button it's assigned to.
                                                </div>
                    ...
                    <div class="py-10">
                        ...
                        <!--begin::Block-->
                        <div class="py-5">
                            All Image Input components are initialized automatically, however the following are the Image
                            input's
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <code>selector</code> is <code>[data-kt-image-input]</code>.
                                                This method can be used to initialize dynamicly populated Image Input
                                                ...
                                                <div class="pt-3">
                                                    ...
                                                    <div class="highlight"> <button class="highlight-copy btn"
                                                        ...
                                                        <div class="highlight-code">
                                                            <pre class="language-javascript"><code class="language-javascript">KTImageInput.createInstances();</code></pre>
                                                        </div>
                                                    </div><!--end::Highlight-->
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <div class="pt-3">
                                                    ...
                                                    <div class="highlight"> <button class="highlight-copy btn"
                                                            data-bs-toggle="tooltip" title="Copy code">copy</button>
                                                        <div class="highlight-code">
                                                            <pre class="language-javascript"><code class="language-javascript">var imageInputElement = document.querySelector(&quot;#kt_image_input_control&quot;);
var imageInput = KTImageInput.getInstance(imageInputElement);</code></pre>
                                                        </div>
                                                    </div><!--end::Highlight-->
                                                </div>
                                            </td>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                Constructs a new instance of <code>KTImageInput</code> class and initializes
                                                ...
                                                <div class="pt-3 mb-3">
                                                    ...
                                                    <div class="highlight"> <button class="highlight-copy btn"
                                                        ...
                                                        <div class="highlight-code">
                                                            <pre class="language-javascript"><code class="language-javascript">var imageInputElement = document.querySelector(&quot;#kt_image_input_control&quot;);
var imageInput = new KTImageInput(imageInputElement);</code></pre>
                                                        </div>
                                                    </div><!--end::Highlight-->
                                                </div>
                                                ...
                                                <div class="d-flex align-items-center rounded py-5 px-5 bg-light-info "><i
                                                        class="ki-duotone ki-information-5 fs-3x text-info me-5"><span
                                                            ...
                                                            class="path3"></span></i> <!--begin::Description-->
                                                    <div class="text-gray-700 fw-bold fs-6">
                                                        Remove <code>data-kt-image-input="true"</code> attribute to avoid
                                                        lazy initializes.
                                                    </div> <!--end::Description-->
                                                </div><!--end::Information-->
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <div class="pt-3">
                                                    ...
                                                    <div class="highlight"> <button class="highlight-copy btn"
                                                            data-bs-toggle="tooltip" title="Copy code">copy</button>
                                                        <div class="highlight-code">
                                                            <pre class="language-javascript"><code class="language-javascript">imageInput.getInputElement();</code></pre>
                                                        </div>
                                                    </div><!--end::Highlight-->
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <div class="pt-3">
                                                    ...
                                                    <div class="highlight"> <button class="highlight-copy btn"
                                                            data-bs-toggle="tooltip" title="Copy code">copy</button>
                                                        <div class="highlight-code">
                                                            <pre class="language-javascript"><code class="language-javascript">imageInput.goElement();</code></pre>
                                                        </div>
                                                    </div><!--end::Highlight-->
                                                </div>
                                            </td>
                            ...
                            <div class="table-responsive border rounded">
                                ...
                                <table class="table table-striped mb-0 g-6">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <code>kt.imageinput.change</code>
                                            </td>
                                            <td>
                                                ...
                                                <div class="pt-3">
                                                    ...
                                                    <div class="highlight"> <button class="highlight-copy btn"
                                                            data-bs-toggle="tooltip" title="Copy code">copy</button>
                                                        <div class="highlight-code">
                                                            <pre class="language-javascript"><code class="language-javascript">var imageInputElement = document.querySelector(&quot;#kt_image_input_example_1&quot;);
...
imageInput.on(&quot;kt.imageinput.change&quot;, function() {
    // console.log(&quot;kt.imageinput.change event is fired&quot;);
                                        ...
                                        <tr>
                                            <td>
                                                <code>kt.imageinput.changed</code>
                                            </td>
                                            <td>
...
imageInput.on(&quot;kt.imageinput.changed&quot;, function() {
    // console.log(&quot;kt.imageinput.changed event is fired&quot;);
                                        ...
                                        <tr>
                                            <td>
                                                <code>kt.imageinput.cancel</code>
                                            </td>
                                            <td>
...
imageInput.on(&quot;kt.imageinput.cancel&quot;, function() {
    // console.log(&quot;kt.imageinput.cancel event is fired&quot;);
                                        ...
                                        <tr>
                                            <td>
                                                <code>kt.imageinput.canceled</code>
                                            </td>
                                            <td>
...
imageInput.on(&quot;kt.imageinput.canceled&quot;, function() {
    // console.log(&quot;kt.imageinput.canceled event is fired&quot;);
                                        ...
                                        <tr>
                                            <td>
                                                <code>kt.imageinput.remove</code>
                                            </td>
                                            <td>
...
imageInput.on(&quot;kt.imageinput.remove&quot;, function() {
    // console.log(&quot;kt.imageinput.remove event is fired&quot;);
                                        ...
                                        <tr>
                                            <td>
                                                <code>kt.imageinput.removed</code>
                                            </td>
                                            <td>
