            ...
            <div class="card card-docs flex-row-fluid mb-2" id="kt_docs_content_card">
                ...
                <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                    ...
                    <div class="pb-10">
                        ...
                        <!--begin::Block-->
                        <div class="py-5">
                            Form Repeater creates an interface to add and remove a repeatable group of input elements. For
                    ...
                    <div class="py-10">
                        ...
                        <!--begin::Block-->
                        <div class="py-5">
                            Form Repeater's script bundles are separate from our global bundle and required to be included
                            and initialized manually on related pages.
                        </div>
                        <!--end::Block-->
                        ...
                        <div class="py-5">
                            ...
                            <div class="highlight"> <button class="highlight-copy btn" data-bs-toggle="tooltip"
                                ...
                                <div class="highlight-code">
                                    <pre class="language-html"><code class="language-html">&lt;script src=&quot;admin/assets/plugins/custom/formrepeater/formrepeater.bundle.js&quot;&gt;&lt;/script&gt;</code></pre>
                                </div>
                            </div><!--end::Highlight-->
                        </div>
                        <!--end::Code-->
                    ...
                    <div class="pt-10">
                        ...
                        <div class="pt-5">
                            <ul class="py-0">
                                <li class="py-2">
                                    Form Repeater's CSS and Javascript is required to be added into the page via the <a
                                        href="#usage" class="me-1" data-kt-scroll-toggle>usage code</a> snippet above,
                                    along with our other global bundles.
                                </li>
                                <li class="py-2">
                                    Add an <code>id</code> HTML attribute to wrap the element wrapper that consists of
                                    repeated inputs. Then add <code>data-repeater-item</code> to define the repeated items.
                                </li>
                                <li class="pt-2">
                                    Please refer to the <a href="https://github.com/DubFriend/jquery.repeater"
                                        target="_blank" class="me-1">official documentation</a> for all options available.
                                </li>
                            </ul>
                        </div>
                        <!--end::Block-->
